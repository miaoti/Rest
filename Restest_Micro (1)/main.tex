...
Testing microservice-based systems spans API-level test generation, inter-service contract validation, resilience testing, and runtime diagnosis using distributed traces. Systematic reviews consistently highlight the difficulty of validating end-to-end behaviors that emerge from chains of service interactions rather than single endpoints alone, and call for tooling that is both workflow-aware and automation-friendly (e.g., discoverability of public entry points, realistic test data, and better oracles) \cite{waseem2020testing,miao2025sms}. We summarize the most relevant lines of work and contrast them with our trace-driven, root-API approach.

\subsection{API-Level Automated Test Generation}
%====================================================================
