...
public class BooksTest_1747604699826 {
    ...
    public void testScenario1() throws Exception {
        ...
        if (!scenarioFailed) {
            ...
            Allure.getLifecycle().startStep(java.util.UUID.randomUUID().toString(), new io.qameta.allure.model.StepResult().setName("Step 1: user-service POST /users").setStatus(Status.SKIPPED));
        }
        ...
        if (!scenarioFailed) {
            ...
            Allure.getLifecycle().startStep(java.util.UUID.randomUUID().toString(), new io.qameta.allure.model.StepResult().setName("Step 2: order-service POST /orders").setStatus(Status.SKIPPED));
        }
        ...
        if (!scenarioFailed) {
            ...
            Allure.getLifecycle().startStep(java.util.UUID.randomUUID().toString(), new io.qameta.allure.model.StepResult().setName("Step 3: payment-service POST /payments").setStatus(Status.SKIPPED));
        }
