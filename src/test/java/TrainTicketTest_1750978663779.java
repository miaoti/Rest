...
public class TrainTicketTest_1750978663779 {
    ...
    public void testScenario1() throws Exception {
        ...
        if (!scenarioFailed.get()) {
            ...
            try {
                ...
                req = req.body("{\"basicPriceRate\":\"test317\",\"firstClassPriceRate\":\"test321\",\"id\":\"test323\",\"routeId\":\"test325\",\"trainType\":\"test326\"}");
