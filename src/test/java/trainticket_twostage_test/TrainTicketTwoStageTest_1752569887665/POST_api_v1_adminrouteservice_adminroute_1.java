        ...
        Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
            ...
            if (!shouldSkip) {
                ...
                try {
                    ...
                    req = req.body("{\"distanceList\":\"800\",\"distances\":\"25.6\",\"endStation\":\"Borough hall\",\"id\":\"unique_id789\",\"loginId\":\"john_doe2023\",\"startStation\":\"Los angeles union station\",\"stationList\":\"Tokyo shinjuku station\",\"stations\":\"Baker Street\"}");
                    Allure.addAttachment("📋 Request Body", "application/json", "{\"distanceList\":\"800\",\"distances\":\"25.6\",\"endStation\":\"Borough hall\",\"id\":\"unique_id789\",\"loginId\":\"john_doe2023\",\"startStation\":\"Los angeles union station\",\"stationList\":\"Tokyo shinjuku station\",\"stations\":\"Baker Street\"}");
        ...
        Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
            ...
            if (!shouldSkip) {
                ...
                try {
                    ...
                    req = req.contentType("application/json");
                    req = req.body("{\"distanceList\":\"800\",\"endStation\":\"Borough hall\",\"id\":\"unique_id789\",\"startStation\":\"Los angeles union station\",\"stationList\":\"Tokyo shinjuku station\"}");
                    Allure.addAttachment("📋 Request Body", "application/json", "{\"distanceList\":\"800\",\"endStation\":\"Borough hall\",\"id\":\"unique_id789\",\"startStation\":\"Los angeles union station\",\"stationList\":\"Tokyo shinjuku station\"}");
        ...
        Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
            ...
            if (!shouldSkip) {
                ...
                try {
                    ...
                    req = req.contentType("application/json");
                    req = req.body("{\"distanceList\":\"25.6\",\"distances\":\"10\",\"endStation\":\"Borough hall\",\"id\":\"Xyz7890\",\"loginId\":\"admin456\",\"startStation\":\"chicago o'hare international airport\",\"stationList\":\"San Francisco Union Square\",\"stations\":\"Union Square\"}");
                    Allure.addAttachment("📋 Request Body", "application/json", "{\"distanceList\":\"25.6\",\"distances\":\"10\",\"endStation\":\"Borough hall\",\"id\":\"Xyz7890\",\"loginId\":\"admin456\",\"startStation\":\"chicago o'hare international airport\",\"stationList\":\"San Francisco Union Square\",\"stations\":\"Union Square\"}");
                    Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                           .then().log().ifValidationFails()
                           .statusCode(200)
                           .extract().response();
        ...
        Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
            ...
            if (!shouldSkip) {
                ...
                try {
                    ...
                    req = req.contentType("application/json");
                    req = req.body("{\"distanceList\":\"25.6\",\"endStation\":\"Borough hall\",\"id\":\"Xyz7890\",\"startStation\":\"chicago o'hare international airport\",\"stationList\":\"San Francisco Union Square\"}");
                    Allure.addAttachment("📋 Request Body", "application/json", "{\"distanceList\":\"25.6\",\"endStation\":\"Borough hall\",\"id\":\"Xyz7890\",\"startStation\":\"chicago o'hare international airport\",\"stationList\":\"San Francisco Union Square\"}");
                    Response stepResponse3 = req.when().post("/api/v1/routeservice/routes")
                           .then().log().ifValidationFails()
                           .statusCode(200)
                           .extract().response();
        ...
        Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
            ...
            if (!shouldSkip) {
                ...
                try {
                    ...
                    req = req.contentType("application/json");
                    req = req.body("{\"distanceList\":\"800\",\"distances\":\"9.9\",\"endStation\":\"borough hall\",\"id\":\"buf\",\"loginId\":\"testuser001\",\"startStation\":\"Chicago O'Hare International Airport\",\"stationList\":\"london victoria station\",\"stations\":\"times square\"}");
                    Allure.addAttachment("📋 Request Body", "application/json", "{\"distanceList\":\"800\",\"distances\":\"9.9\",\"endStation\":\"borough hall\",\"id\":\"buf\",\"loginId\":\"testuser001\",\"startStation\":\"Chicago O'Hare International Airport\",\"stationList\":\"london victoria station\",\"stations\":\"times square\"}");
                    Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                           .then().log().ifValidationFails()
                           .statusCode(200)
                           .extract().response();
        ...
        Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
            ...
            if (!shouldSkip) {
                ...
                try {
                    ...
                    req = req.contentType("application/json");
                    req = req.body("{\"distanceList\":\"800\",\"endStation\":\"borough hall\",\"id\":\"buf\",\"startStation\":\"Chicago O'Hare International Airport\",\"stationList\":\"london victoria station\"}");
                    Allure.addAttachment("📋 Request Body", "application/json", "{\"distanceList\":\"800\",\"endStation\":\"borough hall\",\"id\":\"buf\",\"startStation\":\"Chicago O'Hare International Airport\",\"stationList\":\"london victoria station\"}");
                    Response stepResponse3 = req.when().post("/api/v1/routeservice/routes")
                           .then().log().ifValidationFails()
                           .statusCode(200)
                           .extract().response();
        ...
        Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
            ...
            if (!shouldSkip) {
                ...
                try {
                    ...
                    req = req.contentType("application/json");
                    req = req.body("{\"distanceList\":\"450.75\",\"distances\":\"25.6\",\"endStation\":\"borough hall\",\"id\":\"User_456\",\"loginId\":\"john_doe2023\",\"startStation\":\"Los Angeles Union Station\",\"stationList\":\"San Francisco Union Square\",\"stations\":\"Times square\"}");
                    Allure.addAttachment("📋 Request Body", "application/json", "{\"distanceList\":\"450.75\",\"distances\":\"25.6\",\"endStation\":\"borough hall\",\"id\":\"User_456\",\"loginId\":\"john_doe2023\",\"startStation\":\"Los Angeles Union Station\",\"stationList\":\"San Francisco Union Square\",\"stations\":\"Times square\"}");
                    Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                           .then().log().ifValidationFails()
                           .statusCode(200)
                           .extract().response();
        ...
        Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
            ...
            if (!shouldSkip) {
                ...
                try {
                    ...
                    req = req.contentType("application/json");
                    req = req.body("{\"distanceList\":\"450.75\",\"endStation\":\"borough hall\",\"id\":\"User_456\",\"startStation\":\"Los Angeles Union Station\",\"stationList\":\"San Francisco Union Square\"}");
                    Allure.addAttachment("📋 Request Body", "application/json", "{\"distanceList\":\"450.75\",\"endStation\":\"borough hall\",\"id\":\"User_456\",\"startStation\":\"Los Angeles Union Station\",\"stationList\":\"San Francisco Union Square\"}");
                    Response stepResponse3 = req.when().post("/api/v1/routeservice/routes")
                           .then().log().ifValidationFails()
                           .statusCode(200)
                           .extract().response();
        ...
        Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
            ...
            if (!shouldSkip) {
                ...
                try {
                    ...
                    req = req.contentType("application/json");
                    req = req.body("{\"distanceList\":\"300\",\"distances\":\"9.9\",\"endStation\":\"Borough hall\",\"id\":\"uniqueness\",\"loginId\":\"Sydney_measured_####kbps\",\"startStation\":\"Los Angeles Union Station\",\"stationList\":\"Tokyo Shinjuku Station\",\"stations\":\"union square\"}");
                    Allure.addAttachment("📋 Request Body", "application/json", "{\"distanceList\":\"300\",\"distances\":\"9.9\",\"endStation\":\"Borough hall\",\"id\":\"uniqueness\",\"loginId\":\"Sydney_measured_####kbps\",\"startStation\":\"Los Angeles Union Station\",\"stationList\":\"Tokyo Shinjuku Station\",\"stations\":\"union square\"}");
                    Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                           .then().log().ifValidationFails()
                           .statusCode(200)
                           .extract().response();
        ...
        Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
            ...
            if (!shouldSkip) {
                ...
                try {
                    ...
                    req = req.contentType("application/json");
                    req = req.body("{\"distanceList\":\"300\",\"endStation\":\"Borough hall\",\"id\":\"uniqueness\",\"startStation\":\"Los Angeles Union Station\",\"stationList\":\"Tokyo Shinjuku Station\"}");
                    Allure.addAttachment("📋 Request Body", "application/json", "{\"distanceList\":\"300\",\"endStation\":\"Borough hall\",\"id\":\"uniqueness\",\"startStation\":\"Los Angeles Union Station\",\"stationList\":\"Tokyo Shinjuku Station\"}");
                    Response stepResponse3 = req.when().post("/api/v1/routeservice/routes")
                           .then().log().ifValidationFails()
                           .statusCode(200)
                           .extract().response();
        ...
        Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
            ...
            if (!shouldSkip) {
                ...
                try {
                    ...
                    req = req.contentType("application/json");
                    req = req.body("{\"distanceList\":\"300\",\"distances\":\"80\",\"endStation\":\"Grand central terminal\",\"id\":\"User_456\",\"loginId\":\"admins\",\"startStation\":\"Boston logan international airport\",\"stationList\":\"sydney central railway station\",\"stations\":\"Downtown crossing\"}");
                    Allure.addAttachment("📋 Request Body", "application/json", "{\"distanceList\":\"300\",\"distances\":\"80\",\"endStation\":\"Grand central terminal\",\"id\":\"User_456\",\"loginId\":\"admins\",\"startStation\":\"Boston logan international airport\",\"stationList\":\"sydney central railway station\",\"stations\":\"Downtown crossing\"}");
                    Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                           .then().log().ifValidationFails()
                           .statusCode(200)
                           .extract().response();
        ...
        Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
            ...
            if (!shouldSkip) {
                ...
                try {
                    ...
                    req = req.contentType("application/json");
                    req = req.body("{\"distanceList\":\"300\",\"endStation\":\"Grand central terminal\",\"id\":\"User_456\",\"startStation\":\"Boston logan international airport\",\"stationList\":\"sydney central railway station\"}");
                    Allure.addAttachment("📋 Request Body", "application/json", "{\"distanceList\":\"300\",\"endStation\":\"Grand central terminal\",\"id\":\"User_456\",\"startStation\":\"Boston logan international airport\",\"stationList\":\"sydney central railway station\"}");
                    Response stepResponse3 = req.when().post("/api/v1/routeservice/routes")
                           .then().log().ifValidationFails()
                           .statusCode(200)
                           .extract().response();
        ...
        Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
            ...
            if (!shouldSkip) {
                ...
                try {
                    ...
                    req = req.contentType("application/json");
                    req = req.body("{\"distanceList\":\"300\",\"distances\":\"25.6\",\"endStation\":\"lancaster road\",\"id\":\"distinctive\",\"loginId\":\"john_doe2023\",\"startStation\":\"New York Penn Station\",\"stationList\":\"tokyo shinjuku station\",\"stations\":\"Central station\"}");
                    Allure.addAttachment("📋 Request Body", "application/json", "{\"distanceList\":\"300\",\"distances\":\"25.6\",\"endStation\":\"lancaster road\",\"id\":\"distinctive\",\"loginId\":\"john_doe2023\",\"startStation\":\"New York Penn Station\",\"stationList\":\"tokyo shinjuku station\",\"stations\":\"Central station\"}");
                    Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                           .then().log().ifValidationFails()
                           .statusCode(200)
                           .extract().response();
        ...
        Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
            ...
            if (!shouldSkip) {
                ...
                try {
                    ...
                    req = req.contentType("application/json");
                    req = req.body("{\"distanceList\":\"300\",\"endStation\":\"lancaster road\",\"id\":\"distinctive\",\"startStation\":\"New York Penn Station\",\"stationList\":\"tokyo shinjuku station\"}");
                    Allure.addAttachment("📋 Request Body", "application/json", "{\"distanceList\":\"300\",\"endStation\":\"lancaster road\",\"id\":\"distinctive\",\"startStation\":\"New York Penn Station\",\"stationList\":\"tokyo shinjuku station\"}");
                    Response stepResponse3 = req.when().post("/api/v1/routeservice/routes")
                           .then().log().ifValidationFails()
                           .statusCode(200)
                           .extract().response();
        ...
        Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
            ...
            if (!shouldSkip) {
                ...
                try {
                    ...
                    req = req.contentType("application/json");
                    req = req.body("{\"distanceList\":\"300\",\"distances\":\"10\",\"endStation\":\"Springfield train station\",\"id\":\"xyz7890\",\"loginId\":\"admins\",\"startStation\":\"San Francisco International Airport\",\"stationList\":\"Tokyo shinjuku station\",\"stations\":\"downtown crossing\"}");
                    Allure.addAttachment("📋 Request Body", "application/json", "{\"distanceList\":\"300\",\"distances\":\"10\",\"endStation\":\"Springfield train station\",\"id\":\"xyz7890\",\"loginId\":\"admins\",\"startStation\":\"San Francisco International Airport\",\"stationList\":\"Tokyo shinjuku station\",\"stations\":\"downtown crossing\"}");
                    Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                           .then().log().ifValidationFails()
                           .statusCode(200)
                           .extract().response();
        ...
        Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
            ...
            if (!shouldSkip) {
                ...
                try {
                    ...
                    req = req.contentType("application/json");
                    req = req.body("{\"distanceList\":\"300\",\"endStation\":\"Springfield train station\",\"id\":\"xyz7890\",\"startStation\":\"San Francisco International Airport\",\"stationList\":\"Tokyo shinjuku station\"}");
                    Allure.addAttachment("📋 Request Body", "application/json", "{\"distanceList\":\"300\",\"endStation\":\"Springfield train station\",\"id\":\"xyz7890\",\"startStation\":\"San Francisco International Airport\",\"stationList\":\"Tokyo shinjuku station\"}");
                    Response stepResponse3 = req.when().post("/api/v1/routeservice/routes")
                           .then().log().ifValidationFails()
                           .statusCode(200)
                           .extract().response();
        ...
        Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
            ...
            if (!shouldSkip) {
                ...
                try {
                    ...
                    req = req.contentType("application/json");
                    req = req.body("{\"distanceList\":\"800\",\"distances\":\"45.3\",\"endStation\":\"Springfield Train Station\",\"id\":\"Xyz7890\",\"loginId\":\"McIntyre_fondly_remembered\",\"startStation\":\"Chicago o'hare international airport\",\"stationList\":\"London victoria station\",\"stations\":\"Downtown Crossing\"}");
                    Allure.addAttachment("📋 Request Body", "application/json", "{\"distanceList\":\"800\",\"distances\":\"45.3\",\"endStation\":\"Springfield Train Station\",\"id\":\"Xyz7890\",\"loginId\":\"McIntyre_fondly_remembered\",\"startStation\":\"Chicago o'hare international airport\",\"stationList\":\"London victoria station\",\"stations\":\"Downtown Crossing\"}");
                    Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                           .then().log().ifValidationFails()
                           .statusCode(200)
                           .extract().response();
        ...
        Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
            ...
            if (!shouldSkip) {
                ...
                try {
                    ...
                    req = req.contentType("application/json");
                    req = req.body("{\"distanceList\":\"800\",\"endStation\":\"Springfield Train Station\",\"id\":\"Xyz7890\",\"startStation\":\"Chicago o'hare international airport\",\"stationList\":\"London victoria station\"}");
                    Allure.addAttachment("📋 Request Body", "application/json", "{\"distanceList\":\"800\",\"endStation\":\"Springfield Train Station\",\"id\":\"Xyz7890\",\"startStation\":\"Chicago o'hare international airport\",\"stationList\":\"London victoria station\"}");
                    Response stepResponse3 = req.when().post("/api/v1/routeservice/routes")
                           .then().log().ifValidationFails()
                           .statusCode(200)
                           .extract().response();
        ...
        Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
            ...
            if (!shouldSkip) {
                ...
                try {
                    ...
                    req = req.contentType("application/json");
                    req = req.body("{\"distanceList\":\"300\",\"distances\":\"10\",\"endStation\":\"springfield train station\",\"id\":\"user_456\",\"loginId\":\"guests\",\"startStation\":\"Los Angeles Union Station\",\"stationList\":\"London victoria station\",\"stations\":\"Downtown Crossing\"}");
                    Allure.addAttachment("📋 Request Body", "application/json", "{\"distanceList\":\"300\",\"distances\":\"10\",\"endStation\":\"springfield train station\",\"id\":\"user_456\",\"loginId\":\"guests\",\"startStation\":\"Los Angeles Union Station\",\"stationList\":\"London victoria station\",\"stations\":\"Downtown Crossing\"}");
                    Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                           .then().log().ifValidationFails()
                           .statusCode(200)
                           .extract().response();
        ...
        Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
            ...
            if (!shouldSkip) {
                ...
                try {
                    ...
                    req = req.contentType("application/json");
                    req = req.body("{\"distanceList\":\"300\",\"endStation\":\"springfield train station\",\"id\":\"user_456\",\"startStation\":\"Los Angeles Union Station\",\"stationList\":\"London victoria station\"}");
                    Allure.addAttachment("📋 Request Body", "application/json", "{\"distanceList\":\"300\",\"endStation\":\"springfield train station\",\"id\":\"user_456\",\"startStation\":\"Los Angeles Union Station\",\"stationList\":\"London victoria station\"}");
                    Response stepResponse3 = req.when().post("/api/v1/routeservice/routes")
                           .then().log().ifValidationFails()
                           .statusCode(200)
                           .extract().response();
