            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        String requestBody1 = "{\"accountId\":\"test965\",\"boughtDate\":\"test5\",\"coachNumber\":\"test52\",\"contactsDocumentNumber\":\"test104\",\"contactsName\":\"test159\",\"differenceMoney\":\"test211\",\"documentType\":\"test266\",\"from\":\"test322\",\"id\":\"test168\",\"price\":\"test403\",\"seatClass\":\"test447\",\"seatNumber\":\"test503\",\"status\":\"test573\",\"to\":\"test630\",\"trainNumber\":\"67aba9ad-f550-46b3-ac36-2de602f63bdf\",\"travelDate\":\"test760\",\"travelTime\":\"test799\"}";
            ...
            Allure.step("Step 2: ts-order-other-service POST /api/v1/orderOtherService/orderOther/admin (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "{\"accountId\":\"test965\",\"boughtDate\":\"test5\",\"coachNumber\":\"test52\",\"contactsDocumentNumber\":\"test104\",\"contactsName\":\"test159\",\"documentType\":\"test266\",\"from\":\"test322\",\"id\":\"test168\",\"price\":\"test403\",\"seatClass\":\"test447\",\"seatNumber\":\"test503\",\"status\":\"test573\",\"to\":\"test630\",\"trainNumber\":\"67aba9ad-f550-46b3-ac36-2de602f63bdf\",\"travelDate\":\"test760\",\"travelTime\":\"test799\"}";
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"test965\",\"boughtDate\":\"test5\",\"coachNumber\":\"test52\",\"contactsDocumentNumber\":\"test104\",\"contactsName\":\"test159\",\"differenceMoney\":\"test211\",\"documentType\":\"test266\",\"from\":\"test322\",\"id\":\"test168\",\"price\":\"test403\",\"seatClass\":\"test447\",\"seatNumber\":\"test503\",\"status\":\"test573\",\"to\":\"test630\",\"trainNumber\":\"test103\",\"travelDate\":\"test760\",\"travelTime\":\"test799\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-order-other-service POST /api/v1/orderOtherService/orderOther/admin (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "{\"accountId\":\"test965\",\"boughtDate\":\"test5\",\"coachNumber\":\"test52\",\"contactsDocumentNumber\":\"test104\",\"contactsName\":\"test159\",\"documentType\":\"test266\",\"from\":\"test322\",\"id\":\"test168\",\"price\":\"test403\",\"seatClass\":\"test447\",\"seatNumber\":\"test503\",\"status\":\"test573\",\"to\":\"test630\",\"trainNumber\":\"test103\",\"travelDate\":\"test760\",\"travelTime\":\"test799\"}";
                        req = req.body(requestBody2);
