package trainticket_twostage_test.TrainTicketTwoStageTest_1754425702690;
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        String requestBody1 = "{\"distanceList\":\"$.data[*].averageSpeed\",\"distances\":\"67aba9ad-f550-46b3-ac36-2de602f63bdf\",\"endStation\":\"taiyuan\",\"id\":\"test168\",\"loginId\":\"test217\",\"startStation\":\"04b0a8ff-4d70-40ca-9e55-98d2ca2cf325\",\"stationList\":\"test314\",\"stations\":\"04b0a8ff-4d70-40ca-9e55-98d2ca2cf325\"}";
            ...
            Allure.step("Step 2: ts-station-service POST /api/v1/stationservice/stations/idlist (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "[\"test508\", \"test508\"]";
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"$.data[*].averageSpeed\",\"endStation\":\"taiyuan\",\"id\":\"test168\",\"startStation\":\"04b0a8ff-4d70-40ca-9e55-98d2ca2cf325\",\"stationList\":\"test314\"}";
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"$.data[*].averageSpeed\",\"distances\":\"67aba9ad-f550-46b3-ac36-2de602f63bdf\",\"endStation\":\"taiyuan\",\"id\":\"test168\",\"loginId\":\"test217\",\"startStation\":\"04b0a8ff-4d70-40ca-9e55-98d2ca2cf325\",\"stationList\":\"04b0a8ff-4d70-40ca-9e55-98d2ca2cf325\",\"stations\":\"04b0a8ff-4d70-40ca-9e55-98d2ca2cf325\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"$.data[*].averageSpeed\",\"endStation\":\"taiyuan\",\"id\":\"test168\",\"startStation\":\"04b0a8ff-4d70-40ca-9e55-98d2ca2cf325\",\"stationList\":\"04b0a8ff-4d70-40ca-9e55-98d2ca2cf325\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 2: ts-station-service POST /api/v1/stationservice/stations/idlist (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "[\"test508\", \"test508\", \"test508\", \"test508\"]";
                        req = req.body(requestBody2);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"$.data[*].averageSpeed\",\"distances\":\"test882\",\"endStation\":\"test905\",\"id\":\"test168\",\"loginId\":\"test217\",\"startStation\":\"04b0a8ff-4d70-40ca-9e55-98d2ca2cf325\",\"stationList\":\"04b0a8ff-4d70-40ca-9e55-98d2ca2cf325\",\"stations\":\"04b0a8ff-4d70-40ca-9e55-98d2ca2cf325\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"$.data[*].averageSpeed\",\"endStation\":\"test905\",\"id\":\"test168\",\"startStation\":\"04b0a8ff-4d70-40ca-9e55-98d2ca2cf325\",\"stationList\":\"04b0a8ff-4d70-40ca-9e55-98d2ca2cf325\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"test27\",\"distances\":\"test882\",\"endStation\":\"taiyuan\",\"id\":\"test168\",\"loginId\":\"test217\",\"startStation\":\"04b0a8ff-4d70-40ca-9e55-98d2ca2cf325\",\"stationList\":\"04b0a8ff-4d70-40ca-9e55-98d2ca2cf325\",\"stations\":\"04b0a8ff-4d70-40ca-9e55-98d2ca2cf325\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"test27\",\"endStation\":\"taiyuan\",\"id\":\"test168\",\"startStation\":\"04b0a8ff-4d70-40ca-9e55-98d2ca2cf325\",\"stationList\":\"04b0a8ff-4d70-40ca-9e55-98d2ca2cf325\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 2: ts-station-service POST /api/v1/stationservice/stations/idlist (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "[\"test508\", \"test508\", \"test508\"]";
                        req = req.body(requestBody2);
