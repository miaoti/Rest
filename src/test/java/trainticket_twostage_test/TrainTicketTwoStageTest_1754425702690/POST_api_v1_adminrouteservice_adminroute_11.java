            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"$.data[*].averageSpeed\",\"distances\":\"67aba9ad-f550-46b3-ac36-2de602f63bdf\",\"endStation\":\"test905\",\"id\":\"test168\",\"loginId\":\"test217\",\"startStation\":\"04b0a8ff-4d70-40ca-9e55-98d2ca2cf325\",\"stationList\":\"04b0a8ff-4d70-40ca-9e55-98d2ca2cf325\",\"stations\":\"04b0a8ff-4d70-40ca-9e55-98d2ca2cf325\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"$.data[*].averageSpeed\",\"distances\":\"test882\",\"endStation\":\"taiyuan\",\"id\":\"test168\",\"loginId\":\"test217\",\"startStation\":\"04b0a8ff-4d70-40ca-9e55-98d2ca2cf325\",\"stationList\":\"04b0a8ff-4d70-40ca-9e55-98d2ca2cf325\",\"stations\":\"04b0a8ff-4d70-40ca-9e55-98d2ca2cf325\"}";
                        req = req.body(requestBody1);
