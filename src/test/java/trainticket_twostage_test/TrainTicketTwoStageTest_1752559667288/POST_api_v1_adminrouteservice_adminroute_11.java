        ...
        if (shouldExecuteStep1) {
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                try {
                    ...
                    Allure.addAttachment("📋 Request Body", "application/json", "{\"distanceList\":\"10 kilometers\",\"distances\":\"500\",\"endStation\":\"New York Penn Station\",\"id\":\"nbc\",\"loginId\":\"Sydney_measured_####kbps\",\"startStation\":\"Chicago Union Terminal\",\"stationList\":\"Pier 13\",\"stations\":\"Boston south station\"}");
        ...
        if (shouldExecuteStep3) {
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                try {
                    ...
                    Allure.addAttachment("📋 Request Body", "application/json", "{\"distanceList\":\"10 kilometers\",\"endStation\":\"New York Penn Station\",\"id\":\"nbc\",\"startStation\":\"Chicago Union Terminal\",\"stationList\":\"Pier 13\"}");
        ...
        if (shouldExecuteStep1) {
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                try {
                    ...
                    Allure.addAttachment("📋 Request Body", "application/json", "{\"distanceList\":\"10 kilometers\",\"distances\":\"12.4\",\"endStation\":\"new york penn station\",\"id\":\"New york city\",\"loginId\":\"user123\",\"startStation\":\"houston hobby airport\",\"stationList\":\"bayside mall\",\"stations\":\"los angeles union station\"}");
                    Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                       .then().log().ifValidationFails()
                       .statusCode(200)
                       .extract().response();
        ...
        if (shouldExecuteStep3) {
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                try {
                    ...
                    Allure.addAttachment("📋 Request Body", "application/json", "{\"distanceList\":\"10 kilometers\",\"endStation\":\"new york penn station\",\"id\":\"New york city\",\"startStation\":\"houston hobby airport\",\"stationList\":\"bayside mall\"}");
                    Response stepResponse3 = req.when().post("/api/v1/routeservice/routes")
                       .then().log().ifValidationFails()
                       .statusCode(200)
                       .extract().response();
        ...
        if (shouldExecuteStep1) {
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                try {
                    ...
                    Allure.addAttachment("📋 Request Body", "application/json", "{\"distanceList\":\"7 feet\",\"distances\":\"12.4\",\"endStation\":\"San Francisco Market Street Station\",\"id\":\"abc-def-ghi\",\"loginId\":\"guests\",\"startStation\":\"New York Penn Station\",\"stationList\":\"Union square\",\"stations\":\"chicago union train terminal\"}");
                    Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                       .then().log().ifValidationFails()
                       .statusCode(200)
                       .extract().response();
        ...
        if (shouldExecuteStep3) {
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                try {
                    ...
                    Allure.addAttachment("📋 Request Body", "application/json", "{\"distanceList\":\"7 feet\",\"endStation\":\"San Francisco Market Street Station\",\"id\":\"abc-def-ghi\",\"startStation\":\"New York Penn Station\",\"stationList\":\"Union square\"}");
                    Response stepResponse3 = req.when().post("/api/v1/routeservice/routes")
                       .then().log().ifValidationFails()
                       .statusCode(200)
                       .extract().response();
        ...
        if (shouldExecuteStep1) {
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                try {
                    ...
                    Allure.addAttachment("📋 Request Body", "application/json", "{\"distanceList\":\"10 kilometers\",\"distances\":\"25.3\",\"endStation\":\"new york penn station\",\"id\":\"nbc\",\"loginId\":\"member001\",\"startStation\":\"Houston hobby airport\",\"stationList\":\"Central Station\",\"stations\":\"Boston South Station\"}");
                    Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                       .then().log().ifValidationFails()
                       .statusCode(200)
                       .extract().response();
        ...
        if (shouldExecuteStep3) {
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                try {
                    ...
                    Allure.addAttachment("📋 Request Body", "application/json", "{\"distanceList\":\"10 kilometers\",\"endStation\":\"new york penn station\",\"id\":\"nbc\",\"startStation\":\"Houston hobby airport\",\"stationList\":\"Central Station\"}");
                    Response stepResponse3 = req.when().post("/api/v1/routeservice/routes")
                       .then().log().ifValidationFails()
                       .statusCode(200)
                       .extract().response();
        ...
        if (shouldExecuteStep1) {
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                try {
                    ...
                    Allure.addAttachment("📋 Request Body", "application/json", "{\"distanceList\":\"10 kilometers\",\"distances\":\"25.3\",\"endStation\":\"New york penn station\",\"id\":\"1a2b3c\",\"loginId\":\"User123\",\"startStation\":\"Houston hobby airport\",\"stationList\":\"Bayside Mall\",\"stations\":\"Los angeles union station\"}");
                    Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                       .then().log().ifValidationFails()
                       .statusCode(200)
                       .extract().response();
        ...
        if (shouldExecuteStep3) {
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                try {
                    ...
                    Allure.addAttachment("📋 Request Body", "application/json", "{\"distanceList\":\"10 kilometers\",\"endStation\":\"New york penn station\",\"id\":\"1a2b3c\",\"startStation\":\"Houston hobby airport\",\"stationList\":\"Bayside Mall\"}");
                    Response stepResponse3 = req.when().post("/api/v1/routeservice/routes")
                       .then().log().ifValidationFails()
                       .statusCode(200)
                       .extract().response();
        ...
        if (shouldExecuteStep1) {
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                try {
                    ...
                    Allure.addAttachment("📋 Request Body", "application/json", "{\"distanceList\":\"3 inches\",\"distances\":\"7.89\",\"endStation\":\"chicago union station\",\"id\":\"1A2B3C\",\"loginId\":\"memeber\",\"startStation\":\"Los angeles union station\",\"stationList\":\"Bayside mall\",\"stations\":\"los angeles union station\"}");
                    Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                       .then().log().ifValidationFails()
                       .statusCode(200)
                       .extract().response();
        ...
        if (shouldExecuteStep3) {
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                try {
                    ...
                    Allure.addAttachment("📋 Request Body", "application/json", "{\"distanceList\":\"3 inches\",\"endStation\":\"chicago union station\",\"id\":\"1A2B3C\",\"startStation\":\"Los angeles union station\",\"stationList\":\"Bayside mall\"}");
                    Response stepResponse3 = req.when().post("/api/v1/routeservice/routes")
                       .then().log().ifValidationFails()
                       .statusCode(200)
                       .extract().response();
        ...
        if (shouldExecuteStep1) {
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                try {
                    ...
                    Allure.addAttachment("📋 Request Body", "application/json", "{\"distanceList\":\"2.5 yards\",\"distances\":\"10\",\"endStation\":\"Chicago Union Station\",\"id\":\"Sydney_measured_####kbps\",\"loginId\":\"testuser\",\"startStation\":\"Chicago union terminal\",\"stationList\":\"Bayside Mall\",\"stations\":\"San Francisco 4th Street BART\"}");
                    Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                       .then().log().ifValidationFails()
                       .statusCode(200)
                       .extract().response();
        ...
        if (shouldExecuteStep3) {
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                try {
                    ...
                    Allure.addAttachment("📋 Request Body", "application/json", "{\"distanceList\":\"2.5 yards\",\"endStation\":\"Chicago Union Station\",\"id\":\"Sydney_measured_####kbps\",\"startStation\":\"Chicago union terminal\",\"stationList\":\"Bayside Mall\"}");
                    Response stepResponse3 = req.when().post("/api/v1/routeservice/routes")
                       .then().log().ifValidationFails()
                       .statusCode(200)
                       .extract().response();
        ...
        if (shouldExecuteStep1) {
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                try {
                    ...
                    Allure.addAttachment("📋 Request Body", "application/json", "{\"distanceList\":\"3 inches\",\"distances\":\"7.89\",\"endStation\":\"Boston Logan International Airport\",\"id\":\"New york city\",\"loginId\":\"Guest789\",\"startStation\":\"san francisco international airport\",\"stationList\":\"Central Station\",\"stations\":\"Boston south station\"}");
                    Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                       .then().log().ifValidationFails()
                       .statusCode(200)
                       .extract().response();
        ...
        if (shouldExecuteStep3) {
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                try {
                    ...
                    Allure.addAttachment("📋 Request Body", "application/json", "{\"distanceList\":\"3 inches\",\"endStation\":\"Boston Logan International Airport\",\"id\":\"New york city\",\"startStation\":\"san francisco international airport\",\"stationList\":\"Central Station\"}");
                    Response stepResponse3 = req.when().post("/api/v1/routeservice/routes")
                       .then().log().ifValidationFails()
                       .statusCode(200)
                       .extract().response();
        ...
        if (shouldExecuteStep1) {
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                try {
                    ...
                    Allure.addAttachment("📋 Request Body", "application/json", "{\"distanceList\":\"7 feet\",\"distances\":\"25.3\",\"endStation\":\"Chicago union station\",\"id\":\"4567890\",\"loginId\":\"Guest789\",\"startStation\":\"San Francisco International Airport\",\"stationList\":\"Bayside mall\",\"stations\":\"san francisco 4th street bart\"}");
                    Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                       .then().log().ifValidationFails()
                       .statusCode(200)
                       .extract().response();
        ...
        if (shouldExecuteStep3) {
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                try {
                    ...
                    Allure.addAttachment("📋 Request Body", "application/json", "{\"distanceList\":\"7 feet\",\"endStation\":\"Chicago union station\",\"id\":\"4567890\",\"startStation\":\"San Francisco International Airport\",\"stationList\":\"Bayside mall\"}");
                    Response stepResponse3 = req.when().post("/api/v1/routeservice/routes")
                       .then().log().ifValidationFails()
                       .statusCode(200)
                       .extract().response();
        ...
        if (shouldExecuteStep1) {
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                try {
                    ...
                    Allure.addAttachment("📋 Request Body", "application/json", "{\"distanceList\":\"7 feet\",\"distances\":\"12.4\",\"endStation\":\"San Francisco Market Street Station\",\"id\":\"user123\",\"loginId\":\"Admin456\",\"startStation\":\"San Francisco International Airport\",\"stationList\":\"Bayside mall\",\"stations\":\"boston south station\"}");
                    Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                       .then().log().ifValidationFails()
                       .statusCode(200)
                       .extract().response();
        ...
        if (shouldExecuteStep3) {
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                try {
                    ...
                    Allure.addAttachment("📋 Request Body", "application/json", "{\"distanceList\":\"7 feet\",\"endStation\":\"San Francisco Market Street Station\",\"id\":\"user123\",\"startStation\":\"San Francisco International Airport\",\"stationList\":\"Bayside mall\"}");
                    Response stepResponse3 = req.when().post("/api/v1/routeservice/routes")
                       .then().log().ifValidationFails()
                       .statusCode(200)
                       .extract().response();
