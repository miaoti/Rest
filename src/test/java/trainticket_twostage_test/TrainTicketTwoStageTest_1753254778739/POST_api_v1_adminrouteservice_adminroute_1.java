            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        String requestBody1 = "{\"distanceList\":\"New york, ny\",\"distances\":\"3.5\",\"endStation\":\"San Francisco Union Square\",\"id\":\"maj_dec\",\"loginId\":\"user123\",\"startStation\":\"Los Angeles Union Station\",\"stationList\":\"boston south station\",\"stations\":\"Bay Street Pier\"}";
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"New york, ny\",\"endStation\":\"San Francisco Union Square\",\"id\":\"maj_dec\",\"startStation\":\"Los Angeles Union Station\",\"stationList\":\"boston south station\"}";
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"chicago, il\",\"distances\":\"200\",\"endStation\":\"Chicago loop\",\"id\":\"zxcvbnm\",\"loginId\":\"guests\",\"startStation\":\"Chicago union passenger terminal\",\"stationList\":\"boston south station\",\"stations\":\"Grand central terminal\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"chicago, il\",\"endStation\":\"Chicago loop\",\"id\":\"zxcvbnm\",\"startStation\":\"Chicago union passenger terminal\",\"stationList\":\"boston south station\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"phoenix, az\",\"distances\":\"200\",\"endStation\":\"Houston Hobby Airport\",\"id\":\"OXi####_combretastatin_A1\",\"loginId\":\"McIntyre_fondly_remembered\",\"startStation\":\"Los angeles union station\",\"stationList\":\"New york penn station\",\"stations\":\"bay street pier\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"phoenix, az\",\"endStation\":\"Houston Hobby Airport\",\"id\":\"OXi####_combretastatin_A1\",\"startStation\":\"Los angeles union station\",\"stationList\":\"New york penn station\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"Phoenix, AZ\",\"distances\":\"200\",\"endStation\":\"New york penn station\",\"id\":\"Abc123\",\"loginId\":\"john_doe01\",\"startStation\":\"Chicago Union Passenger Terminal\",\"stationList\":\"los angeles union station\",\"stations\":\"Union square bus stop\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"Phoenix, AZ\",\"endStation\":\"New york penn station\",\"id\":\"Abc123\",\"startStation\":\"Chicago Union Passenger Terminal\",\"stationList\":\"los angeles union station\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"Houston, tx\",\"distances\":\"200\",\"endStation\":\"san francisco union square\",\"id\":\"Ghi789\",\"loginId\":\"User123\",\"startStation\":\"Los angeles union station\",\"stationList\":\"Los Angeles Union Station\",\"stations\":\"Bay street pier\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"Houston, tx\",\"endStation\":\"san francisco union square\",\"id\":\"Ghi789\",\"startStation\":\"Los angeles union station\",\"stationList\":\"Los Angeles Union Station\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"Phoenix, AZ\",\"distances\":\"42\",\"endStation\":\"New york penn station\",\"id\":\"gwa\",\"loginId\":\"guest789\",\"startStation\":\"Philadelphia 30th Street Station\",\"stationList\":\"Boston south station\",\"stations\":\"Grand Central Terminal\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"Phoenix, AZ\",\"endStation\":\"New york penn station\",\"id\":\"gwa\",\"startStation\":\"Philadelphia 30th Street Station\",\"stationList\":\"Boston south station\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"new york, ny\",\"distances\":\"7.89\",\"endStation\":\"Chicago loop\",\"id\":\"cbs\",\"loginId\":\"Sydney_measured_####kbps\",\"startStation\":\"Houston hobby airport\",\"stationList\":\"Chicago union station\",\"stations\":\"Bay street pier\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"new york, ny\",\"endStation\":\"Chicago loop\",\"id\":\"cbs\",\"startStation\":\"Houston hobby airport\",\"stationList\":\"Chicago union station\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"new york, ny\",\"distances\":\"7.89\",\"endStation\":\"new york penn station\",\"id\":\"OXi####_combretastatin_A1\",\"loginId\":\"McIntyre_fondly_remembered\",\"startStation\":\"New york penn station\",\"stationList\":\"los angeles union station\",\"stations\":\"Central station\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"new york, ny\",\"endStation\":\"new york penn station\",\"id\":\"OXi####_combretastatin_A1\",\"startStation\":\"New york penn station\",\"stationList\":\"los angeles union station\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"Phoenix, AZ\",\"distances\":\"100\",\"endStation\":\"san francisco union square\",\"id\":\"zxcvbnm\",\"loginId\":\"McIntyre_fondly_remembered\",\"startStation\":\"New York Penn Station\",\"stationList\":\"boston south station\",\"stations\":\"Union Square Bus Stop\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"Phoenix, AZ\",\"endStation\":\"san francisco union square\",\"id\":\"zxcvbnm\",\"startStation\":\"New York Penn Station\",\"stationList\":\"boston south station\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"chicago, il\",\"distances\":\"7.89\",\"endStation\":\"New york penn station\",\"id\":\"OXi####_combretastatin_A1\",\"loginId\":\"john_doe01\",\"startStation\":\"Philadelphia 30th street station\",\"stationList\":\"boston south station\",\"stations\":\"Bay Street Pier\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"chicago, il\",\"endStation\":\"New york penn station\",\"id\":\"OXi####_combretastatin_A1\",\"startStation\":\"Philadelphia 30th street station\",\"stationList\":\"boston south station\"}";
                        req = req.body(requestBody3);
