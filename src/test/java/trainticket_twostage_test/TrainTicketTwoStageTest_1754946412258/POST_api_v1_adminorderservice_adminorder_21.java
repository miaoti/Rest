package trainticket_twostage_test.TrainTicketTwoStageTest_1754946412258;
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        String requestBody1 = "{\"accountId\":\"test609\",\"boughtDate\":\"test609\",\"coachNumber\":\"test611\",\"contactsDocumentNumber\":\"test612\",\"contactsName\":\"test613\",\"differenceMoney\":\"test615\",\"documentType\":\"test617\",\"from\":\"test618\",\"id\":\"test279\",\"price\":\"p4601\",\"seatClass\":\"test620\",\"seatNumber\":\"test621\",\"status\":\"test621\",\"to\":\"test622\",\"trainNumber\":\"test622\",\"travelDate\":\"test623\",\"travelTime\":\"test624\"}";
            ...
            Allure.step("Step 2: ts-order-other-service POST /api/v1/orderOtherService/orderOther/admin (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "{\"accountId\":\"test609\",\"boughtDate\":\"test609\",\"coachNumber\":\"test611\",\"contactsDocumentNumber\":\"test612\",\"contactsName\":\"test613\",\"documentType\":\"test617\",\"from\":\"test618\",\"id\":\"test279\",\"price\":\"p4601\",\"seatClass\":\"test620\",\"seatNumber\":\"test621\",\"status\":\"test621\",\"to\":\"test622\",\"trainNumber\":\"test622\",\"travelDate\":\"test623\",\"travelTime\":\"test624\"}";
