            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        String requestBody1 = "{\"distanceList\":\"dist429h\",\"distances\":\"[\\\"dis8238m\\\", \\\"dis6671d\\\"]\",\"endStation\":\"test277\",\"id\":\"test279\",\"loginId\":\"test280\",\"startStation\":\"test282\",\"stationList\":\"test283\",\"stations\":\"[\\\"test285\\\"]\"}";
            ...
            Allure.step("Step 2: ts-station-service POST /api/v1/stationservice/stations/idlist (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "[\"[\\\"test300\\\"]\", \"[\\\"test300\\\"]\", \"[\\\"test300\\\"]\", \"[\\\"test300\\\"]\"]";
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"dist429h\",\"endStation\":\"test277\",\"id\":\"test279\",\"startStation\":\"test282\",\"stationList\":\"test283\"}";
            ...
            Allure.step("Step 2: ts-station-service POST /api/v1/stationservice/stations/idlist (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "[\"[\\\"test300\\\"]\", \"[\\\"test300\\\"]\"]";
                        req = req.body(requestBody2);
            ...
            Allure.step("Step 2: ts-station-service POST /api/v1/stationservice/stations/idlist (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "[\"[\\\"test300\\\"]\", \"[\\\"test300\\\"]\", \"[\\\"test300\\\"]\"]";
                        req = req.body(requestBody2);
