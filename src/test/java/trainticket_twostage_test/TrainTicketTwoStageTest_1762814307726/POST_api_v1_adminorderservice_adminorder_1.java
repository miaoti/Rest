package trainticket_twostage_test.TrainTicketTwoStageTest_1762814307726;
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        String requestBody1 = "{\"accountId\":\"1234567890\",\"boughtDate\":\"2024-03-15\",\"coachNumber\":12346,\"contactsDocumentNumber\":\"DocumentNumber_One\",\"contactsName\":\"John Smith\",\"differenceMoney\":\"100.50\",\"documentType\":1,\"from\":\"test@service.io\",\"id\":\"user123\",\"price\":\"19.99\",\"seatClass\":1,\"seatNumber\":\"A12\",\"status\":1,\"to\":\"user@example.com\",\"trainNumber\":\"KuaiSu\",\"travelDate\":\"2013-05-07\",\"travelTime\":\"1200\"}";
                        ...
                        allStepParameters.put("body", "{\"accountId\":\"1234567890\",\"boughtDate\":\"2024-03-15\",\"coachNumber\":12346,\"contactsDocumentNumber\":\"DocumentNumber_One\",\"contactsName\":\"John Smith\",\"differenceMoney\":\"100.50\",\"documentType\":1,\"from\":\"test@service.io\",\"id\":\"user123\",\"price\":\"19.99\",\"seatClass\":1,\"seatNumber\":\"A12\",\"status\":1,\"to\":\"user@example.com\",\"trainNumber\":\"KuaiSu\",\"travelDate\":\"2013-05-07\",\"travelTime\":\"1200\"}");
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"1234567890\",\"boughtDate\":\"2024-02-18\",\"coachNumber\":12347,\"contactsDocumentNumber\":\"ABC123456789\",\"contactsName\":\"John Smith\",\"differenceMoney\":\"150.50\",\"documentType\":1,\"from\":\"user@example.com\",\"id\":\"user123\",\"price\":\"19.99\",\"seatClass\":1,\"seatNumber\":\"- ThirdClass-45\",\"status\":5,\"to\":\"user@example.com\",\"trainNumber\":\"TR2023\",\"travelDate\":\"2023-12-25\",\"travelTime\":\"123\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"accountId\":\"1234567890\",\"boughtDate\":\"2024-02-18\",\"coachNumber\":12347,\"contactsDocumentNumber\":\"ABC123456789\",\"contactsName\":\"John Smith\",\"differenceMoney\":\"150.50\",\"documentType\":1,\"from\":\"user@example.com\",\"id\":\"user123\",\"price\":\"19.99\",\"seatClass\":1,\"seatNumber\":\"- ThirdClass-45\",\"status\":5,\"to\":\"user@example.com\",\"trainNumber\":\"TR2023\",\"travelDate\":\"2023-12-25\",\"travelTime\":\"123\"}");
                        Response stepResponse1 = req.when().post("/api/v1/adminorderservice/adminorder")
                               .then().log().ifValidationFails()
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"1234567890\",\"boughtDate\":\"2023-12-15\",\"coachNumber\":12345,\"contactsDocumentNumber\":\"ABC123456789\",\"contactsName\":\"John Smith\",\"differenceMoney\":\"100.50\",\"documentType\":\"abc\",\"from\":\"user@example.com\",\"id\":\"test-id-789\",\"price\":\"8.0\",\"seatClass\":1,\"seatNumber\":\"- Standard-89\",\"status\":1,\"to\":\"user@example.com\",\"trainNumber\":\"TR2023\",\"travelDate\":\"2023-12-25\",\"travelTime\":\"2023-12-15T09:30:00Z\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"9f3b57d8-82dc-5dg2-c6cc-c79517e0eb7g\",\"boughtDate\":\"2024-02-28\",\"coachNumber\":1234,\"contactsDocumentNumber\":\"123\",\"contactsName\":\"John Smith\",\"differenceMoney\":\"100.50\",\"documentType\":1,\"from\":\"info@business.co.uk\",\"id\":\"user123\",\"price\":\"19.99\",\"seatClass\":1,\"seatNumber\":\"FirstClass-30\",\"status\":1,\"to\":\"trainticket_service@163.com\",\"trainNumber\":\"TR2023\",\"travelDate\":\"2013-05-06\",\"travelTime\":\"700\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"accountId\":\"9f3b57d8-82dc-5dg2-c6cc-c79517e0eb7g\",\"boughtDate\":\"2024-02-28\",\"coachNumber\":1234,\"contactsDocumentNumber\":\"123\",\"contactsName\":\"John Smith\",\"differenceMoney\":\"100.50\",\"documentType\":1,\"from\":\"info@business.co.uk\",\"id\":\"user123\",\"price\":\"19.99\",\"seatClass\":1,\"seatNumber\":\"FirstClass-30\",\"status\":1,\"to\":\"trainticket_service@163.com\",\"trainNumber\":\"TR2023\",\"travelDate\":\"2013-05-06\",\"travelTime\":\"700\"}");
                        Response stepResponse1 = req.when().post("/api/v1/adminorderservice/adminorder")
                               .then().log().ifValidationFails()
                               // Negative test: expect error code (4XX or 5XX), not success code
                               .statusCode(org.hamcrest.Matchers.greaterThanOrEqualTo(400))
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"1234567890\",\"boughtDate\":\"2024-01-20\",\"coachNumber\":1234,\"contactsDocumentNumber\":\"ABC123456789\",\"contactsName\":\"Sarah Johnson\",\"differenceMoney\":\"100.50\",\"documentType\":1,\"from\":\"user@example.com\",\"id\":\"guest-001\",\"price\":\"19.99\",\"seatClass\":1,\"seatNumber\":\"A12\",\"status\":1,\"to\":\"user@example.com\",\"trainNumber\":\"TR2023\",\"travelDate\":\"2023-12-25\",\"travelTime\":\"shanghai\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"accountId\":\"1234567890\",\"boughtDate\":\"2024-01-20\",\"coachNumber\":1234,\"contactsDocumentNumber\":\"ABC123456789\",\"contactsName\":\"Sarah Johnson\",\"differenceMoney\":\"100.50\",\"documentType\":1,\"from\":\"user@example.com\",\"id\":\"guest-001\",\"price\":\"19.99\",\"seatClass\":1,\"seatNumber\":\"A12\",\"status\":1,\"to\":\"user@example.com\",\"trainNumber\":\"TR2023\",\"travelDate\":\"2023-12-25\",\"travelTime\":\"shanghai\"}");
                        Response stepResponse1 = req.when().post("/api/v1/adminorderservice/adminorder")
                               .then().log().ifValidationFails()
                               .statusCode(200)
                               .extract().response();
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"1234567890\",\"boughtDate\":\"2023-12-15\",\"coachNumber\":1234,\"contactsDocumentNumber\":\"ABC123456789\",\"contactsName\":\"John Smith\",\"differenceMoney\":\"100.50\",\"documentType\":2,\"from\":\"user@example.com\",\"id\":\"moderator-222\",\"price\":\"0.99\",\"seatClass\":4,\"seatNumber\":\"A12\",\"status\":1,\"to\":\"user@example.com\",\"trainNumber\":\"GaoTieTwo\",\"travelDate\":\"2023-12-25\",\"travelTime\":\"2023-12-15T09:30:00Z\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"4d2a46c7-71cb-4cf1-b5bb-b68406d9da6f\",\"boughtDate\":\"2023-12-15\",\"coachNumber\":1234,\"contactsDocumentNumber\":\"ABC123456789\",\"contactsName\":\"John Smith\",\"differenceMoney\":\"100.50\",\"documentType\":1,\"from\":\"support@company.org\",\"id\":\"user123\",\"price\":\"1000.00\",\"seatClass\":1,\"seatNumber\":\"A12\",\"status\":1,\"to\":\"user@example.com\",\"trainNumber\":\"TR2023\",\"travelDate\":\"2023-12-25\",\"travelTime\":\"2023-12-15T09:30:00Z\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"accountId\":\"4d2a46c7-71cb-4cf1-b5bb-b68406d9da6f\",\"boughtDate\":\"2023-12-15\",\"coachNumber\":1234,\"contactsDocumentNumber\":\"ABC123456789\",\"contactsName\":\"John Smith\",\"differenceMoney\":\"100.50\",\"documentType\":1,\"from\":\"support@company.org\",\"id\":\"user123\",\"price\":\"1000.00\",\"seatClass\":1,\"seatNumber\":\"A12\",\"status\":1,\"to\":\"user@example.com\",\"trainNumber\":\"TR2023\",\"travelDate\":\"2023-12-25\",\"travelTime\":\"2023-12-15T09:30:00Z\"}");
                        Response stepResponse1 = req.when().post("/api/v1/adminorderservice/adminorder")
                               .then().log().ifValidationFails()
                               .statusCode(200)
                               .extract().response();
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"1234567890\",\"boughtDate\":\"2023-12-15\",\"coachNumber\":1234,\"contactsDocumentNumber\":\"ABC123456789\",\"contactsName\":\"John Smith\",\"differenceMoney\":\"100.50\",\"documentType\":1,\"from\":\"admin@domain.net\",\"id\":\"admin-456\",\"price\":\"19.99\",\"seatClass\":1,\"seatNumber\":\"A12\",\"status\":1,\"to\":\"user@example.com\",\"trainNumber\":\"Z2468\",\"travelDate\":\"2013-05-05\",\"travelTime\":\"2023-12-15T09:30:00Z\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"1234567890\",\"boughtDate\":\"2024-02-20\",\"coachNumber\":1234,\"contactsDocumentNumber\":\"ABC123456789\",\"contactsName\":\"Michael Brown\",\"differenceMoney\":\"100.50\",\"documentType\":3,\"from\":\"test@service.io\",\"id\":\"test-id-789\",\"price\":\"19.99\",\"seatClass\":1,\"seatNumber\":\"A12\",\"status\":1,\"to\":\"trainticket_promo@163.com\",\"trainNumber\":\"TR2023\",\"travelDate\":\"2013-05-09\",\"travelTime\":\"2023-12-15T09:30:00Z\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"accountId\":\"1234567890\",\"boughtDate\":\"2024-02-20\",\"coachNumber\":1234,\"contactsDocumentNumber\":\"ABC123456789\",\"contactsName\":\"Michael Brown\",\"differenceMoney\":\"100.50\",\"documentType\":3,\"from\":\"test@service.io\",\"id\":\"test-id-789\",\"price\":\"19.99\",\"seatClass\":1,\"seatNumber\":\"A12\",\"status\":1,\"to\":\"trainticket_promo@163.com\",\"trainNumber\":\"TR2023\",\"travelDate\":\"2013-05-09\",\"travelTime\":\"2023-12-15T09:30:00Z\"}");
                        Response stepResponse1 = req.when().post("/api/v1/adminorderservice/adminorder")
                               .then().log().ifValidationFails()
                               .statusCode(200)
                               .extract().response();
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"1234567890\",\"boughtDate\":\"2023-12-15\",\"coachNumber\":5678,\"contactsDocumentNumber\":\"XYZ987654321\",\"contactsName\":\"123\",\"differenceMoney\":\"100.50\",\"documentType\":4,\"from\":\"user@example.com\",\"id\":\"user123\",\"price\":\"19.99\",\"seatClass\":1,\"seatNumber\":\"A12\",\"status\":1,\"to\":\"user@example.com\",\"trainNumber\":\"TR2023\",\"travelDate\":\"2023-12-25\",\"travelTime\":\"2023-12-15T09:30:00Z\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"accountId\":\"1234567890\",\"boughtDate\":\"2023-12-15\",\"coachNumber\":5678,\"contactsDocumentNumber\":\"XYZ987654321\",\"contactsName\":\"123\",\"differenceMoney\":\"100.50\",\"documentType\":4,\"from\":\"user@example.com\",\"id\":\"user123\",\"price\":\"19.99\",\"seatClass\":1,\"seatNumber\":\"A12\",\"status\":1,\"to\":\"user@example.com\",\"trainNumber\":\"TR2023\",\"travelDate\":\"2023-12-25\",\"travelTime\":\"2023-12-15T09:30:00Z\"}");
                        Response stepResponse1 = req.when().post("/api/v1/adminorderservice/adminorder")
                               .then().log().ifValidationFails()
                               // Negative test: expect error code (4XX or 5XX), not success code
                               .statusCode(org.hamcrest.Matchers.greaterThanOrEqualTo(400))
