            ...
            Allure.step("Step 1: ts-admin-basic-info-service POST /api/v1/adminbasicservice/adminbasic/prices (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        String requestBody1 = "{\"basicPriceRate\":\"12.95\",\"firstClassPriceRate\":\"12345.67\",\"id\":\"qwerty_keyboard\",\"routeId\":\"unique_route_123\",\"trainType\":\"passengers\"}";
            ...
            Allure.step("Step 2: ts-price-service POST /api/v1/priceservice/prices (expect 201)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        String requestBody2 = "{\"basicPriceRate\":\"12.95\",\"firstClassPriceRate\":\"12345.67\",\"id\":\"qwerty_keyboard\",\"routeId\":\"unique_route_123\",\"trainType\":\"passengers\"}";
            ...
            Allure.step("Step 1: ts-admin-basic-info-service POST /api/v1/adminbasicservice/adminbasic/prices (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        String requestBody1 = "{\"basicPriceRate\":\"0.01\",\"firstClassPriceRate\":\"75.6\",\"id\":\"qwerty_keyboard\",\"routeId\":\"distinctive\",\"trainType\":\"HighSpeed\"}";
                        Allure.addAttachment("📋 Request Body", "application/json", requestBody1);
                        req = req.body(requestBody1);
                        Response stepResponse1 = req.when().post("/api/v1/adminbasicservice/adminbasic/prices")
                               .then().log().ifValidationFails()
            ...
            Allure.step("Step 2: ts-price-service POST /api/v1/priceservice/prices (expect 201)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        String requestBody2 = "{\"basicPriceRate\":\"0.01\",\"firstClassPriceRate\":\"75.6\",\"id\":\"qwerty_keyboard\",\"routeId\":\"distinctive\",\"trainType\":\"HighSpeed\"}";
                        Allure.addAttachment("📋 Request Body", "application/json", requestBody2);
                        req = req.body(requestBody2);
                        Response stepResponse2 = req.when().post("/api/v1/priceservice/prices")
                               .then().log().ifValidationFails()
            ...
            Allure.step("Step 1: ts-admin-basic-info-service POST /api/v1/adminbasicservice/adminbasic/prices (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        String requestBody1 = "{\"basicPriceRate\":\"3.49\",\"firstClassPriceRate\":\"234.99\",\"id\":\"zxcvbnm\",\"routeId\":\"specialchars!@#\",\"trainType\":\"passanger\"}";
                        Allure.addAttachment("📋 Request Body", "application/json", requestBody1);
                        req = req.body(requestBody1);
                        Response stepResponse1 = req.when().post("/api/v1/adminbasicservice/adminbasic/prices")
                               .then().log().ifValidationFails()
            ...
            Allure.step("Step 2: ts-price-service POST /api/v1/priceservice/prices (expect 201)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        String requestBody2 = "{\"basicPriceRate\":\"3.49\",\"firstClassPriceRate\":\"234.99\",\"id\":\"zxcvbnm\",\"routeId\":\"specialchars!@#\",\"trainType\":\"passanger\"}";
                        Allure.addAttachment("📋 Request Body", "application/json", requestBody2);
                        req = req.body(requestBody2);
                        Response stepResponse2 = req.when().post("/api/v1/priceservice/prices")
                               .then().log().ifValidationFails()
            ...
            Allure.step("Step 1: ts-admin-basic-info-service POST /api/v1/adminbasicservice/adminbasic/prices (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        String requestBody1 = "{\"basicPriceRate\":\"12.95\",\"firstClassPriceRate\":\"75.6\",\"id\":\"abcde\",\"routeId\":\"xyz7890\",\"trainType\":\"Crew\"}";
                        Allure.addAttachment("📋 Request Body", "application/json", requestBody1);
                        req = req.body(requestBody1);
                        Response stepResponse1 = req.when().post("/api/v1/adminbasicservice/adminbasic/prices")
                               .then().log().ifValidationFails()
            ...
            Allure.step("Step 2: ts-price-service POST /api/v1/priceservice/prices (expect 201)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        String requestBody2 = "{\"basicPriceRate\":\"12.95\",\"firstClassPriceRate\":\"75.6\",\"id\":\"abcde\",\"routeId\":\"xyz7890\",\"trainType\":\"Crew\"}";
                        Allure.addAttachment("📋 Request Body", "application/json", requestBody2);
                        req = req.body(requestBody2);
                        Response stepResponse2 = req.when().post("/api/v1/priceservice/prices")
                               .then().log().ifValidationFails()
            ...
            Allure.step("Step 1: ts-admin-basic-info-service POST /api/v1/adminbasicservice/adminbasic/prices (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        String requestBody1 = "{\"basicPriceRate\":\"0.01\",\"firstClassPriceRate\":\"234.99\",\"id\":\"Abcde\",\"routeId\":\"yyyy\",\"trainType\":\"aimless_nobodies\"}";
                        Allure.addAttachment("📋 Request Body", "application/json", requestBody1);
                        req = req.body(requestBody1);
                        Response stepResponse1 = req.when().post("/api/v1/adminbasicservice/adminbasic/prices")
                               .then().log().ifValidationFails()
            ...
            Allure.step("Step 2: ts-price-service POST /api/v1/priceservice/prices (expect 201)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        String requestBody2 = "{\"basicPriceRate\":\"0.01\",\"firstClassPriceRate\":\"234.99\",\"id\":\"Abcde\",\"routeId\":\"yyyy\",\"trainType\":\"aimless_nobodies\"}";
                        Allure.addAttachment("📋 Request Body", "application/json", requestBody2);
                        req = req.body(requestBody2);
                        Response stepResponse2 = req.when().post("/api/v1/priceservice/prices")
                               .then().log().ifValidationFails()
            ...
            Allure.step("Step 1: ts-admin-basic-info-service POST /api/v1/adminbasicservice/adminbasic/prices (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        String requestBody1 = "{\"basicPriceRate\":\"0.75\",\"firstClassPriceRate\":\"12345.67\",\"id\":\"Qwerty_keypad\",\"routeId\":\"xyz7890\",\"trainType\":\"passenger\"}";
                        Allure.addAttachment("📋 Request Body", "application/json", requestBody1);
                        req = req.body(requestBody1);
                        Response stepResponse1 = req.when().post("/api/v1/adminbasicservice/adminbasic/prices")
                               .then().log().ifValidationFails()
            ...
            Allure.step("Step 2: ts-price-service POST /api/v1/priceservice/prices (expect 201)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        String requestBody2 = "{\"basicPriceRate\":\"0.75\",\"firstClassPriceRate\":\"12345.67\",\"id\":\"Qwerty_keypad\",\"routeId\":\"xyz7890\",\"trainType\":\"passenger\"}";
                        Allure.addAttachment("📋 Request Body", "application/json", requestBody2);
                        req = req.body(requestBody2);
                        Response stepResponse2 = req.when().post("/api/v1/priceservice/prices")
                               .then().log().ifValidationFails()
            ...
            Allure.step("Step 1: ts-admin-basic-info-service POST /api/v1/adminbasicservice/adminbasic/prices (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        String requestBody1 = "{\"basicPriceRate\":\"0.01\",\"firstClassPriceRate\":\"234.99\",\"id\":\"Zxcvbnm\",\"routeId\":\"uniquely\",\"trainType\":\"passanger\"}";
                        Allure.addAttachment("📋 Request Body", "application/json", requestBody1);
                        req = req.body(requestBody1);
                        Response stepResponse1 = req.when().post("/api/v1/adminbasicservice/adminbasic/prices")
                               .then().log().ifValidationFails()
            ...
            Allure.step("Step 2: ts-price-service POST /api/v1/priceservice/prices (expect 201)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        String requestBody2 = "{\"basicPriceRate\":\"0.01\",\"firstClassPriceRate\":\"234.99\",\"id\":\"Zxcvbnm\",\"routeId\":\"uniquely\",\"trainType\":\"passanger\"}";
                        Allure.addAttachment("📋 Request Body", "application/json", requestBody2);
                        req = req.body(requestBody2);
                        Response stepResponse2 = req.when().post("/api/v1/priceservice/prices")
                               .then().log().ifValidationFails()
            ...
            Allure.step("Step 1: ts-admin-basic-info-service POST /api/v1/adminbasicservice/adminbasic/prices (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        String requestBody1 = "{\"basicPriceRate\":\"3.49\",\"firstClassPriceRate\":\"12345.67\",\"id\":\"zxcvbnm\",\"routeId\":\"printf\",\"trainType\":\"intermodal\"}";
                        Allure.addAttachment("📋 Request Body", "application/json", requestBody1);
                        req = req.body(requestBody1);
                        Response stepResponse1 = req.when().post("/api/v1/adminbasicservice/adminbasic/prices")
                               .then().log().ifValidationFails()
            ...
            Allure.step("Step 2: ts-price-service POST /api/v1/priceservice/prices (expect 201)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        String requestBody2 = "{\"basicPriceRate\":\"3.49\",\"firstClassPriceRate\":\"12345.67\",\"id\":\"zxcvbnm\",\"routeId\":\"printf\",\"trainType\":\"intermodal\"}";
                        Allure.addAttachment("📋 Request Body", "application/json", requestBody2);
                        req = req.body(requestBody2);
                        Response stepResponse2 = req.when().post("/api/v1/priceservice/prices")
                               .then().log().ifValidationFails()
            ...
            Allure.step("Step 1: ts-admin-basic-info-service POST /api/v1/adminbasicservice/adminbasic/prices (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        String requestBody1 = "{\"basicPriceRate\":\"0.01\",\"firstClassPriceRate\":\"10.5\",\"id\":\"abcde\",\"routeId\":\"uniqueness\",\"trainType\":\"crewmembers\"}";
                        Allure.addAttachment("📋 Request Body", "application/json", requestBody1);
                        req = req.body(requestBody1);
                        Response stepResponse1 = req.when().post("/api/v1/adminbasicservice/adminbasic/prices")
                               .then().log().ifValidationFails()
            ...
            Allure.step("Step 2: ts-price-service POST /api/v1/priceservice/prices (expect 201)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        String requestBody2 = "{\"basicPriceRate\":\"0.01\",\"firstClassPriceRate\":\"10.5\",\"id\":\"abcde\",\"routeId\":\"uniqueness\",\"trainType\":\"crewmembers\"}";
                        Allure.addAttachment("📋 Request Body", "application/json", requestBody2);
                        req = req.body(requestBody2);
                        Response stepResponse2 = req.when().post("/api/v1/priceservice/prices")
                               .then().log().ifValidationFails()
            ...
            Allure.step("Step 1: ts-admin-basic-info-service POST /api/v1/adminbasicservice/adminbasic/prices (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        String requestBody1 = "{\"basicPriceRate\":\"3.49\",\"firstClassPriceRate\":\"234.99\",\"id\":\"Qwerty_keyboard\",\"routeId\":\"distinctive\",\"trainType\":\"Locomotive\"}";
                        Allure.addAttachment("📋 Request Body", "application/json", requestBody1);
                        req = req.body(requestBody1);
                        Response stepResponse1 = req.when().post("/api/v1/adminbasicservice/adminbasic/prices")
                               .then().log().ifValidationFails()
            ...
            Allure.step("Step 2: ts-price-service POST /api/v1/priceservice/prices (expect 201)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        String requestBody2 = "{\"basicPriceRate\":\"3.49\",\"firstClassPriceRate\":\"234.99\",\"id\":\"Qwerty_keyboard\",\"routeId\":\"distinctive\",\"trainType\":\"Locomotive\"}";
                        Allure.addAttachment("📋 Request Body", "application/json", requestBody2);
                        req = req.body(requestBody2);
                        Response stepResponse2 = req.when().post("/api/v1/priceservice/prices")
                               .then().log().ifValidationFails()
