            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"dist429h\",\"distances\":\"[\\\"dis8238m\\\", \\\"dis6671d\\\"]\",\"endStation\":\"test12\",\"id\":\"test13\",\"loginId\":\"lo4292\",\"startStation\":\"star2606\",\"stationList\":\"sta3762\",\"stations\":\"[\\\"test547\\\"]\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"dist429h\",\"distances\":\"[\\\"dis8238m\\\", \\\"dis6671d\\\"]\",\"endStation\":\"test12\",\"id\":\"test13\",\"loginId\":\"lo4292\",\"startStation\":\"test547\",\"stationList\":\"test974\",\"stations\":\"[\\\"st1839\\\", \\\"sta2046\\\"]\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"dist429h\",\"distances\":\"[\\\"dis8238m\\\", \\\"dis6671d\\\"]\",\"endStation\":\"test12\",\"id\":\"test13\",\"loginId\":\"lo4292\",\"startStation\":\"star2606\",\"stationList\":\"test974\",\"stations\":\"[\\\"st1839\\\", \\\"sta2046\\\"]\"}";
                        req = req.body(requestBody1);
