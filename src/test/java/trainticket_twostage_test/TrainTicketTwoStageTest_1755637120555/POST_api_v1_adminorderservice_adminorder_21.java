            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        String requestBody1 = "{\"accountId\":\"acc9976\",\"boughtDate\":\"bou969\",\"coachNumber\":\"742\",\"contactsDocumentNumber\":\"DocumentNumber_One\",\"contactsName\":\"cont8766\",\"differenceMoney\":\"diffe2813\",\"documentType\":\"690\",\"from\":\"DFW\",\"id\":\"test13\",\"price\":\"0.38\",\"seatClass\":\"744\",\"seatNumber\":\"FirstClass-30\",\"status\":\"0\",\"to\":\"t3707\",\"trainNumber\":\"tra1921\",\"travelDate\":\"tra8456\",\"travelTime\":\"tra2583\"}";
            ...
            Allure.step("Step 2: ts-order-other-service POST /api/v1/orderOtherService/orderOther/admin (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "{\"accountId\":\"acc9976\",\"boughtDate\":\"bou969\",\"coachNumber\":\"742\",\"contactsDocumentNumber\":\"DocumentNumber_One\",\"contactsName\":\"cont8766\",\"documentType\":\"690\",\"from\":\"DFW\",\"id\":\"test13\",\"price\":\"0.38\",\"seatClass\":\"744\",\"seatNumber\":\"FirstClass-30\",\"status\":\"0\",\"to\":\"t3707\",\"trainNumber\":\"tra1921\",\"travelDate\":\"tra8456\",\"travelTime\":\"tra2583\"}";
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"test957\",\"boughtDate\":\"bou969\",\"coachNumber\":\"742\",\"contactsDocumentNumber\":\"DocumentNumber_One\",\"contactsName\":\"cont8766\",\"differenceMoney\":\"test957\",\"documentType\":\"690\",\"from\":\"DFW\",\"id\":\"test13\",\"price\":\"0.38\",\"seatClass\":\"744\",\"seatNumber\":\"FirstClass-30\",\"status\":\"0\",\"to\":\"t3707\",\"trainNumber\":\"tra1921\",\"travelDate\":\"tra8456\",\"travelTime\":\"tra2583\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-order-other-service POST /api/v1/orderOtherService/orderOther/admin (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "{\"accountId\":\"test957\",\"boughtDate\":\"bou969\",\"coachNumber\":\"742\",\"contactsDocumentNumber\":\"DocumentNumber_One\",\"contactsName\":\"cont8766\",\"documentType\":\"690\",\"from\":\"DFW\",\"id\":\"test13\",\"price\":\"0.38\",\"seatClass\":\"744\",\"seatNumber\":\"FirstClass-30\",\"status\":\"0\",\"to\":\"t3707\",\"trainNumber\":\"tra1921\",\"travelDate\":\"tra8456\",\"travelTime\":\"tra2583\"}";
                        req = req.body(requestBody2);
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"acc9976\",\"boughtDate\":\"bou969\",\"coachNumber\":\"742\",\"contactsDocumentNumber\":\"DocumentNumber_One\",\"contactsName\":\"cont8766\",\"differenceMoney\":\"diffe2813\",\"documentType\":\"690\",\"from\":\"DFW\",\"id\":\"test13\",\"price\":\"0.38\",\"seatClass\":\"744\",\"seatNumber\":\"FirstClass-30\",\"status\":\"0\",\"to\":\"t3707\",\"trainNumber\":\"test960\",\"travelDate\":\"tra8456\",\"travelTime\":\"tra2583\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-order-other-service POST /api/v1/orderOtherService/orderOther/admin (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "{\"accountId\":\"acc9976\",\"boughtDate\":\"bou969\",\"coachNumber\":\"742\",\"contactsDocumentNumber\":\"DocumentNumber_One\",\"contactsName\":\"cont8766\",\"documentType\":\"690\",\"from\":\"DFW\",\"id\":\"test13\",\"price\":\"0.38\",\"seatClass\":\"744\",\"seatNumber\":\"FirstClass-30\",\"status\":\"0\",\"to\":\"t3707\",\"trainNumber\":\"test960\",\"travelDate\":\"tra8456\",\"travelTime\":\"tra2583\"}";
                        req = req.body(requestBody2);
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"test957\",\"boughtDate\":\"bou969\",\"coachNumber\":\"962\",\"contactsDocumentNumber\":\"DocumentNumber_One\",\"contactsName\":\"cont8766\",\"differenceMoney\":\"test957\",\"documentType\":\"690\",\"from\":\"test962\",\"id\":\"test13\",\"price\":\"0.38\",\"seatClass\":\"744\",\"seatNumber\":\"FirstClass-30\",\"status\":\"0\",\"to\":\"t3707\",\"trainNumber\":\"tra1921\",\"travelDate\":\"tra8456\",\"travelTime\":\"tra2583\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-order-other-service POST /api/v1/orderOtherService/orderOther/admin (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "{\"accountId\":\"test957\",\"boughtDate\":\"bou969\",\"coachNumber\":\"962\",\"contactsDocumentNumber\":\"DocumentNumber_One\",\"contactsName\":\"cont8766\",\"documentType\":\"690\",\"from\":\"test962\",\"id\":\"test13\",\"price\":\"0.38\",\"seatClass\":\"744\",\"seatNumber\":\"FirstClass-30\",\"status\":\"0\",\"to\":\"t3707\",\"trainNumber\":\"tra1921\",\"travelDate\":\"tra8456\",\"travelTime\":\"tra2583\"}";
                        req = req.body(requestBody2);
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"test957\",\"boughtDate\":\"bou969\",\"coachNumber\":\"742\",\"contactsDocumentNumber\":\"DocumentNumber_One\",\"contactsName\":\"test964\",\"differenceMoney\":\"diffe2813\",\"documentType\":\"690\",\"from\":\"DFW\",\"id\":\"test13\",\"price\":\"0.38\",\"seatClass\":\"744\",\"seatNumber\":\"FirstClass-30\",\"status\":\"0\",\"to\":\"t3707\",\"trainNumber\":\"test960\",\"travelDate\":\"tra8456\",\"travelTime\":\"tra2583\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-order-other-service POST /api/v1/orderOtherService/orderOther/admin (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "{\"accountId\":\"test957\",\"boughtDate\":\"bou969\",\"coachNumber\":\"742\",\"contactsDocumentNumber\":\"DocumentNumber_One\",\"contactsName\":\"test964\",\"documentType\":\"690\",\"from\":\"DFW\",\"id\":\"test13\",\"price\":\"0.38\",\"seatClass\":\"744\",\"seatNumber\":\"FirstClass-30\",\"status\":\"0\",\"to\":\"t3707\",\"trainNumber\":\"test960\",\"travelDate\":\"tra8456\",\"travelTime\":\"tra2583\"}";
                        req = req.body(requestBody2);
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"acc9976\",\"boughtDate\":\"bou969\",\"coachNumber\":\"test962\",\"contactsDocumentNumber\":\"DocumentNumber_One\",\"contactsName\":\"cont8766\",\"differenceMoney\":\"test957\",\"documentType\":\"690\",\"from\":\"test962\",\"id\":\"test13\",\"price\":\"0.38\",\"seatClass\":\"744\",\"seatNumber\":\"FirstClass-30\",\"status\":\"0\",\"to\":\"t3707\",\"trainNumber\":\"tra1921\",\"travelDate\":\"tra8456\",\"travelTime\":\"tra2583\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-order-other-service POST /api/v1/orderOtherService/orderOther/admin (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "{\"accountId\":\"acc9976\",\"boughtDate\":\"bou969\",\"coachNumber\":\"test962\",\"contactsDocumentNumber\":\"DocumentNumber_One\",\"contactsName\":\"cont8766\",\"documentType\":\"690\",\"from\":\"test962\",\"id\":\"test13\",\"price\":\"0.38\",\"seatClass\":\"744\",\"seatNumber\":\"FirstClass-30\",\"status\":\"0\",\"to\":\"t3707\",\"trainNumber\":\"tra1921\",\"travelDate\":\"tra8456\",\"travelTime\":\"tra2583\"}";
                        req = req.body(requestBody2);
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"test957\",\"boughtDate\":\"bou969\",\"coachNumber\":\"962\",\"contactsDocumentNumber\":\"DocumentNumber_One\",\"contactsName\":\"test964\",\"differenceMoney\":\"diffe2813\",\"documentType\":\"690\",\"from\":\"DFW\",\"id\":\"test13\",\"price\":\"0.38\",\"seatClass\":\"744\",\"seatNumber\":\"FirstClass-30\",\"status\":\"0\",\"to\":\"t3707\",\"trainNumber\":\"test960\",\"travelDate\":\"tra8456\",\"travelTime\":\"tra2583\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-order-other-service POST /api/v1/orderOtherService/orderOther/admin (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "{\"accountId\":\"test957\",\"boughtDate\":\"bou969\",\"coachNumber\":\"962\",\"contactsDocumentNumber\":\"DocumentNumber_One\",\"contactsName\":\"test964\",\"documentType\":\"690\",\"from\":\"DFW\",\"id\":\"test13\",\"price\":\"0.38\",\"seatClass\":\"744\",\"seatNumber\":\"FirstClass-30\",\"status\":\"0\",\"to\":\"t3707\",\"trainNumber\":\"test960\",\"travelDate\":\"tra8456\",\"travelTime\":\"tra2583\"}";
                        req = req.body(requestBody2);
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"acc9976\",\"boughtDate\":\"bou969\",\"coachNumber\":\"742\",\"contactsDocumentNumber\":\"DocumentNumber_One\",\"contactsName\":\"cont8766\",\"differenceMoney\":\"test957\",\"documentType\":\"690\",\"from\":\"test962\",\"id\":\"test13\",\"price\":\"0.38\",\"seatClass\":\"744\",\"seatNumber\":\"FirstClass-30\",\"status\":\"0\",\"to\":\"t3707\",\"trainNumber\":\"tra1921\",\"travelDate\":\"tra8456\",\"travelTime\":\"test969\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-order-other-service POST /api/v1/orderOtherService/orderOther/admin (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "{\"accountId\":\"acc9976\",\"boughtDate\":\"bou969\",\"coachNumber\":\"742\",\"contactsDocumentNumber\":\"DocumentNumber_One\",\"contactsName\":\"cont8766\",\"documentType\":\"690\",\"from\":\"test962\",\"id\":\"test13\",\"price\":\"0.38\",\"seatClass\":\"744\",\"seatNumber\":\"FirstClass-30\",\"status\":\"0\",\"to\":\"t3707\",\"trainNumber\":\"tra1921\",\"travelDate\":\"tra8456\",\"travelTime\":\"test969\"}";
                        req = req.body(requestBody2);
