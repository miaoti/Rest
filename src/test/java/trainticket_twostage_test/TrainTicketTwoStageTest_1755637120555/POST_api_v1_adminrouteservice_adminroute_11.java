            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        String requestBody1 = "{\"distanceList\":\"dist429h\",\"distances\":\"[\\\"dis8238m\\\", \\\"dis6671d\\\"]\",\"endStation\":\"test12\",\"id\":\"test13\",\"loginId\":\"test850\",\"startStation\":\"star2606\",\"stationList\":\"sta3762\",\"stations\":\"[\\\"st1839\\\", \\\"sta2046\\\"]\"}";
            ...
            Allure.step("Step 2: ts-station-service POST /api/v1/stationservice/stations/idlist (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "[\"[\\\"test236\\\"]\", \"[\\\"test236\\\"]\", \"[\\\"test236\\\"]\"]";
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"dist429h\",\"endStation\":\"test12\",\"id\":\"test13\",\"startStation\":\"star2606\",\"stationList\":\"sta3762\"}";
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"dist429h\",\"distances\":\"[\\\"dis8238m\\\", \\\"dis6671d\\\"]\",\"endStation\":\"test12\",\"id\":\"test13\",\"loginId\":\"test850\",\"startStation\":\"test547\",\"stationList\":\"test974\",\"stations\":\"[\\\"st1839\\\", \\\"sta2046\\\"]\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"dist429h\",\"endStation\":\"test12\",\"id\":\"test13\",\"startStation\":\"test547\",\"stationList\":\"test974\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"dist429h\",\"distances\":\"[\\\"dis8238m\\\", \\\"dis6671d\\\"]\",\"endStation\":\"test12\",\"id\":\"test13\",\"loginId\":\"lo4292\",\"startStation\":\"star2606\",\"stationList\":\"sta3762\",\"stations\":\"[\\\"st1839\\\", \\\"sta2046\\\"]\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-station-service POST /api/v1/stationservice/stations/idlist (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "[\"[\\\"test236\\\"]\", \"[\\\"test236\\\"]\"]";
                        req = req.body(requestBody2);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"dist429h\",\"distances\":\"[\\\"dis8238m\\\", \\\"dis6671d\\\"]\",\"endStation\":\"test12\",\"id\":\"test13\",\"loginId\":\"lo4292\",\"startStation\":\"star2606\",\"stationList\":\"test974\",\"stations\":\"[\\\"test547\\\"]\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"dist429h\",\"endStation\":\"test12\",\"id\":\"test13\",\"startStation\":\"star2606\",\"stationList\":\"test974\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"dist429h\",\"distances\":\"[\\\"dis8238m\\\", \\\"dis6671d\\\"]\",\"endStation\":\"test12\",\"id\":\"test13\",\"loginId\":\"test850\",\"startStation\":\"test547\",\"stationList\":\"sta3762\",\"stations\":\"[\\\"st1839\\\", \\\"sta2046\\\"]\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"dist429h\",\"endStation\":\"test12\",\"id\":\"test13\",\"startStation\":\"test547\",\"stationList\":\"sta3762\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"dist429h\",\"distances\":\"[\\\"dis8238m\\\", \\\"dis6671d\\\"]\",\"endStation\":\"test12\",\"id\":\"test13\",\"loginId\":\"test850\",\"startStation\":\"star2606\",\"stationList\":\"test974\",\"stations\":\"[\\\"st1839\\\", \\\"sta2046\\\"]\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-station-service POST /api/v1/stationservice/stations/idlist (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "[\"[\\\"test236\\\"]\", \"[\\\"test236\\\"]\", \"[\\\"test236\\\"]\", \"[\\\"test236\\\"]\"]";
                        req = req.body(requestBody2);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"dist429h\",\"distances\":\"[\\\"dis8238m\\\", \\\"dis6671d\\\"]\",\"endStation\":\"test12\",\"id\":\"test13\",\"loginId\":\"lo4292\",\"startStation\":\"test547\",\"stationList\":\"sta3762\",\"stations\":\"[\\\"st1839\\\", \\\"sta2046\\\"]\"}";
                        req = req.body(requestBody1);
