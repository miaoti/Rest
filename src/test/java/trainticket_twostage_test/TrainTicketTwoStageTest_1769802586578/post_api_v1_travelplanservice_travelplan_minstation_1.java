package trainticket_twostage_test.TrainTicketTwoStageTest_1769802586578;
            ...
            Allure.step("Step 1: ts-travel-plan-service POST /api/v1/travelplanservice/travelPlan/minStation [expect 200]", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        String requestBody1 = "{\"departureTime\":\"2026-02-15\",\"endPlace\":\"Beijing\",\"startPlace\":\"Shenzhen\"}";
                        ...
                        allStepParameters.put("body", "{\"departureTime\":\"2026-02-15\",\"endPlace\":\"Beijing\",\"startPlace\":\"Shenzhen\"}");
            ...
            Allure.step("Step 1: ts-travel-plan-service POST /api/v1/travelplanservice/travelPlan/minStation [expect not 200]", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"departureTime\":123456,\"endPlace\":\"Shanghai\",\"startPlace\":\"Beijing\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"departureTime\":123456,\"endPlace\":\"Shanghai\",\"startPlace\":\"Beijing\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/travelplanservice/travelPlan/minStation")
                               .then().log().ifValidationFails()
                               .extract().response();
