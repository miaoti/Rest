package trainticket_twostage_test.TrainTicketTwoStageTest_1763419229301;
...
public class POST_api_v1_travelservice_trips_left_1 {
            ...
            Allure.step("Step 1: ts-travel-service POST /api/v1/travelservice/trips/left (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        String requestBody1 = "{\"departureTime\":\"2025-11-20T08:30:00Z\",\"endPlace\":\"Beijing Railway Station\",\"startPlace\":\"Beijing Railway Station\"}";
                        ...
                        allStepParameters.put("body", "{\"departureTime\":\"2025-11-20T08:30:00Z\",\"endPlace\":\"Beijing Railway Station\",\"startPlace\":\"Beijing Railway Station\"}");
            ...
            Allure.step("Step 1: ts-travel-service POST /api/v1/travelservice/trips/left (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"departureTime\":\"15:25\",\"endPlace\":\"Beijing Railway Station\",\"startPlace\":\"Beijing Railway Station\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"departureTime\":\"15:25\",\"endPlace\":\"Beijing Railway Station\",\"startPlace\":\"Beijing Railway Station\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/travelservice/trips/left")
                               .then().log().ifValidationFails()
                               .extract().response();
            ...
            Allure.step("Step 1: ts-travel-service POST /api/v1/travelservice/trips/left (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"departureTime\":\"14:45\",\"endPlace\":\"Beijing Railway Station\",\"startPlace\":\"Beijing Railway Station\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"departureTime\":\"14:45\",\"endPlace\":\"Beijing Railway Station\",\"startPlace\":\"Beijing Railway Station\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/travelservice/trips/left")
                               .then().log().ifValidationFails()
                               .extract().response();
            ...
            Allure.step("Step 1: ts-travel-service POST /api/v1/travelservice/trips/left (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"departureTime\":\"11:35\",\"endPlace\":\"Beijing Railway Station\",\"startPlace\":\"Beijing Railway Station\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"departureTime\":\"11:35\",\"endPlace\":\"Beijing Railway Station\",\"startPlace\":\"Beijing Railway Station\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/travelservice/trips/left")
                               .then().log().ifValidationFails()
                               .extract().response();
            ...
            Allure.step("Step 1: ts-travel-service POST /api/v1/travelservice/trips/left (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"departureTime\":\"12:15\",\"endPlace\":\"Beijing Railway Station\",\"startPlace\":\"123\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"departureTime\":\"12:15\",\"endPlace\":\"Beijing Railway Station\",\"startPlace\":\"123\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/travelservice/trips/left")
                               .then().log().ifValidationFails()
                               .extract().response();
            ...
            Allure.step("Step 1: ts-travel-service POST /api/v1/travelservice/trips/left (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"departureTime\":\"2025-11-20T08:30:00Z\",\"endPlace\":\"123\",\"startPlace\":\"Shanghai Hongqiao Station\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"departureTime\":\"2025-11-20T08:30:00Z\",\"endPlace\":\"123\",\"startPlace\":\"Shanghai Hongqiao Station\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/travelservice/trips/left")
                               .then().log().ifValidationFails()
                               .extract().response();
    ...
    public void test_negative_POST_1_8() throws Exception {
        ...
        // 🚨 NEGATIVE TEST METADATA
        Allure.parameter("🚨 Test Type", "NEGATIVE (Invalid Input Testing)");
        Allure.parameter("🔴 Invalid Parameters", "departureTime=1999-13-01T12:00:00Z");
        Allure.description("**⚠️ This is a NEGATIVE test case with intentionally invalid inputs.**\n\n" +
                         "The following parameters were intentionally set to invalid values:\n" +
                         "departureTime=1999-13-01T12:00:00Z\n\n" +
                         "This test expects a 4XX or 5XX error response. If it returns 2XX, the test will FAIL.");
            ...
            Allure.step("Step 1: ts-travel-service POST /api/v1/travelservice/trips/left (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"departureTime\":\"1999-13-01T12:00:00Z\",\"endPlace\":\"Hangzhou East Station\",\"startPlace\":\"Beijing Railway Station\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"departureTime\":\"1999-13-01T12:00:00Z\",\"endPlace\":\"Hangzhou East Station\",\"startPlace\":\"Beijing Railway Station\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/travelservice/trips/left")
                               .then().log().ifValidationFails()
                               .extract().response();
            ...
            Allure.step("Step 1: ts-travel-service POST /api/v1/travelservice/trips/left (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"departureTime\":\"2025-11-20T08:30:00Z\",\"endPlace\":\"Beijing Railway Station\",\"startPlace\":\"Guangzhou South Railway Station\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"departureTime\":\"2025-11-20T08:30:00Z\",\"endPlace\":\"Beijing Railway Station\",\"startPlace\":\"Guangzhou South Railway Station\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/travelservice/trips/left")
                               .then().log().ifValidationFails()
                               .extract().response();
