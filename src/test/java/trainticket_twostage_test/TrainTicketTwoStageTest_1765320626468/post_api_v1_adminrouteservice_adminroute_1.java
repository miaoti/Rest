package trainticket_twostage_test.TrainTicketTwoStageTest_1765320626468;
...
public class post_api_v1_adminrouteservice_adminroute_1 {
    ...
    public void test_negative_POST_1_1() throws Exception {
        ...
        es.us.isa.restest.enhancer.TestResultCapture.addParameter(
            ...
            null, false);
        es.us.isa.restest.enhancer.TestResultCapture.addParameter(
            "stationList", "New York Penn Station,Grand Central Terminal,Times Square Station", 
            "string", "formData", 
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute [expect not 200]", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        String requestBody1 = "{\"distanceList\":\"12.5,8.2,15.7,22.1,5.9\",\"endStation\":123,\"id\":\"ADMIN-000123\",\"loginId\":\"admin_user_001\",\"startStation\":\"Chicago Union Station\",\"stationList\":\"Chicago Union Station,New York Penn Station,Grand Central Terminal,Times Square Station\"}";
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"12.5,8.2,15.7,22.1,5.9\",\"endStation\":123,\"id\":\"ADMIN-000123\",\"loginId\":\"admin_user_001\",\"startStation\":\"Chicago Union Station\",\"stationList\":\"Chicago Union Station,New York Penn Station,Grand Central Terminal,Times Square Station\"}");
    ...
    public void test_POST_1_2() throws Exception {
        ...
        // ═══════════════════════════════════════════════════════════════════════
        Allure.label("enhancement", "ENHANCED");
        Allure.addAttachment("📝 Original Failure", "text/plain", "Original Status: 200\nOriginal Response: {\"status\":0,\"msg\":\"start or end station not include in stationList.\",\"data\":null}\nEnhanced Parameters: {endStation=Times Square Station, stationList=New York Penn Station,Grand Central Terminal,Times Square Station,Chicago Union Station, startStation=New York Penn Station}");
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute [expect 200]", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"15.2\",\"endStation\":\"Times Square Station\",\"id\":\"AR-2025-001\",\"loginId\":\"admin_user_001\",\"startStation\":\"New York Penn Station\",\"stationList\":\"New York Penn Station,Grand Central Terminal,Times Square Station,Chicago Union Station\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"15.2\",\"endStation\":\"Times Square Station\",\"id\":\"AR-2025-001\",\"loginId\":\"admin_user_001\",\"startStation\":\"New York Penn Station\",\"stationList\":\"New York Penn Station,Grand Central Terminal,Times Square Station,Chicago Union Station\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               .extract().response();
    ...
    public void test_negative_POST_1_3() throws Exception {
        ...
        // ═══════════════════════════════════════════════════════════════════════
        Allure.label("enhancement", "ENHANCED");
        Allure.addAttachment("📝 Original Failure", "text/plain", "Original Status: 200\nOriginal Response: {\"status\":0,\"msg\":\"start or end station not include in stationList.\",\"data\":null}\nEnhanced Parameters: {endStation=Grand Central Terminal, startStation=New York Penn Station}");
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute [expect not 200]", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"15.2\",\"endStation\":\"Grand Central Terminal\",\"id\":\"AR-2025-001\",\"loginId\":123,\"startStation\":\"New York Penn Station\",\"stationList\":\"New York Penn Station,Grand Central Terminal,Times Square Station\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"15.2\",\"endStation\":\"Grand Central Terminal\",\"id\":\"AR-2025-001\",\"loginId\":123,\"startStation\":\"New York Penn Station\",\"stationList\":\"New York Penn Station,Grand Central Terminal,Times Square Station\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               .extract().response();
    ...
    public void test_negative_POST_1_4() throws Exception {
        ...
        es.us.isa.restest.enhancer.TestResultCapture.addParameter(
            ...
            "12.5,8.2,15.7,22.1,5.9", false);
        es.us.isa.restest.enhancer.TestResultCapture.addParameter(
            "endStation", "Boston South Station", 
            "string", "formData", 
            null, 
            null, false);
        es.us.isa.restest.enhancer.TestResultCapture.addParameter(
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute [expect not 200]", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"15.2\",\"endStation\":\"Boston South Station\",\"id\":\"AR-2025-001\",\"loginId\":\"dispatcher_team_lead\",\"startStation\":\"Chicago Union Station\",\"stationList\":123}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"15.2\",\"endStation\":\"Boston South Station\",\"id\":\"AR-2025-001\",\"loginId\":\"dispatcher_team_lead\",\"startStation\":\"Chicago Union Station\",\"stationList\":123}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               .extract().response();
    ...
    public void test_negative_POST_1_5() throws Exception {
        ...
        // ═══════════════════════════════════════════════════════════════════════
        Allure.label("enhancement", "ENHANCED");
        Allure.addAttachment("📝 Original Failure", "text/plain", "Original Status: 200\nOriginal Response: {\"status\":0,\"msg\":\"start or end station not include in stationList.\",\"data\":null}\nEnhanced Parameters: {endStation=Boston South Station, stationList=New York Penn Station,Grand Central Terminal,Times Square Station, startStation=Boston South Station}");
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute [expect not 200]", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":123,\"endStation\":\"Boston South Station\",\"id\":\"ROUTE-456-XYZ\",\"loginId\":\"admin_user_001\",\"startStation\":\"Boston South Station\",\"stationList\":\"New York Penn Station,Grand Central Terminal,Times Square Station\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":123,\"endStation\":\"Boston South Station\",\"id\":\"ROUTE-456-XYZ\",\"loginId\":\"admin_user_001\",\"startStation\":\"Boston South Station\",\"stationList\":\"New York Penn Station,Grand Central Terminal,Times Square Station\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               .extract().response();
