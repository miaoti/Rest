package trainticket_twostage_test.TrainTicketTwoStageTest_1762803310635;
...
public class POST_api_v1_adminorderservice_adminorder_1 {
    ...
    public void test_negative_POST_1_1() throws Exception {
        ...
        Allure.parameter("🔴 Invalid Parameters", "travelTime=1234567890123456789012345678901");
        Allure.description("**⚠️ This is a NEGATIVE test case with intentionally invalid inputs.**\n\n" +
                         ...
                         "travelTime=1234567890123456789012345678901\n\n" +
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        String requestBody1 = "{\"accountId\":\"1234567890\",\"boughtDate\":\"2023-10-26\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"5551234567\",\"contactsName\":\"Jane Smith\",\"differenceMoney\":\"100\",\"documentType\":\"1\",\"from\":\"123\",\"id\":\"123\",\"price\":\"19.99\",\"seatClass\":\"4\",\"seatNumber\":\"1A\",\"status\":\"10\",\"to\":\"John Doe\",\"trainNumber\":\"G1245\",\"travelDate\":\"2023-12-25\",\"travelTime\":\"1234567890123456789012345678901\"}";
    ...
    public void test_negative_POST_1_2() throws Exception {
        ...
        // 🚨 NEGATIVE TEST METADATA
        Allure.parameter("🚨 Test Type", "NEGATIVE (Invalid Input Testing)");
        Allure.parameter("🔴 Invalid Parameters", "documentType=\"123\"");
        Allure.description("**⚠️ This is a NEGATIVE test case with intentionally invalid inputs.**\n\n" +
                         "The following parameters were intentionally set to invalid values:\n" +
                         "documentType=\"123\"\n\n" +
                         "This test expects a 4XX or 5XX error response. If it returns 2XX, the test will FAIL.");
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"1234567890\",\"boughtDate\":\"2023-10-26\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"1234567890\",\"contactsName\":\"John Doe\",\"differenceMoney\":\"100\",\"documentType\":\"\\\"123\\\"\",\"from\":\"123\",\"id\":\"9a8b7c\",\"price\":\"19.99\",\"seatClass\":\"1\",\"seatNumber\":\"1A\",\"status\":\"10\",\"to\":\"John Doe\",\"trainNumber\":\"12345\",\"travelDate\":\"2023-12-25\",\"travelTime\":\"30\"}";
                        req = req.body(requestBody1);
    ...
    public void test_negative_POST_1_3() throws Exception {
        ...
        // 🚨 NEGATIVE TEST METADATA
        Allure.parameter("🚨 Test Type", "NEGATIVE (Invalid Input Testing)");
        Allure.parameter("🔴 Invalid Parameters", "contactsDocumentNumber=-1234567890123456789012345678901");
        Allure.description("**⚠️ This is a NEGATIVE test case with intentionally invalid inputs.**\n\n" +
                         "The following parameters were intentionally set to invalid values:\n" +
                         "contactsDocumentNumber=-1234567890123456789012345678901\n\n" +
                         "This test expects a 4XX or 5XX error response. If it returns 2XX, the test will FAIL.");
    ...
    public void test_negative_POST_1_4() throws Exception {
        ...
        // 🚨 NEGATIVE TEST METADATA
        Allure.parameter("🚨 Test Type", "NEGATIVE (Invalid Input Testing)");
        Allure.parameter("🔴 Invalid Parameters", "contactsName=123456789012345678901234567890");
        Allure.description("**⚠️ This is a NEGATIVE test case with intentionally invalid inputs.**\n\n" +
                         "The following parameters were intentionally set to invalid values:\n" +
                         "contactsName=123456789012345678901234567890\n\n" +
                         "This test expects a 4XX or 5XX error response. If it returns 2XX, the test will FAIL.");
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"1234567890\",\"boughtDate\":\"2023-10-26\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"1234567890\",\"contactsName\":\"123456789012345678901234567890\",\"differenceMoney\":\"100\",\"documentType\":\"1\",\"from\":\"123\",\"id\":\"123\",\"price\":\"19.99\",\"seatClass\":\"1\",\"seatNumber\":\"1A\",\"status\":\"10\",\"to\":\"John Doe\",\"trainNumber\":\"G1244\",\"travelDate\":\"2023-12-25\",\"travelTime\":\"30\"}";
                        req = req.body(requestBody1);
    ...
    public void test_negative_POST_1_5() throws Exception {
        ...
        // 🚨 NEGATIVE TEST METADATA
        Allure.parameter("🚨 Test Type", "NEGATIVE (Invalid Input Testing)");
        Allure.parameter("🔴 Invalid Parameters", "differenceMoney=123456789012345678901234567890123456789012");
        Allure.description("**⚠️ This is a NEGATIVE test case with intentionally invalid inputs.**\n\n" +
                         "The following parameters were intentionally set to invalid values:\n" +
                         "differenceMoney=123456789012345678901234567890123456789012\n\n" +
                         "This test expects a 4XX or 5XX error response. If it returns 2XX, the test will FAIL.");
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"1234567890\",\"boughtDate\":\"2023-10-26\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"1234567890\",\"contactsName\":\"John Doe\",\"differenceMoney\":\"123456789012345678901234567890123456789012\",\"documentType\":\"1\",\"from\":\"123\",\"id\":\"123\",\"price\":\"19.99\",\"seatClass\":\"1\",\"seatNumber\":\"1A\",\"status\":\"10\",\"to\":\"John Doe\",\"trainNumber\":\"12345\",\"travelDate\":\"2024-11-05\",\"travelTime\":\"30\"}";
                        req = req.body(requestBody1);
    ...
    public void test_negative_POST_1_6() throws Exception {
        ...
        // 🚨 NEGATIVE TEST METADATA
        Allure.parameter("🚨 Test Type", "NEGATIVE (Invalid Input Testing)");
        Allure.parameter("🔴 Invalid Parameters", "seatNumber=123456789012345678901234567890");
        Allure.description("**⚠️ This is a NEGATIVE test case with intentionally invalid inputs.**\n\n" +
                         "The following parameters were intentionally set to invalid values:\n" +
                         "seatNumber=123456789012345678901234567890\n\n" +
                         "This test expects a 4XX or 5XX error response. If it returns 2XX, the test will FAIL.");
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"1234567890\",\"boughtDate\":\"2023-10-26\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"1234567890\",\"contactsName\":\"John Doe\",\"differenceMoney\":\"100\",\"documentType\":\"1\",\"from\":\"123\",\"id\":\"123\",\"price\":\"19.99\",\"seatClass\":\"1\",\"seatNumber\":\"123456789012345678901234567890\",\"status\":\"10\",\"to\":\"Jane Smith\",\"trainNumber\":\"12345\",\"travelDate\":\"2023-12-25\",\"travelTime\":\"30\"}";
                        req = req.body(requestBody1);
    ...
    public void test_negative_POST_1_7() throws Exception {
        ...
        // 🚨 NEGATIVE TEST METADATA
        Allure.parameter("🚨 Test Type", "NEGATIVE (Invalid Input Testing)");
        Allure.parameter("🔴 Invalid Parameters", "accountId=!@#$%^&*()_+=-`~[]\\{}|;':\",./<>?");
        Allure.description("**⚠️ This is a NEGATIVE test case with intentionally invalid inputs.**\n\n" +
                         "The following parameters were intentionally set to invalid values:\n" +
                         "accountId=!@#$%^&*()_+=-`~[]\\{}|;':\",./<>?\n\n" +
                         "This test expects a 4XX or 5XX error response. If it returns 2XX, the test will FAIL.");
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"!@#$%^&*()_+=-`~[]\\\\{}|;':\\\",./<>?\",\"boughtDate\":\"2024-01-05\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"1234567890\",\"contactsName\":\"John Doe\",\"differenceMoney\":\"-50\",\"documentType\":\"1\",\"from\":\"123\",\"id\":\"123\",\"price\":\"19.99\",\"seatClass\":\"5\",\"seatNumber\":\"5B-789\",\"status\":\"10\",\"to\":\"Peter Jones\",\"trainNumber\":\"12345\",\"travelDate\":\"2023-12-25\",\"travelTime\":\"30\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"accountId\":\"!@#$%^&*()_+=-`~[]\\\\{}|;':\\\",./<>?\",\"boughtDate\":\"2024-01-05\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"1234567890\",\"contactsName\":\"John Doe\",\"differenceMoney\":\"-50\",\"documentType\":\"1\",\"from\":\"123\",\"id\":\"123\",\"price\":\"19.99\",\"seatClass\":\"5\",\"seatNumber\":\"5B-789\",\"status\":\"10\",\"to\":\"Peter Jones\",\"trainNumber\":\"12345\",\"travelDate\":\"2023-12-25\",\"travelTime\":\"30\"}");
                        Response stepResponse1 = req.when().post("/api/v1/adminorderservice/adminorder")
                               .then().log().ifValidationFails()
                               // Negative test: expect error code (4XX or 5XX), not success code
                               .statusCode(org.hamcrest.Matchers.greaterThanOrEqualTo(400))
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"1234567890\",\"boughtDate\":\"2023-10-26\",\"coachNumber\":\"123456789012345678901234567890\",\"contactsDocumentNumber\":\"1234567890\",\"contactsName\":\"John Doe\",\"differenceMoney\":\"100\",\"documentType\":\"1\",\"from\":\"123\",\"id\":\"123\",\"price\":\"19.99\",\"seatClass\":\"1\",\"seatNumber\":\"1A\",\"status\":\"10\",\"to\":\"John Doe\",\"trainNumber\":\"12345\",\"travelDate\":\"2025-07-10\",\"travelTime\":\"30\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"accountId\":\"1234567890\",\"boughtDate\":\"2023-10-26\",\"coachNumber\":\"123456789012345678901234567890\",\"contactsDocumentNumber\":\"1234567890\",\"contactsName\":\"John Doe\",\"differenceMoney\":\"100\",\"documentType\":\"1\",\"from\":\"123\",\"id\":\"123\",\"price\":\"19.99\",\"seatClass\":\"1\",\"seatNumber\":\"1A\",\"status\":\"10\",\"to\":\"John Doe\",\"trainNumber\":\"12345\",\"travelDate\":\"2025-07-10\",\"travelTime\":\"30\"}");
                        Response stepResponse1 = req.when().post("/api/v1/adminorderservice/adminorder")
                               .then().log().ifValidationFails()
                               // Negative test: expect error code (4XX or 5XX), not success code
                               .statusCode(org.hamcrest.Matchers.greaterThanOrEqualTo(400))
    ...
    public void test_negative_POST_1_9() throws Exception {
        ...
        // 🚨 NEGATIVE TEST METADATA
        Allure.parameter("🚨 Test Type", "NEGATIVE (Invalid Input Testing)");
        Allure.parameter("🔴 Invalid Parameters", "travelDate=2023-13-27-13:00:00:00abcdefgh");
        Allure.description("**⚠️ This is a NEGATIVE test case with intentionally invalid inputs.**\n\n" +
                         "The following parameters were intentionally set to invalid values:\n" +
                         "travelDate=2023-13-27-13:00:00:00abcdefgh\n\n" +
                         "This test expects a 4XX or 5XX error response. If it returns 2XX, the test will FAIL.");
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"1234567890\",\"boughtDate\":\"2023-10-26\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"1234567890\",\"contactsName\":\"John Doe\",\"differenceMoney\":\"100\",\"documentType\":\"1\",\"from\":\"123\",\"id\":\"123\",\"price\":\"19.99\",\"seatClass\":\"1\",\"seatNumber\":\"1A\",\"status\":\"10\",\"to\":\"John Doe\",\"trainNumber\":\"12345\",\"travelDate\":\"2023-13-27-13:00:00:00abcdefgh\",\"travelTime\":\"30\"}";
                        req = req.body(requestBody1);
    ...
    public void test_negative_POST_1_10() throws Exception {
        ...
        // 🚨 NEGATIVE TEST METADATA
        Allure.parameter("🚨 Test Type", "NEGATIVE (Invalid Input Testing)");
        Allure.parameter("🔴 Invalid Parameters", "boughtDate=2023-13-32-A-B-C-D-E-F-G");
        Allure.description("**⚠️ This is a NEGATIVE test case with intentionally invalid inputs.**\n\n" +
                         "The following parameters were intentionally set to invalid values:\n" +
                         "boughtDate=2023-13-32-A-B-C-D-E-F-G\n\n" +
                         "This test expects a 4XX or 5XX error response. If it returns 2XX, the test will FAIL.");
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"1234567890\",\"boughtDate\":\"2023-13-32-A-B-C-D-E-F-G\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"1234567890\",\"contactsName\":\"John Doe\",\"differenceMoney\":\"100\",\"documentType\":\"1\",\"from\":\"123\",\"id\":\"123\",\"price\":\"19.99\",\"seatClass\":\"1\",\"seatNumber\":\"1A\",\"status\":\"10\",\"to\":\"John Doe\",\"trainNumber\":\"12345\",\"travelDate\":\"2023-12-25\",\"travelTime\":\"30\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"accountId\":\"1234567890\",\"boughtDate\":\"2023-13-32-A-B-C-D-E-F-G\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"1234567890\",\"contactsName\":\"John Doe\",\"differenceMoney\":\"100\",\"documentType\":\"1\",\"from\":\"123\",\"id\":\"123\",\"price\":\"19.99\",\"seatClass\":\"1\",\"seatNumber\":\"1A\",\"status\":\"10\",\"to\":\"John Doe\",\"trainNumber\":\"12345\",\"travelDate\":\"2023-12-25\",\"travelTime\":\"30\"}");
                        Response stepResponse1 = req.when().post("/api/v1/adminorderservice/adminorder")
                               .then().log().ifValidationFails()
                               // Negative test: expect error code (4XX or 5XX), not success code
                               .statusCode(org.hamcrest.Matchers.greaterThanOrEqualTo(400))
