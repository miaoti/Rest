package trainticket_twostage_test.TrainTicketTwoStageTest_1762802437742;
...
public class POST_api_v1_adminorderservice_adminorder_1 {
    ...
    public void test_negative_POST_1_1() throws Exception {
        ...
        Allure.parameter("🚨 Test Type", "Negative Testing (Error Validation)");
        Allure.parameter("🔴 Invalid Parameters", "travelTime=abcde");
        Allure.description("**⚠️ This is a negative test case for error validation.**\n\n" +
                         "The following parameters were intentionally set to invalid values:\n" +
                         "travelTime=abcde\n\n" +
                         "This test expects error status codes (400-599) and will fail if it receives success codes (200-299).");
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        String requestBody1 = "{\"accountId\":\"1234567890\",\"boughtDate\":\"2023-10-26\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"123456789\",\"contactsName\":\"John Doe\",\"differenceMoney\":\"100\",\"documentType\":\"1\",\"from\":\"123\",\"id\":\"xyz\",\"price\":\"19.99\",\"seatClass\":\"1\",\"seatNumber\":\"123\",\"status\":\"10\",\"to\":\"JohnDoe\",\"trainNumber\":\"12345\",\"travelDate\":\"2023-12-25\",\"travelTime\":\"abcde\"}";
                        ...
                        // Negative test case: Expect error status code (400-599)
                        Response stepResponse1 = req.when().post("/api/v1/adminorderservice/adminorder")
                               .then().log().ifValidationFails()
                               .extract().response();
                        
                        // Validate that negative test case received an error status code
                        int actualStatus1 = stepResponse1.getStatusCode();
                        if (actualStatus1 < 400) {
                            String errorMsg = "Negative test case expected error status code (400-599), but received success code: " + actualStatus1;
                            System.err.println("❌ " + errorMsg);
                            org.junit.Assert.fail(errorMsg);
                        }
                        
                        // Negative test case: Validate error status and report
                        ...
                        try {
                            ...
                            if (actualStatus1 >= 400 && actualStatus1 < 600) {
                                // Expected error status code received
                                System.out.println("✅ Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200) - EXPECTED ERROR (" + actualStatus1 + ")");
                                Allure.parameter("🎯 Result", "✅ EXPECTED ERROR (" + actualStatus1 + " in " + responseTime + "ms)");
                                Allure.addAttachment("📥 Error Response (" + actualStatus1 + ")", "application/json", responseBody);
                            } else {
                                // Unexpected success code - should have been caught earlier, but report anyway
                                System.out.println("❌ Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200) - UNEXPECTED SUCCESS (" + actualStatus1 + ")");
                                Allure.parameter("🎯 Result", "❌ UNEXPECTED SUCCESS (" + actualStatus1 + ")");
                                Allure.addAttachment("📥 Response (" + actualStatus1 + ")", "application/json", responseBody);
                            }
                            ...
                            System.out.println("✅ Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200) - EXPECTED ERROR (response capture failed)");
                            Allure.parameter("🎯 Result", "✅ EXPECTED ERROR (response capture failed)");
                        }
                    } catch (Throwable t) {
                        ...
                        if (t instanceof java.net.ConnectException) {
                            ...
                            // Check if this is a negative test case that received a success code
                            if (t.getMessage() != null && t.getMessage().contains("Negative test case expected error status code")) {
                                errorType = "Negative Test Validation Failed";
                                failureReason = "Negative test case received success code instead of expected error code (400-599). This indicates the API did not properly validate invalid input.";
                            } else {
    ...
    public void test_negative_POST_1_2() throws Exception {
        ...
        // 🚨 NEGATIVE TEST METADATA
        Allure.parameter("🚨 Test Type", "Negative Testing (Error Validation)");
        Allure.parameter("🔴 Invalid Parameters", "documentType=123.45");
        Allure.description("**⚠️ This is a negative test case for error validation.**\n\n" +
                         "The following parameters were intentionally set to invalid values:\n" +
                         "documentType=123.45\n\n" +
                         "This test expects error status codes (400-599) and will fail if it receives success codes (200-299).");
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"1234567890\",\"boughtDate\":\"2023-10-26\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"123456789\",\"contactsName\":\"John Doe\",\"differenceMoney\":\"100\",\"documentType\":\"123.45\",\"from\":\"123\",\"id\":\"123\",\"price\":\"19.99\",\"seatClass\":\"1\",\"seatNumber\":\"123\",\"status\":\"-5\",\"to\":\"JohnDoe\",\"trainNumber\":\"12345\",\"travelDate\":\"2023-12-25\",\"travelTime\":\"1h 35m\"}";
                        req = req.body(requestBody1);
    ...
    public void test_negative_POST_1_3() throws Exception {
        ...
        // 🚨 NEGATIVE TEST METADATA
        Allure.parameter("🚨 Test Type", "Negative Testing (Error Validation)");
        Allure.parameter("🔴 Invalid Parameters", "contactsDocumentNumber= ");
        Allure.description("**⚠️ This is a negative test case for error validation.**\n\n" +
                         "The following parameters were intentionally set to invalid values:\n" +
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"1234567890\",\"boughtDate\":\"2023-10-26\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\" \",\"contactsName\":\"John Doe\",\"differenceMoney\":\"100\",\"documentType\":\"1\",\"from\":\"123\",\"id\":\"123\",\"price\":\"0.99\",\"seatClass\":\"1\",\"seatNumber\":\"123\",\"status\":\"10\",\"to\":\"JohnDoe\",\"trainNumber\":\"12345\",\"travelDate\":\"2023-12-25\",\"travelTime\":\"1h 35m\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"accountId\":\"1234567890\",\"boughtDate\":\"2023-10-26\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\" \",\"contactsName\":\"John Doe\",\"differenceMoney\":\"100\",\"documentType\":\"1\",\"from\":\"123\",\"id\":\"123\",\"price\":\"0.99\",\"seatClass\":\"1\",\"seatNumber\":\"123\",\"status\":\"10\",\"to\":\"JohnDoe\",\"trainNumber\":\"12345\",\"travelDate\":\"2023-12-25\",\"travelTime\":\"1h 35m\"}");
                        // Negative test case: Expect error status code (400-599)
                        Response stepResponse1 = req.when().post("/api/v1/adminorderservice/adminorder")
                               .then().log().ifValidationFails()
                               .extract().response();
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"1234567890\",\"boughtDate\":\"2023-10-26\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"123456789\",\"contactsName\":\"123\",\"differenceMoney\":\"25.50\",\"documentType\":\"1\",\"from\":\"123\",\"id\":\"123\",\"price\":\"1000.00\",\"seatClass\":\"1\",\"seatNumber\":\"Invalid Seat\",\"status\":\"10\",\"to\":\"JohnDoe\",\"trainNumber\":\"12345\",\"travelDate\":\"2023-12-25\",\"travelTime\":\"1h 35m\"}";
                        req = req.body(requestBody1);
    ...
    public void test_negative_POST_1_5() throws Exception {
        ...
        // 🚨 NEGATIVE TEST METADATA
        Allure.parameter("🚨 Test Type", "Negative Testing (Error Validation)");
        Allure.parameter("🔴 Invalid Parameters", "differenceMoney=1234567890123456789012345678901234567890");
        Allure.description("**⚠️ This is a negative test case for error validation.**\n\n" +
                         "The following parameters were intentionally set to invalid values:\n" +
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"1234567890\",\"boughtDate\":\"2023-10-26\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"123456789\",\"contactsName\":\"John Doe\",\"differenceMoney\":\"1234567890123456789012345678901234567890\",\"documentType\":\"1\",\"from\":\"123\",\"id\":\"123\",\"price\":\"19.99\",\"seatClass\":\"1\",\"seatNumber\":\"123\",\"status\":\"10\",\"to\":\"JohnDoe\",\"trainNumber\":\"12345\",\"travelDate\":\"2023-12-25\",\"travelTime\":\"1h 35m\"}";
                        req = req.body(requestBody1);
    ...
    public void test_negative_POST_1_6() throws Exception {
        ...
        // 🚨 NEGATIVE TEST METADATA
        Allure.parameter("🚨 Test Type", "Negative Testing (Error Validation)");
        Allure.parameter("🔴 Invalid Parameters", "seatNumber=null");
        Allure.description("**⚠️ This is a negative test case for error validation.**\n\n" +
                         "The following parameters were intentionally set to invalid values:\n" +
                         "seatNumber=null\n\n" +
                         "This test expects error status codes (400-599) and will fail if it receives success codes (200-299).");
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"1234567890\",\"boughtDate\":\"2023-10-26\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"123456789\",\"contactsName\":\"John Doe\",\"differenceMoney\":\"100\",\"documentType\":\"1\",\"from\":\"123\",\"id\":\"123\",\"price\":\"19.99\",\"seatClass\":\"4\",\"seatNumber\":null,\"status\":\"10\",\"to\":\"JohnDoe\",\"trainNumber\":\"12345\",\"travelDate\":\"2023-12-25\",\"travelTime\":\"1h 35m\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":null,\"boughtDate\":\"2023-10-26\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"123456789\",\"contactsName\":\"Jane Smith\",\"differenceMoney\":\"100\",\"documentType\":\"1\",\"from\":\"123\",\"id\":\"123\",\"price\":\"19.99\",\"seatClass\":\"1\",\"seatNumber\":\"123\",\"status\":\"10\",\"to\":\"JohnDoe\",\"trainNumber\":\"12345\",\"travelDate\":\"2023-12-25\",\"travelTime\":\"1h 35m\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"accountId\":null,\"boughtDate\":\"2023-10-26\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"123456789\",\"contactsName\":\"Jane Smith\",\"differenceMoney\":\"100\",\"documentType\":\"1\",\"from\":\"123\",\"id\":\"123\",\"price\":\"19.99\",\"seatClass\":\"1\",\"seatNumber\":\"123\",\"status\":\"10\",\"to\":\"JohnDoe\",\"trainNumber\":\"12345\",\"travelDate\":\"2023-12-25\",\"travelTime\":\"1h 35m\"}");
                        // Negative test case: Expect error status code (400-599)
                        Response stepResponse1 = req.when().post("/api/v1/adminorderservice/adminorder")
                               .then().log().ifValidationFails()
                               .extract().response();
    ...
    public void test_negative_POST_1_8() throws Exception {
        ...
        // 🚨 NEGATIVE TEST METADATA
        Allure.parameter("🚨 Test Type", "Negative Testing (Error Validation)");
        Allure.parameter("🔴 Invalid Parameters", "coachNumber=123456789012345678901234567890");
        Allure.description("**⚠️ This is a negative test case for error validation.**\n\n" +
                         "The following parameters were intentionally set to invalid values:\n" +
                         "coachNumber=123456789012345678901234567890\n\n" +
                         "This test expects error status codes (400-599) and will fail if it receives success codes (200-299).");
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"1234567890\",\"boughtDate\":\"2023-10-26\",\"coachNumber\":\"123456789012345678901234567890\",\"contactsDocumentNumber\":\"123456789\",\"contactsName\":\"John Doe\",\"differenceMoney\":\"100\",\"documentType\":\"100\",\"from\":\"123\",\"id\":\"123\",\"price\":\"19.99\",\"seatClass\":\"1\",\"seatNumber\":\"123\",\"status\":\"0\",\"to\":\"JohnDoe\",\"trainNumber\":\"12345\",\"travelDate\":\"2024-02-29\",\"travelTime\":\"1h 35m\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"accountId\":\"1234567890\",\"boughtDate\":\"2023-10-26\",\"coachNumber\":\"123456789012345678901234567890\",\"contactsDocumentNumber\":\"123456789\",\"contactsName\":\"John Doe\",\"differenceMoney\":\"100\",\"documentType\":\"100\",\"from\":\"123\",\"id\":\"123\",\"price\":\"19.99\",\"seatClass\":\"1\",\"seatNumber\":\"123\",\"status\":\"0\",\"to\":\"JohnDoe\",\"trainNumber\":\"12345\",\"travelDate\":\"2024-02-29\",\"travelTime\":\"1h 35m\"}");
                        // Negative test case: Expect error status code (400-599)
                        Response stepResponse1 = req.when().post("/api/v1/adminorderservice/adminorder")
                               .then().log().ifValidationFails()
                               .extract().response();
    ...
    public void test_negative_POST_1_9() throws Exception {
        ...
        // 🚨 NEGATIVE TEST METADATA
        Allure.parameter("🚨 Test Type", "Negative Testing (Error Validation)");
        Allure.parameter("🔴 Invalid Parameters", "travelDate=2023-13-29");
        Allure.description("**⚠️ This is a negative test case for error validation.**\n\n" +
                         "The following parameters were intentionally set to invalid values:\n" +
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"1234567890\",\"boughtDate\":\"2024-03-15\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"123456789\",\"contactsName\":\"John Doe\",\"differenceMoney\":\"100\",\"documentType\":\"1\",\"from\":\"123\",\"id\":\"123\",\"price\":\"19.99\",\"seatClass\":\"1\",\"seatNumber\":\"123\",\"status\":\"10\",\"to\":\"JohnDoe\",\"trainNumber\":\"12345\",\"travelDate\":\"2023-13-29\",\"travelTime\":\"1h 35m\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"accountId\":\"1234567890\",\"boughtDate\":\"2024-03-15\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"123456789\",\"contactsName\":\"John Doe\",\"differenceMoney\":\"100\",\"documentType\":\"1\",\"from\":\"123\",\"id\":\"123\",\"price\":\"19.99\",\"seatClass\":\"1\",\"seatNumber\":\"123\",\"status\":\"10\",\"to\":\"JohnDoe\",\"trainNumber\":\"12345\",\"travelDate\":\"2023-13-29\",\"travelTime\":\"1h 35m\"}");
                        // Negative test case: Expect error status code (400-599)
                        Response stepResponse1 = req.when().post("/api/v1/adminorderservice/adminorder")
                               .then().log().ifValidationFails()
                               .extract().response();
    ...
    public void test_negative_POST_1_10() throws Exception {
        ...
        // 🚨 NEGATIVE TEST METADATA
        Allure.parameter("🚨 Test Type", "Negative Testing (Error Validation)");
        Allure.parameter("🔴 Invalid Parameters", "boughtDate=2023-13-09");
        Allure.description("**⚠️ This is a negative test case for error validation.**\n\n" +
                         "The following parameters were intentionally set to invalid values:\n" +
                         "boughtDate=2023-13-09\n\n" +
                         "This test expects error status codes (400-599) and will fail if it receives success codes (200-299).");
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"1234567890\",\"boughtDate\":\"2023-13-09\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"123456789\",\"contactsName\":\"John Doe\",\"differenceMoney\":\"100\",\"documentType\":\"1\",\"from\":\"123\",\"id\":\"123\",\"price\":\"19.99\",\"seatClass\":\"1\",\"seatNumber\":\"123\",\"status\":\"10\",\"to\":\"JohnDoe\",\"trainNumber\":\"12345\",\"travelDate\":\"2023-12-25\",\"travelTime\":\"2h 42m\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"accountId\":\"1234567890\",\"boughtDate\":\"2023-13-09\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"123456789\",\"contactsName\":\"John Doe\",\"differenceMoney\":\"100\",\"documentType\":\"1\",\"from\":\"123\",\"id\":\"123\",\"price\":\"19.99\",\"seatClass\":\"1\",\"seatNumber\":\"123\",\"status\":\"10\",\"to\":\"JohnDoe\",\"trainNumber\":\"12345\",\"travelDate\":\"2023-12-25\",\"travelTime\":\"2h 42m\"}");
                        // Negative test case: Expect error status code (400-599)
                        Response stepResponse1 = req.when().post("/api/v1/adminorderservice/adminorder")
                               .then().log().ifValidationFails()
                               .extract().response();
    ...
    public void test_negative_POST_1_11() throws Exception {
        ...
        // 🚨 NEGATIVE TEST METADATA
        Allure.parameter("🚨 Test Type", "Negative Testing (Error Validation)");
        Allure.parameter("🔴 Invalid Parameters", "price=\"invalid_price\"");
        Allure.description("**⚠️ This is a negative test case for error validation.**\n\n" +
                         "The following parameters were intentionally set to invalid values:\n" +
                         "price=\"invalid_price\"\n\n" +
                         "This test expects error status codes (400-599) and will fail if it receives success codes (200-299).");
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"1234567890\",\"boughtDate\":\"2023-10-26\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"123456789\",\"contactsName\":\"Robert Jones\",\"differenceMoney\":\"100\",\"documentType\":\"1\",\"from\":\"123\",\"id\":\"123\",\"price\":\"\\\"invalid_price\\\"\",\"seatClass\":\"1\",\"seatNumber\":\"123\",\"status\":\"10\",\"to\":\"JohnDoe\",\"trainNumber\":\"12345\",\"travelDate\":\"2023-12-25\",\"travelTime\":\"1h 35m\"}";
                        req = req.body(requestBody1);
    ...
    public void test_negative_POST_1_12() throws Exception {
        ...
        // 🚨 NEGATIVE TEST METADATA
        Allure.parameter("🚨 Test Type", "Negative Testing (Error Validation)");
        Allure.parameter("🔴 Invalid Parameters", "seatClass=1000000000000000000000000000000");
        Allure.description("**⚠️ This is a negative test case for error validation.**\n\n" +
                         "The following parameters were intentionally set to invalid values:\n" +
                         "seatClass=1000000000000000000000000000000\n\n" +
                         "This test expects error status codes (400-599) and will fail if it receives success codes (200-299).");
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"1234567890\",\"boughtDate\":\"2023-10-26\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"123456789\",\"contactsName\":\"John Doe\",\"differenceMoney\":\"100\",\"documentType\":\"1\",\"from\":\"123\",\"id\":\"123\",\"price\":\"19.99\",\"seatClass\":\"1000000000000000000000000000000\",\"seatNumber\":\"123\",\"status\":\"1000\",\"to\":\"JohnDoe\",\"trainNumber\":\"12345\",\"travelDate\":\"2023-12-25\",\"travelTime\":\"1h 35m\"}";
                        req = req.body(requestBody1);
    ...
    public void test_negative_POST_1_13() throws Exception {
        ...
        // 🚨 NEGATIVE TEST METADATA
        Allure.parameter("🚨 Test Type", "Negative Testing (Error Validation)");
        Allure.parameter("🔴 Invalid Parameters", "from= ");
        Allure.description("**⚠️ This is a negative test case for error validation.**\n\n" +
                         "The following parameters were intentionally set to invalid values:\n" +
                         "from= \n\n" +
                         "This test expects error status codes (400-599) and will fail if it receives success codes (200-299).");
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"1234567890\",\"boughtDate\":\"2023-10-26\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"123456789\",\"contactsName\":\"John Doe\",\"differenceMoney\":\"100\",\"documentType\":\"1\",\"from\":\" \",\"id\":\"-123\",\"price\":\"19.99\",\"seatClass\":\"1\",\"seatNumber\":\"123\",\"status\":\"10\",\"to\":\"JohnDoe\",\"trainNumber\":\"12345\",\"travelDate\":\"2023-12-25\",\"travelTime\":\"3h 10m\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"accountId\":\"1234567890\",\"boughtDate\":\"2023-10-26\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"123456789\",\"contactsName\":\"John Doe\",\"differenceMoney\":\"100\",\"documentType\":\"1\",\"from\":\" \",\"id\":\"-123\",\"price\":\"19.99\",\"seatClass\":\"1\",\"seatNumber\":\"123\",\"status\":\"10\",\"to\":\"JohnDoe\",\"trainNumber\":\"12345\",\"travelDate\":\"2023-12-25\",\"travelTime\":\"3h 10m\"}");
                        // Negative test case: Expect error status code (400-599)
                        Response stepResponse1 = req.when().post("/api/v1/adminorderservice/adminorder")
                               .then().log().ifValidationFails()
                               .extract().response();
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"1234567890\",\"boughtDate\":\"2023-10-26\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"123456789\",\"contactsName\":\"John Doe\",\"differenceMoney\":\"-1000\",\"documentType\":\"1\",\"from\":\"123\",\"id\":\"123\",\"price\":\"19.99\",\"seatClass\":\"1\",\"seatNumber\":\"123\",\"status\":\"10\",\"to\":\"JohnDoe\",\"trainNumber\":\"G1244\",\"travelDate\":\"2023-12-25\",\"travelTime\":\"1h 35m\"}";
                        req = req.body(requestBody1);
    ...
    public void test_negative_POST_1_15() throws Exception {
        ...
        // 🚨 NEGATIVE TEST METADATA
        Allure.parameter("🚨 Test Type", "Negative Testing (Error Validation)");
        Allure.parameter("🔴 Invalid Parameters", "to=false");
        Allure.description("**⚠️ This is a negative test case for error validation.**\n\n" +
                         "The following parameters were intentionally set to invalid values:\n" +
                         "to=false\n\n" +
                         "This test expects error status codes (400-599) and will fail if it receives success codes (200-299).");
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"1234567890\",\"boughtDate\":\"2023-10-26\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"123456789\",\"contactsName\":\"Michael Brown\",\"differenceMoney\":\"100\",\"documentType\":\"1\",\"from\":\"123\",\"id\":\"123\",\"price\":\"19.99\",\"seatClass\":\"1\",\"seatNumber\":\"123\",\"status\":\"10\",\"to\":\"false\",\"trainNumber\":\"12345\",\"travelDate\":\"2023-12-25\",\"travelTime\":\"1h 35m\"}";
                        req = req.body(requestBody1);
