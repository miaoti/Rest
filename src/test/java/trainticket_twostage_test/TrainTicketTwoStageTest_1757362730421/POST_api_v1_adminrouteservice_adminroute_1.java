package trainticket_twostage_test.TrainTicketTwoStageTest_1757362730421;
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        String requestBody1 = "{\"distanceList\":\"350,1000,1300\",\"distances\":\"[\\\"10\\\", \\\"50\\\", \\\"75\\\", \\\"100\\\", \\\"150\\\"]\",\"endStation\":\"Grand Central Terminal\",\"id\":\"0b23bd3e-876a-4af3-b920-c50a90c90b04\",\"loginId\":\"4d2a46c7-71cb-4cf1-b5bb-b68406d9da6f\",\"startStation\":\"wuxi\",\"stationList\":\"wuxi,shijiazhuang\",\"stations\":\"[\\\"wuxi\\\", \\\"shijiazhuang\\\"]\"}";
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"220\",\"distances\":\"[\\\"10\\\", \\\"50\\\", \\\"75\\\", \\\"100\\\", \\\"150\\\"]\",\"endStation\":\"Union Station\",\"id\":\"9fc9c261-3263-4bfa-82f8-bb44e06b2f52\",\"loginId\":\"7u9v0w1x-2345-6789-0\",\"startStation\":\"dallas\",\"stationList\":\"dallas\",\"stations\":\"[\\\"dallas\\\"]\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"400\",\"distances\":\"[\\\"10\\\", \\\"50\\\", \\\"75\\\", \\\"100\\\", \\\"150\\\"]\",\"endStation\":\"Times Square\",\"id\":\"98765432-10fed-cba9-8765-43210fedcba\",\"loginId\":\"f8a9b0c1-2345-6789-0123-456789abcdef\",\"startStation\":\"suzhou\",\"stationList\":\"suzhou\",\"stations\":\"[\\\"suzhou\\\"]\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"950\",\"distances\":\"[\\\"10\\\", \\\"50\\\", \\\"75\\\", \\\"100\\\", \\\"150\\\"]\",\"endStation\":\"Central Park South\",\"id\":\"1a2b3c4d-5e6f-7890-1234-567890abcdef\",\"loginId\":\"d7e6f5a4-b3c2-1098-7654-3210fedcba98\",\"startStation\":\"waco\",\"stationList\":\"waco\",\"stations\":\"[\\\"waco\\\"]\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"1200\",\"distances\":\"[\\\"10\\\", \\\"50\\\", \\\"75\\\", \\\"100\\\", \\\"150\\\"]\",\"endStation\":\"Penn Station\",\"id\":\"b2c3d4e5-6f78-9012-3456-\",\"loginId\":\"9c8b7a65-4321-0fed-cba9-876543210abc\",\"startStation\":\"shijiazhuang\",\"stationList\":\"shijiazhuang\",\"stations\":\"[\\\"shijiazhuang\\\"]\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"875\",\"distances\":\"[\\\"10\\\", \\\"50\\\", \\\"75\\\", \\\"100\\\", \\\"150\\\"]\",\"endStation\":\"Grand Central Terminal\",\"id\":\"12345\",\"loginId\":\"a1b2c3d4-e5f6-7890-1234-567890abcdef\",\"startStation\":\"austin\",\"stationList\":\"austin\",\"stations\":\"[\\\"austin\\\"]\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"600\",\"distances\":\"[\\\"10\\\", \\\"50\\\", \\\"75\\\", \\\"100\\\", \\\"150\\\"]\",\"endStation\":\"Grand Central Terminal\",\"id\":\"12345\",\"loginId\":\"4d2a46c7-71cb-4cf1-b5bb-b68406d9da6f\",\"startStation\":\"shanghaihongqiao\",\"stationList\":\"wuxi\",\"stations\":\"[\\\"wuxi\\\"]\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"1450\",\"distances\":\"[\\\"10\\\", \\\"50\\\", \\\"75\\\", \\\"100\\\", \\\"150\\\"]\",\"endStation\":\"Union Station\",\"id\":\"fedcba98-7654-3210-fedc-ba9876543210\",\"loginId\":\"john.doe123\",\"startStation\":\"zhenjiang\",\"stationList\":\"shanghaihongqiao\",\"stations\":\"[\\\"shanghaihongqiao\\\"]\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"1150\",\"distances\":\"[\\\"10\\\", \\\"50\\\", \\\"75\\\", \\\"100\\\", \\\"150\\\"]\",\"endStation\":\"Times Square\",\"id\":\"a1b2c3d4-e5f6-7890-1234-567890abcdef\",\"loginId\":\"jane_smith456\",\"startStation\":\"jiaxingnan\",\"stationList\":\"zhenjiang\",\"stations\":\"[\\\"zhenjiang\\\"]\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"1380\",\"distances\":\"[\\\"10\\\", \\\"50\\\", \\\"75\\\", \\\"100\\\", \\\"150\\\"]\",\"endStation\":\"Central Park South\",\"id\":\"0b23bd3e-876a-4af3-b920-c50a90c90b04\",\"loginId\":\"robert.jones789\",\"startStation\":\"xuzhou\",\"stationList\":\"jiaxingnan\",\"stations\":\"[\\\"jiaxingnan\\\"]\"}";
                        req = req.body(requestBody1);
