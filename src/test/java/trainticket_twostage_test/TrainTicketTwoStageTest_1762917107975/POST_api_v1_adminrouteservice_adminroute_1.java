package trainticket_twostage_test.TrainTicketTwoStageTest_1762917107975;
...
public class POST_api_v1_adminrouteservice_adminroute_1 {
    ...
    // ⚠️ CRITICAL: Use Jaeger backend API endpoint, NOT UI API endpoint
    // Backend API: /api/traces/{id} - Returns COMPLETE trace with all spans
    // UI API: /jaeger/ui/api/trace/{id} - May return truncated/summarized trace
    private static final String JAEGER_BASE_URL = System.getProperty("jaeger.base.url", "http://129.62.148.112:30005/api");
    ...
    private static String generateTraceTable(JSONObject trace) {
        try {
            ...
            if (!traceId.isEmpty()) {
                ...
                String uiBase = JAEGER_BASE_URL.replace("/api", "/jaeger/ui");
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"12.5\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":\"New York Penn Station\",\"id\":\"1234567890\",\"loginId\":\"admin_user_123\",\"startStation\":\"New York Penn Station\",\"stationList\":\"New York Penn Station\",\"stations\":[\"Grand Central Terminal\",\"Times Square Station\",\"Brooklyn Bridge Station\",\"Union Square Station\",\"Washington Square Station\"]}");
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"12.5\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":\"123\",\"id\":\"1234567890\",\"loginId\":\"admin_user_123\",\"startStation\":\"New York Penn Station\",\"stationList\":\"New York Penn Station\",\"stations\":[\"Grand Central Terminal\",\"Times Square Station\",\"Brooklyn Bridge Station\",\"Union Square Station\",\"Washington Square Station\"]}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"12.5\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":\"123\",\"id\":\"1234567890\",\"loginId\":\"admin_user_123\",\"startStation\":\"New York Penn Station\",\"stationList\":\"New York Penn Station\",\"stations\":[\"Grand Central Terminal\",\"Times Square Station\",\"Brooklyn Bridge Station\",\"Union Square Station\",\"Washington Square Station\"]}");
                        Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               // Negative test: expect error code (4XX or 5XX), not success code
                               .statusCode(org.hamcrest.Matchers.greaterThanOrEqualTo(400))
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"123\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":\"New York Penn Station\",\"id\":\"1234567890\",\"loginId\":\"admin_user_123\",\"startStation\":\"New York Penn Station\",\"stationList\":\"New York Penn Station\",\"stations\":[\"Grand Central Terminal\",\"Times Square Station\",\"Brooklyn Bridge Station\",\"Union Square Station\",\"Washington Square Station\"]}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"123\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":\"New York Penn Station\",\"id\":\"1234567890\",\"loginId\":\"admin_user_123\",\"startStation\":\"New York Penn Station\",\"stationList\":\"New York Penn Station\",\"stations\":[\"Grand Central Terminal\",\"Times Square Station\",\"Brooklyn Bridge Station\",\"Union Square Station\",\"Washington Square Station\"]}");
                        Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               // Negative test: expect error code (4XX or 5XX), not success code
                               .statusCode(org.hamcrest.Matchers.greaterThanOrEqualTo(400))
