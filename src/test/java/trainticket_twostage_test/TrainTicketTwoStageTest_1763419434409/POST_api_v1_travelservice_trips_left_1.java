package trainticket_twostage_test.TrainTicketTwoStageTest_1763419434409;
            ...
            Allure.step("Step 1: ts-travel-service POST /api/v1/travelservice/trips/left (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        String requestBody1 = "{\"departureTime\":\"12025-11-25T08:30:00Z\",\"endPlace\":\"New York\",\"startPlace\":\"Hangzhou\"}";
                        ...
                        allStepParameters.put("body", "{\"departureTime\":\"12025-11-25T08:30:00Z\",\"endPlace\":\"New York\",\"startPlace\":\"Hangzhou\"}");
            ...
            Allure.step("Step 1: ts-travel-service POST /api/v1/travelservice/trips/left (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"departureTime\":\"123\",\"endPlace\":\"Los Angeles\",\"startPlace\":\"notBeijing\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"departureTime\":\"123\",\"endPlace\":\"Los Angeles\",\"startPlace\":\"notBeijing\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/travelservice/trips/left")
                               .then().log().ifValidationFails()
                               .extract().response();
            ...
            Allure.step("Step 1: ts-travel-service POST /api/v1/travelservice/trips/left (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"departureTime\":\"12025-11-25T08:30:00Z\",\"endPlace\":\"New York\",\"startPlace\":\"123\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"departureTime\":\"12025-11-25T08:30:00Z\",\"endPlace\":\"New York\",\"startPlace\":\"123\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/travelservice/trips/left")
                               .then().log().ifValidationFails()
                               .extract().response();
            ...
            Allure.step("Step 1: ts-travel-service POST /api/v1/travelservice/trips/left (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"departureTime\":\"12025-11-25T08:30:00Z\",\"endPlace\":\"Chicago\",\"startPlace\":\"notBeijing\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"departureTime\":\"12025-11-25T08:30:00Z\",\"endPlace\":\"Chicago\",\"startPlace\":\"notBeijing\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/travelservice/trips/left")
                               .then().log().ifValidationFails()
                               .extract().response();
            ...
            Allure.step("Step 1: ts-travel-service POST /api/v1/travelservice/trips/left (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"departureTime\":\"12025-11-25T08:30:00Z\",\"endPlace\":\"123\",\"startPlace\":\"Shanghai\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"departureTime\":\"12025-11-25T08:30:00Z\",\"endPlace\":\"123\",\"startPlace\":\"Shanghai\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/travelservice/trips/left")
                               .then().log().ifValidationFails()
                               .extract().response();
            ...
            Allure.step("Step 1: ts-travel-service POST /api/v1/travelservice/trips/left (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"departureTime\":\"12025-11-25T08:30:00Z\",\"endPlace\":\"New York\",\"startPlace\":\"notBeijing\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"departureTime\":\"12025-11-25T08:30:00Z\",\"endPlace\":\"New York\",\"startPlace\":\"notBeijing\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/travelservice/trips/left")
                               .then().log().ifValidationFails()
                               .extract().response();
            ...
            Allure.step("Step 1: ts-travel-service POST /api/v1/travelservice/trips/left (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"departureTime\":\"2025-11-30T20:00:00Z\",\"endPlace\":\"New York\",\"startPlace\":\"notBeijing\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"departureTime\":\"2025-11-30T20:00:00Z\",\"endPlace\":\"New York\",\"startPlace\":\"notBeijing\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/travelservice/trips/left")
                               .then().log().ifValidationFails()
                               .extract().response();
            ...
            Allure.step("Step 1: ts-travel-service POST /api/v1/travelservice/trips/left (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"departureTime\":\"1900-12-31T25:00:00Z\",\"endPlace\":\"New York\",\"startPlace\":\"notBeijing\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"departureTime\":\"1900-12-31T25:00:00Z\",\"endPlace\":\"New York\",\"startPlace\":\"notBeijing\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/travelservice/trips/left")
                               .then().log().ifValidationFails()
                               .extract().response();
            ...
            Allure.step("Step 1: ts-travel-service POST /api/v1/travelservice/trips/left (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"departureTime\":\"12025-11-25T08:30:00Z\",\"endPlace\":\"New York\",\"startPlace\":\"Guangzhou\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"departureTime\":\"12025-11-25T08:30:00Z\",\"endPlace\":\"New York\",\"startPlace\":\"Guangzhou\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/travelservice/trips/left")
                               .then().log().ifValidationFails()
                               .extract().response();
