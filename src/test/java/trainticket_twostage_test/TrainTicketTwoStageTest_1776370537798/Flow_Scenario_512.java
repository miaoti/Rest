...
@io.qameta.allure.junit4.DisplayName("Flow_Scenario_512 | GET /api/v1/adminorderservice/adminorder")
public class Flow_Scenario_512 {
    ...
    public void test_positive_flow_S512_v1() throws Exception {
        ...
        Allure.label("suite", "GET /api/v1/adminorderservice/adminorder");
        Allure.label("subSuite", "[Valid] v1");
        Allure.label("story", "GET /api/v1/adminorderservice/adminorder");
        ...
        Allure.label("story", "test_positive_flow_S512_v1");
