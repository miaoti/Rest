package trainticket_twostage_test.TrainTicketTwoStageTest_1762204248310;
...
public class POST_api_v1_adminorderservice_adminorder_1 {
    ...
    public void test_faulty_POST_1_1() throws Exception {
        ...
        Allure.parameter("🔴 Faulty Parameters", "boughtDate=2023-13-07, coachNumber=5, documentType=-1, from=123456789012345678901234567890, price=12345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234, seatClass=-1, travelDate=2023-13-02, travelTime=1234567890123456789012345678901234567890");
        Allure.description("**⚠️ This is an intentional FAULTY test case for negative testing.**\n\n" +
                         ...
                         "boughtDate=2023-13-07\ncoachNumber=5\ndocumentType=-1\nfrom=123456789012345678901234567890\nprice=12345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234\nseatClass=-1\ntravelDate=2023-13-02\ntravelTime=1234567890123456789012345678901234567890\n\n" +
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        String requestBody1 = "{\"accountId\":\"1234567890\",\"boughtDate\":\"2023-13-07\",\"coachNumber\":\"5\",\"contactsDocumentNumber\":\"123456789\",\"contactsName\":\"John Doe\",\"differenceMoney\":\"100\",\"documentType\":\"-1\",\"from\":\"123456789012345678901234567890\",\"id\":\"123\",\"price\":\"12345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234\",\"seatClass\":\"-1\",\"seatNumber\":\"1A12\",\"status\":\"10\",\"to\":\"JohnDoe\",\"trainNumber\":\"K5679\",\"travelDate\":\"2023-13-02\",\"travelTime\":\"1234567890123456789012345678901234567890\"}";
                        ...
                        allStepParameters.put("body", "{\"accountId\":\"1234567890\",\"boughtDate\":\"2023-13-07\",\"coachNumber\":\"5\",\"contactsDocumentNumber\":\"123456789\",\"contactsName\":\"John Doe\",\"differenceMoney\":\"100\",\"documentType\":\"-1\",\"from\":\"123456789012345678901234567890\",\"id\":\"123\",\"price\":\"12345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234\",\"seatClass\":\"-1\",\"seatNumber\":\"1A12\",\"status\":\"10\",\"to\":\"JohnDoe\",\"trainNumber\":\"K5679\",\"travelDate\":\"2023-13-02\",\"travelTime\":\"1234567890123456789012345678901234567890\"}");
    ...
    public void test_faulty_POST_1_2() throws Exception {
        // 🚨 FAULTY TEST METADATA
        Allure.parameter("🚨 Test Type", "FAULTY (Negative Testing)");
        Allure.parameter("🔴 Faulty Parameters", "accountId=12345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345, from=123456789012345678901234567890, price=, seatClass=10000000000, to=to-123, trainNumber=NULL, travelDate=2023-13-06, travelTime=");
        Allure.description("**⚠️ This is an intentional FAULTY test case for negative testing.**\n\n" +
                         "The following parameters were intentionally set to invalid values:\n" +
                         "accountId=12345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345\nfrom=123456789012345678901234567890\nprice=\nseatClass=10000000000\nto=to-123\ntrainNumber=NULL\ntravelDate=2023-13-06\ntravelTime=\n\n" +
                         "This test is expected to trigger validation errors or error responses.");
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"12345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345\",\"boughtDate\":\"2023-10-26\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"123456789\",\"contactsName\":\"John Doe\",\"differenceMoney\":\"100\",\"documentType\":\"1\",\"from\":\"123456789012345678901234567890\",\"id\":\"123\",\"price\":\"\",\"seatClass\":\"10000000000\",\"seatNumber\":\"1A12\",\"status\":\"10\",\"to\":\"to-123\",\"trainNumber\":\"NULL\",\"travelDate\":\"2023-13-06\",\"travelTime\":\"\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"accountId\":\"12345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345\",\"boughtDate\":\"2023-10-26\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"123456789\",\"contactsName\":\"John Doe\",\"differenceMoney\":\"100\",\"documentType\":\"1\",\"from\":\"123456789012345678901234567890\",\"id\":\"123\",\"price\":\"\",\"seatClass\":\"10000000000\",\"seatNumber\":\"1A12\",\"status\":\"10\",\"to\":\"to-123\",\"trainNumber\":\"NULL\",\"travelDate\":\"2023-13-06\",\"travelTime\":\"\"}");
                        Response stepResponse1 = req.when().post("/api/v1/adminorderservice/adminorder")
                               .then().log().ifValidationFails()
                               .statusCode(200)
                               .extract().response();
    ...
    public void test_faulty_POST_1_3() throws Exception {
        // 🚨 FAULTY TEST METADATA
        Allure.parameter("🚨 Test Type", "FAULTY (Negative Testing)");
        Allure.parameter("🔴 Faulty Parameters", "accountId=, boughtDate=2023-13-05, coachNumber=\"coachNumber\", contactsDocumentNumber=12345678901234567890123456789012345678901234567890, contactsName=1234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890, differenceMoney=Null, documentType=\"documentType\", from=null, id=-100, price=12345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234, seatClass=-1, seatNumber=!@#$%^&*()_+=-`~[]\{}|;':\",., status=null, to=to123, trainNumber=NaN, travelDate=2023-13-10, travelTime=1234567890123456789012345678901234567890");
        Allure.description("**⚠️ This is an intentional FAULTY test case for negative testing.**\n\n" +
                         "The following parameters were intentionally set to invalid values:\n" +
                         "accountId=\nboughtDate=2023-13-05\ncoachNumber=\"coachNumber\"\ncontactsDocumentNumber=12345678901234567890123456789012345678901234567890\ncontactsName=1234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890\ndifferenceMoney=Null\ndocumentType=\"documentType\"\nfrom=null\nid=-100\nprice=12345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234\nseatClass=-1\nseatNumber=!@#$%^&*()_+=-`~[]\{}|;':\",.\nstatus=null\nto=to123\ntrainNumber=NaN\ntravelDate=2023-13-10\ntravelTime=1234567890123456789012345678901234567890\n\n" +
                         "This test is expected to trigger validation errors or error responses.");
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"\",\"boughtDate\":\"2023-13-05\",\"coachNumber\":\"\\\"coachNumber\\\"\",\"contactsDocumentNumber\":\"12345678901234567890123456789012345678901234567890\",\"contactsName\":\"1234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890\",\"differenceMoney\":\"Null\",\"documentType\":\"\\\"documentType\\\"\",\"from\":\"null\",\"id\":\"-100\",\"price\":\"12345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234\",\"seatClass\":\"-1\",\"seatNumber\":\"!@#$%^&*()_+=-`~[]\\\\{}|;':\\\",.\",\"status\":\"10\",\"to\":\"to123\",\"trainNumber\":\"NaN\",\"travelDate\":\"2023-13-10\",\"travelTime\":\"1234567890123456789012345678901234567890\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"accountId\":\"\",\"boughtDate\":\"2023-13-05\",\"coachNumber\":\"\\\"coachNumber\\\"\",\"contactsDocumentNumber\":\"12345678901234567890123456789012345678901234567890\",\"contactsName\":\"1234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890\",\"differenceMoney\":\"Null\",\"documentType\":\"\\\"documentType\\\"\",\"from\":\"null\",\"id\":\"-100\",\"price\":\"12345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234\",\"seatClass\":\"-1\",\"seatNumber\":\"!@#$%^&*()_+=-`~[]\\\\{}|;':\\\",.\",\"status\":\"10\",\"to\":\"to123\",\"trainNumber\":\"NaN\",\"travelDate\":\"2023-13-10\",\"travelTime\":\"1234567890123456789012345678901234567890\"}");
                        Response stepResponse1 = req.when().post("/api/v1/adminorderservice/adminorder")
                               .then().log().ifValidationFails()
                               .statusCode(200)
                               .extract().response();
    ...
    public void test_faulty_POST_1_4() throws Exception {
        // 🚨 FAULTY TEST METADATA
        Allure.parameter("🚨 Test Type", "FAULTY (Negative Testing)");
        Allure.parameter("🔴 Faulty Parameters", "accountId=, boughtDate=2023-13-07, contactsDocumentNumber=, contactsName= , documentType=0, price=, seatClass=123456789012345678901234567890, seatNumber=1234567890123456789012345678901, to=123, trainNumber=1234567890123456789012345678901234567890, travelTime=");
        Allure.description("**⚠️ This is an intentional FAULTY test case for negative testing.**\n\n" +
                         "The following parameters were intentionally set to invalid values:\n" +
                         "accountId=\nboughtDate=2023-13-07\ncontactsDocumentNumber=\ncontactsName= \ndocumentType=0\nprice=\nseatClass=123456789012345678901234567890\nseatNumber=1234567890123456789012345678901\nto=123\ntrainNumber=1234567890123456789012345678901234567890\ntravelTime=\n\n" +
                         "This test is expected to trigger validation errors or error responses.");
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"\",\"boughtDate\":\"2023-13-07\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"\",\"contactsName\":\" \",\"differenceMoney\":\"25.50\",\"documentType\":\"0\",\"from\":\"123\",\"id\":\"abc\",\"price\":\"\",\"seatClass\":\"123456789012345678901234567890\",\"seatNumber\":\"1234567890123456789012345678901\",\"status\":\"0\",\"to\":\"123\",\"trainNumber\":\"1234567890123456789012345678901234567890\",\"travelDate\":\"2024-03-15\",\"travelTime\":\"\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"accountId\":\"\",\"boughtDate\":\"2023-13-07\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"\",\"contactsName\":\" \",\"differenceMoney\":\"25.50\",\"documentType\":\"0\",\"from\":\"123\",\"id\":\"abc\",\"price\":\"\",\"seatClass\":\"123456789012345678901234567890\",\"seatNumber\":\"1234567890123456789012345678901\",\"status\":\"0\",\"to\":\"123\",\"trainNumber\":\"1234567890123456789012345678901234567890\",\"travelDate\":\"2024-03-15\",\"travelTime\":\"\"}");
                        Response stepResponse1 = req.when().post("/api/v1/adminorderservice/adminorder")
                               .then().log().ifValidationFails()
                               .statusCode(200)
                               .extract().response();
    ...
    public void test_faulty_POST_1_5() throws Exception {
        // 🚨 FAULTY TEST METADATA
        Allure.parameter("🚨 Test Type", "FAULTY (Negative Testing)");
        Allure.parameter("🔴 Faulty Parameters", "accountId= , boughtDate=2023-13-04, coachNumber=\"coachNumber\", contactsDocumentNumber=1234567890123456789012345678901234567890123456789012345678901234, contactsName=1234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890, differenceMoney=123.456, documentType={ \"key\": \"value\"}, from=true, id=null, price=null, seatClass=True, seatNumber= , status=500, to=to, trainNumber=veryLongStringThatShouldFail123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890, travelDate=2023-13-02, travelTime=travelTime");
        Allure.description("**⚠️ This is an intentional FAULTY test case for negative testing.**\n\n" +
                         "The following parameters were intentionally set to invalid values:\n" +
                         "accountId= \nboughtDate=2023-13-04\ncoachNumber=\"coachNumber\"\ncontactsDocumentNumber=1234567890123456789012345678901234567890123456789012345678901234\ncontactsName=1234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890\ndifferenceMoney=123.456\ndocumentType={ \"key\": \"value\"}\nfrom=true\nid=null\nprice=null\nseatClass=True\nseatNumber= \nstatus=500\nto=to\ntrainNumber=veryLongStringThatShouldFail123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890\ntravelDate=2023-13-02\ntravelTime=travelTime\n\n" +
                         "This test is expected to trigger validation errors or error responses.");
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\" \",\"boughtDate\":\"2023-13-04\",\"coachNumber\":\"\\\"coachNumber\\\"\",\"contactsDocumentNumber\":\"1234567890123456789012345678901234567890123456789012345678901234\",\"contactsName\":\"1234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890\",\"differenceMoney\":\"123.456\",\"documentType\":\"{ \\\"key\\\": \\\"value\\\"}\",\"from\":\"true\",\"id\":\"456\",\"price\":\"19.99\",\"seatClass\":\"True\",\"seatNumber\":\" \",\"status\":\"500\",\"to\":\"to\",\"trainNumber\":\"veryLongStringThatShouldFail123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890\",\"travelDate\":\"2023-13-02\",\"travelTime\":\"travelTime\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"accountId\":\" \",\"boughtDate\":\"2023-13-04\",\"coachNumber\":\"\\\"coachNumber\\\"\",\"contactsDocumentNumber\":\"1234567890123456789012345678901234567890123456789012345678901234\",\"contactsName\":\"1234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890\",\"differenceMoney\":\"123.456\",\"documentType\":\"{ \\\"key\\\": \\\"value\\\"}\",\"from\":\"true\",\"id\":\"456\",\"price\":\"19.99\",\"seatClass\":\"True\",\"seatNumber\":\" \",\"status\":\"500\",\"to\":\"to\",\"trainNumber\":\"veryLongStringThatShouldFail123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890\",\"travelDate\":\"2023-13-02\",\"travelTime\":\"travelTime\"}");
                        Response stepResponse1 = req.when().post("/api/v1/adminorderservice/adminorder")
                               .then().log().ifValidationFails()
                               .statusCode(200)
                               .extract().response();
