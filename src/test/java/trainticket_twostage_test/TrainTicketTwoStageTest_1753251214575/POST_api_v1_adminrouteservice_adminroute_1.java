            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        String requestBody1 = "{\"distanceList\":\"0\",\"distances\":\"75\",\"endStation\":\"los angeles union station\",\"id\":\"User_1\",\"loginId\":\"admin_456\",\"startStation\":\"Boston Logan International Airport\",\"stationList\":\"los angeles union passenger terminal\",\"stations\":\"new york penn station\"}";
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"0\",\"endStation\":\"los angeles union station\",\"id\":\"User_1\",\"startStation\":\"Boston Logan International Airport\",\"stationList\":\"los angeles union passenger terminal\"}";
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"0\",\"distances\":\"10\",\"endStation\":\"Los Angeles Union Station\",\"id\":\"abcdefg\",\"loginId\":\"users\",\"startStation\":\"San francisco terminal 5\",\"stationList\":\"houston hobby airport\",\"stations\":\"San francisco caltrain terminal\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"0\",\"endStation\":\"Los Angeles Union Station\",\"id\":\"abcdefg\",\"startStation\":\"San francisco terminal 5\",\"stationList\":\"houston hobby airport\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"50\",\"distances\":\"3.14\",\"endStation\":\"Boston Logan International Airport\",\"id\":\"12345\",\"loginId\":\"Sydney_measured_####kbps\",\"startStation\":\"New york penn station\",\"stationList\":\"boston logan international airport\",\"stations\":\"san francisco caltrain terminal\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"50\",\"endStation\":\"Boston Logan International Airport\",\"id\":\"12345\",\"startStation\":\"New york penn station\",\"stationList\":\"boston logan international airport\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"var_bd_=_getElementsByClass\",\"distances\":\"10\",\"endStation\":\"Los angeles union station\",\"id\":\"users\",\"loginId\":\"admins\",\"startStation\":\"Chicago o'hare international airport\",\"stationList\":\"Chicago Union Station\",\"stations\":\"San francisco caltrain terminal\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"var_bd_=_getElementsByClass\",\"endStation\":\"Los angeles union station\",\"id\":\"users\",\"startStation\":\"Chicago o'hare international airport\",\"stationList\":\"Chicago Union Station\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"0\",\"distances\":\"10\",\"endStation\":\"boston logan international airport\",\"id\":\"users\",\"loginId\":\"john_doe987\",\"startStation\":\"los angeles union station\",\"stationList\":\"Chicago union station\",\"stations\":\"Houston intermodal transportation center\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"0\",\"endStation\":\"boston logan international airport\",\"id\":\"users\",\"startStation\":\"los angeles union station\",\"stationList\":\"Chicago union station\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"789\",\"distances\":\"10\",\"endStation\":\"Chicago O'Hare International Airport\",\"id\":\"user_1\",\"loginId\":\"Admin_456\",\"startStation\":\"san francisco terminal 5\",\"stationList\":\"Los angeles union passenger terminal\",\"stations\":\"San francisco caltrain terminal\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"789\",\"endStation\":\"Chicago O'Hare International Airport\",\"id\":\"user_1\",\"startStation\":\"san francisco terminal 5\",\"stationList\":\"Los angeles union passenger terminal\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"0\",\"distances\":\"50\",\"endStation\":\"Boston logan international airport\",\"id\":\"12345\",\"loginId\":\"dave\",\"startStation\":\"San francisco terminal 5\",\"stationList\":\"los angeles union passenger terminal\",\"stations\":\"Los Angeles International Airport\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"0\",\"endStation\":\"Boston logan international airport\",\"id\":\"12345\",\"startStation\":\"San francisco terminal 5\",\"stationList\":\"los angeles union passenger terminal\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"-10\",\"distances\":\"3.14\",\"endStation\":\"Los angeles union station\",\"id\":\"User_1\",\"loginId\":\"users\",\"startStation\":\"Boston Logan International Airport\",\"stationList\":\"Houston Hobby Airport\",\"stations\":\"Houston Intermodal Transportation Center\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"-10\",\"endStation\":\"Los angeles union station\",\"id\":\"User_1\",\"startStation\":\"Boston Logan International Airport\",\"stationList\":\"Houston Hobby Airport\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"789\",\"distances\":\"75\",\"endStation\":\"New York Penn Station\",\"id\":\"user_1\",\"loginId\":\"jane.smith001\",\"startStation\":\"San Francisco Terminal 5\",\"stationList\":\"los angeles union passenger terminal\",\"stations\":\"houston intermodal transportation center\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"789\",\"endStation\":\"New York Penn Station\",\"id\":\"user_1\",\"startStation\":\"San Francisco Terminal 5\",\"stationList\":\"los angeles union passenger terminal\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"789\",\"distances\":\"75\",\"endStation\":\"New York Penn Station\",\"id\":\"User_1\",\"loginId\":\"johnston\",\"startStation\":\"san francisco terminal 5\",\"stationList\":\"Houston hobby airport\",\"stations\":\"houston intermodal transportation center\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"789\",\"endStation\":\"New York Penn Station\",\"id\":\"User_1\",\"startStation\":\"san francisco terminal 5\",\"stationList\":\"Houston hobby airport\"}";
                        req = req.body(requestBody3);
