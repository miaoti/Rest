package trainticket_twostage_test.TrainTicketTwoStageTest_1762906187413;
...
public class POST_api_v1_adminrouteservice_adminroute_1 {
                            ...
                            if (data.length() > 0) {
                                ...
                                if (bestScore > 0) {
                                    ...
                                    if (isCurrentTrace) {
                                        ...
                                        // Found current execution - fetch COMPLETE trace with all spans
                                        if (bestTrace != null) {
                                            String traceId = bestTrace.optString("traceID", "");
                                            if (!traceId.isEmpty()) {
                                                debugInfo.append("\n🔄 Fetching complete trace for ID: ").append(traceId).append("\n");
                                                String traceDetailUrl = JAEGER_BASE_URL + "/trace/" + traceId;
                                                ...
                                                if (traceRes.statusCode() >= 200 && traceRes.statusCode() < 300) {
                                                    ...
                                                    debugInfo.append("⚠️  Failed to fetch complete trace (status: ").append(traceRes.statusCode()).append("), using summary\n");
                                                }
                                            }
    ...
    private static boolean isApiCall(JSONObject span) {
        ...
        // Exclude gateway-only spans (internal routing, no actual business logic)
        if (opName.equals("POST /*") || opName.equals("GET /*") || opName.equals("PUT /*") || 
            opName.equals("DELETE /*") || opName.equals("PATCH /*") ||
            opName.equals("FilteringWebHandler.handle") || 
            opName.equals("OnCommittedResponseWrapper.sendError")) {
            return false; // Gateway-internal operations, not business API calls
        }
        ...
        if (tags != null) {
            for (int t = 0; t < tags.length(); t++) {
                ...
                if ("http.route".equals(key)) { httpRoute = value; }
            }
        }
        
        // Exclude gateway catch-all routes
        if ("/*".equals(httpRoute)) {
            return false; // Gateway wildcard route, not a business API
        }
        
        // Must be an actual API call with specific route
        if (hasHttpMethod && hasHttpUrl && httpUrl.contains("/api/")) {
            return true;
        }
        
        if (opName.contains("/api/") && opName.matches(".*(GET|POST|PUT|DELETE|PATCH).*")) {
            return true;
        }
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        String requestBody1 = "{\"distanceList\":\"12.5\",\"distances\":[\"15.5\",\"22.3\",\"8.7\",\"35.1\",\"12.9\"],\"endStation\":\"New York Penn Station\",\"id\":\"1234567890\",\"loginId\":\"admin_user_123\",\"startStation\":\"New York Penn Station\",\"stationList\":\"New York Penn Station\",\"stations\":[\"Grand Central Terminal\",\"Times Square Station\",\"Brooklyn Bridge Station\",\"Union Square Station\",\"Washington Square Station\"]}";
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"12.5\",\"distances\":[\"15.5\",\"22.3\",\"8.7\",\"35.1\",\"12.9\"],\"endStation\":\"New York Penn Station\",\"id\":\"1234567890\",\"loginId\":\"admin_user_123\",\"startStation\":\"New York Penn Station\",\"stationList\":\"New York Penn Station\",\"stations\":[\"Grand Central Terminal\",\"Times Square Station\",\"Brooklyn Bridge Station\",\"Union Square Station\",\"Washington Square Station\"]}");
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"12.5\",\"distances\":\"123\",\"endStation\":\"New York Penn Station\",\"id\":\"1234567890\",\"loginId\":\"admin_user_123\",\"startStation\":\"New York Penn Station\",\"stationList\":\"New York Penn Station\",\"stations\":[\"Grand Central Terminal\",\"Times Square Station\",\"Brooklyn Bridge Station\",\"Union Square Station\",\"Washington Square Station\"]}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"12.5\",\"distances\":\"123\",\"endStation\":\"New York Penn Station\",\"id\":\"1234567890\",\"loginId\":\"admin_user_123\",\"startStation\":\"New York Penn Station\",\"stationList\":\"New York Penn Station\",\"stations\":[\"Grand Central Terminal\",\"Times Square Station\",\"Brooklyn Bridge Station\",\"Union Square Station\",\"Washington Square Station\"]}");
                        Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"12.5\",\"distances\":[\"15.5\",\"22.3\",\"8.7\",\"35.1\",\"12.9\"],\"endStation\":\"123\",\"id\":\"1234567890\",\"loginId\":\"admin_user_123\",\"startStation\":\"New York Penn Station\",\"stationList\":\"New York Penn Station\",\"stations\":[\"Grand Central Terminal\",\"Times Square Station\",\"Brooklyn Bridge Station\",\"Union Square Station\",\"Washington Square Station\"]}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"12.5\",\"distances\":[\"15.5\",\"22.3\",\"8.7\",\"35.1\",\"12.9\"],\"endStation\":\"123\",\"id\":\"1234567890\",\"loginId\":\"admin_user_123\",\"startStation\":\"New York Penn Station\",\"stationList\":\"New York Penn Station\",\"stations\":[\"Grand Central Terminal\",\"Times Square Station\",\"Brooklyn Bridge Station\",\"Union Square Station\",\"Washington Square Station\"]}");
                        Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               // Negative test: expect error code (4XX or 5XX), not success code
                               .statusCode(org.hamcrest.Matchers.greaterThanOrEqualTo(400))
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"12.5\",\"distances\":[\"15.5\",\"22.3\",\"8.7\",\"35.1\",\"12.9\"],\"endStation\":\"New York Penn Station\",\"id\":\"1234567890\",\"loginId\":\"123\",\"startStation\":\"New York Penn Station\",\"stationList\":\"New York Penn Station\",\"stations\":[\"Grand Central Terminal\",\"Times Square Station\",\"Brooklyn Bridge Station\",\"Union Square Station\",\"Washington Square Station\"]}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"12.5\",\"distances\":[\"15.5\",\"22.3\",\"8.7\",\"35.1\",\"12.9\"],\"endStation\":\"New York Penn Station\",\"id\":\"1234567890\",\"loginId\":\"admin_user_123\",\"startStation\":\"New York Penn Station\",\"stationList\":\"123\",\"stations\":[\"Grand Central Terminal\",\"Times Square Station\",\"Brooklyn Bridge Station\",\"Union Square Station\",\"Washington Square Station\"]}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"123\",\"distances\":[\"15.5\",\"22.3\",\"8.7\",\"35.1\",\"12.9\"],\"endStation\":\"New York Penn Station\",\"id\":\"1234567890\",\"loginId\":\"admin_user_123\",\"startStation\":\"New York Penn Station\",\"stationList\":\"New York Penn Station\",\"stations\":[\"Grand Central Terminal\",\"Times Square Station\",\"Brooklyn Bridge Station\",\"Union Square Station\",\"Washington Square Station\"]}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"123\",\"distances\":[\"15.5\",\"22.3\",\"8.7\",\"35.1\",\"12.9\"],\"endStation\":\"New York Penn Station\",\"id\":\"1234567890\",\"loginId\":\"admin_user_123\",\"startStation\":\"New York Penn Station\",\"stationList\":\"New York Penn Station\",\"stations\":[\"Grand Central Terminal\",\"Times Square Station\",\"Brooklyn Bridge Station\",\"Union Square Station\",\"Washington Square Station\"]}");
                        Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               // Negative test: expect error code (4XX or 5XX), not success code
                               .statusCode(org.hamcrest.Matchers.greaterThanOrEqualTo(400))
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"12.5\",\"distances\":[\"15.5\",\"22.3\",\"8.7\",\"35.1\",\"12.9\"],\"endStation\":\"New York Penn Station\",\"id\":\"1234567890\",\"loginId\":\"admin_user_123\",\"startStation\":\"123\",\"stationList\":\"New York Penn Station\",\"stations\":[\"Grand Central Terminal\",\"Times Square Station\",\"Brooklyn Bridge Station\",\"Union Square Station\",\"Washington Square Station\"]}";
                        req = req.body(requestBody1);
