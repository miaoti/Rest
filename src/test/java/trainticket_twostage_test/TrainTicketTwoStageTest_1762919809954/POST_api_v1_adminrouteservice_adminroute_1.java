package trainticket_twostage_test.TrainTicketTwoStageTest_1762919809954;
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        String requestBody1 = "{\"distanceList\":\"12.5\",\"distances\":\"123\",\"endStation\":\"New York Penn Station\",\"id\":\"1234567890\",\"loginId\":\"admin_user_123\",\"startStation\":\"New York Penn Station\",\"stationList\":\"Central Station\",\"stations\":[\"Grand Central Terminal\",\"Penn Station\",\"Union Station\",\"Times Square Station\",\"Broadway Station\"]}";
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"12.5\",\"distances\":\"123\",\"endStation\":\"New York Penn Station\",\"id\":\"1234567890\",\"loginId\":\"admin_user_123\",\"startStation\":\"New York Penn Station\",\"stationList\":\"Central Station\",\"stations\":[\"Grand Central Terminal\",\"Penn Station\",\"Union Station\",\"Times Square Station\",\"Broadway Station\"]}");
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"12.5\",\"distances\":[\"15.5\",\"22.3\",\"8.7\",\"35.1\",\"12.9\"],\"endStation\":\"123\",\"id\":\"1234567890\",\"loginId\":\"admin_user_123\",\"startStation\":\"New York Penn Station\",\"stationList\":\"Central Station\",\"stations\":[\"Grand Central Terminal\",\"Penn Station\",\"Union Station\",\"Times Square Station\",\"Broadway Station\"]}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"12.5\",\"distances\":[\"15.5\",\"22.3\",\"8.7\",\"35.1\",\"12.9\"],\"endStation\":\"123\",\"id\":\"1234567890\",\"loginId\":\"admin_user_123\",\"startStation\":\"New York Penn Station\",\"stationList\":\"Central Station\",\"stations\":[\"Grand Central Terminal\",\"Penn Station\",\"Union Station\",\"Times Square Station\",\"Broadway Station\"]}");
                        Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               // Negative test: expect error code (4XX or 5XX), not success code
                               .statusCode(org.hamcrest.Matchers.greaterThanOrEqualTo(400))
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"12.5\",\"distances\":[\"15.5\",\"22.3\",\"8.7\",\"35.1\",\"12.9\"],\"endStation\":\"New York Penn Station\",\"id\":\"1234567890\",\"loginId\":\"123\",\"startStation\":\"New York Penn Station\",\"stationList\":\"Central Station\",\"stations\":[\"Grand Central Terminal\",\"Penn Station\",\"Union Station\",\"Times Square Station\",\"Broadway Station\"]}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"12.5\",\"distances\":[\"15.5\",\"22.3\",\"8.7\",\"35.1\",\"12.9\"],\"endStation\":\"New York Penn Station\",\"id\":\"1234567890\",\"loginId\":\"123\",\"startStation\":\"New York Penn Station\",\"stationList\":\"Central Station\",\"stations\":[\"Grand Central Terminal\",\"Penn Station\",\"Union Station\",\"Times Square Station\",\"Broadway Station\"]}");
                        Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               // Negative test: expect error code (4XX or 5XX), not success code
                               .statusCode(org.hamcrest.Matchers.greaterThanOrEqualTo(400))
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"12.5\",\"distances\":[\"15.5\",\"22.3\",\"8.7\",\"35.1\",\"12.9\"],\"endStation\":\"New York Penn Station\",\"id\":\"1234567890\",\"loginId\":\"admin_user_123\",\"startStation\":\"New York Penn Station\",\"stationList\":\"123\",\"stations\":[\"Grand Central Terminal\",\"Penn Station\",\"Union Station\",\"Times Square Station\",\"Broadway Station\"]}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"12.5\",\"distances\":[\"15.5\",\"22.3\",\"8.7\",\"35.1\",\"12.9\"],\"endStation\":\"New York Penn Station\",\"id\":\"1234567890\",\"loginId\":\"admin_user_123\",\"startStation\":\"New York Penn Station\",\"stationList\":\"123\",\"stations\":[\"Grand Central Terminal\",\"Penn Station\",\"Union Station\",\"Times Square Station\",\"Broadway Station\"]}");
                        Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               // Negative test: expect error code (4XX or 5XX), not success code
                               .statusCode(org.hamcrest.Matchers.greaterThanOrEqualTo(400))
