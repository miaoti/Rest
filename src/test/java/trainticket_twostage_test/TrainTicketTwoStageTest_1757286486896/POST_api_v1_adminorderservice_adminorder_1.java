package trainticket_twostage_test.TrainTicketTwoStageTest_1757286486896;
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        String requestBody1 = "{\"accountId\":\"4d2a46c7-71cb-4cf1-b5bb-b68406d9da6f\",\"boughtDate\":\"2013-05-04 09:00:00\",\"coachNumber\":\"789\",\"contactsDocumentNumber\":\"DocumentNumber_One\",\"contactsName\":\"trainticket_notify@163.com\",\"differenceMoney\":\"12.34\",\"documentType\":\"1\",\"from\":\"DFW\",\"id\":\"0b23bd3e-876a-4af3-b920-c50a90c90b04\",\"price\":\"8.0\",\"seatClass\":\"2\",\"seatNumber\":\"FirstClass-30\",\"status\":\"1\",\"to\":\"London\",\"trainNumber\":\"1234567890\",\"travelDate\":\"2013-05-04 09:51:52\",\"travelTime\":\"350\"}";
                        ...
                        try {
                            ...
                            attachJaegerTrace("ts-admin-order-service", "POST", "/api/v1/adminorderservice/adminorder", requestStartMicros);
                        } catch (Exception e) {
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"98765432-10fe-4567-89ab-cdef01234567\",\"boughtDate\":\"2015-03-22 10:15:00\",\"coachNumber\":\"0\",\"contactsDocumentNumber\":\"DocumentNumber_Two\",\"contactsName\":\"fdse_microservice\",\"differenceMoney\":\"25.75\",\"documentType\":\"100\",\"from\":\"shanghai\",\"id\":\"9fc9c261-3263-4bfa-82f8-bb44e06b2f52\",\"price\":\"2.0\",\"seatClass\":\"1\",\"seatNumber\":\"Business-15\",\"status\":\"0\",\"to\":\"London\",\"trainNumber\":\"ABCDEFGHIJKL\",\"travelDate\":\"2013-05-11\",\"travelTime\":\"0\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"b3a290d8-f1e7-4c8d-90bc-1234567890ab\",\"boughtDate\":\"2019-05-18 12:00:00\",\"coachNumber\":\"1300\",\"contactsDocumentNumber\":\"DocumentNumber_Six\",\"contactsName\":\"account_manager_johnson\",\"differenceMoney\":\"50.00\",\"documentType\":\"500\",\"from\":\"tokyo\",\"id\":\"1a2b3c4d-5e6f-7890-1234-567890abcdef\",\"price\":\"4.0\",\"seatClass\":\"2\",\"seatNumber\":\"Silver-76\",\"status\":\"2\",\"to\":\"New York\",\"trainNumber\":\"9876543210\",\"travelDate\":\"2013-05-10 07:29:56\",\"travelTime\":\"1300\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"a7b9c1d3-e4f5-6789-abcd-ef0123456789\",\"boughtDate\":\"2020-12-03 09:30:00\",\"coachNumber\":\"500\",\"contactsDocumentNumber\":\"DocumentNumber_Eight\",\"contactsName\":\"sales_department\",\"differenceMoney\":\"10.50\",\"documentType\":\"1000\",\"from\":\"rome\",\"id\":\"cdef8765-4321-0fedcba98-7654-\",\"price\":\"3. 20.0\",\"seatClass\":\"1\",\"seatNumber\":\"Bronze-3\",\"status\":\"3\",\"to\":\"Paris\",\"trainNumber\":\"1234567890\",\"travelDate\":\"2013-05-04 14:35:18\",\"travelTime\":\"500\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"e5f6g7h8-90ij-1234-5678-abcdef012345\",\"boughtDate\":\"2021-06-14\",\"coachNumber\":\"1200\",\"contactsDocumentNumber\":\"DocumentNumber_Nine\",\"contactsName\":\"customer_service_desk\",\"differenceMoney\":\"234.56\",\"documentType\":\"5000\",\"from\":\"sydney\",\"id\":\"f8a7b6c5-d4e3-2109-8765-43210fedcba\",\"price\":\"4. 24.0\",\"seatClass\":\"2\",\"seatNumber\":\"Economy-83\",\"status\":\"4\",\"to\":\"Tokyo\",\"trainNumber\":\"1A2B3C4D5E\",\"travelDate\":\"2013-05-05 08:22:01\",\"travelTime\":\"1200\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"1a2b3c4d-5678-90ab-\",\"boughtDate\":\"2017-09-11 08:45:00\",\"coachNumber\":\"700\",\"contactsDocumentNumber\":\"1234567890\",\"contactsName\":\"technical_support_team\",\"differenceMoney\":\"100\",\"documentType\":\"1\",\"from\":\"mumbai\",\"id\":\"a1b2c3d4-e5f6-7890-1234-567890abcdef\",\"price\":\"7. 100.0\",\"seatClass\":\"1\",\"seatNumber\":\"Premium-22\",\"status\":\"5\",\"to\":\"Sydney\",\"trainNumber\":\"1234567890\",\"travelDate\":\"2013-05-06 11:17:45\",\"travelTime\":\"700\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"4d2a46c7-71cb-4cf1-b5bb-b68406d9da6f\",\"boughtDate\":\"2018-01-29 16:00:00\",\"coachNumber\":\"1000\",\"contactsDocumentNumber\":\"DocumentNumber_Ten\",\"contactsName\":\"sales_lead_smith\",\"differenceMoney\":\"100.25\",\"documentType\":\"100\",\"from\":\"london\",\"id\":\"98765432-bcdef-0123-4567-89abcdef123\",\"price\":\"2. 16.0\",\"seatClass\":\"2\",\"seatNumber\":\"First-67\",\"status\":\"6\",\"to\":\"London\",\"trainNumber\":\"F123456789\",\"travelDate\":\"2013-05-07 19:53:29\",\"travelTime\":\"1000\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"98765432-10fe-4567-89ab-cdef01234567\",\"boughtDate\":\"2014-11-15 14:30:00\",\"coachNumber\":\"350\",\"contactsDocumentNumber\":\"1234567890\",\"contactsName\":\"support_team\",\"differenceMoney\":\"123.45\",\"documentType\":\"500\",\"from\":\"paris\",\"id\":\"0b23bd3e-876a-4af3-b920-c50a90c90b04\",\"price\":\"5. 32.0\",\"seatClass\":\"1\",\"seatNumber\":\"Standard-91\",\"status\":\"7\",\"to\":\"New York\",\"trainNumber\":\"1234567890\",\"travelDate\":\"2013-05-08 02:48:10\",\"travelTime\":\"650\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"b3a290d8-f1e7-4c8d-90bc-1234567890ab\",\"boughtDate\":\"2016-07-08 18:00:00\",\"coachNumber\":\"1100\",\"contactsDocumentNumber\":\"DocumentNumber_Four\",\"contactsName\":\"billing_inquiries@example.com\",\"differenceMoney\":\"567.89\",\"documentType\":\"1000\",\"from\":\"berlin\",\"id\":\"9fc9c261-3263-4bfa-82f8-bb44e06b2f52\",\"price\":\"1. 10.0\",\"seatClass\":\"2\",\"seatNumber\":\"VIP-48\",\"status\":\"8\",\"to\":\"Paris\",\"trainNumber\":\"ABCDEFGHIJKL\",\"travelDate\":\"2013-05-09 16:01:33\",\"travelTime\":\"800\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"a7b9c1d3-e4f5-6789-abcd-ef0123456789\",\"boughtDate\":\"2013-05-04 09:00:00\",\"coachNumber\":\"800\",\"contactsDocumentNumber\":\"1234567890\",\"contactsName\":\"trainticket_notify@163.com\",\"differenceMoney\":\"1000.00\",\"documentType\":\"5000\",\"from\":\"atlanta\",\"id\":\"1a2b3c4d-5e6f-7890-1234-567890abcdef\",\"price\":\"6. 50.0\",\"seatClass\":\"1\",\"seatNumber\":\"Deluxe-112\",\"status\":\"1\",\"to\":\"Tokyo\",\"trainNumber\":\"9876543210\",\"travelDate\":\"2013-05-04 09:51:52\",\"travelTime\":\"350\"}";
                        req = req.body(requestBody1);
