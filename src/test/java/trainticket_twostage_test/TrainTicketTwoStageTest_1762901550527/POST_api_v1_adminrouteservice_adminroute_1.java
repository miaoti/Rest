...
public class POST_api_v1_adminrouteservice_adminroute_1 {
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        String requestBody1 = "{\"distanceList\":\"12.5\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":\"New York Penn Station\",\"id\":\"route-12345\",\"loginId\":\"manager_login_001\",\"startStation\":\"Central Station\",\"stationList\":\"Downtown Plaza\",\"stations\":[\"Grand Central Terminal\",\"Penn Station\",\"Union Station\",\"Times Square Station\",\"Broadway Station\"]}";
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"12.5\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":\"New York Penn Station\",\"id\":\"route-12345\",\"loginId\":\"manager_login_001\",\"startStation\":\"Central Station\",\"stationList\":\"Downtown Plaza\",\"stations\":[\"Grand Central Terminal\",\"Penn Station\",\"Union Station\",\"Times Square Station\",\"Broadway Station\"]}");
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"12.5\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":\"New York Penn Station\",\"id\":\"service-98765\",\"loginId\":\"admin_user_123\",\"startStation\":\"Central Station\",\"stationList\":\"Central Station\",\"stations\":[\"Grand Central Terminal\",\"Penn Station\",\"Union Station\",\"Times Square Station\",\"Broadway Station\"]}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"12.5\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":\"New York Penn Station\",\"id\":\"service-98765\",\"loginId\":\"admin_user_123\",\"startStation\":\"Central Station\",\"stationList\":\"Central Station\",\"stations\":[\"Grand Central Terminal\",\"Penn Station\",\"Union Station\",\"Times Square Station\",\"Broadway Station\"]}");
                        Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               .statusCode(200)
                               .extract().response();
    ...
    public void test_negative_POST_1_4() throws Exception {
        ...
        Allure.parameter("🔴 Invalid Parameters", "distances=123");
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"12.5\",\"distances\":\"123\",\"endStation\":\"Chicago Union Station\",\"id\":\"route-12345\",\"loginId\":\"admin_user_123\",\"startStation\":\"Central Station\",\"stationList\":\"Central Station\",\"stations\":[\"Grand Central Terminal\",\"Penn Station\",\"Union Station\",\"Times Square Station\",\"Broadway Station\"]}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"12.5\",\"distances\":\"123\",\"endStation\":\"Chicago Union Station\",\"id\":\"route-12345\",\"loginId\":\"admin_user_123\",\"startStation\":\"Central Station\",\"stationList\":\"Central Station\",\"stations\":[\"Grand Central Terminal\",\"Penn Station\",\"Union Station\",\"Times Square Station\",\"Broadway Station\"]}");
                        Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"8.2\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":\"123\",\"id\":\"route-12345\",\"loginId\":\"admin_user_123\",\"startStation\":\"Central Station\",\"stationList\":\"North Avenue Stop\",\"stations\":[\"Grand Central Terminal\",\"Penn Station\",\"Union Station\",\"Times Square Station\",\"Broadway Station\"]}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"8.2\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":\"123\",\"id\":\"route-12345\",\"loginId\":\"admin_user_123\",\"startStation\":\"Central Station\",\"stationList\":\"North Avenue Stop\",\"stations\":[\"Grand Central Terminal\",\"Penn Station\",\"Union Station\",\"Times Square Station\",\"Broadway Station\"]}");
                        Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               // Negative test: expect error code (4XX or 5XX), not success code
                               .statusCode(org.hamcrest.Matchers.greaterThanOrEqualTo(400))
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"12.5\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":\"New York Penn Station\",\"id\":\"route-12345\",\"loginId\":\"admin_user_123\",\"startStation\":\"Central Station\",\"stationList\":\"Central Station\",\"stations\":[\"nanjing\"]}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"12.5\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":\"New York Penn Station\",\"id\":\"route-12345\",\"loginId\":\"admin_user_123\",\"startStation\":\"Central Station\",\"stationList\":\"Central Station\",\"stations\":[\"nanjing\"]}");
                        Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               .statusCode(200)
                               .extract().response();
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"15.7\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":\"New York Penn Station\",\"id\":\"route-12345\",\"loginId\":\"admin_user_123\",\"startStation\":\"Central Station\",\"stationList\":\"Central Station\",\"stations\":[\"Grand Central Terminal\",\"Penn Station\",\"Union Station\",\"Times Square Station\",\"Broadway Station\"]}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"15.7\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":\"New York Penn Station\",\"id\":\"route-12345\",\"loginId\":\"admin_user_123\",\"startStation\":\"Central Station\",\"stationList\":\"Central Station\",\"stations\":[\"Grand Central Terminal\",\"Penn Station\",\"Union Station\",\"Times Square Station\",\"Broadway Station\"]}");
                        Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               .statusCode(200)
                               .extract().response();
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"12.5\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":\"New York Penn Station\",\"id\":\"route-12345\",\"loginId\":\"123\",\"startStation\":\"Central Station\",\"stationList\":\"Central Station\",\"stations\":[\"shijiazhuang\"]}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"12.5\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":\"New York Penn Station\",\"id\":\"route-12345\",\"loginId\":\"123\",\"startStation\":\"Central Station\",\"stationList\":\"Central Station\",\"stations\":[\"shijiazhuang\"]}");
                        Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               // Negative test: expect error code (4XX or 5XX), not success code
                               .statusCode(org.hamcrest.Matchers.greaterThanOrEqualTo(400))
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"3.1\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":\"New York Penn Station\",\"id\":\"route-12345\",\"loginId\":\"admin_user_123\",\"startStation\":\"Central Station\",\"stationList\":\"123\",\"stations\":[\"Grand Central Terminal\",\"Penn Station\",\"Union Station\",\"Times Square Station\",\"Broadway Station\"]}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"3.1\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":\"New York Penn Station\",\"id\":\"route-12345\",\"loginId\":\"admin_user_123\",\"startStation\":\"Central Station\",\"stationList\":\"123\",\"stations\":[\"Grand Central Terminal\",\"Penn Station\",\"Union Station\",\"Times Square Station\",\"Broadway Station\"]}");
                        Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               // Negative test: expect error code (4XX or 5XX), not success code
                               .statusCode(org.hamcrest.Matchers.greaterThanOrEqualTo(400))
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"123\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":\"New York Penn Station\",\"id\":\"route-12345\",\"loginId\":\"admin_user_123\",\"startStation\":\"Central Station\",\"stationList\":\"Central Station\",\"stations\":[\"Grand Central Terminal\",\"Penn Station\",\"Union Station\",\"Times Square Station\",\"Broadway Station\"]}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"123\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":\"New York Penn Station\",\"id\":\"route-12345\",\"loginId\":\"admin_user_123\",\"startStation\":\"Central Station\",\"stationList\":\"Central Station\",\"stations\":[\"Grand Central Terminal\",\"Penn Station\",\"Union Station\",\"Times Square Station\",\"Broadway Station\"]}");
                        Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               // Negative test: expect error code (4XX or 5XX), not success code
                               .statusCode(org.hamcrest.Matchers.greaterThanOrEqualTo(400))
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"12.5\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":\"New York Penn Station\",\"id\":\"ts-777\",\"loginId\":\"admin_user_123\",\"startStation\":\"Central Station\",\"stationList\":\"Central Station\",\"stations\":[\"Grand Central Terminal\",\"Penn Station\",\"Union Station\",\"Times Square Station\",\"Broadway Station\"]}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"12.5\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":\"New York Penn Station\",\"id\":\"ts-777\",\"loginId\":\"admin_user_123\",\"startStation\":\"Central Station\",\"stationList\":\"Central Station\",\"stations\":[\"Grand Central Terminal\",\"Penn Station\",\"Union Station\",\"Times Square Station\",\"Broadway Station\"]}");
                        Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               .statusCode(200)
                               .extract().response();
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"12.5\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":\"New York Penn Station\",\"id\":\"route-12345\",\"loginId\":\"admin_user_123\",\"startStation\":\"123\",\"stationList\":\"Central Station\",\"stations\":[\"Grand Central Terminal\",\"Penn Station\",\"Union Station\",\"Times Square Station\",\"Broadway Station\"]}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"12.5\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":\"New York Penn Station\",\"id\":\"route-12345\",\"loginId\":\"admin_user_123\",\"startStation\":\"123\",\"stationList\":\"Central Station\",\"stations\":[\"Grand Central Terminal\",\"Penn Station\",\"Union Station\",\"Times Square Station\",\"Broadway Station\"]}");
                        Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               // Negative test: expect error code (4XX or 5XX), not success code
                               .statusCode(org.hamcrest.Matchers.greaterThanOrEqualTo(400))
