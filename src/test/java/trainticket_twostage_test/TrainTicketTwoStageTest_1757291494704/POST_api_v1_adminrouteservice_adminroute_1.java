package trainticket_twostage_test.TrainTicketTwoStageTest_1757291494704;
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"210\",\"distances\":\"[\\\"10\\\", \\\"50\\\", \\\"100\\\", \\\"250\\\", \\\"500\\\"]\",\"endStation\":\"Times Square\",\"id\":\"9fc9c261-3263-4bfa-82f8-bb44e06b2f52\",\"loginId\":\"f8a9b0c1-2345-6789-0123-456789abcdef\",\"startStation\":\"dallas\",\"stationList\":\"Grand Central Terminal\",\"stations\":\"[\\\"wuxi\\\", \\\"shijiazhuang\\\"]\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"400\",\"distances\":\"[\\\"10\\\", \\\"50\\\", \\\"100\\\", \\\"250\\\", \\\"500\\\"]\",\"endStation\":\"Grand Central Terminal\",\"id\":\"d4c8f3a1-b29d-4e7a-8c6d-f1a9b876e543\",\"loginId\":\"9cba0de1-2345-6789-0123-456789abcdef\",\"startStation\":\"suzhou\",\"stationList\":\"Times Square - 42nd Street\",\"stations\":\"[\\\"dallas\\\"]\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"950\",\"distances\":\"[\\\"10\\\", \\\"50\\\", \\\"100\\\", \\\"250\\\", \\\"500\\\"]\",\"endStation\":\"Penn Station\",\"id\":\"f1e2d3c4-b3a2-1098-7654-3456789abcd\",\"loginId\":\"7b8a9c0d-e5f6-7890-1234-\",\"startStation\":\"waco\",\"stationList\":\"Union Station\",\"stations\":\"[\\\"suzhou\\\"]\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"1200\",\"distances\":\"[\\\"10\\\", \\\"50\\\", \\\"100\\\", \\\"250\\\", \\\"500\\\"]\",\"endStation\":\"Central Park South\",\"id\":\"87654321-9876-5432-1098-7654321fedc\",\"loginId\":\"1a2b3c4d-e5f6-7890-1234-567890abcdef\",\"startStation\":\"shijiazhuang\",\"stationList\":\"Central Park South\",\"stations\":\"[\\\"waco\\\"]\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"875\",\"distances\":\"[\\\"10\\\", \\\"50\\\", \\\"100\\\", \\\"250\\\", \\\"500\\\"]\",\"endStation\":\"Brooklyn Bridge\",\"id\":\"2a9b8c7d-e5f6-\",\"loginId\":\"a1b2c3d4-e5f6-7890-1234-567890abcdef\",\"startStation\":\"austin\",\"stationList\":\"Brooklyn Bridge - Manhattan Side\",\"stations\":\"[\\\"Grand Central Terminal\\\", \\\"Union Station - Denver\\\", \\\"Waterloo Station\\\", \\\"King's Cross St. Pancras\\\", \\\"Victoria Station\\\"]\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"1450\",\"distances\":\"[\\\"10\\\", \\\"50\\\", \\\"100\\\", \\\"250\\\", \\\"500\\\"]\",\"endStation\":\"Grand Central Terminal\",\"id\":\"a1b2c3d4-e5f6-7890-1234-567890abcdef\",\"loginId\":\"4d2a46c7-71cb-4cf1-b5bb-b68406d9da6f\",\"startStation\":\"shanghaihongqiao\",\"stationList\":\"Grand Central Terminal\",\"stations\":\"[\\\"shijiazhuang\\\"]\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"1120\",\"distances\":\"[\\\"10\\\", \\\"50\\\", \\\"100\\\", \\\"250\\\", \\\"500\\\"]\",\"endStation\":\"Grand Central Terminal\",\"id\":\"0b23bd3e-876a-4af3-b920-c50a90c90b04\",\"loginId\":\"john.doe123\",\"startStation\":\"zhenjiang\",\"stationList\":\"Grand Central Terminal\",\"stations\":\"[\\\"austin\\\"]\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"1380\",\"distances\":\"[\\\"10\\\", \\\"50\\\", \\\"100\\\", \\\"250\\\", \\\"500\\\"]\",\"endStation\":\"Times Square\",\"id\":\"123\",\"loginId\":\"john.doe123\",\"startStation\":\"jiaxingnan\",\"stationList\":\"Times Square - 42nd Street\",\"stations\":\"[\\\"wuxi\\\"]\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"1270\",\"distances\":\"[\\\"10\\\", \\\"50\\\", \\\"100\\\", \\\"250\\\", \\\"500\\\"]\",\"endStation\":\"Penn Station\",\"id\":\"abc\",\"loginId\":\"john.doe123\",\"startStation\":\"xuzhou\",\"stationList\":\"Union Station\",\"stations\":\"[\\\"Grand Central Terminal\\\", \\\"Union Station - Denver\\\", \\\"Waterloo Station\\\", \\\"King's Cross St. Pancras\\\", \\\"Victoria Station\\\"]\"}";
                        req = req.body(requestBody1);
