package trainticket_twostage_test.TrainTicketTwoStageTest_1754446255346;
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        String requestBody1 = "{\"accountId\":\"4d2a46c7-71cb-4cf1-b5bb-b68406d9da6f\",\"boughtDate\":\"2023-10-26\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"2135488099312X\",\"contactsName\":\"trainticket_notify@163.com\",\"differenceMoney\":\"100.0\",\"documentType\":\"1\",\"from\":\"shanghai\",\"id\":\"76543210\",\"price\":\"8.0\",\"seatClass\":\"1\",\"seatNumber\":\"1A\",\"status\":\"1\",\"to\":\"PDX\",\"trainNumber\":\"12345\",\"travelDate\":\"2024-03-15\",\"travelTime\":\"30\"}";
            ...
            Allure.step("Step 2: ts-order-other-service POST /api/v1/orderOtherService/orderOther/admin (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "{\"accountId\":\"4d2a46c7-71cb-4cf1-b5bb-b68406d9da6f\",\"boughtDate\":\"2023-10-26\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"2135488099312X\",\"contactsName\":\"trainticket_notify@163.com\",\"documentType\":\"1\",\"from\":\"shanghai\",\"id\":\"76543210\",\"price\":\"8.0\",\"seatClass\":\"1\",\"seatNumber\":\"1A\",\"status\":\"1\",\"to\":\"PDX\",\"trainNumber\":\"12345\",\"travelDate\":\"2024-03-15\",\"travelTime\":\"30\"}";
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"98765432-bcdf-a123-4567-89abcdef0123\",\"boughtDate\":\"2013-05-04 09:00:00\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"1234567890\",\"contactsName\":\"fdse_microservice\",\"differenceMoney\":\"100\",\"documentType\":\"1\",\"from\":\"suzhou\",\"id\":\"c1234567-8012-3456-7890-1a2b3c4d5e6f\",\"price\":\"2.0\",\"seatClass\":\"1\",\"seatNumber\":\"1A\",\"status\":\"1235\",\"to\":\"beijing\",\"trainNumber\":\"12345\",\"travelDate\":\"2024-03-15\",\"travelTime\":\"30\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-order-other-service POST /api/v1/orderOtherService/orderOther/admin (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "{\"accountId\":\"98765432-bcdf-a123-4567-89abcdef0123\",\"boughtDate\":\"2013-05-04 09:00:00\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"1234567890\",\"contactsName\":\"fdse_microservice\",\"documentType\":\"1\",\"from\":\"suzhou\",\"id\":\"c1234567-8012-3456-7890-1a2b3c4d5e6f\",\"price\":\"2.0\",\"seatClass\":\"1\",\"seatNumber\":\"1A\",\"status\":\"1235\",\"to\":\"beijing\",\"trainNumber\":\"12345\",\"travelDate\":\"2024-03-15\",\"travelTime\":\"30\"}";
                        req = req.body(requestBody2);
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"d4e5f678-9012-3456-7890-abcdef\",\"boughtDate\":\"2013-05-04 12:00:00\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"165490237891DC\",\"contactsName\":\"trainticket_escalation@gmail.com\",\"differenceMoney\":\"10000.0\",\"documentType\":\"1\",\"from\":\"2013-05-04 17:51:52\",\"id\":\"06f71780-c647-465c-969f-cf8c019bc45f\",\"price\":\"4.0\",\"seatClass\":\"1\",\"seatNumber\":\"1A\",\"status\":\"7890\",\"to\":\"ORD\",\"trainNumber\":\"12345\",\"travelDate\":\"2024-07-20\",\"travelTime\":\"30\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-order-other-service POST /api/v1/orderOtherService/orderOther/admin (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "{\"accountId\":\"d4e5f678-9012-3456-7890-abcdef\",\"boughtDate\":\"2013-05-04 12:00:00\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"165490237891DC\",\"contactsName\":\"trainticket_escalation@gmail.com\",\"documentType\":\"1\",\"from\":\"2013-05-04 17:51:52\",\"id\":\"06f71780-c647-465c-969f-cf8c019bc45f\",\"price\":\"4.0\",\"seatClass\":\"1\",\"seatNumber\":\"1A\",\"status\":\"7890\",\"to\":\"ORD\",\"trainNumber\":\"12345\",\"travelDate\":\"2024-07-20\",\"travelTime\":\"30\"}";
                        req = req.body(requestBody2);
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"1234567890\",\"boughtDate\":\"2013-05-04 15:51:52\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"609876543210PQ\",\"contactsName\":\"fdse_monitoring_team\",\"differenceMoney\":\"100\",\"documentType\":\"1235\",\"from\":\"2013-05-04 12:00:00\",\"id\":\"bdbacf78-877f-4d8c-ace5-399f12897a57\",\"price\":\"1. 16.0\",\"seatClass\":\"1\",\"seatNumber\":\"1A\",\"status\":\"34567\",\"to\":\"LAX\",\"trainNumber\":\"12345\",\"travelDate\":\"2024-07-20\",\"travelTime\":\"30\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-order-other-service POST /api/v1/orderOtherService/orderOther/admin (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "{\"accountId\":\"1234567890\",\"boughtDate\":\"2013-05-04 15:51:52\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"609876543210PQ\",\"contactsName\":\"fdse_monitoring_team\",\"documentType\":\"1235\",\"from\":\"2013-05-04 12:00:00\",\"id\":\"bdbacf78-877f-4d8c-ace5-399f12897a57\",\"price\":\"1. 16.0\",\"seatClass\":\"1\",\"seatNumber\":\"1A\",\"status\":\"34567\",\"to\":\"LAX\",\"trainNumber\":\"12345\",\"travelDate\":\"2024-07-20\",\"travelTime\":\"30\"}";
                        req = req.body(requestBody2);
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"1a2b3c4d-5678-9012-3456-7890abcdef12\",\"boughtDate\":\"2013-05-04 10:30:00\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"2987654321987GH\",\"contactsName\":\"trainticket_feedback@yahoo.com\",\"differenceMoney\":\"200.0\",\"documentType\":\"1234\",\"from\":\"2013-05-04 15:51:52\",\"id\":\"e8a9b2c3-d4e5-f678-9ab0-123456789abc\",\"price\":\"4. 128.0\",\"seatClass\":\"1\",\"seatNumber\":\"1A\",\"status\":\"65432\",\"to\":\"MIA\",\"trainNumber\":\"12345\",\"travelDate\":\"2024-07-20\",\"travelTime\":\"30\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-order-other-service POST /api/v1/orderOtherService/orderOther/admin (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "{\"accountId\":\"1a2b3c4d-5678-9012-3456-7890abcdef12\",\"boughtDate\":\"2013-05-04 10:30:00\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"2987654321987GH\",\"contactsName\":\"trainticket_feedback@yahoo.com\",\"documentType\":\"1234\",\"from\":\"2013-05-04 15:51:52\",\"id\":\"e8a9b2c3-d4e5-f678-9ab0-123456789abc\",\"price\":\"4. 128.0\",\"seatClass\":\"1\",\"seatNumber\":\"1A\",\"status\":\"65432\",\"to\":\"MIA\",\"trainNumber\":\"12345\",\"travelDate\":\"2024-07-20\",\"travelTime\":\"30\"}";
                        req = req.body(requestBody2);
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"a1b2c3d4-e5f6-7890-1234-567890abcdef\",\"boughtDate\":\"2013-05-04 07:55:49\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"567890123456IJ\",\"contactsName\":\"fdse_analytics_group\",\"differenceMoney\":\"5000.0\",\"documentType\":\"1\",\"from\":\"2013-05-04 09:00:00\",\"id\":\"4f7e8d9c-b5a4-3210-fedc-ba9876543210\",\"price\":\"2. 32.0\",\"seatClass\":\"1\",\"seatNumber\":\"1A\",\"status\":\"43210\",\"to\":\"ATL\",\"trainNumber\":\"12345\",\"travelDate\":\"2024-03-15\",\"travelTime\":\"30\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-order-other-service POST /api/v1/orderOtherService/orderOther/admin (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "{\"accountId\":\"a1b2c3d4-e5f6-7890-1234-567890abcdef\",\"boughtDate\":\"2013-05-04 07:55:49\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"567890123456IJ\",\"contactsName\":\"fdse_analytics_group\",\"documentType\":\"1\",\"from\":\"2013-05-04 09:00:00\",\"id\":\"4f7e8d9c-b5a4-3210-fedc-ba9876543210\",\"price\":\"2. 32.0\",\"seatClass\":\"1\",\"seatNumber\":\"1A\",\"status\":\"43210\",\"to\":\"ATL\",\"trainNumber\":\"12345\",\"travelDate\":\"2024-03-15\",\"travelTime\":\"30\"}";
                        req = req.body(requestBody2);
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"fedcba09-8765-4321-0fed-cba987654321\",\"boughtDate\":\"2013-05-04 21:17:01\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"1234567890\",\"contactsName\":\"trainticket_support@outlook.com\",\"differenceMoney\":\"7500.50\",\"documentType\":\"1235\",\"from\":\"123\",\"id\":\"9d8f7a6b-5c4b-3a21-9d8e-f0a1b2c3d456\",\"price\":\"7. 1024.0\",\"seatClass\":\"1\",\"seatNumber\":\"1A\",\"status\":\"87654\",\"to\":\"DEN\",\"trainNumber\":\"12345\",\"travelDate\":\"2024-07-20\",\"travelTime\":\"30\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-order-other-service POST /api/v1/orderOtherService/orderOther/admin (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "{\"accountId\":\"fedcba09-8765-4321-0fed-cba987654321\",\"boughtDate\":\"2013-05-04 21:17:01\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"1234567890\",\"contactsName\":\"trainticket_support@outlook.com\",\"documentType\":\"1235\",\"from\":\"123\",\"id\":\"9d8f7a6b-5c4b-3a21-9d8e-f0a1b2c3d456\",\"price\":\"7. 1024.0\",\"seatClass\":\"1\",\"seatNumber\":\"1A\",\"status\":\"87654\",\"to\":\"DEN\",\"trainNumber\":\"12345\",\"travelDate\":\"2024-07-20\",\"travelTime\":\"30\"}";
                        req = req.body(requestBody2);
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"4d2a46c7-71cb-4cf1-b5bb-b68406d9da6f\",\"boughtDate\":\"2013-05-04 13:22:33\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"419827364518KL\",\"contactsName\":\"fdse_data_science_unit\",\"differenceMoney\":\"100000.0\",\"documentType\":\"1234\",\"from\":\"taiyuan\",\"id\":\"76543210\",\"price\":\"6. 512.0\",\"seatClass\":\"1\",\"seatNumber\":\"1A\",\"status\":\"12345\",\"to\":\"SFO\",\"trainNumber\":\"12345\",\"travelDate\":\"2024-07-20\",\"travelTime\":\"30\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-order-other-service POST /api/v1/orderOtherService/orderOther/admin (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "{\"accountId\":\"4d2a46c7-71cb-4cf1-b5bb-b68406d9da6f\",\"boughtDate\":\"2013-05-04 13:22:33\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"419827364518KL\",\"contactsName\":\"fdse_data_science_unit\",\"documentType\":\"1234\",\"from\":\"taiyuan\",\"id\":\"76543210\",\"price\":\"6. 512.0\",\"seatClass\":\"1\",\"seatNumber\":\"1A\",\"status\":\"12345\",\"to\":\"SFO\",\"trainNumber\":\"12345\",\"travelDate\":\"2024-07-20\",\"travelTime\":\"30\"}";
                        req = req.body(requestBody2);
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"98765432-bcdf-a123-4567-89abcdef0123\",\"boughtDate\":\"2013-05-04 19:01:25\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"876543219876EF\",\"contactsName\":\"trainticket_operations@zoho.com\",\"differenceMoney\":\"100\",\"documentType\":\"1\",\"from\":\"2013-05-04 09:30:00\",\"id\":\"c1234567-8012-3456-7890-1a2b3c4d5e6f\",\"price\":\"3. 64.0\",\"seatClass\":\"1\",\"seatNumber\":\"1A\",\"status\":\"98765\",\"to\":\"JFK\",\"trainNumber\":\"12345\",\"travelDate\":\"2024-07-20\",\"travelTime\":\"30\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-order-other-service POST /api/v1/orderOtherService/orderOther/admin (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "{\"accountId\":\"98765432-bcdf-a123-4567-89abcdef0123\",\"boughtDate\":\"2013-05-04 19:01:25\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"876543219876EF\",\"contactsName\":\"trainticket_operations@zoho.com\",\"documentType\":\"1\",\"from\":\"2013-05-04 09:30:00\",\"id\":\"c1234567-8012-3456-7890-1a2b3c4d5e6f\",\"price\":\"3. 64.0\",\"seatClass\":\"1\",\"seatNumber\":\"1A\",\"status\":\"98765\",\"to\":\"JFK\",\"trainNumber\":\"12345\",\"travelDate\":\"2024-07-20\",\"travelTime\":\"30\"}";
                        req = req.body(requestBody2);
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"d4e5f678-9012-3456-7890-abcdef\",\"boughtDate\":\"2013-05-04 18:45:18\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"736542109876MN\",\"contactsName\":\"John Doe\",\"differenceMoney\":\"150.75\",\"documentType\":\"1\",\"from\":\"guangzhou\",\"id\":\"06f71780-c647-465c-969f-cf8c019bc45f\",\"price\":\"5. 256.0\",\"seatClass\":\"1\",\"seatNumber\":\"1A\",\"status\":\"10\",\"to\":\"John Doe\",\"trainNumber\":\"12345\",\"travelDate\":\"2024-07-20\",\"travelTime\":\"30\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-order-other-service POST /api/v1/orderOtherService/orderOther/admin (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "{\"accountId\":\"d4e5f678-9012-3456-7890-abcdef\",\"boughtDate\":\"2013-05-04 18:45:18\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"736542109876MN\",\"contactsName\":\"John Doe\",\"documentType\":\"1\",\"from\":\"guangzhou\",\"id\":\"06f71780-c647-465c-969f-cf8c019bc45f\",\"price\":\"5. 256.0\",\"seatClass\":\"1\",\"seatNumber\":\"1A\",\"status\":\"10\",\"to\":\"John Doe\",\"trainNumber\":\"12345\",\"travelDate\":\"2024-07-20\",\"travelTime\":\"30\"}";
                        req = req.body(requestBody2);
