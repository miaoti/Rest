...
public class delete_api_v1_admintravelservice_admintravel_3cscript_3ealert_28_27test_27_29_3c_2fscript_3e_601 {
    ...
    public void test_negative_DELETE_601_45() throws Exception {
        ...
        Allure.label("subSuite", "test_negative_DELETE_601_45");
                                    ...
                                    if (dataValue instanceof org.json.JSONObject) {
                                        ...
                                        if (dataObj.optBoolean("injected", false)) {
                                            ...
                                            if (!detectedFaultName.isEmpty()) {
                                                ...
                                                System.out.println("🔍 FAULT DETECTED (in failed test): " + detectedFaultName + " in test: test_negative_DELETE_601_45");
                                            }
                                        }
                                    }
                                }
