...
public class delete_api_v1_admintravelservice_admintravel_trip_369258147_601 {
    ...
    public void test_DELETE_601_14() throws Exception {
        ...
        // Original Status: 200
        // Enhanced Parameters: [adminUserId, travelId, deleteReason]
        // ═══════════════════════════════════════════════════════════════════════
        Allure.label("enhancement", "ENHANCED");
        Allure.addAttachment("📝 Original Failure", "text/plain", "Original Status: 200\nOriginal Response: {\"status\":0,\"msg\":\"Admin delete travel failed\",\"data\":null}\nEnhanced Parameters: {adminUserId=admin_user_123, travelId=TRIP-369258147, deleteReason=Travel request cancelled by admin}");
        ...
        Allure.label("subSuite", "test_DELETE_601_14");
                                    ...
                                    if (dataValue instanceof org.json.JSONObject) {
                                        ...
                                        if (dataObj.optBoolean("injected", false)) {
                                            ...
                                            if (!detectedFaultName.isEmpty()) {
                                                ...
                                                System.out.println("🔍 FAULT DETECTED (in failed test): " + detectedFaultName + " in test: test_DELETE_601_14");
                                            }
                                        }
                                    }
                                }
