package trainticket_twostage_test.TrainTicketTwoStageTest_1762206366772;
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        String requestBody1 = "{\"accountId\":\"1234567890\",\"boughtDate\":\"2023-10-26\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"123456789\",\"contactsName\":\"John Smith\",\"differenceMoney\":\"100\",\"documentType\":\"1\",\"from\":\"123\",\"id\":\"123\",\"price\":\"19.99\",\"seatClass\":\"3\",\"seatNumber\":\"1A\",\"status\":\"10\",\"to\":\"JohnDoe\",\"trainNumber\":\"12345\",\"travelDate\":\"2023-12-24\",\"travelTime\":\"30\"}";
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"1234567890\",\"boughtDate\":\"2023-10-26\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"1112223333\",\"contactsName\":\"John Smith\",\"differenceMoney\":\"25.50\",\"documentType\":\"1\",\"from\":\"123\",\"id\":\"123\",\"price\":\"19.99\",\"seatClass\":\"1\",\"seatNumber\":\"1A\",\"status\":\"10\",\"to\":\"JohnDoe\",\"trainNumber\":\"12345\",\"travelDate\":\"2023-12-24\",\"travelTime\":\"65\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"1234567890\",\"boughtDate\":\"2024-02-29\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"123456789\",\"contactsName\":\"John Smith\",\"differenceMoney\":\"100\",\"documentType\":\"1\",\"from\":\"123\",\"id\":\"123\",\"price\":\"19.99\",\"seatClass\":\"1\",\"seatNumber\":\"1A\",\"status\":\"10\",\"to\":\"PeterPan\",\"trainNumber\":\"12345\",\"travelDate\":\"2023-12-24\",\"travelTime\":\"30\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"1234567890\",\"boughtDate\":\"2023-10-26\",\"coachNumber\":\"67890\",\"contactsDocumentNumber\":\"123456789\",\"contactsName\":\"John Smith\",\"differenceMoney\":\"100\",\"documentType\":\"1\",\"from\":\"123\",\"id\":\"123\",\"price\":\"19.99\",\"seatClass\":\"1\",\"seatNumber\":\"1A\",\"status\":\"10\",\"to\":\"123 Main Street\",\"trainNumber\":\"12345\",\"travelDate\":\"2023-12-24\",\"travelTime\":\"30\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"1234567890\",\"boughtDate\":\"2023-10-26\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"123456789\",\"contactsName\":\"John Smith\",\"differenceMoney\":\"100\",\"documentType\":\"1\",\"from\":\"xyz\",\"id\":\"123\",\"price\":\"100.50\",\"seatClass\":\"4\",\"seatNumber\":\"1A\",\"status\":\"10\",\"to\":\"JohnDoe\",\"trainNumber\":\"12345\",\"travelDate\":\"2023-12-24\",\"travelTime\":\"30\"}";
                        req = req.body(requestBody1);
