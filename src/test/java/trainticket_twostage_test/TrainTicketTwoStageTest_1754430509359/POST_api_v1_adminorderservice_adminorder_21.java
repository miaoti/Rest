package trainticket_twostage_test.TrainTicketTwoStageTest_1754430509359;
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        String requestBody1 = "{\"accountId\":\"test818\",\"boughtDate\":\"test819\",\"coachNumber\":\"test820\",\"contactsDocumentNumber\":\"test821\",\"contactsName\":\"test823\",\"differenceMoney\":\"test825\",\"documentType\":\"test825\",\"from\":\"test826\",\"id\":\"test428\",\"price\":\"test826\",\"seatClass\":\"test827\",\"seatNumber\":\"test828\",\"status\":\"test828\",\"to\":\"test829\",\"trainNumber\":\"test830\",\"travelDate\":\"test831\",\"travelTime\":\"test831\"}";
            ...
            Allure.step("Step 2: ts-order-other-service POST /api/v1/orderOtherService/orderOther/admin (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "{\"accountId\":\"test818\",\"boughtDate\":\"test819\",\"coachNumber\":\"test820\",\"contactsDocumentNumber\":\"test821\",\"contactsName\":\"test823\",\"documentType\":\"test825\",\"from\":\"test826\",\"id\":\"test428\",\"price\":\"test826\",\"seatClass\":\"test827\",\"seatNumber\":\"test828\",\"status\":\"test828\",\"to\":\"test829\",\"trainNumber\":\"test830\",\"travelDate\":\"test831\",\"travelTime\":\"test831\"}";
