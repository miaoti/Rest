...
public class POST_api_v1_adminrouteservice_adminroute_1 {
    ...
    public void test_negative_POST_1_1() throws Exception {
        ...
        // Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 4XX/5XX error)
        ...
        try {
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    System.out.println("▶️ EXECUTING: Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 4XX/5XX error) (dependency analysis passed)");
                    try {
                        RequestSpecification req = RestAssured.given();
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"12.5\",\"distances\":\"INVALID_VALUE_MISSING_distances\",\"endStation\":\"New York Penn Station\",\"id\":\"AR-123456\",\"loginId\":\"user_login_2023\",\"startStation\":\"Westfield Station\",\"stationList\":\"Central Station\",\"stations\":[\"Grand Central Terminal\",\"Penn Station\",\"Union Station\",\"Times Square Station\",\"Broadway Station\"]}";
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"12.5\",\"distances\":\"INVALID_VALUE_MISSING_distances\",\"endStation\":\"New York Penn Station\",\"id\":\"AR-123456\",\"loginId\":\"user_login_2023\",\"startStation\":\"Westfield Station\",\"stationList\":\"Central Station\",\"stations\":[\"Grand Central Terminal\",\"Penn Station\",\"Union Station\",\"Times Square Station\",\"Broadway Station\"]}");
                        ...
                        System.out.println("✅ Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 4XX/5XX error) - SUCCESS");
                        ...
                        System.out.println("❌ Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 4XX/5XX error) - FAILED: " + t.getMessage());
                        ...
                        errorDetails.append("=====================================\n\n");
                        errorDetails.append("📋 Step: Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 4XX/5XX error)\n");
                        ...
                        throw new RuntimeException("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 4XX/5XX error) failed: " + failureReason + " (" + errorType + ")", t);
                    }
                } else {
                    // ⏭️ SKIP: Clean skip reporting with proper Allure status
                    System.out.println("⏭️ SKIPPING: Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 4XX/5XX error) - " + skipReason);
                    stepResults.put(1, false);
            ...
            if (stepException instanceof RuntimeException && stepException.getMessage().startsWith("Step failed:")) {
                ...
                System.out.println("⚠️ Step wrapper failed for Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 4XX/5XX error): " + stepException.getMessage());
                stepResults.put(1, false);
            }
        }
    ...
    @Test
    public void test_negative_POST_1_2() throws Exception {
        // Record test execution for fault detection tracking
        es.us.isa.restest.analysis.FaultDetectionTracker.getInstance()
            .recordTestCase(this.getClass().getName(), "test_negative_POST_1_2");
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"8.3\",\"distances\":[\"25.5\",\"12.0\",\"30.75\",\"8.2\",\"15.3\"],\"endStation\":\"INVALID_VALUE_MISSING_endStation\",\"id\":\"AR-123456\",\"loginId\":\"admin_user_123\",\"startStation\":\"Central Station\",\"stationList\":\"Central Station\",\"stations\":[\"Grand Central Terminal\",\"Penn Station\",\"Union Station\",\"Times Square Station\",\"Broadway Station\"]}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"8.3\",\"distances\":[\"25.5\",\"12.0\",\"30.75\",\"8.2\",\"15.3\"],\"endStation\":\"INVALID_VALUE_MISSING_endStation\",\"id\":\"AR-123456\",\"loginId\":\"admin_user_123\",\"startStation\":\"Central Station\",\"stationList\":\"Central Station\",\"stations\":[\"Grand Central Terminal\",\"Penn Station\",\"Union Station\",\"Times Square Station\",\"Broadway Station\"]}");
                        Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               // Negative test: expect error code (4XX or 5XX), not success code
                               .statusCode(org.hamcrest.Matchers.greaterThanOrEqualTo(400))
                                ...
                                if (dataObj.optBoolean("injected", false)) {
                                    ...
                                    if (!detectedFaultName.isEmpty()) {
                                        es.us.isa.restest.analysis.FaultDetectionTracker.getInstance().recordDetectedFault(
                                            detectedFaultName,
                                            this.getClass().getName(),
                                            "test_negative_POST_1_2",
                                            System.currentTimeMillis(),
                                            faultCheckBody
                                        );
                                        System.out.println("🔍 FAULT DETECTED: " + detectedFaultName + " in test: test_negative_POST_1_2");
                                    }
                                }
                            }
                        } catch (Exception faultEx) {
        ...
        Allure.label("severity", severity);
        Allure.label("feature", "Microservice Workflow");
        Allure.label("story", "test_negative_POST_1_2");
        Allure.description("Microservice test scenario with " + totalSteps + " steps.");
        
        System.out.println("=== SCENARIO RESULT ===");
        System.out.println("Scenario: test_negative_POST_1_2");
        System.out.println("Total Steps: " + totalSteps);
        System.out.println("Successful: " + successfulSteps);
        System.out.println("Failed: " + failedSteps);
        System.out.println("Login Status: " + (loginSucceeded.get() ? "SUCCESS" : "FAILED"));
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"15.7\",\"distances\":[\"25.5\",\"12.0\",\"30.75\",\"8.2\",\"15.3\"],\"endStation\":\"New York Penn Station\",\"id\":\"AR-123456\",\"loginId\":\"admin_user_123\",\"startStation\":\"Central Station\",\"stationList\":\"Central Station\",\"stations\":[\"Grand Central Terminal\",\"Penn Station\",\"Union Station\",\"Times Square Station\",\"Broadway Station\"]}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"15.7\",\"distances\":[\"25.5\",\"12.0\",\"30.75\",\"8.2\",\"15.3\"],\"endStation\":\"New York Penn Station\",\"id\":\"AR-123456\",\"loginId\":\"admin_user_123\",\"startStation\":\"Central Station\",\"stationList\":\"Central Station\",\"stations\":[\"Grand Central Terminal\",\"Penn Station\",\"Union Station\",\"Times Square Station\",\"Broadway Station\"]}");
                        Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               .statusCode(200)
                               .extract().response();
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"12.5\",\"distances\":[\"25.5\",\"12.0\",\"30.75\",\"8.2\",\"15.3\"],\"endStation\":\"New York Penn Station\",\"id\":\"AR-123456\",\"loginId\":\"admin_user_123\",\"startStation\":\"Central Station\",\"stationList\":\"Westside Station\",\"stations\":[\"Grand Central Terminal\",\"Penn Station\",\"Union Station\",\"Times Square Station\",\"Broadway Station\"]}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"12.5\",\"distances\":[\"25.5\",\"12.0\",\"30.75\",\"8.2\",\"15.3\"],\"endStation\":\"New York Penn Station\",\"id\":\"AR-123456\",\"loginId\":\"admin_user_123\",\"startStation\":\"Central Station\",\"stationList\":\"Westside Station\",\"stations\":[\"Grand Central Terminal\",\"Penn Station\",\"Union Station\",\"Times Square Station\",\"Broadway Station\"]}");
                        Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               .statusCode(200)
                               .extract().response();
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"12.5\",\"distances\":[\"25.5\",\"12.0\",\"30.75\",\"8.2\",\"15.3\"],\"endStation\":\"New York Penn Station\",\"id\":\"SYSTEM-567890\",\"loginId\":\"INVALID_VALUE_MISSING_loginId\",\"startStation\":\"Central Station\",\"stationList\":\"Central Station\",\"stations\":[\"suzhou\"]}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"12.5\",\"distances\":[\"25.5\",\"12.0\",\"30.75\",\"8.2\",\"15.3\"],\"endStation\":\"New York Penn Station\",\"id\":\"SYSTEM-567890\",\"loginId\":\"INVALID_VALUE_MISSING_loginId\",\"startStation\":\"Central Station\",\"stationList\":\"Central Station\",\"stations\":[\"suzhou\"]}");
                        Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               // Negative test: expect error code (4XX or 5XX), not success code
                               .statusCode(org.hamcrest.Matchers.greaterThanOrEqualTo(400))
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"12.5\",\"distances\":[\"25.5\",\"12.0\",\"30.75\",\"8.2\",\"15.3\"],\"endStation\":\"Los Angeles Union Station\",\"id\":\"AR-123456\",\"loginId\":\"admin_user_123\",\"startStation\":\"Central Station\",\"stationList\":\"Central Station\",\"stations\":[\"Grand Central Terminal\",\"Penn Station\",\"Union Station\",\"Times Square Station\",\"Broadway Station\"]}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"12.5\",\"distances\":[\"25.5\",\"12.0\",\"30.75\",\"8.2\",\"15.3\"],\"endStation\":\"Los Angeles Union Station\",\"id\":\"AR-123456\",\"loginId\":\"admin_user_123\",\"startStation\":\"Central Station\",\"stationList\":\"Central Station\",\"stations\":[\"Grand Central Terminal\",\"Penn Station\",\"Union Station\",\"Times Square Station\",\"Broadway Station\"]}");
                        Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               .statusCode(200)
                               .extract().response();
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"12.5\",\"distances\":[\"25.5\",\"12.0\",\"30.75\",\"8.2\",\"15.3\"],\"endStation\":\"New York Penn Station\",\"id\":\"AR-123456\",\"loginId\":\"admin_user_123\",\"startStation\":\"Central Station\",\"stationList\":\"Central Station\",\"stations\":[\"hangzhou\"]}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"12.5\",\"distances\":[\"25.5\",\"12.0\",\"30.75\",\"8.2\",\"15.3\"],\"endStation\":\"New York Penn Station\",\"id\":\"AR-123456\",\"loginId\":\"admin_user_123\",\"startStation\":\"Central Station\",\"stationList\":\"Central Station\",\"stations\":[\"hangzhou\"]}");
                        Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               .statusCode(200)
                               .extract().response();
    ...
    public void test_POST_1_8() throws Exception {
        // Record test execution for fault detection tracking
        es.us.isa.restest.analysis.FaultDetectionTracker.getInstance()
            .recordTestCase(this.getClass().getName(), "test_POST_1_8");
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"12.5\",\"distances\":[\"25.5\",\"12.0\",\"30.75\",\"8.2\",\"15.3\"],\"endStation\":\"New York Penn Station\",\"id\":\"TS-789012\",\"loginId\":\"admin_user_123\",\"startStation\":\"Central Station\",\"stationList\":\"Main Street Terminal\",\"stations\":[\"wuxi\"]}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"12.5\",\"distances\":[\"25.5\",\"12.0\",\"30.75\",\"8.2\",\"15.3\"],\"endStation\":\"New York Penn Station\",\"id\":\"TS-789012\",\"loginId\":\"admin_user_123\",\"startStation\":\"Central Station\",\"stationList\":\"Main Street Terminal\",\"stations\":[\"wuxi\"]}");
                        Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               .statusCode(200)
                               .extract().response();
                            ...
                            if (faultJson.has("data")) {
                                ...
                                if (dataObj.optBoolean("injected", false)) {
                                    ...
                                    if (!detectedFaultName.isEmpty()) {
                                        ...
                                        System.out.println("🔍 FAULT DETECTED: " + detectedFaultName + " in test: test_POST_1_8");
                                    }
                                }
                            }
                        } catch (Exception faultEx) {
    ...
    public void test_POST_1_9() throws Exception {
        // Record test execution for fault detection tracking
        es.us.isa.restest.analysis.FaultDetectionTracker.getInstance()
            .recordTestCase(this.getClass().getName(), "test_POST_1_9");
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"12.5\",\"distances\":[\"25.5\",\"12.0\",\"30.75\",\"8.2\",\"15.3\"],\"endStation\":\"New York Penn Station\",\"id\":\"ADMIN-345678\",\"loginId\":\"admin_user_123\",\"startStation\":\"Central Station\",\"stationList\":\"Central Station\",\"stations\":[\"Grand Central Terminal\",\"Penn Station\",\"Union Station\",\"Times Square Station\",\"Broadway Station\"]}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"12.5\",\"distances\":[\"25.5\",\"12.0\",\"30.75\",\"8.2\",\"15.3\"],\"endStation\":\"New York Penn Station\",\"id\":\"ADMIN-345678\",\"loginId\":\"admin_user_123\",\"startStation\":\"Central Station\",\"stationList\":\"Central Station\",\"stations\":[\"Grand Central Terminal\",\"Penn Station\",\"Union Station\",\"Times Square Station\",\"Broadway Station\"]}");
                        Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               .statusCode(200)
                               .extract().response();
                            ...
                            if (faultJson.has("data")) {
                                ...
                                if (dataObj.optBoolean("injected", false)) {
                                    ...
                                    if (!detectedFaultName.isEmpty()) {
                                        ...
                                        System.out.println("🔍 FAULT DETECTED: " + detectedFaultName + " in test: test_POST_1_9");
                                    }
                                }
                            }
                        } catch (Exception faultEx) {
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"12.5\",\"distances\":[\"25.5\",\"12.0\",\"30.75\",\"8.2\",\"15.3\"],\"endStation\":\"Chicago Union Station\",\"id\":\"AR-123456\",\"loginId\":\"admin_user_123\",\"startStation\":\"Main Street Terminal\",\"stationList\":\"Central Station\",\"stations\":[\"Grand Central Terminal\",\"Penn Station\",\"Union Station\",\"Times Square Station\",\"Broadway Station\"]}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"12.5\",\"distances\":[\"25.5\",\"12.0\",\"30.75\",\"8.2\",\"15.3\"],\"endStation\":\"Chicago Union Station\",\"id\":\"AR-123456\",\"loginId\":\"admin_user_123\",\"startStation\":\"Main Street Terminal\",\"stationList\":\"Central Station\",\"stations\":[\"Grand Central Terminal\",\"Penn Station\",\"Union Station\",\"Times Square Station\",\"Broadway Station\"]}");
                        Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               .statusCode(200)
                               .extract().response();
    ...
    @Test
    public void test_POST_1_11() throws Exception {
        // Record test execution for fault detection tracking
        es.us.isa.restest.analysis.FaultDetectionTracker.getInstance()
            .recordTestCase(this.getClass().getName(), "test_POST_1_11");
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"12.5\",\"distances\":[\"25.5\",\"12.0\",\"30.75\",\"8.2\",\"15.3\"],\"endStation\":\"New York Penn Station\",\"id\":\"AR-123456\",\"loginId\":\"testadmin001\",\"startStation\":\"Central Station\",\"stationList\":\"Central Station\",\"stations\":[\"Grand Central Terminal\",\"Penn Station\",\"Union Station\",\"Times Square Station\",\"Broadway Station\"]}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"12.5\",\"distances\":[\"25.5\",\"12.0\",\"30.75\",\"8.2\",\"15.3\"],\"endStation\":\"New York Penn Station\",\"id\":\"AR-123456\",\"loginId\":\"testadmin001\",\"startStation\":\"Central Station\",\"stationList\":\"Central Station\",\"stations\":[\"Grand Central Terminal\",\"Penn Station\",\"Union Station\",\"Times Square Station\",\"Broadway Station\"]}");
                        Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               .statusCode(200)
                               .extract().response();
                            ...
                            if (faultJson.has("data")) {
                                ...
                                if (dataObj.optBoolean("injected", false)) {
                                    ...
                                    if (!detectedFaultName.isEmpty()) {
                                        ...
                                        System.out.println("🔍 FAULT DETECTED: " + detectedFaultName + " in test: test_POST_1_11");
                                    }
                                }
                            }
                        } catch (Exception faultEx) {
        ...
        Allure.label("severity", severity);
        Allure.label("feature", "Microservice Workflow");
        Allure.label("story", "test_POST_1_11");
        Allure.description("Microservice test scenario with " + totalSteps + " steps.");
        
        System.out.println("=== SCENARIO RESULT ===");
        System.out.println("Scenario: test_POST_1_11");
        System.out.println("Total Steps: " + totalSteps);
        System.out.println("Successful: " + successfulSteps);
        System.out.println("Failed: " + failedSteps);
        System.out.println("Login Status: " + (loginSucceeded.get() ? "SUCCESS" : "FAILED"));
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"6.2\",\"distances\":[\"25.5\",\"12.0\",\"30.75\",\"8.2\",\"15.3\"],\"endStation\":\"Boston South Station\",\"id\":\"AR-123456\",\"loginId\":\"admin_user_123\",\"startStation\":\"Downtown Plaza\",\"stationList\":\"Central Station\",\"stations\":[\"Grand Central Terminal\",\"Penn Station\",\"Union Station\",\"Times Square Station\",\"Broadway Station\"]}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"6.2\",\"distances\":[\"25.5\",\"12.0\",\"30.75\",\"8.2\",\"15.3\"],\"endStation\":\"Boston South Station\",\"id\":\"AR-123456\",\"loginId\":\"admin_user_123\",\"startStation\":\"Downtown Plaza\",\"stationList\":\"Central Station\",\"stations\":[\"Grand Central Terminal\",\"Penn Station\",\"Union Station\",\"Times Square Station\",\"Broadway Station\"]}");
                        Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               .statusCode(200)
                               .extract().response();
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"12.5\",\"distances\":[\"25.5\",\"12.0\",\"30.75\",\"8.2\",\"15.3\"],\"endStation\":\"New York Penn Station\",\"id\":\"ROUTE-901234\",\"loginId\":\"service_manager\",\"startStation\":\"Central Station\",\"stationList\":\"INVALID_VALUE_MISSING_stationList\",\"stations\":[\"Grand Central Terminal\",\"Penn Station\",\"Union Station\",\"Times Square Station\",\"Broadway Station\"]}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"12.5\",\"distances\":[\"25.5\",\"12.0\",\"30.75\",\"8.2\",\"15.3\"],\"endStation\":\"New York Penn Station\",\"id\":\"ROUTE-901234\",\"loginId\":\"service_manager\",\"startStation\":\"Central Station\",\"stationList\":\"INVALID_VALUE_MISSING_stationList\",\"stations\":[\"Grand Central Terminal\",\"Penn Station\",\"Union Station\",\"Times Square Station\",\"Broadway Station\"]}");
                        Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               // Negative test: expect error code (4XX or 5XX), not success code
                               .statusCode(org.hamcrest.Matchers.greaterThanOrEqualTo(400))
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"INVALID_VALUE_MISSING_distanceList\",\"distances\":[\"25.5\",\"12.0\",\"30.75\",\"8.2\",\"15.3\"],\"endStation\":\"New York Penn Station\",\"id\":\"SYSTEM-567890\",\"loginId\":\"admin_user_123\",\"startStation\":\"Central Station\",\"stationList\":\"Central Station\",\"stations\":[\"shanghai\"]}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"INVALID_VALUE_MISSING_distanceList\",\"distances\":[\"25.5\",\"12.0\",\"30.75\",\"8.2\",\"15.3\"],\"endStation\":\"New York Penn Station\",\"id\":\"SYSTEM-567890\",\"loginId\":\"admin_user_123\",\"startStation\":\"Central Station\",\"stationList\":\"Central Station\",\"stations\":[\"shanghai\"]}");
                        Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               // Negative test: expect error code (4XX or 5XX), not success code
                               .statusCode(org.hamcrest.Matchers.greaterThanOrEqualTo(400))
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"12.5\",\"distances\":[\"25.5\",\"12.0\",\"30.75\",\"8.2\",\"15.3\"],\"endStation\":\"New York Penn Station\",\"id\":\"AR-123456\",\"loginId\":\"sysadmin99\",\"startStation\":\"Northside Depot\",\"stationList\":\"Downtown Plaza\",\"stations\":[\"Grand Central Terminal\",\"Penn Station\",\"Union Station\",\"Times Square Station\",\"Broadway Station\"]}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"12.5\",\"distances\":[\"25.5\",\"12.0\",\"30.75\",\"8.2\",\"15.3\"],\"endStation\":\"New York Penn Station\",\"id\":\"AR-123456\",\"loginId\":\"sysadmin99\",\"startStation\":\"Northside Depot\",\"stationList\":\"Downtown Plaza\",\"stations\":[\"Grand Central Terminal\",\"Penn Station\",\"Union Station\",\"Times Square Station\",\"Broadway Station\"]}");
                        Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               .statusCode(200)
                               .extract().response();
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"12.5\",\"distances\":[\"25.5\",\"12.0\",\"30.75\",\"8.2\",\"15.3\"],\"endStation\":\"Seattle King Street Station\",\"id\":\"AR-123456\",\"loginId\":\"admin_user_123\",\"startStation\":\"Central Station\",\"stationList\":\"North Avenue Stop\",\"stations\":[\"Grand Central Terminal\",\"Penn Station\",\"Union Station\",\"Times Square Station\",\"Broadway Station\"]}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"12.5\",\"distances\":[\"25.5\",\"12.0\",\"30.75\",\"8.2\",\"15.3\"],\"endStation\":\"Seattle King Street Station\",\"id\":\"AR-123456\",\"loginId\":\"admin_user_123\",\"startStation\":\"Central Station\",\"stationList\":\"North Avenue Stop\",\"stations\":[\"Grand Central Terminal\",\"Penn Station\",\"Union Station\",\"Times Square Station\",\"Broadway Station\"]}");
                        Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               .statusCode(200)
                               .extract().response();
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"12.5\",\"distances\":[\"25.5\",\"12.0\",\"30.75\",\"8.2\",\"15.3\"],\"endStation\":\"New York Penn Station\",\"id\":\"AR-123456\",\"loginId\":\"admin_user_123\",\"startStation\":\"Central Station\",\"stationList\":\"Central Station\",\"stations\":[\"Grand Central Terminal\",\"Penn Station\",\"Union Station\",\"Times Square Station\",\"Broadway Station\"]}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"12.5\",\"distances\":[\"25.5\",\"12.0\",\"30.75\",\"8.2\",\"15.3\"],\"endStation\":\"New York Penn Station\",\"id\":\"AR-123456\",\"loginId\":\"admin_user_123\",\"startStation\":\"Central Station\",\"stationList\":\"Central Station\",\"stations\":[\"Grand Central Terminal\",\"Penn Station\",\"Union Station\",\"Times Square Station\",\"Broadway Station\"]}");
                        Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               .statusCode(200)
                               .extract().response();
    ...
    @Test
    public void test_negative_POST_1_18() throws Exception {
        // Record test execution for fault detection tracking
        es.us.isa.restest.analysis.FaultDetectionTracker.getInstance()
            .recordTestCase(this.getClass().getName(), "test_negative_POST_1_18");
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"12.5\",\"distances\":[\"25.5\",\"12.0\",\"30.75\",\"8.2\",\"15.3\"],\"endStation\":\"New York Penn Station\",\"id\":\"AR-123456\",\"loginId\":\"admin_user_123\",\"startStation\":\"INVALID_VALUE_MISSING_startStation\",\"stationList\":\"Central Station\",\"stations\":[\"Grand Central Terminal\",\"Penn Station\",\"Union Station\",\"Times Square Station\",\"Broadway Station\"]}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"12.5\",\"distances\":[\"25.5\",\"12.0\",\"30.75\",\"8.2\",\"15.3\"],\"endStation\":\"New York Penn Station\",\"id\":\"AR-123456\",\"loginId\":\"admin_user_123\",\"startStation\":\"INVALID_VALUE_MISSING_startStation\",\"stationList\":\"Central Station\",\"stations\":[\"Grand Central Terminal\",\"Penn Station\",\"Union Station\",\"Times Square Station\",\"Broadway Station\"]}");
                        Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               // Negative test: expect error code (4XX or 5XX), not success code
                               .statusCode(org.hamcrest.Matchers.greaterThanOrEqualTo(400))
                                ...
                                if (dataObj.optBoolean("injected", false)) {
                                    ...
                                    if (!detectedFaultName.isEmpty()) {
                                        es.us.isa.restest.analysis.FaultDetectionTracker.getInstance().recordDetectedFault(
                                            detectedFaultName,
                                            this.getClass().getName(),
                                            "test_negative_POST_1_18",
                                            System.currentTimeMillis(),
                                            faultCheckBody
                                        );
                                        System.out.println("🔍 FAULT DETECTED: " + detectedFaultName + " in test: test_negative_POST_1_18");
                                    }
                                }
                            }
                        } catch (Exception faultEx) {
        ...
        Allure.label("severity", severity);
        Allure.label("feature", "Microservice Workflow");
        Allure.label("story", "test_negative_POST_1_18");
        Allure.description("Microservice test scenario with " + totalSteps + " steps.");
        
        System.out.println("=== SCENARIO RESULT ===");
        System.out.println("Scenario: test_negative_POST_1_18");
        System.out.println("Total Steps: " + totalSteps);
        System.out.println("Successful: " + successfulSteps);
        System.out.println("Failed: " + failedSteps);
        System.out.println("Login Status: " + (loginSucceeded.get() ? "SUCCESS" : "FAILED"));
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"20.1\",\"distances\":[\"25.5\",\"12.0\",\"30.75\",\"8.2\",\"15.3\"],\"endStation\":\"New York Penn Station\",\"id\":\"123\",\"loginId\":\"admin_user_123\",\"startStation\":\"Central Station\",\"stationList\":\"Central Station\",\"stations\":[\"Grand Central Terminal\",\"Penn Station\",\"Union Station\",\"Times Square Station\",\"Broadway Station\"]}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"20.1\",\"distances\":[\"25.5\",\"12.0\",\"30.75\",\"8.2\",\"15.3\"],\"endStation\":\"New York Penn Station\",\"id\":\"123\",\"loginId\":\"admin_user_123\",\"startStation\":\"Central Station\",\"stationList\":\"Central Station\",\"stations\":[\"Grand Central Terminal\",\"Penn Station\",\"Union Station\",\"Times Square Station\",\"Broadway Station\"]}");
                        Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               // Negative test: expect error code (4XX or 5XX), not success code
                               .statusCode(org.hamcrest.Matchers.greaterThanOrEqualTo(400))
    ...
    @Test
    public void test_negative_POST_1_20() throws Exception {
        // Record test execution for fault detection tracking
        es.us.isa.restest.analysis.FaultDetectionTracker.getInstance()
            .recordTestCase(this.getClass().getName(), "test_negative_POST_1_20");
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"12.5\",\"distances\":[\"25.5\",\"12.0\",\"30.75\",\"8.2\",\"15.3\"],\"endStation\":\"Los Angeles Union Station\",\"id\":\"AR-123456\",\"loginId\":\"admin_user_123\",\"startStation\":\"Central Station\",\"stationList\":\"Central Station\",\"stations\":\"INVALID_VALUE_MISSING_stations\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"12.5\",\"distances\":[\"25.5\",\"12.0\",\"30.75\",\"8.2\",\"15.3\"],\"endStation\":\"Los Angeles Union Station\",\"id\":\"AR-123456\",\"loginId\":\"admin_user_123\",\"startStation\":\"Central Station\",\"stationList\":\"Central Station\",\"stations\":\"INVALID_VALUE_MISSING_stations\"}");
                        Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               // Negative test: expect error code (4XX or 5XX), not success code
                               .statusCode(org.hamcrest.Matchers.greaterThanOrEqualTo(400))
                                ...
                                if (dataObj.optBoolean("injected", false)) {
                                    ...
                                    if (!detectedFaultName.isEmpty()) {
                                        es.us.isa.restest.analysis.FaultDetectionTracker.getInstance().recordDetectedFault(
                                            detectedFaultName,
                                            this.getClass().getName(),
                                            "test_negative_POST_1_20",
                                            System.currentTimeMillis(),
                                            faultCheckBody
                                        );
                                        System.out.println("🔍 FAULT DETECTED: " + detectedFaultName + " in test: test_negative_POST_1_20");
                                    }
                                }
                            }
                        } catch (Exception faultEx) {
        ...
        Allure.label("severity", severity);
        Allure.label("feature", "Microservice Workflow");
        Allure.label("story", "test_negative_POST_1_20");
        Allure.description("Microservice test scenario with " + totalSteps + " steps.");
        
        System.out.println("=== SCENARIO RESULT ===");
        System.out.println("Scenario: test_negative_POST_1_20");
        System.out.println("Total Steps: " + totalSteps);
        System.out.println("Successful: " + successfulSteps);
        System.out.println("Failed: " + failedSteps);
        System.out.println("Login Status: " + (loginSucceeded.get() ? "SUCCESS" : "FAILED"));
    ...
    @Test
    public void test_negative_POST_1_21() throws Exception {
        // Record test execution for fault detection tracking
        es.us.isa.restest.analysis.FaultDetectionTracker.getInstance()
            .recordTestCase(this.getClass().getName(), "test_negative_POST_1_21");
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"12.5\",\"distances\":\"INVALID_VALUE_MISSING_distances\",\"endStation\":\"New York Penn Station\",\"id\":\"TS-789012\",\"loginId\":\"admin_user_123\",\"startStation\":\"Central Station\",\"stationList\":\"Westside Station\",\"stations\":[\"shanghaihongqiao\"]}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"12.5\",\"distances\":\"INVALID_VALUE_MISSING_distances\",\"endStation\":\"New York Penn Station\",\"id\":\"TS-789012\",\"loginId\":\"admin_user_123\",\"startStation\":\"Central Station\",\"stationList\":\"Westside Station\",\"stations\":[\"shanghaihongqiao\"]}");
                        Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               // Negative test: expect error code (4XX or 5XX), not success code
                               .statusCode(org.hamcrest.Matchers.greaterThanOrEqualTo(400))
                                ...
                                if (dataObj.optBoolean("injected", false)) {
                                    ...
                                    if (!detectedFaultName.isEmpty()) {
                                        es.us.isa.restest.analysis.FaultDetectionTracker.getInstance().recordDetectedFault(
                                            detectedFaultName,
                                            this.getClass().getName(),
                                            "test_negative_POST_1_21",
                                            System.currentTimeMillis(),
                                            faultCheckBody
                                        );
                                        System.out.println("🔍 FAULT DETECTED: " + detectedFaultName + " in test: test_negative_POST_1_21");
                                    }
                                }
                            }
                        } catch (Exception faultEx) {
        ...
        Allure.label("severity", severity);
        Allure.label("feature", "Microservice Workflow");
        Allure.label("story", "test_negative_POST_1_21");
        Allure.description("Microservice test scenario with " + totalSteps + " steps.");
        
        System.out.println("=== SCENARIO RESULT ===");
        System.out.println("Scenario: test_negative_POST_1_21");
        System.out.println("Total Steps: " + totalSteps);
        System.out.println("Successful: " + successfulSteps);
        System.out.println("Failed: " + failedSteps);
        System.out.println("Login Status: " + (loginSucceeded.get() ? "SUCCESS" : "FAILED"));
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"12.5\",\"distances\":[\"25.5\",\"12.0\",\"30.75\",\"8.2\",\"15.3\"],\"endStation\":\"INVALID_VALUE_MISSING_endStation\",\"id\":\"AR-123456\",\"loginId\":\"admin_user_123\",\"startStation\":\"Westfield Station\",\"stationList\":\"Central Station\",\"stations\":[\"Grand Central Terminal\",\"Penn Station\",\"Union Station\",\"Times Square Station\",\"Broadway Station\"]}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"12.5\",\"distances\":[\"25.5\",\"12.0\",\"30.75\",\"8.2\",\"15.3\"],\"endStation\":\"INVALID_VALUE_MISSING_endStation\",\"id\":\"AR-123456\",\"loginId\":\"admin_user_123\",\"startStation\":\"Westfield Station\",\"stationList\":\"Central Station\",\"stations\":[\"Grand Central Terminal\",\"Penn Station\",\"Union Station\",\"Times Square Station\",\"Broadway Station\"]}");
                        Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               // Negative test: expect error code (4XX or 5XX), not success code
                               .statusCode(org.hamcrest.Matchers.greaterThanOrEqualTo(400))
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"12.5\",\"distances\":[\"25.5\",\"12.0\",\"30.75\",\"8.2\",\"15.3\"],\"endStation\":\"Chicago Union Station\",\"id\":\"AR-123456\",\"loginId\":\"admin_user_123\",\"startStation\":\"Central Station\",\"stationList\":\"Central Station\",\"stations\":[\"jinan\"]}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"12.5\",\"distances\":[\"25.5\",\"12.0\",\"30.75\",\"8.2\",\"15.3\"],\"endStation\":\"Chicago Union Station\",\"id\":\"AR-123456\",\"loginId\":\"admin_user_123\",\"startStation\":\"Central Station\",\"stationList\":\"Central Station\",\"stations\":[\"jinan\"]}");
                        Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               .statusCode(200)
                               .extract().response();
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"8.3\",\"distances\":[\"25.5\",\"12.0\",\"30.75\",\"8.2\",\"15.3\"],\"endStation\":\"New York Penn Station\",\"id\":\"ADMIN-345678\",\"loginId\":\"admin_user_123\",\"startStation\":\"Central Station\",\"stationList\":\"Central Station\",\"stations\":[\"Grand Central Terminal\",\"Penn Station\",\"Union Station\",\"Times Square Station\",\"Broadway Station\"]}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"8.3\",\"distances\":[\"25.5\",\"12.0\",\"30.75\",\"8.2\",\"15.3\"],\"endStation\":\"New York Penn Station\",\"id\":\"ADMIN-345678\",\"loginId\":\"admin_user_123\",\"startStation\":\"Central Station\",\"stationList\":\"Central Station\",\"stations\":[\"Grand Central Terminal\",\"Penn Station\",\"Union Station\",\"Times Square Station\",\"Broadway Station\"]}");
                        Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               .statusCode(200)
                               .extract().response();
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"15.7\",\"distances\":[\"25.5\",\"12.0\",\"30.75\",\"8.2\",\"15.3\"],\"endStation\":\"New York Penn Station\",\"id\":\"AR-123456\",\"loginId\":\"admin_user_123\",\"startStation\":\"Central Station\",\"stationList\":\"Central Station\",\"stations\":[\"taiyuan\"]}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"15.7\",\"distances\":[\"25.5\",\"12.0\",\"30.75\",\"8.2\",\"15.3\"],\"endStation\":\"New York Penn Station\",\"id\":\"AR-123456\",\"loginId\":\"admin_user_123\",\"startStation\":\"Central Station\",\"stationList\":\"Central Station\",\"stations\":[\"taiyuan\"]}");
                        Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               .statusCode(200)
                               .extract().response();
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"6.2\",\"distances\":[\"25.5\",\"12.0\",\"30.75\",\"8.2\",\"15.3\"],\"endStation\":\"New York Penn Station\",\"id\":\"AR-123456\",\"loginId\":\"user_login_2023\",\"startStation\":\"Central Station\",\"stationList\":\"Main Street Terminal\",\"stations\":[\"Grand Central Terminal\",\"Penn Station\",\"Union Station\",\"Times Square Station\",\"Broadway Station\"]}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"6.2\",\"distances\":[\"25.5\",\"12.0\",\"30.75\",\"8.2\",\"15.3\"],\"endStation\":\"New York Penn Station\",\"id\":\"AR-123456\",\"loginId\":\"user_login_2023\",\"startStation\":\"Central Station\",\"stationList\":\"Main Street Terminal\",\"stations\":[\"Grand Central Terminal\",\"Penn Station\",\"Union Station\",\"Times Square Station\",\"Broadway Station\"]}");
                        Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               .statusCode(200)
                               .extract().response();
    ...
    @Test
    public void test_POST_1_27() throws Exception {
        // Record test execution for fault detection tracking
        es.us.isa.restest.analysis.FaultDetectionTracker.getInstance()
            .recordTestCase(this.getClass().getName(), "test_POST_1_27");
                            ...
                            if (faultJson.has("data")) {
                                ...
                                if (dataObj.optBoolean("injected", false)) {
                                    ...
                                    if (!detectedFaultName.isEmpty()) {
                                        ...
                                        System.out.println("🔍 FAULT DETECTED: " + detectedFaultName + " in test: test_POST_1_27");
                                    }
                                }
                            }
                        } catch (Exception faultEx) {
        ...
        Allure.label("severity", severity);
        Allure.label("feature", "Microservice Workflow");
        Allure.label("story", "test_POST_1_27");
        Allure.description("Microservice test scenario with " + totalSteps + " steps.");
        
        System.out.println("=== SCENARIO RESULT ===");
        System.out.println("Scenario: test_POST_1_27");
        System.out.println("Total Steps: " + totalSteps);
        System.out.println("Successful: " + successfulSteps);
        System.out.println("Failed: " + failedSteps);
        System.out.println("Login Status: " + (loginSucceeded.get() ? "SUCCESS" : "FAILED"));
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"12.5\",\"distances\":[\"25.5\",\"12.0\",\"30.75\",\"8.2\",\"15.3\"],\"endStation\":\"Boston South Station\",\"id\":\"ROUTE-901234\",\"loginId\":\"INVALID_VALUE_MISSING_loginId\",\"startStation\":\"Central Station\",\"stationList\":\"Central Station\",\"stations\":[\"Grand Central Terminal\",\"Penn Station\",\"Union Station\",\"Times Square Station\",\"Broadway Station\"]}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"12.5\",\"distances\":[\"25.5\",\"12.0\",\"30.75\",\"8.2\",\"15.3\"],\"endStation\":\"Boston South Station\",\"id\":\"ROUTE-901234\",\"loginId\":\"INVALID_VALUE_MISSING_loginId\",\"startStation\":\"Central Station\",\"stationList\":\"Central Station\",\"stations\":[\"Grand Central Terminal\",\"Penn Station\",\"Union Station\",\"Times Square Station\",\"Broadway Station\"]}");
                        Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               // Negative test: expect error code (4XX or 5XX), not success code
                               .statusCode(org.hamcrest.Matchers.greaterThanOrEqualTo(400))
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"12.5\",\"distances\":[\"25.5\",\"12.0\",\"30.75\",\"8.2\",\"15.3\"],\"endStation\":\"New York Penn Station\",\"id\":\"SYSTEM-567890\",\"loginId\":\"admin_user_123\",\"startStation\":\"Central Station\",\"stationList\":\"INVALID_VALUE_MISSING_stationList\",\"stations\":[\"Grand Central Terminal\",\"Penn Station\",\"Union Station\",\"Times Square Station\",\"Broadway Station\"]}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"12.5\",\"distances\":[\"25.5\",\"12.0\",\"30.75\",\"8.2\",\"15.3\"],\"endStation\":\"New York Penn Station\",\"id\":\"SYSTEM-567890\",\"loginId\":\"admin_user_123\",\"startStation\":\"Central Station\",\"stationList\":\"INVALID_VALUE_MISSING_stationList\",\"stations\":[\"Grand Central Terminal\",\"Penn Station\",\"Union Station\",\"Times Square Station\",\"Broadway Station\"]}");
                        Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               // Negative test: expect error code (4XX or 5XX), not success code
                               .statusCode(org.hamcrest.Matchers.greaterThanOrEqualTo(400))
