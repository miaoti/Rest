            ...
            Allure.step("Step 1: ts-admin-travel-service DELETE /api/v1/admintravelservice/admintravel/123 (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        Response stepResponse1 = req.when().delete("/api/v1/admintravelservice/admintravel/123")
                               .then().log().ifValidationFails()
                        ...
                        try {
                            ...
                            attachJaegerTrace("ts-admin-travel-service", "DELETE", "/api/v1/admintravelservice/admintravel/123", requestStartMicros, allStepParameters);
                        } catch (Exception e) {
