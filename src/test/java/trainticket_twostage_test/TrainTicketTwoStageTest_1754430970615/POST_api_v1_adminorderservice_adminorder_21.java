            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        String requestBody1 = "{\"accountId\":\"1234567890\",\"boughtDate\":\"2025-04-30 09:14:51\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"123456789\",\"contactsName\":\"John Smith\",\"differenceMoney\":\"100\",\"documentType\":\"1\",\"from\":\"shanghai\",\"id\":\"123\",\"price\":\"0.38,1.0\",\"seatClass\":\"1\",\"seatNumber\":\"Seat Service\",\"status\":\"10\",\"to\":\"JohnDoe\",\"trainNumber\":\"1234567890\",\"travelDate\":\"2024-03-15\",\"travelTime\":\"1440\"}";
            ...
            Allure.step("Step 2: ts-order-other-service POST /api/v1/orderOtherService/orderOther/admin (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "{\"accountId\":\"1234567890\",\"boughtDate\":\"2025-04-30 09:14:51\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"123456789\",\"contactsName\":\"John Smith\",\"documentType\":\"1\",\"from\":\"shanghai\",\"id\":\"123\",\"price\":\"0.38,1.0\",\"seatClass\":\"1\",\"seatNumber\":\"Seat Service\",\"status\":\"10\",\"to\":\"JohnDoe\",\"trainNumber\":\"1234567890\",\"travelDate\":\"2024-03-15\",\"travelTime\":\"1440\"}";
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"1234567890\",\"boughtDate\":\"2023-10-26\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"123456789\",\"contactsName\":\"John Smith\",\"differenceMoney\":\"100\",\"documentType\":\"1\",\"from\":\"shanghai\",\"id\":\"123\",\"price\":\"0.38,1.0\",\"seatClass\":\"1\",\"seatNumber\":\"Seat Service\",\"status\":\"1\",\"to\":\"PDX\",\"trainNumber\":\"1234567890\",\"travelDate\":\"2024-03-15\",\"travelTime\":\"1440\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-order-other-service POST /api/v1/orderOtherService/orderOther/admin (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "{\"accountId\":\"1234567890\",\"boughtDate\":\"2023-10-26\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"123456789\",\"contactsName\":\"John Smith\",\"documentType\":\"1\",\"from\":\"shanghai\",\"id\":\"123\",\"price\":\"0.38,1.0\",\"seatClass\":\"1\",\"seatNumber\":\"Seat Service\",\"status\":\"1\",\"to\":\"PDX\",\"trainNumber\":\"1234567890\",\"travelDate\":\"2024-03-15\",\"travelTime\":\"1440\"}";
                        req = req.body(requestBody2);
