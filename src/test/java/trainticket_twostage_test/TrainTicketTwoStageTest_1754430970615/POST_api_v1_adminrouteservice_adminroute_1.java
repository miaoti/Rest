            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"10\",\"distances\":\"London Victoria\",\"endStation\":\"Grand Central Terminal\",\"id\":\"123\",\"loginId\":\"john.doe123\",\"startStation\":\"Paris\",\"stationList\":\"shanghai,suzhou,taiyuan\",\"stations\":\"Grand Central Terminal\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-station-service POST /api/v1/stationservice/stations/idlist (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "[\"\\\"Grand Central Terminal\\\"\", \"wuxi,shijiazhuang\", \"wuxi,shijiazhuang\"]";
                        req = req.body(requestBody2);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"10\",\"distances\":\"120\",\"endStation\":\"Grand Central Terminal\",\"id\":\"123\",\"loginId\":\"john.doe123\",\"startStation\":\"Paris\",\"stationList\":\"Grand Central Terminal\",\"stations\":\"suzhou,shanghai,taiyuan\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"10\",\"endStation\":\"Grand Central Terminal\",\"id\":\"123\",\"startStation\":\"Paris\",\"stationList\":\"Grand Central Terminal\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 2: ts-station-service POST /api/v1/stationservice/stations/idlist (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "[\"wuxi,shijiazhuang\", \"wuxi,shijiazhuang\", \"\\\"Grand Central Terminal\\\"\"]";
                        req = req.body(requestBody2);
