package trainticket_twostage_test.TrainTicketTwoStageTest_1757289395001;
                            ...
                            if (data.length() > 0) {
                                ...
                                for (int i = 0; i < data.length(); i++) {
                                    ...
                                    if (closestTime < Long.MAX_VALUE) {
                                        if (closestTime < 2000000L) traceScore += 2000; // Within 2 seconds (EXACT execution)
                                        else if (closestTime < 5000000L) traceScore += 1000; // Within 5 seconds (very recent)
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        String requestBody1 = "{\"distanceList\":\"350,1000,1300\",\"distances\":\"[10, 25, 50]\",\"endStation\":\"Grand Central Terminal\",\"id\":\"0b23bd3e-876a-4af3-b920-c50a90c90b04\",\"loginId\":\"4d2a46c7-71cb-4cf1-b5bb-b68406d9da6f\",\"startStation\":\"Grand Central Terminal\",\"stationList\":\"wuxi,shijiazhuang\",\"stations\":\"[\\\"wuxi\\\", \\\"shijiazhuang\\\"]\"}";
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"375\",\"distances\":\"[10, 25, 50]\",\"endStation\":\"Times Square\",\"id\":\"9fc9c261-3263-4bfa-82f8-bb44e06b2f52\",\"loginId\":\"1a2b3c4d-5678\",\"startStation\":\"Union Station\",\"stationList\":\"dallas\",\"stations\":\"[\\\"dallas\\\"]\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"400\",\"distances\":\"[10, 25, 50]\",\"endStation\":\"Grand Central Terminal\",\"id\":\"c4d7e8f9-a1b2-3456-7890-1234567890ab\",\"loginId\":\"98765432-10fe-4567-89ab-cdef01234567\",\"startStation\":\"King Street Station\",\"stationList\":\"suzhou\",\"stations\":\"[\\\"suzhou\\\"]\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"1200\",\"distances\":\"[10, 25, 50]\",\"endStation\":\"Penn Station\",\"id\":\"78901234-5678-9012-3456-7890abcdef12\",\"loginId\":\"f8a9b0c1-d2e3-4f56-7890-1234567890ab\",\"startStation\":\"Grand Central Terminal\",\"stationList\":\"waco\",\"stations\":\"[\\\"waco\\\"]\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"1320\",\"distances\":\"[10, 25, 50]\",\"endStation\":\"Grand Central Terminal\",\"id\":\"f1e2d3c4-b3a2-1098-7654-3210fedcba98\",\"loginId\":\"b7c8d9e0-1f2a-3456-7890-1234567890bc\",\"startStation\":\"Waterloo Station\",\"stationList\":\"shijiazhuang\",\"stations\":\"[\\\"shijiazhuang\\\"]\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"1450\",\"distances\":\"[10, 25, 50]\",\"endStation\":\"Times Square\",\"id\":\"a1b2c3d4-e5f6-7890-1234-567890abcdef\",\"loginId\":\"a1b2c3d4-e5f6-7890-1234-567890abcdef\",\"startStation\":\"Penn Station\",\"stationList\":\"austin\",\"stations\":\"[\\\"austin\\\"]\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"1150\",\"distances\":\"[10, 25, 50]\",\"endStation\":\"Penn Station\",\"id\":\"1a2b3c4d-5678-90\",\"loginId\":\"4d2a46c7-71cb-4cf1-b5bb-b68406d9da6f\",\"startStation\":\"Grand Central Terminal\",\"stationList\":\"wuxi\",\"stations\":\"[\\\"wuxi\\\"]\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"1050\",\"distances\":\"[10, 25, 50]\",\"endStation\":\"Grand Central Terminal\",\"id\":\"0b23bd3e-876a-4af3-b920-c50a90c90b04\",\"loginId\":\"1a2b3c4d-5678\",\"startStation\":\"Grand Central Terminal\",\"stationList\":\"shanghaihongqiao\",\"stations\":\"[\\\"shanghaihongqiao\\\"]\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"1280\",\"distances\":\"[10, 25, 50]\",\"endStation\":\"Times Square\",\"id\":\"9fc9c261-3263-4bfa-82f8-bb44e06b2f52\",\"loginId\":\"98765432-10fe-4567-89ab-cdef01234567\",\"startStation\":\"Union Station\",\"stationList\":\"zhenjiang\",\"stations\":\"[\\\"zhenjiang\\\"]\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"780\",\"distances\":\"[10, 25, 50]\",\"endStation\":\"Penn Station\",\"id\":\"c4d7e8f9-a1b2-3456-7890-1234567890ab\",\"loginId\":\"f8a9b0c1-d2e3-4f56-7890-1234567890ab\",\"startStation\":\"Grand Central Terminal\",\"stationList\":\"jiaxingnan\",\"stations\":\"[\\\"jiaxingnan\\\"]\"}";
                        req = req.body(requestBody1);
