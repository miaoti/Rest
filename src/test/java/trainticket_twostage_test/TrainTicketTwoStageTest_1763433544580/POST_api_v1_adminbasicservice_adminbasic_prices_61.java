...
public class POST_api_v1_adminbasicservice_adminbasic_prices_61 {
            ...
            Allure.step("Step 1: ts-admin-basic-info-service POST /api/v1/adminbasicservice/adminbasic/prices (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        String requestBody1 = "{\"firstClassPriceRate\":125.5,\"id\":\"AR-2025-001\",\"routeId\":\"US-Route-001\",\"trainType\":\"Regional\"}";
                        ...
                        allStepParameters.put("body", "{\"firstClassPriceRate\":125.5,\"id\":\"AR-2025-001\",\"routeId\":\"US-Route-001\",\"trainType\":\"Regional\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/adminbasicservice/adminbasic/prices")
                               .then().log().ifValidationFails()
                               .extract().response();
                        ...
                        try {
                            ...
                            attachJaegerTrace("ts-admin-basic-info-service", "POST", "/api/v1/adminbasicservice/adminbasic/prices", requestStartMicros, allStepParameters, false);
                        } catch (Exception e) {
                        ...
                        // ⏱️ Wait longer for trace propagation to Jaeger (increased delay)
                        try { Thread.sleep(3000); } catch (InterruptedException ie) { Thread.currentThread().interrupt(); }
                        attachJaegerTrace("ts-admin-basic-info-service", "POST", "/api/v1/adminbasicservice/adminbasic/prices", requestStartMicros, allStepParameters, true);
            ...
            Allure.step("Step 1: ts-admin-basic-info-service POST /api/v1/adminbasicservice/adminbasic/prices (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"basicPriceRate\":125.5,\"firstClassPriceRate\":125.5,\"id\":\"nanjing\",\"trainType\":\"Express\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"basicPriceRate\":125.5,\"firstClassPriceRate\":125.5,\"id\":\"nanjing\",\"trainType\":\"Express\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/adminbasicservice/adminbasic/prices")
                               .then().log().ifValidationFails()
                               .extract().response();
            ...
            Allure.step("Step 1: ts-admin-basic-info-service POST /api/v1/adminbasicservice/adminbasic/prices (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"basicPriceRate\":150.75,\"firstClassPriceRate\":125.5,\"id\":\"AR-2025-001\",\"routeId\":\"2c4a6b8d-0e2f-4567-89ab-cdef12345678\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"basicPriceRate\":150.75,\"firstClassPriceRate\":125.5,\"id\":\"AR-2025-001\",\"routeId\":\"2c4a6b8d-0e2f-4567-89ab-cdef12345678\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/adminbasicservice/adminbasic/prices")
                               .then().log().ifValidationFails()
                               .extract().response();
            ...
            Allure.step("Step 1: ts-admin-basic-info-service POST /api/v1/adminbasicservice/adminbasic/prices (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"basicPriceRate\":125.5,\"id\":\"shijiazhuang\",\"routeId\":\"US-Route-001\",\"trainType\":\"High-Speed\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"basicPriceRate\":125.5,\"id\":\"shijiazhuang\",\"routeId\":\"US-Route-001\",\"trainType\":\"High-Speed\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/adminbasicservice/adminbasic/prices")
                               .then().log().ifValidationFails()
                               .extract().response();
    ...
    public void test_negative_POST_61_5() throws Exception {
        ...
        Allure.parameter("🔴 Invalid Parameters", "id=' OR '1'='1");
            ...
            Allure.step("Step 1: ts-admin-basic-info-service POST /api/v1/adminbasicservice/adminbasic/prices (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"basicPriceRate\":125.5,\"firstClassPriceRate\":125.5,\"id\":\"' OR '1'='1\",\"routeId\":\"US-Route-001\",\"trainType\":\"Express\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"basicPriceRate\":125.5,\"firstClassPriceRate\":125.5,\"id\":\"' OR '1'='1\",\"routeId\":\"US-Route-001\",\"trainType\":\"Express\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/adminbasicservice/adminbasic/prices")
                               .then().log().ifValidationFails()
                               .extract().response();
            ...
            Allure.step("Step 1: ts-admin-basic-info-service POST /api/v1/adminbasicservice/adminbasic/prices (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"basicPriceRate\":125.5,\"firstClassPriceRate\":125.5,\"id\":\"AR-2025-001\",\"routeId\":\"US-Route-001\",\"trainType\":\"Intercity\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"basicPriceRate\":125.5,\"firstClassPriceRate\":125.5,\"id\":\"AR-2025-001\",\"routeId\":\"US-Route-001\",\"trainType\":\"Intercity\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/adminbasicservice/adminbasic/prices")
                               .then().log().ifValidationFails()
                               .extract().response();
            ...
            Allure.step("Step 1: ts-admin-basic-info-service POST /api/v1/adminbasicservice/adminbasic/prices (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"basicPriceRate\":125.5,\"firstClassPriceRate\":125.5,\"id\":\"AR-2025-001\",\"routeId\":\"US-Route-001\",\"trainType\":\"Express\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"basicPriceRate\":125.5,\"firstClassPriceRate\":125.5,\"id\":\"AR-2025-001\",\"routeId\":\"US-Route-001\",\"trainType\":\"Express\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/adminbasicservice/adminbasic/prices")
                               .then().log().ifValidationFails()
                               .extract().response();
            ...
            Allure.step("Step 1: ts-admin-basic-info-service POST /api/v1/adminbasicservice/adminbasic/prices (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"basicPriceRate\":125.5,\"firstClassPriceRate\":125.5,\"id\":\"9fc9c261-3263-4bfa-82f8-bb44e06b2f52\",\"routeId\":\"9a8b7c6d-5e4f-32\",\"trainType\":\"Express\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"basicPriceRate\":125.5,\"firstClassPriceRate\":125.5,\"id\":\"9fc9c261-3263-4bfa-82f8-bb44e06b2f52\",\"routeId\":\"9a8b7c6d-5e4f-32\",\"trainType\":\"Express\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/adminbasicservice/adminbasic/prices")
                               .then().log().ifValidationFails()
                               .extract().response();
    ...
    @Test
    public void test_POST_61_9() throws Exception {
        // Record test execution for fault detection tracking
        es.us.isa.restest.analysis.FaultDetectionTracker.getInstance()
            .recordTestCase(this.getClass().getName(), "test_POST_61_9");
            ...
            Allure.step("Step 1: ts-admin-basic-info-service POST /api/v1/adminbasicservice/adminbasic/prices (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"firstClassPriceRate\":89.99,\"id\":\"AR-2025-001\",\"routeId\":\"92708982-77af-4318-be25-57ccb0ff69ad\",\"trainType\":\"Express\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"firstClassPriceRate\":89.99,\"id\":\"AR-2025-001\",\"routeId\":\"92708982-77af-4318-be25-57ccb0ff69ad\",\"trainType\":\"Express\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/adminbasicservice/adminbasic/prices")
                               .then().log().ifValidationFails()
                               .extract().response();
                            ...
                            if (faultJson.has("data")) {
                                ...
                                if (dataObj.optBoolean("injected", false)) {
                                    ...
                                    if (!detectedFaultName.isEmpty()) {
                                        ...
                                        System.out.println("🔍 FAULT DETECTED: " + detectedFaultName + " in test: test_POST_61_9");
                                    }
                                }
                            }
                        } catch (Exception faultEx) {
        ...
        Allure.label("severity", severity);
        Allure.label("feature", "Microservice Workflow");
        Allure.label("story", "test_POST_61_9");
        Allure.description("Microservice test scenario with " + totalSteps + " steps.");
        
        System.out.println("=== SCENARIO RESULT ===");
        System.out.println("Scenario: test_POST_61_9");
        System.out.println("Total Steps: " + totalSteps);
        System.out.println("Successful: " + successfulSteps);
        System.out.println("Failed: " + failedSteps);
        System.out.println("Login Status: " + (loginSucceeded.get() ? "SUCCESS" : "FAILED"));
            ...
            Allure.step("Step 1: ts-admin-basic-info-service POST /api/v1/adminbasicservice/adminbasic/prices (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"basicPriceRate\":125.5,\"firstClassPriceRate\":125.5,\"id\":\"AR-2025-001\",\"routeId\":\"US-Route-001\",\"trainType\":\"Shinkansen\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"basicPriceRate\":125.5,\"firstClassPriceRate\":125.5,\"id\":\"AR-2025-001\",\"routeId\":\"US-Route-001\",\"trainType\":\"Shinkansen\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/adminbasicservice/adminbasic/prices")
                               .then().log().ifValidationFails()
                               .extract().response();
            ...
            Allure.step("Step 1: ts-admin-basic-info-service POST /api/v1/adminbasicservice/adminbasic/prices (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"basicPriceRate\":125.5,\"firstClassPriceRate\":125.5,\"id\":\"AR-2025-001\",\"routeId\":\"US-Route-001\",\"trainType\":\"Regional\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"basicPriceRate\":125.5,\"firstClassPriceRate\":125.5,\"id\":\"AR-2025-001\",\"routeId\":\"US-Route-001\",\"trainType\":\"Regional\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/adminbasicservice/adminbasic/prices")
                               .then().log().ifValidationFails()
                               .extract().response();
            ...
            Allure.step("Step 1: ts-admin-basic-info-service POST /api/v1/adminbasicservice/adminbasic/prices (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"basicPriceRate\":95.25,\"firstClassPriceRate\":125.5,\"id\":\"shanghai\",\"trainType\":\"Express\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"basicPriceRate\":95.25,\"firstClassPriceRate\":125.5,\"id\":\"shanghai\",\"trainType\":\"Express\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/adminbasicservice/adminbasic/prices")
                               .then().log().ifValidationFails()
                               .extract().response();
            ...
            Allure.step("Step 1: ts-admin-basic-info-service POST /api/v1/adminbasicservice/adminbasic/prices (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"basicPriceRate\":125.5,\"firstClassPriceRate\":125.5,\"id\":\"AR-2025-001\",\"routeId\":\"EU-Route-002\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"basicPriceRate\":125.5,\"firstClassPriceRate\":125.5,\"id\":\"AR-2025-001\",\"routeId\":\"EU-Route-002\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/adminbasicservice/adminbasic/prices")
                               .then().log().ifValidationFails()
                               .extract().response();
            ...
            Allure.step("Step 1: ts-admin-basic-info-service POST /api/v1/adminbasicservice/adminbasic/prices (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"basicPriceRate\":125.5,\"firstClassPriceRate\":200.0,\"id\":\"jinan\",\"routeId\":\"AS-Route-003\",\"trainType\":\"Express\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"basicPriceRate\":125.5,\"firstClassPriceRate\":200.0,\"id\":\"jinan\",\"routeId\":\"AS-Route-003\",\"trainType\":\"Express\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/adminbasicservice/adminbasic/prices")
                               .then().log().ifValidationFails()
                               .extract().response();
    ...
    @Test
    public void test_POST_61_16() throws Exception {
        // Record test execution for fault detection tracking
        es.us.isa.restest.analysis.FaultDetectionTracker.getInstance()
            .recordTestCase(this.getClass().getName(), "test_POST_61_16");
            ...
            Allure.step("Step 1: ts-admin-basic-info-service POST /api/v1/adminbasicservice/adminbasic/prices (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"basicPriceRate\":125.5,\"firstClassPriceRate\":150.75,\"id\":\"beijing\",\"routeId\":\"US-Route-001\",\"trainType\":\"Express\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"basicPriceRate\":125.5,\"firstClassPriceRate\":150.75,\"id\":\"beijing\",\"routeId\":\"US-Route-001\",\"trainType\":\"Express\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/adminbasicservice/adminbasic/prices")
                               .then().log().ifValidationFails()
                               .extract().response();
                            ...
                            if (faultJson.has("data")) {
                                ...
                                if (dataObj.optBoolean("injected", false)) {
                                    ...
                                    if (!detectedFaultName.isEmpty()) {
                                        ...
                                        System.out.println("🔍 FAULT DETECTED: " + detectedFaultName + " in test: test_POST_61_16");
                                    }
                                }
                            }
                        } catch (Exception faultEx) {
        ...
        Allure.label("severity", severity);
        Allure.label("feature", "Microservice Workflow");
        Allure.label("story", "test_POST_61_16");
        Allure.description("Microservice test scenario with " + totalSteps + " steps.");
        
        System.out.println("=== SCENARIO RESULT ===");
        System.out.println("Scenario: test_POST_61_16");
        System.out.println("Total Steps: " + totalSteps);
        System.out.println("Successful: " + successfulSteps);
        System.out.println("Failed: " + failedSteps);
        System.out.println("Login Status: " + (loginSucceeded.get() ? "SUCCESS" : "FAILED"));
            ...
            Allure.step("Step 1: ts-admin-basic-info-service POST /api/v1/adminbasicservice/adminbasic/prices (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"basicPriceRate\":125.5,\"id\":\"AR-2025-001\",\"routeId\":\"US-Route-001\",\"trainType\":\"High-Speed\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"basicPriceRate\":125.5,\"id\":\"AR-2025-001\",\"routeId\":\"US-Route-001\",\"trainType\":\"High-Speed\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/adminbasicservice/adminbasic/prices")
                               .then().log().ifValidationFails()
                               .extract().response();
    ...
    @Test
    public void test_negative_POST_61_18() throws Exception {
        // Record test execution for fault detection tracking
        es.us.isa.restest.analysis.FaultDetectionTracker.getInstance()
            .recordTestCase(this.getClass().getName(), "test_negative_POST_61_18");

        // 🚨 NEGATIVE TEST METADATA
        Allure.parameter("🚨 Test Type", "NEGATIVE (Invalid Input Testing)");
        Allure.parameter("🔴 Invalid Parameters", "id=id");
        Allure.description("**⚠️ This is a NEGATIVE test case with intentionally invalid inputs.**\n\n" +
                         "The following parameters were intentionally set to invalid values:\n" +
                         "id=id\n\n" +
                         "This test expects a 4XX or 5XX error response. If it returns 2XX, the test will FAIL.");
            ...
            Allure.step("Step 1: ts-admin-basic-info-service POST /api/v1/adminbasicservice/adminbasic/prices (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"basicPriceRate\":125.5,\"firstClassPriceRate\":125.5,\"id\":\"id\",\"routeId\":\"NA-Route-004\",\"trainType\":\"Express\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"basicPriceRate\":125.5,\"firstClassPriceRate\":125.5,\"id\":\"id\",\"routeId\":\"NA-Route-004\",\"trainType\":\"Express\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/adminbasicservice/adminbasic/prices")
                               .then().log().ifValidationFails()
                               .extract().response();
                                ...
                                if (dataObj.optBoolean("injected", false)) {
                                    ...
                                    if (!detectedFaultName.isEmpty()) {
                                        es.us.isa.restest.analysis.FaultDetectionTracker.getInstance().recordDetectedFault(
                                            detectedFaultName,
                                            this.getClass().getName(),
                                            "test_negative_POST_61_18",
                                            System.currentTimeMillis(),
                                            faultCheckBody
                                        );
                                        System.out.println("🔍 FAULT DETECTED: " + detectedFaultName + " in test: test_negative_POST_61_18");
                                    }
                                }
                            }
                        } catch (Exception faultEx) {
        ...
        Allure.label("severity", severity);
        Allure.label("feature", "Microservice Workflow");
        Allure.label("story", "test_negative_POST_61_18");
        Allure.description("Microservice test scenario with " + totalSteps + " steps.");
        
        System.out.println("=== SCENARIO RESULT ===");
        System.out.println("Scenario: test_negative_POST_61_18");
        System.out.println("Total Steps: " + totalSteps);
        System.out.println("Successful: " + successfulSteps);
        System.out.println("Failed: " + failedSteps);
        System.out.println("Login Status: " + (loginSucceeded.get() ? "SUCCESS" : "FAILED"));
            ...
            Allure.step("Step 1: ts-admin-basic-info-service POST /api/v1/adminbasicservice/adminbasic/prices (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"firstClassPriceRate\":125.5,\"id\":\"AR-2025-001\",\"routeId\":\"US-Route-001\",\"trainType\":\"Intercity\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"firstClassPriceRate\":125.5,\"id\":\"AR-2025-001\",\"routeId\":\"US-Route-001\",\"trainType\":\"Intercity\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/adminbasicservice/adminbasic/prices")
                               .then().log().ifValidationFails()
                               .extract().response();
            ...
            Allure.step("Step 1: ts-admin-basic-info-service POST /api/v1/adminbasicservice/adminbasic/prices (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"basicPriceRate\":125.5,\"firstClassPriceRate\":125.5,\"id\":\"taiyuan\",\"trainType\":\"Express\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"basicPriceRate\":125.5,\"firstClassPriceRate\":125.5,\"id\":\"taiyuan\",\"trainType\":\"Express\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/adminbasicservice/adminbasic/prices")
                               .then().log().ifValidationFails()
                               .extract().response();
    ...
    @Test
    public void test_POST_61_22() throws Exception {
        // Record test execution for fault detection tracking
        es.us.isa.restest.analysis.FaultDetectionTracker.getInstance()
            .recordTestCase(this.getClass().getName(), "test_POST_61_22");
            ...
            Allure.step("Step 1: ts-admin-basic-info-service POST /api/v1/adminbasicservice/adminbasic/prices (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"basicPriceRate\":89.99,\"firstClassPriceRate\":125.5,\"id\":\"AR-2025-001\",\"routeId\":\"US-Route-001\",\"trainType\":\"Shinkansen\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"basicPriceRate\":89.99,\"firstClassPriceRate\":125.5,\"id\":\"AR-2025-001\",\"routeId\":\"US-Route-001\",\"trainType\":\"Shinkansen\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/adminbasicservice/adminbasic/prices")
                               .then().log().ifValidationFails()
                               .extract().response();
                            ...
                            if (faultJson.has("data")) {
                                ...
                                if (dataObj.optBoolean("injected", false)) {
                                    ...
                                    if (!detectedFaultName.isEmpty()) {
                                        ...
                                        System.out.println("🔍 FAULT DETECTED: " + detectedFaultName + " in test: test_POST_61_22");
                                    }
                                }
                            }
                        } catch (Exception faultEx) {
        ...
        Allure.label("severity", severity);
        Allure.label("feature", "Microservice Workflow");
        Allure.label("story", "test_POST_61_22");
        Allure.description("Microservice test scenario with " + totalSteps + " steps.");
        
        System.out.println("=== SCENARIO RESULT ===");
        System.out.println("Scenario: test_POST_61_22");
        System.out.println("Total Steps: " + totalSteps);
        System.out.println("Successful: " + successfulSteps);
        System.out.println("Failed: " + failedSteps);
        System.out.println("Login Status: " + (loginSucceeded.get() ? "SUCCESS" : "FAILED"));
            ...
            Allure.step("Step 1: ts-admin-basic-info-service POST /api/v1/adminbasicservice/adminbasic/prices (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"basicPriceRate\":125.5,\"firstClassPriceRate\":95.25,\"id\":\"AR-2025-001\",\"routeId\":\"US-Route-001\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"basicPriceRate\":125.5,\"firstClassPriceRate\":95.25,\"id\":\"AR-2025-001\",\"routeId\":\"US-Route-001\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/adminbasicservice/adminbasic/prices")
                               .then().log().ifValidationFails()
                               .extract().response();
            ...
            Allure.step("Step 1: ts-admin-basic-info-service POST /api/v1/adminbasicservice/adminbasic/prices (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"basicPriceRate\":200.0,\"firstClassPriceRate\":125.5,\"id\":\"AR-2025-001\",\"routeId\":\"US-Route-001\",\"trainType\":\"Express\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"basicPriceRate\":200.0,\"firstClassPriceRate\":125.5,\"id\":\"AR-2025-001\",\"routeId\":\"US-Route-001\",\"trainType\":\"Express\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/adminbasicservice/adminbasic/prices")
                               .then().log().ifValidationFails()
                               .extract().response();
            ...
            Allure.step("Step 1: ts-admin-basic-info-service POST /api/v1/adminbasicservice/adminbasic/prices (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"basicPriceRate\":125.5,\"id\":\"AR-2025-001\",\"routeId\":\"US-Route-001\",\"trainType\":\"Regional\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"basicPriceRate\":125.5,\"id\":\"AR-2025-001\",\"routeId\":\"US-Route-001\",\"trainType\":\"Regional\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/adminbasicservice/adminbasic/prices")
                               .then().log().ifValidationFails()
                               .extract().response();
    ...
    public void test_negative_POST_61_26() throws Exception {
        ...
        // 🚨 NEGATIVE TEST METADATA
        Allure.parameter("🚨 Test Type", "NEGATIVE (Invalid Input Testing)");
        Allure.parameter("🔴 Invalid Parameters", "id=true");
        Allure.description("**⚠️ This is a NEGATIVE test case with intentionally invalid inputs.**\n\n" +
                         "The following parameters were intentionally set to invalid values:\n" +
                         "id=true\n\n" +
                         "This test expects a 4XX or 5XX error response. If it returns 2XX, the test will FAIL.");
            ...
            Allure.step("Step 1: ts-admin-basic-info-service POST /api/v1/adminbasicservice/adminbasic/prices (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"basicPriceRate\":125.5,\"firstClassPriceRate\":125.5,\"id\":true,\"routeId\":\"US-Route-001\",\"trainType\":\"Express\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"basicPriceRate\":125.5,\"firstClassPriceRate\":125.5,\"id\":true,\"routeId\":\"US-Route-001\",\"trainType\":\"Express\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/adminbasicservice/adminbasic/prices")
                               .then().log().ifValidationFails()
                               .extract().response();
    ...
    @Test
    public void test_POST_61_27() throws Exception {
        // Record test execution for fault detection tracking
        es.us.isa.restest.analysis.FaultDetectionTracker.getInstance()
            .recordTestCase(this.getClass().getName(), "test_POST_61_27");
            ...
            Allure.step("Step 1: ts-admin-basic-info-service POST /api/v1/adminbasicservice/adminbasic/prices (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"basicPriceRate\":150.75,\"firstClassPriceRate\":125.5,\"id\":\"xuzhou\",\"routeId\":\"US-Route-001\",\"trainType\":\"Express\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"basicPriceRate\":150.75,\"firstClassPriceRate\":125.5,\"id\":\"xuzhou\",\"routeId\":\"US-Route-001\",\"trainType\":\"Express\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/adminbasicservice/adminbasic/prices")
                               .then().log().ifValidationFails()
                               .extract().response();
                            ...
                            if (faultJson.has("data")) {
                                ...
                                if (dataObj.optBoolean("injected", false)) {
                                    ...
                                    if (!detectedFaultName.isEmpty()) {
                                        ...
                                        System.out.println("🔍 FAULT DETECTED: " + detectedFaultName + " in test: test_POST_61_27");
                                    }
                                }
                            }
                        } catch (Exception faultEx) {
        ...
        Allure.label("severity", severity);
        Allure.label("feature", "Microservice Workflow");
        Allure.label("story", "test_POST_61_27");
        Allure.description("Microservice test scenario with " + totalSteps + " steps.");
        
        System.out.println("=== SCENARIO RESULT ===");
        System.out.println("Scenario: test_POST_61_27");
        System.out.println("Total Steps: " + totalSteps);
        System.out.println("Successful: " + successfulSteps);
        System.out.println("Failed: " + failedSteps);
        System.out.println("Login Status: " + (loginSucceeded.get() ? "SUCCESS" : "FAILED"));
            ...
            Allure.step("Step 1: ts-admin-basic-info-service POST /api/v1/adminbasicservice/adminbasic/prices (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"basicPriceRate\":125.5,\"firstClassPriceRate\":125.5,\"id\":\"AR-2025-001\",\"routeId\":\"US-Route-001\",\"trainType\":\"High-Speed\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"basicPriceRate\":125.5,\"firstClassPriceRate\":125.5,\"id\":\"AR-2025-001\",\"routeId\":\"US-Route-001\",\"trainType\":\"High-Speed\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/adminbasicservice/adminbasic/prices")
                               .then().log().ifValidationFails()
                               .extract().response();
    ...
    @Test
    public void test_POST_61_30() throws Exception {
        // Record test execution for fault detection tracking
        es.us.isa.restest.analysis.FaultDetectionTracker.getInstance()
            .recordTestCase(this.getClass().getName(), "test_POST_61_30");
            ...
            Allure.step("Step 1: ts-admin-basic-info-service POST /api/v1/adminbasicservice/adminbasic/prices (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"basicPriceRate\":125.5,\"firstClassPriceRate\":89.99,\"id\":\"f8a1b2c3-d4e5-4f6a-7b8c-9d0e1f2a3b4c\",\"routeId\":\"SA-Route-005\",\"trainType\":\"Express\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"basicPriceRate\":125.5,\"firstClassPriceRate\":89.99,\"id\":\"f8a1b2c3-d4e5-4f6a-7b8c-9d0e1f2a3b4c\",\"routeId\":\"SA-Route-005\",\"trainType\":\"Express\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/adminbasicservice/adminbasic/prices")
                               .then().log().ifValidationFails()
                               .extract().response();
                            ...
                            if (faultJson.has("data")) {
                                ...
                                if (dataObj.optBoolean("injected", false)) {
                                    ...
                                    if (!detectedFaultName.isEmpty()) {
                                        ...
                                        System.out.println("🔍 FAULT DETECTED: " + detectedFaultName + " in test: test_POST_61_30");
                                    }
                                }
                            }
                        } catch (Exception faultEx) {
        ...
        Allure.label("severity", severity);
        Allure.label("feature", "Microservice Workflow");
        Allure.label("story", "test_POST_61_30");
        Allure.description("Microservice test scenario with " + totalSteps + " steps.");
        
        System.out.println("=== SCENARIO RESULT ===");
        System.out.println("Scenario: test_POST_61_30");
        System.out.println("Total Steps: " + totalSteps);
        System.out.println("Successful: " + successfulSteps);
        System.out.println("Failed: " + failedSteps);
        System.out.println("Login Status: " + (loginSucceeded.get() ? "SUCCESS" : "FAILED"));
