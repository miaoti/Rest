package trainticket_twostage_test.TrainTicketTwoStageTest_1763433544580;
...
public class POST_api_v1_adminorderservice_adminorder_31 {
    ...
    @Test
    public void test_negative_POST_31_1() throws Exception {
        // Record test execution for fault detection tracking
        es.us.isa.restest.analysis.FaultDetectionTracker.getInstance()
            .recordTestCase(this.getClass().getName(), "test_negative_POST_31_1");
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        String requestBody1 = "{\"accountId\":\"acc-2345\",\"boughtDate\":\"2024-01-20\",\"coachNumber\":12,\"contactsDocumentNumber\":\"AB1234567\",\"contactsName\":\"John Smith\",\"differenceMoney\":\"150.00\",\"documentType\":1,\"from\":\"Beijing\",\"id\":\"AR-2025-001\",\"price\":\"1299.99\",\"seatClass\":1,\"seatNumber\":\"12A\",\"status\":1,\"to\":\"Beijing\",\"trainNumber\":\"G1234\",\"travelDate\":\"2025-12-15\",\"travelTime\":123}";
                        ...
                        allStepParameters.put("body", "{\"accountId\":\"acc-2345\",\"boughtDate\":\"2024-01-20\",\"coachNumber\":12,\"contactsDocumentNumber\":\"AB1234567\",\"contactsName\":\"John Smith\",\"differenceMoney\":\"150.00\",\"documentType\":1,\"from\":\"Beijing\",\"id\":\"AR-2025-001\",\"price\":\"1299.99\",\"seatClass\":1,\"seatNumber\":\"12A\",\"status\":1,\"to\":\"Beijing\",\"trainNumber\":\"G1234\",\"travelDate\":\"2025-12-15\",\"travelTime\":123}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/adminorderservice/adminorder")
                               .then().log().ifValidationFails()
                               .extract().response();
                                ...
                                if (dataObj.optBoolean("injected", false)) {
                                    ...
                                    if (!detectedFaultName.isEmpty()) {
                                        es.us.isa.restest.analysis.FaultDetectionTracker.getInstance().recordDetectedFault(
                                            ...
                                            "test_negative_POST_31_1",
                                            System.currentTimeMillis(),
                                            faultCheckBody
                                        );
                                        System.out.println("🔍 FAULT DETECTED: " + detectedFaultName + " in test: test_negative_POST_31_1");
                                    }
                                }
                            }
                        ...
                        try {
                            ...
                            attachJaegerTrace("ts-admin-order-service", "POST", "/api/v1/adminorderservice/adminorder", requestStartMicros, allStepParameters, false);
                        } catch (Exception e) {
                        ...
                        // ⏱️ Wait longer for trace propagation to Jaeger (increased delay)
                        try { Thread.sleep(3000); } catch (InterruptedException ie) { Thread.currentThread().interrupt(); }
                        attachJaegerTrace("ts-admin-order-service", "POST", "/api/v1/adminorderservice/adminorder", requestStartMicros, allStepParameters, true);
        ...
        Allure.label("story", "test_negative_POST_31_1");
        Allure.description("Microservice test scenario with " + totalSteps + " steps.");
        
        System.out.println("=== SCENARIO RESULT ===");
        System.out.println("Scenario: test_negative_POST_31_1");
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"acc-7890\",\"boughtDate\":\"2024-02-20\",\"coachNumber\":12,\"contactsDocumentNumber\":\"AB1234567\",\"contactsName\":\"John Smith\",\"differenceMoney\":\"300.00\",\"documentType\":\"abc\",\"from\":\"Beijing\",\"id\":\"AR-2025-001\",\"price\":\"1299.99\",\"seatClass\":1,\"seatNumber\":\"12A\",\"status\":2,\"to\":\"Beijing\",\"trainNumber\":\"G1234\",\"travelDate\":\"2025-11-20\",\"travelTime\":\"14:15\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"accountId\":\"acc-7890\",\"boughtDate\":\"2024-02-20\",\"coachNumber\":12,\"contactsDocumentNumber\":\"AB1234567\",\"contactsName\":\"John Smith\",\"differenceMoney\":\"300.00\",\"documentType\":\"abc\",\"from\":\"Beijing\",\"id\":\"AR-2025-001\",\"price\":\"1299.99\",\"seatClass\":1,\"seatNumber\":\"12A\",\"status\":2,\"to\":\"Beijing\",\"trainNumber\":\"G1234\",\"travelDate\":\"2025-11-20\",\"travelTime\":\"14:15\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/adminorderservice/adminorder")
                               .then().log().ifValidationFails()
                               .extract().response();
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"acc-7890\",\"boughtDate\":\"2025-11-20\",\"coachNumber\":12,\"contactsDocumentNumber\":\"AB1234567\",\"contactsName\":\"John Smith\",\"differenceMoney\":\"150.00\",\"documentType\":5,\"from\":\"Shanghai\",\"id\":\"AR-2025-001\",\"price\":\"1299.99\",\"seatClass\":1,\"seatNumber\":\"12A\",\"status\":3,\"to\":\"Beijing\",\"trainNumber\":\"G1234\",\"travelDate\":\"2026-01-10\",\"travelTime\":\"08:30\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"acc-7890\",\"boughtDate\":\"2025-11-20\",\"coachNumber\":12,\"contactsDocumentNumber\":123,\"contactsName\":\"Emily Davis\",\"differenceMoney\":\"150.00\",\"documentType\":1,\"from\":\"Beijing\",\"id\":\"AR-2025-001\",\"price\":\"1299.99\",\"seatClass\":4,\"seatNumber\":\"12A\",\"status\":1,\"to\":\"Beijing\",\"trainNumber\":\"G1234\",\"travelDate\":\"2025-11-20\",\"travelTime\":\"08:30\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"acc-7890\",\"boughtDate\":\"2025-11-20\",\"coachNumber\":12,\"contactsDocumentNumber\":\"DocumentNumber_Ten\",\"contactsName\":123,\"differenceMoney\":\"-25.50\",\"documentType\":1,\"from\":\"Beijing\",\"id\":\"AR-2025-001\",\"price\":\"1299.99\",\"seatClass\":1,\"seatNumber\":\"3E\",\"status\":1,\"to\":\"Beijing\",\"trainNumber\":\"G1234\",\"travelDate\":\"2025-11-28\",\"travelTime\":\"08:30\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"acc-7890\",\"boughtDate\":\"2025-11-20\",\"coachNumber\":12,\"contactsDocumentNumber\":\"AB1234567\",\"contactsName\":\"John Smith\",\"differenceMoney\":\"0.00\",\"documentType\":2,\"from\":\"Beijing\",\"id\":\"AR-2025-001\",\"price\":\"1299.99\",\"seatClass\":1,\"seatNumber\":\"12A\",\"status\":1,\"to\":\"Beijing\",\"trainNumber\":\"D5678\",\"travelDate\":\"2025-11-20\",\"travelTime\":\"08:30\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"acc-7890\",\"boughtDate\":\"2024-01-30\",\"coachNumber\":12,\"contactsDocumentNumber\":\"AB1234567\",\"contactsName\":\"John Smith\",\"differenceMoney\":123,\"documentType\":1,\"from\":\"Beijing\",\"id\":\"AR-2025-001\",\"price\":\"8.0\",\"seatClass\":1,\"seatNumber\":\"12A\",\"status\":1,\"to\":\"Beijing\",\"trainNumber\":\"G1234\",\"travelDate\":\"2025-11-20\",\"travelTime\":\"08:30\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"acc-7890\",\"boughtDate\":\"2025-11-20\",\"coachNumber\":3,\"contactsDocumentNumber\":\"AB1234567\",\"contactsName\":\"John Smith\",\"differenceMoney\":\"75.25\",\"documentType\":3,\"from\":\"Beijing\",\"id\":\"AR-2025-001\",\"price\":\"1299.99\",\"seatClass\":1,\"seatNumber\":\"12A\",\"status\":4,\"to\":\"Beijing\",\"trainNumber\":\"C9012\",\"travelDate\":\"2025-11-20\",\"travelTime\":\"08:30\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"acc-7890\",\"boughtDate\":\"2025-11-20\",\"coachNumber\":25,\"contactsDocumentNumber\":\"AB1234567\",\"contactsName\":\"John Smith\",\"differenceMoney\":\"150.00\",\"documentType\":4,\"from\":\"Beijing\",\"id\":\"AR-2025-001\",\"price\":\"850.50\",\"seatClass\":1,\"seatNumber\":123,\"status\":5,\"to\":\"Beijing\",\"trainNumber\":\"G1234\",\"travelDate\":\"2025-11-20\",\"travelTime\":\"22:45\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"acc-3456\",\"boughtDate\":\"2025-11-20\",\"coachNumber\":8,\"contactsDocumentNumber\":\"AB1234567\",\"contactsName\":\"John Smith\",\"differenceMoney\":\"150.00\",\"documentType\":1,\"from\":\"Beijing\",\"id\":\"AR-2025-001\",\"price\":\"1299.99\",\"seatClass\":1,\"seatNumber\":\"12A\",\"status\":1,\"to\":\"Shanghai\",\"trainNumber\":\"G1234\",\"travelDate\":\"2025-11-20\",\"travelTime\":\"10:20\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"accountId\":\"acc-3456\",\"boughtDate\":\"2025-11-20\",\"coachNumber\":8,\"contactsDocumentNumber\":\"AB1234567\",\"contactsName\":\"John Smith\",\"differenceMoney\":\"150.00\",\"documentType\":1,\"from\":\"Beijing\",\"id\":\"AR-2025-001\",\"price\":\"1299.99\",\"seatClass\":1,\"seatNumber\":\"12A\",\"status\":1,\"to\":\"Shanghai\",\"trainNumber\":\"G1234\",\"travelDate\":\"2025-11-20\",\"travelTime\":\"10:20\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/adminorderservice/adminorder")
                               .then().log().ifValidationFails()
                               .extract().response();
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"acc-7890\",\"boughtDate\":\"2025-11-20\",\"coachNumber\":12,\"contactsDocumentNumber\":\"AB1234567\",\"contactsName\":\"John Smith\",\"differenceMoney\":\"150.00\",\"documentType\":1,\"from\":\"Guangzhou\",\"id\":\"AR-2025-001\",\"price\":\"1299.99\",\"seatClass\":1,\"seatNumber\":\"25B\",\"status\":1,\"to\":\"Beijing\",\"trainNumber\":\"G1234\",\"travelDate\":\"2026-02-05\",\"travelTime\":\"08:30\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":123,\"boughtDate\":\"2025-11-20\",\"coachNumber\":12,\"contactsDocumentNumber\":\"AB1234567\",\"contactsName\":\"John Smith\",\"differenceMoney\":\"300.00\",\"documentType\":1,\"from\":\"Shenzhen\",\"id\":\"AR-2025-001\",\"price\":\"1299.99\",\"seatClass\":1,\"seatNumber\":\"12A\",\"status\":1,\"to\":\"Guangzhou\",\"trainNumber\":\"G1234\",\"travelDate\":\"2025-11-20\",\"travelTime\":\"18:00\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"accountId\":123,\"boughtDate\":\"2025-11-20\",\"coachNumber\":12,\"contactsDocumentNumber\":\"AB1234567\",\"contactsName\":\"John Smith\",\"differenceMoney\":\"300.00\",\"documentType\":1,\"from\":\"Shenzhen\",\"id\":\"AR-2025-001\",\"price\":\"1299.99\",\"seatClass\":1,\"seatNumber\":\"12A\",\"status\":1,\"to\":\"Guangzhou\",\"trainNumber\":\"G1234\",\"travelDate\":\"2025-11-20\",\"travelTime\":\"18:00\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/adminorderservice/adminorder")
                               .then().log().ifValidationFails()
                               .extract().response();
    ...
    @Test
    public void test_negative_POST_31_13() throws Exception {
        // Record test execution for fault detection tracking
        es.us.isa.restest.analysis.FaultDetectionTracker.getInstance()
            .recordTestCase(this.getClass().getName(), "test_negative_POST_31_13");
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"acc-1234\",\"boughtDate\":\"2025-11-20\",\"coachNumber\":\"abc\",\"contactsDocumentNumber\":\"AB1234567\",\"contactsName\":\"Michael Wilson\",\"differenceMoney\":\"150.00\",\"documentType\":1,\"from\":\"Beijing\",\"id\":\"AR-2025-001\",\"price\":\"2100.00\",\"seatClass\":1,\"seatNumber\":\"8C\",\"status\":1,\"to\":\"Beijing\",\"trainNumber\":\"G1234\",\"travelDate\":\"2025-11-20\",\"travelTime\":\"08:30\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"accountId\":\"acc-1234\",\"boughtDate\":\"2025-11-20\",\"coachNumber\":\"abc\",\"contactsDocumentNumber\":\"AB1234567\",\"contactsName\":\"Michael Wilson\",\"differenceMoney\":\"150.00\",\"documentType\":1,\"from\":\"Beijing\",\"id\":\"AR-2025-001\",\"price\":\"2100.00\",\"seatClass\":1,\"seatNumber\":\"8C\",\"status\":1,\"to\":\"Beijing\",\"trainNumber\":\"G1234\",\"travelDate\":\"2025-11-20\",\"travelTime\":\"08:30\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/adminorderservice/adminorder")
                               .then().log().ifValidationFails()
                               .extract().response();
                                ...
                                if (dataObj.optBoolean("injected", false)) {
                                    ...
                                    if (!detectedFaultName.isEmpty()) {
                                        es.us.isa.restest.analysis.FaultDetectionTracker.getInstance().recordDetectedFault(
                                            detectedFaultName,
                                            this.getClass().getName(),
                                            "test_negative_POST_31_13",
                                            System.currentTimeMillis(),
                                            faultCheckBody
                                        );
                                        System.out.println("🔍 FAULT DETECTED: " + detectedFaultName + " in test: test_negative_POST_31_13");
                                    }
                                }
                            }
                        } catch (Exception faultEx) {
        ...
        Allure.label("severity", severity);
        Allure.label("feature", "Microservice Workflow");
        Allure.label("story", "test_negative_POST_31_13");
        Allure.description("Microservice test scenario with " + totalSteps + " steps.");
        
        System.out.println("=== SCENARIO RESULT ===");
        System.out.println("Scenario: test_negative_POST_31_13");
        System.out.println("Total Steps: " + totalSteps);
        System.out.println("Successful: " + successfulSteps);
        System.out.println("Failed: " + failedSteps);
        System.out.println("Login Status: " + (loginSucceeded.get() ? "SUCCESS" : "FAILED"));
    ...
    public void test_negative_POST_31_14() throws Exception {
        ...
        // 🚨 NEGATIVE TEST METADATA
        Allure.parameter("🚨 Test Type", "NEGATIVE (Invalid Input Testing)");
        Allure.parameter("🔴 Invalid Parameters", "travelDate=123456");
        Allure.description("**⚠️ This is a NEGATIVE test case with intentionally invalid inputs.**\n\n" +
                         "The following parameters were intentionally set to invalid values:\n" +
                         "travelDate=123456\n\n" +
                         "This test expects a 4XX or 5XX error response. If it returns 2XX, the test will FAIL.");
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"acc-5678\",\"boughtDate\":\"2025-11-20\",\"coachNumber\":16,\"contactsDocumentNumber\":\"AB1234567\",\"contactsName\":\"John Smith\",\"differenceMoney\":\"150.00\",\"documentType\":5,\"from\":\"Beijing\",\"id\":\"AR-2025-001\",\"price\":\"599.99\",\"seatClass\":5,\"seatNumber\":\"16D\",\"status\":1,\"to\":\"Beijing\",\"trainNumber\":\"T3456\",\"travelDate\":123456,\"travelTime\":\"08:30\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"accountId\":\"acc-5678\",\"boughtDate\":\"2025-11-20\",\"coachNumber\":16,\"contactsDocumentNumber\":\"AB1234567\",\"contactsName\":\"John Smith\",\"differenceMoney\":\"150.00\",\"documentType\":5,\"from\":\"Beijing\",\"id\":\"AR-2025-001\",\"price\":\"599.99\",\"seatClass\":5,\"seatNumber\":\"16D\",\"status\":1,\"to\":\"Beijing\",\"trainNumber\":\"T3456\",\"travelDate\":123456,\"travelTime\":\"08:30\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/adminorderservice/adminorder")
                               .then().log().ifValidationFails()
                               .extract().response();
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"acc-2345\",\"boughtDate\":\"2025-11-20\",\"coachNumber\":12,\"contactsDocumentNumber\":\"AB1234567\",\"contactsName\":\"John Smith\",\"differenceMoney\":\"150.00\",\"documentType\":1,\"from\":\"Hangzhou\",\"id\":\"AR-2025-001\",\"price\":\"1299.99\",\"seatClass\":1,\"seatNumber\":\"3E\",\"status\":1,\"to\":\"Beijing\",\"trainNumber\":\"G1234\",\"travelDate\":\"2025-11-20\",\"travelTime\":\"08:30\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"accountId\":\"acc-2345\",\"boughtDate\":\"2025-11-20\",\"coachNumber\":12,\"contactsDocumentNumber\":\"AB1234567\",\"contactsName\":\"John Smith\",\"differenceMoney\":\"150.00\",\"documentType\":1,\"from\":\"Hangzhou\",\"id\":\"AR-2025-001\",\"price\":\"1299.99\",\"seatClass\":1,\"seatNumber\":\"3E\",\"status\":1,\"to\":\"Beijing\",\"trainNumber\":\"G1234\",\"travelDate\":\"2025-11-20\",\"travelTime\":\"08:30\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/adminorderservice/adminorder")
                               .then().log().ifValidationFails()
                               .extract().response();
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"acc-7890\",\"boughtDate\":\"2025-11-20\",\"coachNumber\":12,\"contactsDocumentNumber\":\"AB1234567\",\"contactsName\":\"John Smith\",\"differenceMoney\":\"150.00\",\"documentType\":1,\"from\":\"Beijing\",\"id\":\"AR-2025-001\",\"price\":\"1650.75\",\"seatClass\":1,\"seatNumber\":\"12A\",\"status\":1,\"to\":\"Beijing\",\"trainNumber\":\"E7890\",\"travelDate\":\"2025-11-20\",\"travelTime\":\"08:30\"}";
                        req = req.body(requestBody1);
    ...
    public void test_negative_POST_31_17() throws Exception {
        ...
        // 🚨 NEGATIVE TEST METADATA
        Allure.parameter("🚨 Test Type", "NEGATIVE (Invalid Input Testing)");
        Allure.parameter("🔴 Invalid Parameters", "boughtDate=123456789");
        Allure.description("**⚠️ This is a NEGATIVE test case with intentionally invalid inputs.**\n\n" +
                         "The following parameters were intentionally set to invalid values:\n" +
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"acc-3456\",\"boughtDate\":123456789,\"coachNumber\":12,\"contactsDocumentNumber\":\"DocumentNumber_Four\",\"contactsName\":\"Maria Garcia\",\"differenceMoney\":\"150.00\",\"documentType\":1,\"from\":\"Beijing\",\"id\":\"AR-2025-001\",\"price\":\"2.0\",\"seatClass\":6,\"seatNumber\":\"12A\",\"status\":1,\"to\":\"Beijing\",\"trainNumber\":\"G1234\",\"travelDate\":\"2025-11-20\",\"travelTime\":\"08:30\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"accountId\":\"acc-3456\",\"boughtDate\":123456789,\"coachNumber\":12,\"contactsDocumentNumber\":\"DocumentNumber_Four\",\"contactsName\":\"Maria Garcia\",\"differenceMoney\":\"150.00\",\"documentType\":1,\"from\":\"Beijing\",\"id\":\"AR-2025-001\",\"price\":\"2.0\",\"seatClass\":6,\"seatNumber\":\"12A\",\"status\":1,\"to\":\"Beijing\",\"trainNumber\":\"G1234\",\"travelDate\":\"2025-11-20\",\"travelTime\":\"08:30\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/adminorderservice/adminorder")
                               .then().log().ifValidationFails()
                               .extract().response();
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"acc-7890\",\"boughtDate\":\"2025-11-20\",\"coachNumber\":12,\"contactsDocumentNumber\":\"AB1234567\",\"contactsName\":\"Robert Johnson\",\"differenceMoney\":\"150.00\",\"documentType\":1,\"from\":\"Beijing\",\"id\":\"TS-789456\",\"price\":\"1299.99\",\"seatClass\":7,\"seatNumber\":\"12A\",\"status\":1,\"to\":\"Beijing\",\"trainNumber\":\"G1234\",\"travelDate\":\"2025-12-15\",\"travelTime\":\"08:30\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"acc-7890\",\"boughtDate\":\"2025-11-20\",\"coachNumber\":12,\"contactsDocumentNumber\":\"DocumentNumber_Seven\",\"contactsName\":\"John Smith\",\"differenceMoney\":\"-25.50\",\"documentType\":1,\"from\":\"Beijing\",\"id\":\"ADMIN-000123\",\"price\":123,\"seatClass\":1,\"seatNumber\":\"12A\",\"status\":2,\"to\":\"Beijing\",\"trainNumber\":\"G1234\",\"travelDate\":\"2025-11-20\",\"travelTime\":\"08:30\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"acc-1234\",\"boughtDate\":\"2025-11-20\",\"coachNumber\":12,\"contactsDocumentNumber\":\"AB1234567\",\"contactsName\":\"Emily Davis\",\"differenceMoney\":\"150.00\",\"documentType\":1,\"from\":\"Beijing\",\"id\":\"ROUTE-456789\",\"price\":\"4.0\",\"seatClass\":1,\"seatNumber\":\"25B\",\"status\":1,\"to\":\"Beijing\",\"trainNumber\":\"G1234\",\"travelDate\":\"2025-11-20\",\"travelTime\":\"08:30\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"accountId\":\"acc-1234\",\"boughtDate\":\"2025-11-20\",\"coachNumber\":12,\"contactsDocumentNumber\":\"AB1234567\",\"contactsName\":\"Emily Davis\",\"differenceMoney\":\"150.00\",\"documentType\":1,\"from\":\"Beijing\",\"id\":\"ROUTE-456789\",\"price\":\"4.0\",\"seatClass\":1,\"seatNumber\":\"25B\",\"status\":1,\"to\":\"Beijing\",\"trainNumber\":\"G1234\",\"travelDate\":\"2025-11-20\",\"travelTime\":\"08:30\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/adminorderservice/adminorder")
                               .then().log().ifValidationFails()
                               .extract().response();
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"acc-7890\",\"boughtDate\":\"2025-11-20\",\"coachNumber\":12,\"contactsDocumentNumber\":\"AB1234567\",\"contactsName\":\"Michael Wilson\",\"differenceMoney\":\"0.00\",\"documentType\":1,\"from\":\"Beijing\",\"id\":\"AR-2025-001\",\"price\":\"1299.99\",\"seatClass\":8,\"seatNumber\":\"12A\",\"status\":1,\"to\":\"Beijing\",\"trainNumber\":\"G1234\",\"travelDate\":\"2025-11-20\",\"travelTime\":\"08:30\"}";
                        req = req.body(requestBody1);
    ...
    @Test
    public void test_negative_POST_31_22() throws Exception {
        // Record test execution for fault detection tracking
        es.us.isa.restest.analysis.FaultDetectionTracker.getInstance()
            .recordTestCase(this.getClass().getName(), "test_negative_POST_31_22");
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"acc-7890\",\"boughtDate\":\"2024-03-10\",\"coachNumber\":12,\"contactsDocumentNumber\":\"AB1234567\",\"contactsName\":\"John Smith\",\"differenceMoney\":\"75.25\",\"documentType\":2,\"from\":\"Shanghai\",\"id\":\"AR-2025-001\",\"price\":\"16.0\",\"seatClass\":\"abc\",\"seatNumber\":\"12A\",\"status\":1,\"to\":\"Beijing\",\"trainNumber\":\"D5678\",\"travelDate\":\"2025-11-20\",\"travelTime\":\"08:30\"}";
                        req = req.body(requestBody1);
                                ...
                                if (dataObj.optBoolean("injected", false)) {
                                    ...
                                    if (!detectedFaultName.isEmpty()) {
                                        es.us.isa.restest.analysis.FaultDetectionTracker.getInstance().recordDetectedFault(
                                            detectedFaultName,
                                            this.getClass().getName(),
                                            "test_negative_POST_31_22",
                                            System.currentTimeMillis(),
                                            faultCheckBody
                                        );
                                        System.out.println("🔍 FAULT DETECTED: " + detectedFaultName + " in test: test_negative_POST_31_22");
                                    }
                                }
                            }
                        } catch (Exception faultEx) {
        ...
        Allure.label("severity", severity);
        Allure.label("feature", "Microservice Workflow");
        Allure.label("story", "test_negative_POST_31_22");
        Allure.description("Microservice test scenario with " + totalSteps + " steps.");
        
        System.out.println("=== SCENARIO RESULT ===");
        System.out.println("Scenario: test_negative_POST_31_22");
        System.out.println("Total Steps: " + totalSteps);
        System.out.println("Successful: " + successfulSteps);
        System.out.println("Failed: " + failedSteps);
        System.out.println("Login Status: " + (loginSucceeded.get() ? "SUCCESS" : "FAILED"));
    ...
    @Test
    public void test_POST_31_23() throws Exception {
        // Record test execution for fault detection tracking
        es.us.isa.restest.analysis.FaultDetectionTracker.getInstance()
            .recordTestCase(this.getClass().getName(), "test_POST_31_23");
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"acc-5678\",\"boughtDate\":\"2025-11-20\",\"coachNumber\":12,\"contactsDocumentNumber\":\"DocumentNumber_Three\",\"contactsName\":\"John Smith\",\"differenceMoney\":\"150.00\",\"documentType\":1,\"from\":\"Beijing\",\"id\":\"AR-2025-001\",\"price\":\"1299.99\",\"seatClass\":1,\"seatNumber\":\"12A\",\"status\":1,\"to\":\"Beijing\",\"trainNumber\":\"G1234\",\"travelDate\":\"2025-11-20\",\"travelTime\":\"14:15\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"accountId\":\"acc-5678\",\"boughtDate\":\"2025-11-20\",\"coachNumber\":12,\"contactsDocumentNumber\":\"DocumentNumber_Three\",\"contactsName\":\"John Smith\",\"differenceMoney\":\"150.00\",\"documentType\":1,\"from\":\"Beijing\",\"id\":\"AR-2025-001\",\"price\":\"1299.99\",\"seatClass\":1,\"seatNumber\":\"12A\",\"status\":1,\"to\":\"Beijing\",\"trainNumber\":\"G1234\",\"travelDate\":\"2025-11-20\",\"travelTime\":\"14:15\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/adminorderservice/adminorder")
                               .then().log().ifValidationFails()
                               .extract().response();
                            ...
                            if (faultJson.has("data")) {
                                ...
                                if (dataObj.optBoolean("injected", false)) {
                                    ...
                                    if (!detectedFaultName.isEmpty()) {
                                        ...
                                        System.out.println("🔍 FAULT DETECTED: " + detectedFaultName + " in test: test_POST_31_23");
                                    }
                                }
                            }
                        } catch (Exception faultEx) {
        ...
        Allure.label("severity", severity);
        Allure.label("feature", "Microservice Workflow");
        Allure.label("story", "test_POST_31_23");
        Allure.description("Microservice test scenario with " + totalSteps + " steps.");
        
        System.out.println("=== SCENARIO RESULT ===");
        System.out.println("Scenario: test_POST_31_23");
        System.out.println("Total Steps: " + totalSteps);
        System.out.println("Successful: " + successfulSteps);
        System.out.println("Failed: " + failedSteps);
        System.out.println("Login Status: " + (loginSucceeded.get() ? "SUCCESS" : "FAILED"));
    ...
    public void test_negative_POST_31_24() throws Exception {
        ...
        // 🚨 NEGATIVE TEST METADATA
        Allure.parameter("🚨 Test Type", "NEGATIVE (Invalid Input Testing)");
        Allure.parameter("🔴 Invalid Parameters", "from=123");
        Allure.description("**⚠️ This is a NEGATIVE test case with intentionally invalid inputs.**\n\n" +
                         "The following parameters were intentionally set to invalid values:\n" +
                         "from=123\n\n" +
                         "This test expects a 4XX or 5XX error response. If it returns 2XX, the test will FAIL.");
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"acc-2345\",\"boughtDate\":\"2025-11-20\",\"coachNumber\":3,\"contactsDocumentNumber\":\"AB1234567\",\"contactsName\":\"Maria Garcia\",\"differenceMoney\":\"150.00\",\"documentType\":1,\"from\":123,\"id\":\"AR-2025-001\",\"price\":\"128.0\",\"seatClass\":9,\"seatNumber\":\"8C\",\"status\":1,\"to\":\"Beijing\",\"trainNumber\":\"G1234\",\"travelDate\":\"2026-01-10\",\"travelTime\":\"22:45\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"accountId\":\"acc-2345\",\"boughtDate\":\"2025-11-20\",\"coachNumber\":3,\"contactsDocumentNumber\":\"AB1234567\",\"contactsName\":\"Maria Garcia\",\"differenceMoney\":\"150.00\",\"documentType\":1,\"from\":123,\"id\":\"AR-2025-001\",\"price\":\"128.0\",\"seatClass\":9,\"seatNumber\":\"8C\",\"status\":1,\"to\":\"Beijing\",\"trainNumber\":\"G1234\",\"travelDate\":\"2026-01-10\",\"travelTime\":\"22:45\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/adminorderservice/adminorder")
                               .then().log().ifValidationFails()
                               .extract().response();
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"acc-7890\",\"boughtDate\":\"2025-11-20\",\"coachNumber\":12,\"contactsDocumentNumber\":\"DocumentNumber_Five\",\"contactsName\":\"John Smith\",\"differenceMoney\":\"300.00\",\"documentType\":1,\"from\":\"Guangzhou\",\"id\":\"ID-123456789\",\"price\":\"32.0\",\"seatClass\":1,\"seatNumber\":\"16D\",\"status\":1,\"to\":\"Shenzhen\",\"trainNumber\":\"C9012\",\"travelDate\":\"2025-11-20\",\"travelTime\":\"08:30\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"acc-7890\",\"boughtDate\":\"2025-11-20\",\"coachNumber\":12,\"contactsDocumentNumber\":\"DocumentNumber_One\",\"contactsName\":\"John Smith\",\"differenceMoney\":\"150.00\",\"documentType\":3,\"from\":\"Beijing\",\"id\":\"AR-2025-001\",\"price\":\"1299.99\",\"seatClass\":10,\"seatNumber\":\"12A\",\"status\":1,\"to\":\"Beijing\",\"trainNumber\":\"T3456\",\"travelDate\":\"2025-11-20\",\"travelTime\":\"10:20\"}";
                        req = req.body(requestBody1);
    ...
    public void test_negative_POST_31_27() throws Exception {
        ...
        // 🚨 NEGATIVE TEST METADATA
        Allure.parameter("🚨 Test Type", "NEGATIVE (Invalid Input Testing)");
        Allure.parameter("🔴 Invalid Parameters", "id=AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA");
        Allure.description("**⚠️ This is a NEGATIVE test case with intentionally invalid inputs.**\n\n" +
                         "The following parameters were intentionally set to invalid values:\n" +
                         "id=AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA\n\n" +
                         "This test expects a 4XX or 5XX error response. If it returns 2XX, the test will FAIL.");
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"acc-7890\",\"boughtDate\":\"2025-11-20\",\"coachNumber\":25,\"contactsDocumentNumber\":\"AB1234567\",\"contactsName\":\"Robert Johnson\",\"differenceMoney\":\"150.00\",\"documentType\":1,\"from\":\"Shenzhen\",\"id\":\"AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA\",\"price\":\"1299.99\",\"seatClass\":1,\"seatNumber\":\"12A\",\"status\":3,\"to\":\"Hangzhou\",\"trainNumber\":\"E7890\",\"travelDate\":\"2025-11-20\",\"travelTime\":\"08:30\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"acc-7890\",\"boughtDate\":\"2025-11-20\",\"coachNumber\":8,\"contactsDocumentNumber\":\"AB1234567\",\"contactsName\":\"John Smith\",\"differenceMoney\":\"150.00\",\"documentType\":1,\"from\":\"Beijing\",\"id\":\"AR-2025-001\",\"price\":\"1299.99\",\"seatClass\":1,\"seatNumber\":\"3E\",\"status\":4,\"to\":\"Beijing\",\"trainNumber\":\"G1234\",\"travelDate\":\"2025-11-20\",\"travelTime\":\"08:30\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"acc-7890\",\"boughtDate\":\"2025-11-20\",\"coachNumber\":12,\"contactsDocumentNumber\":\"AB1234567\",\"contactsName\":\"Emily Davis\",\"differenceMoney\":\"150.00\",\"documentType\":1,\"from\":\"Hangzhou\",\"id\":\"AR-2025-001\",\"price\":\"1299.99\",\"seatClass\":2,\"seatNumber\":\"12A\",\"status\":1,\"to\":\"Beijing\",\"trainNumber\":\"G1234\",\"travelDate\":\"2025-11-28\",\"travelTime\":\"08:30\"}";
                        req = req.body(requestBody1);
    ...
    public void test_negative_POST_31_30() throws Exception {
        ...
        // 🚨 NEGATIVE TEST METADATA
        Allure.parameter("🚨 Test Type", "NEGATIVE (Invalid Input Testing)");
        Allure.parameter("🔴 Invalid Parameters", "to=123");
        Allure.description("**⚠️ This is a NEGATIVE test case with intentionally invalid inputs.**\n\n" +
                         "The following parameters were intentionally set to invalid values:\n" +
                         "to=123\n\n" +
                         "This test expects a 4XX or 5XX error response. If it returns 2XX, the test will FAIL.");
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"acc-7890\",\"boughtDate\":\"2024-01-15\",\"coachNumber\":12,\"contactsDocumentNumber\":\"AB1234567\",\"contactsName\":\"John Smith\",\"differenceMoney\":\"150.00\",\"documentType\":1,\"from\":\"Beijing\",\"id\":\"AR-2025-001\",\"price\":\"1299.99\",\"seatClass\":1,\"seatNumber\":\"12A\",\"status\":5,\"to\":123,\"trainNumber\":\"D5678\",\"travelDate\":\"2025-11-20\",\"travelTime\":\"08:30\"}";
                        req = req.body(requestBody1);
