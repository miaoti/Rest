package trainticket_twostage_test.TrainTicketTwoStageTest_1763429342156;
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        String requestBody1 = "{\"distanceList\":\"2500\",\"distances\":123,\"endStation\":\"Chicago Union Station\",\"id\":\"ABC123XYZ\",\"loginId\":\"sysadmin_test\",\"startStation\":\"Chicago Union Station\",\"stationList\":\"New York Penn Station\",\"stations\":[\"Grand Central Terminal\",\"Penn Station\",\"Union Station\",\"Los Angeles Union Station\",\"Chicago Union Station\"]}";
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"2500\",\"distances\":123,\"endStation\":\"Chicago Union Station\",\"id\":\"ABC123XYZ\",\"loginId\":\"sysadmin_test\",\"startStation\":\"Chicago Union Station\",\"stationList\":\"New York Penn Station\",\"stations\":[\"Grand Central Terminal\",\"Penn Station\",\"Union Station\",\"Los Angeles Union Station\",\"Chicago Union Station\"]}");
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"4000\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":\"Chicago Union Station\",\"id\":\"1234567890\",\"loginId\":\"admin_user_001\",\"startStation\":\"Chicago Union Station\",\"stationList\":\"New York Penn Station\",\"stations\":[\"Grand Central Terminal\",\"Penn Station\",\"Union Station\",\"Los Angeles Union Station\",\"Chicago Union Station\"]}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"4000\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":\"Chicago Union Station\",\"id\":\"1234567890\",\"loginId\":\"admin_user_001\",\"startStation\":\"Chicago Union Station\",\"stationList\":\"New York Penn Station\",\"stations\":[\"Grand Central Terminal\",\"Penn Station\",\"Union Station\",\"Los Angeles Union Station\",\"Chicago Union Station\"]}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               .extract().response();
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"12.5\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":\"Chicago Union Station\",\"id\":\"1234567890\",\"loginId\":\"user_login_98765\",\"startStation\":\"Chicago Union Station\",\"stationList\":\"New York Penn Station\",\"stations\":[\"shijiazhuang\"]}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"12.5\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":\"Chicago Union Station\",\"id\":\"1234567890\",\"loginId\":\"user_login_98765\",\"startStation\":\"Chicago Union Station\",\"stationList\":\"New York Penn Station\",\"stations\":[\"shijiazhuang\"]}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               .extract().response();
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"12.5\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":123,\"id\":\"9876543210\",\"loginId\":\"admin_user_001\",\"startStation\":\"Chicago Union Station\",\"stationList\":\"New York Penn Station\",\"stations\":[\"Grand Central Terminal\",\"Penn Station\",\"Union Station\",\"Los Angeles Union Station\",\"Chicago Union Station\"]}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"12.5\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":123,\"id\":\"9876543210\",\"loginId\":\"admin_user_001\",\"startStation\":\"Chicago Union Station\",\"stationList\":\"New York Penn Station\",\"stations\":[\"Grand Central Terminal\",\"Penn Station\",\"Union Station\",\"Los Angeles Union Station\",\"Chicago Union Station\"]}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               .extract().response();
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"12.5\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":\"Boston South Station\",\"id\":\"1234567890\",\"loginId\":123,\"startStation\":\"Chicago Union Station\",\"stationList\":\"New York Penn Station\",\"stations\":[\"beijing\"]}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"12.5\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":\"Boston South Station\",\"id\":\"1234567890\",\"loginId\":123,\"startStation\":\"Chicago Union Station\",\"stationList\":\"New York Penn Station\",\"stations\":[\"beijing\"]}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               .extract().response();
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"12.5\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":\"Chicago Union Station\",\"id\":\"1234567890\",\"loginId\":\"admin_user_001\",\"startStation\":\"Los Angeles Union Station\",\"stationList\":\"New York Penn Station\",\"stations\":[\"jiaxingnan\"]}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"12.5\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":\"Chicago Union Station\",\"id\":\"1234567890\",\"loginId\":\"admin_user_001\",\"startStation\":\"Los Angeles Union Station\",\"stationList\":\"New York Penn Station\",\"stations\":[\"jiaxingnan\"]}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               .extract().response();
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"12.5\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":\"Chicago Union Station\",\"id\":\"1234567890\",\"loginId\":\"admin_user_001\",\"startStation\":\"Chicago Union Station\",\"stationList\":\"New York Penn Station\",\"stations\":[\"Grand Central Terminal\",\"Penn Station\",\"Union Station\",\"Los Angeles Union Station\",\"Chicago Union Station\"]}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"12.5\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":\"Chicago Union Station\",\"id\":\"1234567890\",\"loginId\":\"admin_user_001\",\"startStation\":\"Chicago Union Station\",\"stationList\":\"New York Penn Station\",\"stations\":[\"Grand Central Terminal\",\"Penn Station\",\"Union Station\",\"Los Angeles Union Station\",\"Chicago Union Station\"]}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               .extract().response();
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"12.5\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":\"Chicago Union Station\",\"id\":\"1234567890\",\"loginId\":\"admin_user_001\",\"startStation\":\"Boston South Station\",\"stationList\":\"New York Penn Station\",\"stations\":[\"zhenjiang\"]}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"12.5\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":\"Chicago Union Station\",\"id\":\"1234567890\",\"loginId\":\"admin_user_001\",\"startStation\":\"Boston South Station\",\"stationList\":\"New York Penn Station\",\"stations\":[\"zhenjiang\"]}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               .extract().response();
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"12.5\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":\"Chicago Union Station\",\"id\":\"1234567890\",\"loginId\":\"svc_account_12345\",\"startStation\":\"Chicago Union Station\",\"stationList\":123,\"stations\":[\"Grand Central Terminal\",\"Penn Station\",\"Union Station\",\"Los Angeles Union Station\",\"Chicago Union Station\"]}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"3500\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":\"Los Angeles Union Station\",\"id\":\"DEF456UVW\",\"loginId\":\"operator_john_doe\",\"startStation\":\"Chicago Union Station\",\"stationList\":\"Los Angeles Union Station\",\"stations\":[\"Grand Central Terminal\",\"Penn Station\",\"Union Station\",\"Los Angeles Union Station\",\"Chicago Union Station\"]}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"3500\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":\"Los Angeles Union Station\",\"id\":\"DEF456UVW\",\"loginId\":\"operator_john_doe\",\"startStation\":\"Chicago Union Station\",\"stationList\":\"Los Angeles Union Station\",\"stations\":[\"Grand Central Terminal\",\"Penn Station\",\"Union Station\",\"Los Angeles Union Station\",\"Chicago Union Station\"]}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               .extract().response();
