package trainticket_twostage_test.TrainTicketTwoStageTest_1762209354792;
...
public class POST_api_v1_adminorderservice_adminorder_1 {
    ...
    public void test_faulty_POST_1_1() throws Exception {
        ...
        Allure.parameter("🔴 Faulty Parameters", "travelTime=travelTime");
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        String requestBody1 = "{\"accountId\":\"1234567890\",\"boughtDate\":\"2023-10-26\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"123456789\",\"contactsName\":\"John Doe\",\"differenceMoney\":\"100\",\"documentType\":\"1\",\"from\":\"1600 Amphitheater Parkway\",\"id\":\"123\",\"price\":\"19.99\",\"seatClass\":\"1\",\"seatNumber\":\"1A\",\"status\":\"10\",\"to\":\"JohnDoe\",\"trainNumber\":\"12345678\",\"travelDate\":\"2024-04-10\",\"travelTime\":\"travelTime\"}";
    ...
    public void test_faulty_POST_1_2() throws Exception {
        // 🚨 FAULTY TEST METADATA
        Allure.parameter("🚨 Test Type", "FAULTY (Negative Testing)");
        Allure.parameter("🔴 Faulty Parameters", "documentType=\"abc\"");
        Allure.description("**⚠️ This is an intentional FAULTY test case for negative testing.**\n\n" +
                         "The following parameters were intentionally set to invalid values:\n" +
                         "documentType=\"abc\"\n\n" +
                         "This test is expected to trigger validation errors or error responses.");
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"123.45\",\"boughtDate\":\"2023-10-26\",\"coachNumber\":\"1000\",\"contactsDocumentNumber\":\"0987654321\",\"contactsName\":\"John Doe\",\"differenceMoney\":\"100\",\"documentType\":\"\\\"abc\\\"\",\"from\":\"123 Main St\",\"id\":\"123\",\"price\":\"19.99\",\"seatClass\":\"1\",\"seatNumber\":\"1A\",\"status\":\"10\",\"to\":\"JohnDoe\",\"trainNumber\":\"12345678\",\"travelDate\":\"2024-05-01\",\"travelTime\":\"1h 55m\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"accountId\":\"123.45\",\"boughtDate\":\"2023-10-26\",\"coachNumber\":\"1000\",\"contactsDocumentNumber\":\"0987654321\",\"contactsName\":\"John Doe\",\"differenceMoney\":\"100\",\"documentType\":\"\\\"abc\\\"\",\"from\":\"123 Main St\",\"id\":\"123\",\"price\":\"19.99\",\"seatClass\":\"1\",\"seatNumber\":\"1A\",\"status\":\"10\",\"to\":\"JohnDoe\",\"trainNumber\":\"12345678\",\"travelDate\":\"2024-05-01\",\"travelTime\":\"1h 55m\"}");
                        Response stepResponse1 = req.when().post("/api/v1/adminorderservice/adminorder")
                               .then().log().ifValidationFails()
                               .statusCode(200)
                               .extract().response();
    ...
    public void test_faulty_POST_1_3() throws Exception {
        // 🚨 FAULTY TEST METADATA
        Allure.parameter("🚨 Test Type", "FAULTY (Negative Testing)");
        Allure.parameter("🔴 Faulty Parameters", "contactsDocumentNumber=12345678901234567890123456789012345678901234567890");
        Allure.description("**⚠️ This is an intentional FAULTY test case for negative testing.**\n\n" +
                         "The following parameters were intentionally set to invalid values:\n" +
                         "contactsDocumentNumber=12345678901234567890123456789012345678901234567890\n\n" +
                         "This test is expected to trigger validation errors or error responses.");
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"1234567890\",\"boughtDate\":\"2023-10-26\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"12345678901234567890123456789012345678901234567890\",\"contactsName\":\"John Doe\",\"differenceMoney\":\"100\",\"documentType\":\"1\",\"from\":\"123 Main St\",\"id\":\"123\",\"price\":\"19.99\",\"seatClass\":\"1\",\"seatNumber\":\"1A\",\"status\":\"10\",\"to\":\"JohnDoe\",\"trainNumber\":\"12345678\",\"travelDate\":\"2024-03-15\",\"travelTime\":\"1h 30m\"}";
                        req = req.body(requestBody1);
    ...
    public void test_faulty_POST_1_4() throws Exception {
        // 🚨 FAULTY TEST METADATA
        Allure.parameter("🚨 Test Type", "FAULTY (Negative Testing)");
        Allure.parameter("🔴 Faulty Parameters", "contactsName=verylongstringthatshouldfail");
        Allure.description("**⚠️ This is an intentional FAULTY test case for negative testing.**\n\n" +
                         "The following parameters were intentionally set to invalid values:\n" +
                         "contactsName=verylongstringthatshouldfail\n\n" +
                         "This test is expected to trigger validation errors or error responses.");
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"1234567890\",\"boughtDate\":\"2023-12-31\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"5551234567\",\"contactsName\":\"verylongstringthatshouldfail\",\"differenceMoney\":\"100\",\"documentType\":\"1\",\"from\":\"123 Main St\",\"id\":\"123\",\"price\":\"19.99\",\"seatClass\":\"1\",\"seatNumber\":\"1A\",\"status\":\"10\",\"to\":\"JohnDoe\",\"trainNumber\":\"12345678\",\"travelDate\":\"2024-06-18\",\"travelTime\":\"1h 30m\"}";
                        req = req.body(requestBody1);
    ...
    public void test_faulty_POST_1_5() throws Exception {
        // 🚨 FAULTY TEST METADATA
        Allure.parameter("🚨 Test Type", "FAULTY (Negative Testing)");
        Allure.parameter("🔴 Faulty Parameters", "differenceMoney=-123");
        Allure.description("**⚠️ This is an intentional FAULTY test case for negative testing.**\n\n" +
                         "The following parameters were intentionally set to invalid values:\n" +
                         "differenceMoney=-123\n\n" +
                         "This test is expected to trigger validation errors or error responses.");
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"1234567890\",\"boughtDate\":\"2023-10-26\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"123456789\",\"contactsName\":\"John Doe\",\"differenceMoney\":\"-123\",\"documentType\":\"1\",\"from\":\"123 Main St\",\"id\":\"123\",\"price\":\"19.99\",\"seatClass\":\"1\",\"seatNumber\":\"1A\",\"status\":\"10\",\"to\":\"JohnDoe\",\"trainNumber\":\"77777777\",\"travelDate\":\"2024-03-15\",\"travelTime\":\"1h 30m\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"1234567890\",\"boughtDate\":\"2024-02-29\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"123456789\",\"contactsName\":\"John Doe\",\"differenceMoney\":\"100\",\"documentType\":\"1\",\"from\":\"123 Main St\",\"id\":\"123\",\"price\":\"19.99\",\"seatClass\":\"1\",\"seatNumber\":\"seatNumber\",\"status\":\"10\",\"to\":\"JohnDoe\",\"trainNumber\":\"12345678\",\"travelDate\":\"2024-03-15\",\"travelTime\":\"1h 30m\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"accountId\":\"1234567890\",\"boughtDate\":\"2024-02-29\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"123456789\",\"contactsName\":\"John Doe\",\"differenceMoney\":\"100\",\"documentType\":\"1\",\"from\":\"123 Main St\",\"id\":\"123\",\"price\":\"19.99\",\"seatClass\":\"1\",\"seatNumber\":\"seatNumber\",\"status\":\"10\",\"to\":\"JohnDoe\",\"trainNumber\":\"12345678\",\"travelDate\":\"2024-03-15\",\"travelTime\":\"1h 30m\"}");
                        Response stepResponse1 = req.when().post("/api/v1/adminorderservice/adminorder")
                               .then().log().ifValidationFails()
                               .statusCode(200)
                               .extract().response();
    ...
    public void test_faulty_POST_1_7() throws Exception {
        // 🚨 FAULTY TEST METADATA
        Allure.parameter("🚨 Test Type", "FAULTY (Negative Testing)");
        Allure.parameter("🔴 Faulty Parameters", "accountId=12345678901234567890123456789012345678901");
        Allure.description("**⚠️ This is an intentional FAULTY test case for negative testing.**\n\n" +
                         "The following parameters were intentionally set to invalid values:\n" +
                         "accountId=12345678901234567890123456789012345678901\n\n" +
                         "This test is expected to trigger validation errors or error responses.");
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"12345678901234567890123456789012345678901\",\"boughtDate\":\"2023-10-26\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"123456789\",\"contactsName\":\"John Doe\",\"differenceMoney\":\"100\",\"documentType\":\"1\",\"from\":\"123 Main St\",\"id\":\"123\",\"price\":\"19.99\",\"seatClass\":\"1\",\"seatNumber\":\"1A\",\"status\":\"10\",\"to\":\"JohnDoe\",\"trainNumber\":\"12345678\",\"travelDate\":\"2024-03-15\",\"travelTime\":\"1h 30m\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"accountId\":\"12345678901234567890123456789012345678901\",\"boughtDate\":\"2023-10-26\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"123456789\",\"contactsName\":\"John Doe\",\"differenceMoney\":\"100\",\"documentType\":\"1\",\"from\":\"123 Main St\",\"id\":\"123\",\"price\":\"19.99\",\"seatClass\":\"1\",\"seatNumber\":\"1A\",\"status\":\"10\",\"to\":\"JohnDoe\",\"trainNumber\":\"12345678\",\"travelDate\":\"2024-03-15\",\"travelTime\":\"1h 30m\"}");
                        Response stepResponse1 = req.when().post("/api/v1/adminorderservice/adminorder")
                               .then().log().ifValidationFails()
                               .statusCode(200)
                               .extract().response();
    ...
    public void test_faulty_POST_1_8() throws Exception {
        // 🚨 FAULTY TEST METADATA
        Allure.parameter("🚨 Test Type", "FAULTY (Negative Testing)");
        Allure.parameter("🔴 Faulty Parameters", "coachNumber=5");
        Allure.description("**⚠️ This is an intentional FAULTY test case for negative testing.**\n\n" +
                         "The following parameters were intentionally set to invalid values:\n" +
                         "coachNumber=5\n\n" +
                         "This test is expected to trigger validation errors or error responses.");
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"-100\",\"boughtDate\":\"2023-10-26\",\"coachNumber\":\"5\",\"contactsDocumentNumber\":\"123456789\",\"contactsName\":\"John Doe\",\"differenceMoney\":\"100\",\"documentType\":\"1\",\"from\":\"123 Main St\",\"id\":\"123\",\"price\":\"19.99\",\"seatClass\":\"1\",\"seatNumber\":\"4A-1\",\"status\":\"10\",\"to\":\"JohnDoe\",\"trainNumber\":\"12345678\",\"travelDate\":\"2024-03-15\",\"travelTime\":\"2h 40m\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"accountId\":\"-100\",\"boughtDate\":\"2023-10-26\",\"coachNumber\":\"5\",\"contactsDocumentNumber\":\"123456789\",\"contactsName\":\"John Doe\",\"differenceMoney\":\"100\",\"documentType\":\"1\",\"from\":\"123 Main St\",\"id\":\"123\",\"price\":\"19.99\",\"seatClass\":\"1\",\"seatNumber\":\"4A-1\",\"status\":\"10\",\"to\":\"JohnDoe\",\"trainNumber\":\"12345678\",\"travelDate\":\"2024-03-15\",\"travelTime\":\"2h 40m\"}");
                        Response stepResponse1 = req.when().post("/api/v1/adminorderservice/adminorder")
                               .then().log().ifValidationFails()
                               .statusCode(200)
                               .extract().response();
    ...
    public void test_faulty_POST_1_9() throws Exception {
        // 🚨 FAULTY TEST METADATA
        Allure.parameter("🚨 Test Type", "FAULTY (Negative Testing)");
        Allure.parameter("🔴 Faulty Parameters", "travelDate=2023-13-32");
        Allure.description("**⚠️ This is an intentional FAULTY test case for negative testing.**\n\n" +
                         "The following parameters were intentionally set to invalid values:\n" +
                         "travelDate=2023-13-32\n\n" +
                         "This test is expected to trigger validation errors or error responses.");
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"1234567890\",\"boughtDate\":\"2023-10-26\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"123456789\",\"contactsName\":\"sales_representative_jones\",\"differenceMoney\":\"100\",\"documentType\":\"1\",\"from\":\"123 Main St\",\"id\":\"123\",\"price\":\"19.99\",\"seatClass\":\"1\",\"seatNumber\":\"5B-20\",\"status\":\"10\",\"to\":\"JohnDoe\",\"trainNumber\":\"12345678\",\"travelDate\":\"2023-13-32\",\"travelTime\":\"1h 30m\"}";
                        req = req.body(requestBody1);
    ...
    public void test_faulty_POST_1_10() throws Exception {
        // 🚨 FAULTY TEST METADATA
        Allure.parameter("🚨 Test Type", "FAULTY (Negative Testing)");
        Allure.parameter("🔴 Faulty Parameters", "boughtDate=2023-13-03");
        Allure.description("**⚠️ This is an intentional FAULTY test case for negative testing.**\n\n" +
                         "The following parameters were intentionally set to invalid values:\n" +
                         "boughtDate=2023-13-03\n\n" +
                         "This test is expected to trigger validation errors or error responses.");
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"1234567890\",\"boughtDate\":\"2023-13-03\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"123456789\",\"contactsName\":\"John Doe\",\"differenceMoney\":\"100\",\"documentType\":\"1\",\"from\":\"123 Main St\",\"id\":\"123\",\"price\":\"19.99\",\"seatClass\":\"1\",\"seatNumber\":\"1A\",\"status\":\"10\",\"to\":\"JohnDoe\",\"trainNumber\":\"12345678\",\"travelDate\":\"2024-03-15\",\"travelTime\":\"1h 30m\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"accountId\":\"1234567890\",\"boughtDate\":\"2023-13-03\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"123456789\",\"contactsName\":\"John Doe\",\"differenceMoney\":\"100\",\"documentType\":\"1\",\"from\":\"123 Main St\",\"id\":\"123\",\"price\":\"19.99\",\"seatClass\":\"1\",\"seatNumber\":\"1A\",\"status\":\"10\",\"to\":\"JohnDoe\",\"trainNumber\":\"12345678\",\"travelDate\":\"2024-03-15\",\"travelTime\":\"1h 30m\"}");
                        Response stepResponse1 = req.when().post("/api/v1/adminorderservice/adminorder")
                               .then().log().ifValidationFails()
                               .statusCode(200)
                               .extract().response();
    ...
    public void test_faulty_POST_1_11() throws Exception {
        // 🚨 FAULTY TEST METADATA
        Allure.parameter("🚨 Test Type", "FAULTY (Negative Testing)");
        Allure.parameter("🔴 Faulty Parameters", "price=12345678901234567890123456789012345");
        Allure.description("**⚠️ This is an intentional FAULTY test case for negative testing.**\n\n" +
                         "The following parameters were intentionally set to invalid values:\n" +
                         "price=12345678901234567890123456789012345\n\n" +
                         "This test is expected to trigger validation errors or error responses.");
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"1234567890\",\"boughtDate\":\"2023-10-26\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"123456789\",\"contactsName\":\"John Doe\",\"differenceMoney\":\"100\",\"documentType\":\"1\",\"from\":\"123 Main St\",\"id\":\"123\",\"price\":\"12345678901234567890123456789012345\",\"seatClass\":\"2\",\"seatNumber\":\"1A\",\"status\":\"10\",\"to\":\"JohnDoe\",\"trainNumber\":\"12345678\",\"travelDate\":\"2024-03-15\",\"travelTime\":\"1h 30m\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"invalid_account_id\",\"boughtDate\":\"2023-10-26\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"123456789\",\"contactsName\":\"John Doe\",\"differenceMoney\":\"100\",\"documentType\":\"1\",\"from\":\"123 Main St\",\"id\":\"123\",\"price\":\"19.99\",\"seatClass\":\"0\",\"seatNumber\":\"1A\",\"status\":\"10\",\"to\":\"JohnDoe\",\"trainNumber\":\"12345678\",\"travelDate\":\"2024-03-15\",\"travelTime\":\"1h 30m\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"accountId\":\"invalid_account_id\",\"boughtDate\":\"2023-10-26\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"123456789\",\"contactsName\":\"John Doe\",\"differenceMoney\":\"100\",\"documentType\":\"1\",\"from\":\"123 Main St\",\"id\":\"123\",\"price\":\"19.99\",\"seatClass\":\"0\",\"seatNumber\":\"1A\",\"status\":\"10\",\"to\":\"JohnDoe\",\"trainNumber\":\"12345678\",\"travelDate\":\"2024-03-15\",\"travelTime\":\"1h 30m\"}");
                        Response stepResponse1 = req.when().post("/api/v1/adminorderservice/adminorder")
                               .then().log().ifValidationFails()
                               .statusCode(200)
                               .extract().response();
    ...
    public void test_faulty_POST_1_13() throws Exception {
        // 🚨 FAULTY TEST METADATA
        Allure.parameter("🚨 Test Type", "FAULTY (Negative Testing)");
        Allure.parameter("🔴 Faulty Parameters", "from=1.23");
        Allure.description("**⚠️ This is an intentional FAULTY test case for negative testing.**\n\n" +
                         "The following parameters were intentionally set to invalid values:\n" +
                         "from=1.23\n\n" +
                         "This test is expected to trigger validation errors or error responses.");
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"1234567890\",\"boughtDate\":\"2023-10-26\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"123456789\",\"contactsName\":\"John Doe\",\"differenceMoney\":\"100\",\"documentType\":\"1\",\"from\":\"1.23\",\"id\":\"123\",\"price\":\"19.99\",\"seatClass\":\"1\",\"seatNumber\":\"1A\",\"status\":\"10\",\"to\":\"JohnDoe\",\"trainNumber\":\"12345678\",\"travelDate\":\"2024-03-15\",\"travelTime\":\"1h 30m\"}";
                        req = req.body(requestBody1);
    ...
    public void test_faulty_POST_1_14() throws Exception {
        // 🚨 FAULTY TEST METADATA
        Allure.parameter("🚨 Test Type", "FAULTY (Negative Testing)");
        Allure.parameter("🔴 Faulty Parameters", "id=!@#$%^&*()_+=-`~[]\{}|;':\",./<>?");
        Allure.description("**⚠️ This is an intentional FAULTY test case for negative testing.**\n\n" +
                         "The following parameters were intentionally set to invalid values:\n" +
                         "id=!@#$%^&*()_+=-`~[]\{}|;':\",./<>?\n\n" +
                         "This test is expected to trigger validation errors or error responses.");
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"1234567890\",\"boughtDate\":\"2023-10-26\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"1112223333\",\"contactsName\":\"John Doe\",\"differenceMoney\":\"100\",\"documentType\":\"1\",\"from\":\"123 Main St\",\"id\":\"!@#$%^&*()_+=-`~[]\\\\{}|;':\\\",./<>?\",\"price\":\"19.99\",\"seatClass\":\"1\",\"seatNumber\":\"1A\",\"status\":\"10\",\"to\":\"PeterPan\",\"trainNumber\":\"12345678\",\"travelDate\":\"2024-03-15\",\"travelTime\":\"1h 30m\"}";
                        req = req.body(requestBody1);
    ...
    public void test_faulty_POST_1_15() throws Exception {
        // 🚨 FAULTY TEST METADATA
        Allure.parameter("🚨 Test Type", "FAULTY (Negative Testing)");
        Allure.parameter("🔴 Faulty Parameters", "to=123");
        Allure.description("**⚠️ This is an intentional FAULTY test case for negative testing.**\n\n" +
                         "The following parameters were intentionally set to invalid values:\n" +
                         "to=123\n\n" +
                         "This test is expected to trigger validation errors or error responses.");
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"1234567890\",\"boughtDate\":\"2023-10-26\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"123456789\",\"contactsName\":\"billing_admin\",\"differenceMoney\":\"100\",\"documentType\":\"1\",\"from\":\"Invalid Input\",\"id\":\"123\",\"price\":\"19.99\",\"seatClass\":\"1\",\"seatNumber\":\"1A\",\"status\":\"10\",\"to\":\"123\",\"trainNumber\":\"12345678\",\"travelDate\":\"2024-03-15\",\"travelTime\":\"1h 30m\"}";
                        req = req.body(requestBody1);
