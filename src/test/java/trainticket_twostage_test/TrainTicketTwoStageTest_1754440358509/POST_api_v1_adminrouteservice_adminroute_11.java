package trainticket_twostage_test.TrainTicketTwoStageTest_1754440358509;
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        String requestBody1 = "{\"distanceList\":\"92708982-77af-4318-be25-57ccb0ff69ad\",\"distances\":\"[\\\"92708982-77af-4318-be25-57ccb0ff69ad\\\"]\",\"endStation\":\"jiaxingnan\",\"id\":\"bdbacf78-877f-4d8c-ace5-399f12897a57\",\"loginId\":\"76543210-987a-4567-8\",\"startStation\":\"3\",\"stationList\":\"chengdu\",\"stations\":\"[\\\"xiamen\\\"]\"}";
            ...
            Allure.step("Step 2: ts-station-service POST /api/v1/stationservice/stations/idlist (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "[\"[\\\"hangzhou\\\"]\", \"[\\\"shanghai\\\", \\\"suzhou\\\", \\\"taiyuan\\\"]\", \"[\\\"suzhou\\\"]\"]";
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"92708982-77af-4318-be25-57ccb0ff69ad\",\"endStation\":\"jiaxingnan\",\"id\":\"bdbacf78-877f-4d8c-ace5-399f12897a57\",\"startStation\":\"3\",\"stationList\":\"chengdu\"}";
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"92708982-77af-4318-be25-57ccb0ff69ad\",\"distances\":\"[\\\"92708982-77af-4318-be25-57ccb0ff69ad\\\"]\",\"endStation\":\"xuzhou\",\"id\":\"a1b2c3d4-5678-90ab-\",\"loginId\":\"4d2a46c7-71cb-4cf1-b5bb-b68406d9da6f\",\"startStation\":\"3\",\"stationList\":\"dalian\",\"stations\":\"[\\\"chongqing\\\"]\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"92708982-77af-4318-be25-57ccb0ff69ad\",\"endStation\":\"xuzhou\",\"id\":\"a1b2c3d4-5678-90ab-\",\"startStation\":\"3\",\"stationList\":\"dalian\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"10\",\"distances\":\"10 miles\",\"endStation\":\"wuxi,shijiazhuang\",\"id\":\"98765432-10fe-4567-89ab-cdef01234567\",\"loginId\":\"f7890123-4567-89ab-cdef-123456789012\",\"startStation\":\"3\",\"stationList\":\"shenzhen\",\"stations\":\"[\\\"shanghai\\\", \\\"suzhou\\\", \\\"taiyuan\\\"]\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-station-service POST /api/v1/stationservice/stations/idlist (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "[\"[\\\"shanghai\\\"]\", \"[\\\"taiyuan\\\"]\", \"\\\"Grand Central Terminal\\\"\", \"[\\\"aefcef3f-3f42-46e8-afd7-6cb2a928bd3d\\\"]\"]";
                        req = req.body(requestBody2);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"10\",\"endStation\":\"wuxi,shijiazhuang\",\"id\":\"98765432-10fe-4567-89ab-cdef01234567\",\"startStation\":\"3\",\"stationList\":\"shenzhen\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"92708982-77af-4318-be25-57ccb0ff69ad\",\"distances\":\"[\\\"92708982-77af-4318-be25-57ccb0ff69ad\\\"]\",\"endStation\":\"dallas\",\"id\":\"f1a2b3c4-5678-90ab-cdef-123456789012\",\"loginId\":\"98765432-10fe-4567-89ab-cdef12345678\",\"startStation\":\"3\",\"stationList\":\"Grand Central Terminal\",\"stations\":\"[\\\"suzhou\\\"]\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-station-service POST /api/v1/stationservice/stations/idlist (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "[\"[\\\"nanjing\\\"]\", \"[\\\"9876\\\"]\", \"[\\\"hangzhou\\\"]\"]";
                        req = req.body(requestBody2);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"92708982-77af-4318-be25-57ccb0ff69ad\",\"endStation\":\"dallas\",\"id\":\"f1a2b3c4-5678-90ab-cdef-123456789012\",\"startStation\":\"3\",\"stationList\":\"Grand Central Terminal\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"92708982-77af-4318-be25-57ccb0ff69ad\",\"distances\":\"[\\\"92708982-77af-4318-be25-57ccb0ff69ad\\\"]\",\"endStation\":\"suzhou\",\"id\":\"4d5e6f78-90bc-4567-89ab-cdef01234567\",\"loginId\":\"a1b2c3d4-e5f6-7890-1234-567890abcdef\",\"startStation\":\"3\",\"stationList\":\"beijing\",\"stations\":\"[\\\"shanghai\\\"]\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-station-service POST /api/v1/stationservice/stations/idlist (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "[\"[\\\"shanghai\\\", \\\"suzhou\\\", \\\"taiyuan\\\"]\", \"[\\\"suzhou\\\"]\", \"[\\\"1235\\\"]\", \"[\\\"1234\\\"]\"]";
                        req = req.body(requestBody2);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"92708982-77af-4318-be25-57ccb0ff69ad\",\"endStation\":\"suzhou\",\"id\":\"4d5e6f78-90bc-4567-89ab-cdef01234567\",\"startStation\":\"3\",\"stationList\":\"beijing\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"92708982-77af-4318-be25-57ccb0ff69ad\",\"distances\":\"[\\\"92708982-77af-4318-be25-57ccb0ff69ad\\\"]\",\"endStation\":\"Grand Central Terminal\",\"id\":\"123\",\"loginId\":\"b3c4d5e6-7890-1234-5678-90abcdef123\",\"startStation\":\"3\",\"stationList\":\"chongqing\",\"stations\":\"[\\\"taiyuan\\\"]\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-station-service POST /api/v1/stationservice/stations/idlist (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "[\"[\\\"shanghai\\\"]\", \"[\\\"taiyuan\\\"]\"]";
                        req = req.body(requestBody2);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"92708982-77af-4318-be25-57ccb0ff69ad\",\"endStation\":\"Grand Central Terminal\",\"id\":\"123\",\"startStation\":\"3\",\"stationList\":\"chongqing\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"92708982-77af-4318-be25-57ccb0ff69ad\",\"distances\":\"[\\\"92708982-77af-4318-be25-57ccb0ff69ad\\\"]\",\"endStation\":\"waco\",\"id\":\"e8a9b2c3-d456-7890-1234-567890abcdef\",\"loginId\":\"76543210-987a-4567-8\",\"startStation\":\"3\",\"stationList\":\"shanghai,suzhou,taiyuan\",\"stations\":\"[\\\"guangzhou\\\"]\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-station-service POST /api/v1/stationservice/stations/idlist (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "[\"[\\\"aefcef3f-3f42-46e8-afd7-6cb2a928bd3d\\\"]\", \"[\\\"nanjing\\\"]\", \"[\\\"9876\\\"]\", \"[\\\"hangzhou\\\"]\"]";
                        req = req.body(requestBody2);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"92708982-77af-4318-be25-57ccb0ff69ad\",\"endStation\":\"waco\",\"id\":\"e8a9b2c3-d456-7890-1234-567890abcdef\",\"startStation\":\"3\",\"stationList\":\"shanghai,suzhou,taiyuan\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"92708982-77af-4318-be25-57ccb0ff69ad\",\"distances\":\"[\\\"92708982-77af-4318-be25-57ccb0ff69ad\\\"]\",\"endStation\":\"shijiazhuang\",\"id\":\"06f71780-c647-465c-969f-cf8c019bc45f\",\"loginId\":\"4d2a46c7-71cb-4cf1-b5bb-b68406d9da6f\",\"startStation\":\"Grand Central Terminal\",\"stationList\":\"suzhou\",\"stations\":\"[\\\"dalian\\\"]\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-station-service POST /api/v1/stationservice/stations/idlist (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "[\"[\\\"shanghai\\\", \\\"suzhou\\\", \\\"taiyuan\\\"]\", \"[\\\"suzhou\\\"]\", \"[\\\"1235\\\"]\"]";
                        req = req.body(requestBody2);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"92708982-77af-4318-be25-57ccb0ff69ad\",\"endStation\":\"shijiazhuang\",\"id\":\"06f71780-c647-465c-969f-cf8c019bc45f\",\"startStation\":\"Grand Central Terminal\",\"stationList\":\"suzhou\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"92708982-77af-4318-be25-57ccb0ff69ad\",\"distances\":\"[\\\"92708982-77af-4318-be25-57ccb0ff69ad\\\"]\",\"endStation\":\"Grand Central Terminal\",\"id\":\"bdbacf78-877f-4d8c-ace5-399f12897a57\",\"loginId\":\"f7890123-4567-89ab-cdef-123456789012\",\"startStation\":\"Grand Central Terminal\",\"stationList\":\"Grand Central Terminal\",\"stations\":\"[\\\"shenzhen\\\"]\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-station-service POST /api/v1/stationservice/stations/idlist (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "[\"[\\\"1234\\\"]\", \"[\\\"shanghai\\\"]\", \"\\\"Grand Central Terminal\\\"\"]";
                        req = req.body(requestBody2);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"92708982-77af-4318-be25-57ccb0ff69ad\",\"endStation\":\"Grand Central Terminal\",\"id\":\"bdbacf78-877f-4d8c-ace5-399f12897a57\",\"startStation\":\"Grand Central Terminal\",\"stationList\":\"Grand Central Terminal\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"92708982-77af-4318-be25-57ccb0ff69ad\",\"distances\":\"[\\\"92708982-77af-4318-be25-57ccb0ff69ad\\\"]\",\"endStation\":\"austin\",\"id\":\"123\",\"loginId\":\"98765432-10fe-4567-89ab-cdef12345678\",\"startStation\":\"Grand Central Terminal\",\"stationList\":\"shanghai\",\"stations\":\"[\\\"xiamen\\\"]\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-station-service POST /api/v1/stationservice/stations/idlist (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "[\"[\\\"taiyuan\\\"]\", \"[\\\"aefcef3f-3f42-46e8-afd7-6cb2a928bd3d\\\"]\", \"\\\"Grand Central Terminal\\\"\", \"[\\\"nanjing\\\"]\"]";
                        req = req.body(requestBody2);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"92708982-77af-4318-be25-57ccb0ff69ad\",\"endStation\":\"austin\",\"id\":\"123\",\"startStation\":\"Grand Central Terminal\",\"stationList\":\"shanghai\"}";
                        req = req.body(requestBody3);
