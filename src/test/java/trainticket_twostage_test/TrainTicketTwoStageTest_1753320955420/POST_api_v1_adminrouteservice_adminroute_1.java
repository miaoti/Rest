package trainticket_twostage_test.TrainTicketTwoStageTest_1753320955420;
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        String requestBody1 = "{\"distanceList\":\"-5.5\",\"distances\":\"```json\",\"endStation\":\"Chicago union station\",\"id\":\"tests\",\"loginId\":\"bennett\",\"startStation\":\"boston south station\",\"stationList\":\"New york penn station\",\"stations\":\"times square station\"}";
            ...
            Allure.step("Step 2: ts-station-service POST /api/v1/stationservice/stations/idlist (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "[\"{id=04b0a8ff-4d70-40ca-9e55-98d2ca2cf325, name=wuxi, stayTime=3}\", \"Chicago\", \"Los Angeles\", \"Miami\"]";
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"-5.5\",\"endStation\":\"Chicago union station\",\"id\":\"tests\",\"startStation\":\"boston south station\",\"stationList\":\"New york penn station\"}";
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"BORDER_=\",\"distances\":\"```json\",\"endStation\":\"New york penn station\",\"id\":\"user123\",\"loginId\":\"Admins\",\"startStation\":\"chicago union passenger terminal\",\"stationList\":\"chicago loop\",\"stations\":\"Grand central terminal\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-station-service POST /api/v1/stationservice/stations/idlist (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "[\"{id=04b0a8ff-4d70-40ca-9e55-98d2ca2cf325, name=wuxi, stayTime=3}\", \"Chicago\", \"Los Angeles\"]";
                        req = req.body(requestBody2);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"BORDER_=\",\"endStation\":\"New york penn station\",\"id\":\"user123\",\"startStation\":\"chicago union passenger terminal\",\"stationList\":\"chicago loop\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"var_bd_=_getElementsByClass\",\"distances\":\"```json\",\"endStation\":\"Los angeles union station\",\"id\":\"test123\",\"loginId\":\"Admin456\",\"startStation\":\"new york penn station\",\"stationList\":\"los angeles union square\",\"stations\":\"Buckingham palace\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-station-service POST /api/v1/stationservice/stations/idlist (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "[\"{id=04b0a8ff-4d70-40ca-9e55-98d2ca2cf325, name=wuxi, stayTime=3}\", \"Chicago\"]";
                        req = req.body(requestBody2);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"var_bd_=_getElementsByClass\",\"endStation\":\"Los angeles union station\",\"id\":\"test123\",\"startStation\":\"new york penn station\",\"stationList\":\"los angeles union square\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"BORDER_=\",\"distances\":\"```\",\"endStation\":\"New York Penn Station\",\"id\":\"howdy\",\"loginId\":\"admins\",\"startStation\":\"los angeles union station\",\"stationList\":\"New York Penn Station\",\"stations\":\"sydney opera house\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"BORDER_=\",\"endStation\":\"New York Penn Station\",\"id\":\"howdy\",\"startStation\":\"los angeles union station\",\"stationList\":\"New York Penn Station\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"-5.5\",\"distances\":\"[\\\"10\\\", \\\"25.5\\\", \\\"40.3\\\", \\\"65.7\\\", \\\"80\\\"]\",\"endStation\":\"Los angeles union station\",\"id\":\"users\",\"loginId\":\"bennett\",\"startStation\":\"los angeles union station\",\"stationList\":\"new york penn station\",\"stations\":\"Sydney opera house\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"-5.5\",\"endStation\":\"Los angeles union station\",\"id\":\"users\",\"startStation\":\"los angeles union station\",\"stationList\":\"new york penn station\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"var_bd_=_getElementsByClass\",\"distances\":\"```\",\"endStation\":\"Houston Hobby Airport\",\"id\":\"hi\",\"loginId\":\"Admins\",\"startStation\":\"san francisco powell street bart station\",\"stationList\":\"Los angeles union square\",\"stations\":\"Sydney Opera House\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"var_bd_=_getElementsByClass\",\"endStation\":\"Houston Hobby Airport\",\"id\":\"hi\",\"startStation\":\"san francisco powell street bart station\",\"stationList\":\"Los angeles union square\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"-5.5\",\"distances\":\"```\",\"endStation\":\"new york penn station\",\"id\":\"tested\",\"loginId\":\"users\",\"startStation\":\"Boston South Station\",\"stationList\":\"houston hobby airport\",\"stations\":\"sydney opera house\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"-5.5\",\"endStation\":\"new york penn station\",\"id\":\"tested\",\"startStation\":\"Boston South Station\",\"stationList\":\"houston hobby airport\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"var_bd_=_getElementsByClass\",\"distances\":\"```json\",\"endStation\":\"Los angeles union station\",\"id\":\"Sydney_measured_####kbps\",\"loginId\":\"john_doe789\",\"startStation\":\"boston south station\",\"stationList\":\"Los angeles union square\",\"stations\":\"Museum of modern art\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"var_bd_=_getElementsByClass\",\"endStation\":\"Los angeles union station\",\"id\":\"Sydney_measured_####kbps\",\"startStation\":\"boston south station\",\"stationList\":\"Los angeles union square\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"-5.5\",\"distances\":\"[\\\"10\\\", \\\"25.5\\\", \\\"40.3\\\", \\\"65.7\\\", \\\"80\\\"]\",\"endStation\":\"houston hobby airport\",\"id\":\"testing\",\"loginId\":\"Admin456\",\"startStation\":\"Boston south station\",\"stationList\":\"chicago loop\",\"stations\":\"museum of modern art\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"-5.5\",\"endStation\":\"houston hobby airport\",\"id\":\"testing\",\"startStation\":\"Boston south station\",\"stationList\":\"chicago loop\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"bd_div_story\",\"distances\":\"[\\\"10\\\", \\\"25.5\\\", \\\"40.3\\\", \\\"65.7\\\", \\\"80\\\"]\",\"endStation\":\"chicago union station\",\"id\":\"user123\",\"loginId\":\"dave\",\"startStation\":\"boston south station\",\"stationList\":\"los angeles union square\",\"stations\":\"Grand central terminal\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"bd_div_story\",\"endStation\":\"chicago union station\",\"id\":\"user123\",\"startStation\":\"boston south station\",\"stationList\":\"los angeles union square\"}";
                        req = req.body(requestBody3);
