            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        String requestBody1 = "{\"distanceList\":\"0\",\"distances\":\"```json\",\"endStation\":\"Chicago Union Station\",\"id\":\"Sydney_measured_####kbps\",\"loginId\":\"admin456\",\"startStation\":\"Boston south station\",\"stationList\":\"chicago loop\",\"stations\":\"Buckingham palace\"}";
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"0\",\"endStation\":\"Chicago Union Station\",\"id\":\"Sydney_measured_####kbps\",\"startStation\":\"Boston south station\",\"stationList\":\"chicago loop\"}";
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"bd_div_story\",\"distances\":\"[\\\"10\\\", \\\"25.5\\\", \\\"40.3\\\", \\\"65.7\\\", \\\"80\\\"]\",\"endStation\":\"Boston south station\",\"id\":\"Abcdefg\",\"loginId\":\"User123\",\"startStation\":\"New york penn station\",\"stationList\":\"new york penn station\",\"stations\":\"Grand Central Terminal\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"bd_div_story\",\"endStation\":\"Boston south station\",\"id\":\"Abcdefg\",\"startStation\":\"New york penn station\",\"stationList\":\"new york penn station\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"BORDER_=\",\"distances\":\"```\",\"endStation\":\"Los Angeles Union Station\",\"id\":\"user123\",\"loginId\":\"root101\",\"startStation\":\"New York Penn Station\",\"stationList\":\"houston hobby airport\",\"stations\":\"buckingham palace\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"BORDER_=\",\"endStation\":\"Los Angeles Union Station\",\"id\":\"user123\",\"startStation\":\"New York Penn Station\",\"stationList\":\"houston hobby airport\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"-5.5\",\"distances\":\"```json\",\"endStation\":\"Chicago union station\",\"id\":\"Abcdefg\",\"loginId\":\"johnston\",\"startStation\":\"San Francisco Powell Street BART Station\",\"stationList\":\"new york penn station\",\"stations\":\"Museum of modern art\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"-5.5\",\"endStation\":\"Chicago union station\",\"id\":\"Abcdefg\",\"startStation\":\"San Francisco Powell Street BART Station\",\"stationList\":\"new york penn station\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"0\",\"distances\":\"[\\\"10\\\", \\\"25.5\\\", \\\"40.3\\\", \\\"65.7\\\", \\\"80\\\"]\",\"endStation\":\"new york penn station\",\"id\":\"goodbye\",\"loginId\":\"admins\",\"startStation\":\"New York Penn Station\",\"stationList\":\"San francisco 49ers stadium\",\"stations\":\"Sydney opera house\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"0\",\"endStation\":\"new york penn station\",\"id\":\"goodbye\",\"startStation\":\"New York Penn Station\",\"stationList\":\"San francisco 49ers stadium\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"bd_div_story\",\"distances\":\"```\",\"endStation\":\"Boston south station\",\"id\":\"test123\",\"loginId\":\"admin456\",\"startStation\":\"boston south station\",\"stationList\":\"New york penn station\",\"stations\":\"Buckingham palace\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"bd_div_story\",\"endStation\":\"Boston south station\",\"id\":\"test123\",\"startStation\":\"boston south station\",\"stationList\":\"New york penn station\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"0\",\"distances\":\"```json\",\"endStation\":\"Boston south station\",\"id\":\"testing\",\"loginId\":\"user123\",\"startStation\":\"new york penn station\",\"stationList\":\"Los angeles union square\",\"stations\":\"Sydney Opera House\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"0\",\"endStation\":\"Boston south station\",\"id\":\"testing\",\"startStation\":\"new york penn station\",\"stationList\":\"Los angeles union square\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"0\",\"distances\":\"[\\\"10\\\", \\\"25.5\\\", \\\"40.3\\\", \\\"65.7\\\", \\\"80\\\"]\",\"endStation\":\"Boston South Station\",\"id\":\"Test123\",\"loginId\":\"bennett\",\"startStation\":\"New york penn station\",\"stationList\":\"san francisco 49ers stadium\",\"stations\":\"Sydney Opera House\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-station-service POST /api/v1/stationservice/stations/idlist (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "[\"test639\", \"Chicago\"]";
                        req = req.body(requestBody2);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"0\",\"endStation\":\"Boston South Station\",\"id\":\"Test123\",\"startStation\":\"New york penn station\",\"stationList\":\"san francisco 49ers stadium\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"bd_div_story\",\"distances\":\"```json\",\"endStation\":\"Houston hobby airport\",\"id\":\"test123\",\"loginId\":\"dave\",\"startStation\":\"chicago union passenger terminal\",\"stationList\":\"Houston Hobby Airport\",\"stations\":\"Sydney Opera House\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"bd_div_story\",\"endStation\":\"Houston hobby airport\",\"id\":\"test123\",\"startStation\":\"chicago union passenger terminal\",\"stationList\":\"Houston Hobby Airport\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"bd_div_story\",\"distances\":\"```\",\"endStation\":\"Houston hobby airport\",\"id\":\"goodbye\",\"loginId\":\"Sydney_measured_####kbps\",\"startStation\":\"chicago union passenger terminal\",\"stationList\":\"Houston hobby airport\",\"stations\":\"buckingham palace\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"bd_div_story\",\"endStation\":\"Houston hobby airport\",\"id\":\"goodbye\",\"startStation\":\"chicago union passenger terminal\",\"stationList\":\"Houston hobby airport\"}";
                        req = req.body(requestBody3);
