package trainticket_twostage_test.TrainTicketTwoStageTest_1762293932700;
...
public class POST_api_v1_adminorderservice_adminorder_1 {
    ...
    public void test_faulty_POST_1_1() throws Exception {
        ...
        Allure.parameter("🔴 Faulty Parameters", "contactsName=1234567890123456789012345678901234567890, documentType=\"0xdeadbeef\", trainNumber=null");
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        String requestBody1 = "{\"accountId\":\"1234567890\",\"boughtDate\":\"2023-10-26\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"1234567890\",\"contactsName\":\"1234567890123456789012345678901234567890\",\"differenceMoney\":\"100\",\"documentType\":\"\\\"0xdeadbeef\\\"\",\"from\":\"12345\",\"id\":\"12345\",\"price\":\"19.99\",\"seatClass\":\"1\",\"seatNumber\":\"1A\",\"status\":\"0\",\"to\":\"JohnDoe\",\"trainNumber\":\"null\",\"travelDate\":\"2013-05-1\",\"travelTime\":\"30\"}";
    ...
    public void test_faulty_POST_1_2() throws Exception {
        // 🚨 FAULTY TEST METADATA
        Allure.parameter("🚨 Test Type", "FAULTY (Negative Testing)");
        Allure.parameter("🔴 Faulty Parameters", "differenceMoney=false, id= ");
        Allure.description("**⚠️ This is an intentional FAULTY test case for negative testing.**\n\n" +
                         "The following parameters were intentionally set to invalid values:\n" +
                         "differenceMoney=false\\nid= \n\n" +
                         "This test is expected to trigger validation errors or error responses.");
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"1234567890\",\"boughtDate\":\"2023-10-26\",\"coachNumber\":\"45678\",\"contactsDocumentNumber\":\"1234567890\",\"contactsName\":\"John Doe\",\"differenceMoney\":\"false\",\"documentType\":\"1\",\"from\":\"12345\",\"id\":\" \",\"price\":\"19.99\",\"seatClass\":\"1\",\"seatNumber\":\"1A\",\"status\":\"10\",\"to\":\"JohnDoe\",\"trainNumber\":\"12345\",\"travelDate\":\"2024-03-15\",\"travelTime\":\"30\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"accountId\":\"1234567890\",\"boughtDate\":\"2023-10-26\",\"coachNumber\":\"45678\",\"contactsDocumentNumber\":\"1234567890\",\"contactsName\":\"John Doe\",\"differenceMoney\":\"false\",\"documentType\":\"1\",\"from\":\"12345\",\"id\":\" \",\"price\":\"19.99\",\"seatClass\":\"1\",\"seatNumber\":\"1A\",\"status\":\"10\",\"to\":\"JohnDoe\",\"trainNumber\":\"12345\",\"travelDate\":\"2024-03-15\",\"travelTime\":\"30\"}");
                        Response stepResponse1 = req.when().post("/api/v1/adminorderservice/adminorder")
                               .then().log().ifValidationFails()
                               .statusCode(200)
                               .extract().response();
    ...
    public void test_faulty_POST_1_3() throws Exception {
        // 🚨 FAULTY TEST METADATA
        Allure.parameter("🚨 Test Type", "FAULTY (Negative Testing)");
        Allure.parameter("🔴 Faulty Parameters", "seatClass=1000000000000000, travelDate=2023-13-27-!@#$%^&*()_+=-`~[]\\{}|;':\",./<>?");
        Allure.description("**⚠️ This is an intentional FAULTY test case for negative testing.**\n\n" +
                         "The following parameters were intentionally set to invalid values:\n" +
                         "seatClass=1000000000000000\\ntravelDate=2023-13-27-!@#$%^&*()_+=-`~[]\\{}|;':\",./<>?\n\n" +
                         "This test is expected to trigger validation errors or error responses.");
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"1234567890\",\"boughtDate\":\"2023-10-26\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"1234567890\",\"contactsName\":\"Michael Brown\",\"differenceMoney\":\"100\",\"documentType\":\"1\",\"from\":\"12345\",\"id\":\"12345\",\"price\":\"19.99\",\"seatClass\":\"1000000000000000\",\"seatNumber\":\"1A\",\"status\":\"10\",\"to\":\"JohnDoe\",\"trainNumber\":\"12345\",\"travelDate\":\"2023-13-27-!@#$%^&*()_+=-`~[]\\\\{}|;':\\\",./<>?\",\"travelTime\":\"30\"}";
                        req = req.body(requestBody1);
    ...
    public void test_faulty_POST_1_4() throws Exception {
        // 🚨 FAULTY TEST METADATA
        Allure.parameter("🚨 Test Type", "FAULTY (Negative Testing)");
        Allure.parameter("🔴 Faulty Parameters", "coachNumber=0");
        Allure.description("**⚠️ This is an intentional FAULTY test case for negative testing.**\n\n" +
                         "The following parameters were intentionally set to invalid values:\n" +
                         "coachNumber=0\n\n" +
                         "This test is expected to trigger validation errors or error responses.");
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"1234567890\",\"boughtDate\":\"2023-10-26\",\"coachNumber\":\"0\",\"contactsDocumentNumber\":\"1234567890\",\"contactsName\":\"John Doe\",\"differenceMoney\":\"100\",\"documentType\":\"1\",\"from\":\"12345\",\"id\":\"123\",\"price\":\"19.99\",\"seatClass\":\"1\",\"seatNumber\":\"1A\",\"status\":\"10\",\"to\":\"JohnDoe\",\"trainNumber\":\"12345\",\"travelDate\":\"2024-03-15\",\"travelTime\":\"30\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"accountId\":\"1234567890\",\"boughtDate\":\"2023-10-26\",\"coachNumber\":\"0\",\"contactsDocumentNumber\":\"1234567890\",\"contactsName\":\"John Doe\",\"differenceMoney\":\"100\",\"documentType\":\"1\",\"from\":\"12345\",\"id\":\"123\",\"price\":\"19.99\",\"seatClass\":\"1\",\"seatNumber\":\"1A\",\"status\":\"10\",\"to\":\"JohnDoe\",\"trainNumber\":\"12345\",\"travelDate\":\"2024-03-15\",\"travelTime\":\"30\"}");
                        Response stepResponse1 = req.when().post("/api/v1/adminorderservice/adminorder")
                               .then().log().ifValidationFails()
                               .statusCode(200)
                               .extract().response();
    ...
    public void test_faulty_POST_1_5() throws Exception {
        // 🚨 FAULTY TEST METADATA
        Allure.parameter("🚨 Test Type", "FAULTY (Negative Testing)");
        Allure.parameter("🔴 Faulty Parameters", "boughtDate=2023-13-32-, coachNumber=null");
        Allure.description("**⚠️ This is an intentional FAULTY test case for negative testing.**\n\n" +
                         "The following parameters were intentionally set to invalid values:\n" +
                         "boughtDate=2023-13-32-\\ncoachNumber=null\n\n" +
                         "This test is expected to trigger validation errors or error responses.");
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"1234567890\",\"boughtDate\":\"2023-13-32-\",\"coachNumber\":null,\"contactsDocumentNumber\":\"1234567890\",\"contactsName\":\"John Doe\",\"differenceMoney\":\"100\",\"documentType\":\"1\",\"from\":\"12345\",\"id\":\"12345\",\"price\":\"19.99\",\"seatClass\":\"4\",\"seatNumber\":\"1A\",\"status\":\"10\",\"to\":\"JohnDoe\",\"trainNumber\":\"12345\",\"travelDate\":\"2024-03-15\",\"travelTime\":\"30\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"accountId\":\"1234567890\",\"boughtDate\":\"2023-13-32-\",\"coachNumber\":null,\"contactsDocumentNumber\":\"1234567890\",\"contactsName\":\"John Doe\",\"differenceMoney\":\"100\",\"documentType\":\"1\",\"from\":\"12345\",\"id\":\"12345\",\"price\":\"19.99\",\"seatClass\":\"4\",\"seatNumber\":\"1A\",\"status\":\"10\",\"to\":\"JohnDoe\",\"trainNumber\":\"12345\",\"travelDate\":\"2024-03-15\",\"travelTime\":\"30\"}");
                        Response stepResponse1 = req.when().post("/api/v1/adminorderservice/adminorder")
                               .then().log().ifValidationFails()
                               .statusCode(200)
                               .extract().response();
    ...
    public void test_faulty_POST_1_6() throws Exception {
        // 🚨 FAULTY TEST METADATA
        Allure.parameter("🚨 Test Type", "FAULTY (Negative Testing)");
        Allure.parameter("🔴 Faulty Parameters", "status=true, travelDate=2023-13-27-01-01-2023");
        Allure.description("**⚠️ This is an intentional FAULTY test case for negative testing.**\n\n" +
                         "The following parameters were intentionally set to invalid values:\n" +
                         "status=true\\ntravelDate=2023-13-27-01-01-2023\n\n" +
                         "This test is expected to trigger validation errors or error responses.");
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"1234567890\",\"boughtDate\":\"2023-10-26\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"1234567890\",\"contactsName\":\"Emily Wilson\",\"differenceMoney\":\"100\",\"documentType\":\"5000\",\"from\":\"12345\",\"id\":\"12345\",\"price\":\"19.99\",\"seatClass\":\"1\",\"seatNumber\":\"1A\",\"status\":\"true\",\"to\":\"123 Main Street\",\"trainNumber\":\"12345\",\"travelDate\":\"2023-13-27-01-01-2023\",\"travelTime\":\"30\"}";
                        req = req.body(requestBody1);
    ...
    public void test_faulty_POST_1_7() throws Exception {
        // 🚨 FAULTY TEST METADATA
        Allure.parameter("🚨 Test Type", "FAULTY (Negative Testing)");
        Allure.parameter("🔴 Faulty Parameters", "accountId= , boughtDate=2023-13-32, documentType=1000000000000000000");
        Allure.description("**⚠️ This is an intentional FAULTY test case for negative testing.**\n\n" +
                         "The following parameters were intentionally set to invalid values:\n" +
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\" \",\"boughtDate\":\"2023-13-32\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"1234567890\",\"contactsName\":\"John Doe\",\"differenceMoney\":\"100\",\"documentType\":\"1000000000000000000\",\"from\":\"12345\",\"id\":\"12345\",\"price\":\"19.99\",\"seatClass\":\"1\",\"seatNumber\":\"5B-10\",\"status\":\"10\",\"to\":\"JohnDoe\",\"trainNumber\":\"12345\",\"travelDate\":\"2024-03-15\",\"travelTime\":\"30\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"accountId\":\" \",\"boughtDate\":\"2023-13-32\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"1234567890\",\"contactsName\":\"John Doe\",\"differenceMoney\":\"100\",\"documentType\":\"1000000000000000000\",\"from\":\"12345\",\"id\":\"12345\",\"price\":\"19.99\",\"seatClass\":\"1\",\"seatNumber\":\"5B-10\",\"status\":\"10\",\"to\":\"JohnDoe\",\"trainNumber\":\"12345\",\"travelDate\":\"2024-03-15\",\"travelTime\":\"30\"}");
                        Response stepResponse1 = req.when().post("/api/v1/adminorderservice/adminorder")
                               .then().log().ifValidationFails()
                               .statusCode(200)
                               .extract().response();
    ...
    public void test_faulty_POST_1_8() throws Exception {
        // 🚨 FAULTY TEST METADATA
        Allure.parameter("🚨 Test Type", "FAULTY (Negative Testing)");
        Allure.parameter("🔴 Faulty Parameters", "coachNumber=abc, seatNumber=123, status=\"invalid\"");
        Allure.description("**⚠️ This is an intentional FAULTY test case for negative testing.**\n\n" +
                         "The following parameters were intentionally set to invalid values:\n" +
                         "coachNumber=abc\\nseatNumber=123\\nstatus=\"invalid\"\n\n" +
                         "This test is expected to trigger validation errors or error responses.");
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"1234567890\",\"boughtDate\":\"2023-10-26\",\"coachNumber\":\"abc\",\"contactsDocumentNumber\":\"1234567890\",\"contactsName\":\"John Doe\",\"differenceMoney\":\"100\",\"documentType\":\"1\",\"from\":\"12345\",\"id\":\"12345\",\"price\":\"19.99\",\"seatClass\":\"1\",\"seatNumber\":\"123\",\"status\":\"\\\"invalid\\\"\",\"to\":\"JohnDoe\",\"trainNumber\":\"12345\",\"travelDate\":\"2013-05-07 17:59:33\",\"travelTime\":\"30\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"accountId\":\"1234567890\",\"boughtDate\":\"2023-10-26\",\"coachNumber\":\"abc\",\"contactsDocumentNumber\":\"1234567890\",\"contactsName\":\"John Doe\",\"differenceMoney\":\"100\",\"documentType\":\"1\",\"from\":\"12345\",\"id\":\"12345\",\"price\":\"19.99\",\"seatClass\":\"1\",\"seatNumber\":\"123\",\"status\":\"\\\"invalid\\\"\",\"to\":\"JohnDoe\",\"trainNumber\":\"12345\",\"travelDate\":\"2013-05-07 17:59:33\",\"travelTime\":\"30\"}");
                        Response stepResponse1 = req.when().post("/api/v1/adminorderservice/adminorder")
                               .then().log().ifValidationFails()
                               .statusCode(200)
                               .extract().response();
    ...
    public void test_faulty_POST_1_9() throws Exception {
        // 🚨 FAULTY TEST METADATA
        Allure.parameter("🚨 Test Type", "FAULTY (Negative Testing)");
        Allure.parameter("🔴 Faulty Parameters", "price=\"123.456\", seatNumber=seatNumber");
        Allure.description("**⚠️ This is an intentional FAULTY test case for negative testing.**\n\n" +
                         "The following parameters were intentionally set to invalid values:\n" +
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"1234567890\",\"boughtDate\":\"2023-11-15\",\"coachNumber\":\"1000\",\"contactsDocumentNumber\":\"1234567890\",\"contactsName\":\"John Doe\",\"differenceMoney\":\"100\",\"documentType\":\"1\",\"from\":\"12345\",\"id\":\"-1\",\"price\":\"\\\"123.456\\\"\",\"seatClass\":\"1\",\"seatNumber\":\"seatNumber\",\"status\":\"10\",\"to\":\"JohnDoe\",\"trainNumber\":\"12345\",\"travelDate\":\"2024-03-15\",\"travelTime\":\"30\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"accountId\":\"1234567890\",\"boughtDate\":\"2023-11-15\",\"coachNumber\":\"1000\",\"contactsDocumentNumber\":\"1234567890\",\"contactsName\":\"John Doe\",\"differenceMoney\":\"100\",\"documentType\":\"1\",\"from\":\"12345\",\"id\":\"-1\",\"price\":\"\\\"123.456\\\"\",\"seatClass\":\"1\",\"seatNumber\":\"seatNumber\",\"status\":\"10\",\"to\":\"JohnDoe\",\"trainNumber\":\"12345\",\"travelDate\":\"2024-03-15\",\"travelTime\":\"30\"}");
                        Response stepResponse1 = req.when().post("/api/v1/adminorderservice/adminorder")
                               .then().log().ifValidationFails()
                               .statusCode(200)
                               .extract().response();
    ...
    public void test_faulty_POST_1_10() throws Exception {
        // 🚨 FAULTY TEST METADATA
        Allure.parameter("🚨 Test Type", "FAULTY (Negative Testing)");
        Allure.parameter("🔴 Faulty Parameters", "contactsName=hello, trainNumber=undefined");
        Allure.description("**⚠️ This is an intentional FAULTY test case for negative testing.**\n\n" +
                         "The following parameters were intentionally set to invalid values:\n" +
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"1234567890\",\"boughtDate\":\"2023-10-26\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"1234567890\",\"contactsName\":\"hello\",\"differenceMoney\":\"100\",\"documentType\":\"1\",\"from\":\"12345\",\"id\":\"12345\",\"price\":\"19.99\",\"seatClass\":\"1\",\"seatNumber\":\"1A\",\"status\":\"1000\",\"to\":\"Invalid Input\",\"trainNumber\":\"undefined\",\"travelDate\":\"2024-03-15\",\"travelTime\":\"30\"}";
                        req = req.body(requestBody1);
    ...
    public void test_faulty_POST_1_11() throws Exception {
        // 🚨 FAULTY TEST METADATA
        Allure.parameter("🚨 Test Type", "FAULTY (Negative Testing)");
        Allure.parameter("🔴 Faulty Parameters", "contactsName=null, documentType=2147483647");
        Allure.description("**⚠️ This is an intentional FAULTY test case for negative testing.**\n\n" +
                         "The following parameters were intentionally set to invalid values:\n" +
                         "contactsName=null\\ndocumentType=2147483647\n\n" +
                         "This test is expected to trigger validation errors or error responses.");
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"1234567890\",\"boughtDate\":\"2024-01-05\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"1234567890\",\"contactsName\":null,\"differenceMoney\":\"100\",\"documentType\":\"2147483647\",\"from\":\"12345\",\"id\":\"12345\",\"price\":\"19.99\",\"seatClass\":\"1\",\"seatNumber\":\"1A\",\"status\":\"10\",\"to\":\"JohnDoe\",\"trainNumber\":\"12345\",\"travelDate\":\"2024-03-15\",\"travelTime\":\"30\"}";
                        req = req.body(requestBody1);
    ...
    public void test_faulty_POST_1_12() throws Exception {
        // 🚨 FAULTY TEST METADATA
        Allure.parameter("🚨 Test Type", "FAULTY (Negative Testing)");
        Allure.parameter("🔴 Faulty Parameters", "documentType=123456789012345678901234567890");
        Allure.description("**⚠️ This is an intentional FAULTY test case for negative testing.**\n\n" +
                         "The following parameters were intentionally set to invalid values:\n" +
                         "documentType=123456789012345678901234567890\n\n" +
                         "This test is expected to trigger validation errors or error responses.");
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"1234567890\",\"boughtDate\":\"2023-10-26\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"1234567890\",\"contactsName\":\"John Doe\",\"differenceMoney\":\"0\",\"documentType\":\"123456789012345678901234567890\",\"from\":\"12345\",\"id\":\"12345\",\"price\":\"19.99\",\"seatClass\":\"1\",\"seatNumber\":\"1A\",\"status\":\"10\",\"to\":\"JohnDoe\",\"trainNumber\":\"12345\",\"travelDate\":\"2024-03-15\",\"travelTime\":\"30\"}";
                        req = req.body(requestBody1);
    ...
    public void test_faulty_POST_1_13() throws Exception {
        // 🚨 FAULTY TEST METADATA
        Allure.parameter("🚨 Test Type", "FAULTY (Negative Testing)");
        Allure.parameter("🔴 Faulty Parameters", "accountId=123, id=1234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890");
        Allure.description("**⚠️ This is an intentional FAULTY test case for negative testing.**\n\n" +
                         "The following parameters were intentionally set to invalid values:\n" +
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"123\",\"boughtDate\":\"2023-10-26\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"1234567890\",\"contactsName\":\"John Doe\",\"differenceMoney\":\"100\",\"documentType\":\"1\",\"from\":\"12345\",\"id\":\"1234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890\",\"price\":\"0.50\",\"seatClass\":\"1\",\"seatNumber\":\"1A\",\"status\":\"10\",\"to\":\"JohnDoe\",\"trainNumber\":\"12345\",\"travelDate\":\"2024-03-15\",\"travelTime\":\"65\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"1234567890\",\"boughtDate\":\"2023-10-26\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"1234567890\",\"contactsName\":\"John Doe\",\"differenceMoney\":\"100\",\"documentType\":\"1\",\"from\":\"12345\",\"id\":\"12345\",\"price\":\"19.99\",\"seatClass\":\"1\",\"seatNumber\":\"1A\",\"status\":\"@#$\",\"to\":\"JohnDoe\",\"trainNumber\":\"12345\",\"travelDate\":\"2024-03-15\",\"travelTime\":\"30\"}";
                        req = req.body(requestBody1);
    ...
    public void test_faulty_POST_1_15() throws Exception {
        // 🚨 FAULTY TEST METADATA
        Allure.parameter("🚨 Test Type", "FAULTY (Negative Testing)");
        Allure.parameter("🔴 Faulty Parameters", "accountId=abcde, seatNumber=null, to=true");
        Allure.description("**⚠️ This is an intentional FAULTY test case for negative testing.**\n\n" +
                         "The following parameters were intentionally set to invalid values:\n" +
                         "accountId=abcde\\nseatNumber=null\\nto=true\n\n" +
                         "This test is expected to trigger validation errors or error responses.");
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"abcde\",\"boughtDate\":\"2023-10-26\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"1234567890\",\"contactsName\":\"John Doe\",\"differenceMoney\":\"100\",\"documentType\":\"1\",\"from\":\"78901\",\"id\":\"12345\",\"price\":\"19.99\",\"seatClass\":\"1\",\"seatNumber\":null,\"status\":\"10\",\"to\":\"true\",\"trainNumber\":\"XYZ789\",\"travelDate\":\"2013-05-06 11:18:45\",\"travelTime\":\"30\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"accountId\":\"abcde\",\"boughtDate\":\"2023-10-26\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"1234567890\",\"contactsName\":\"John Doe\",\"differenceMoney\":\"100\",\"documentType\":\"1\",\"from\":\"78901\",\"id\":\"12345\",\"price\":\"19.99\",\"seatClass\":\"1\",\"seatNumber\":null,\"status\":\"10\",\"to\":\"true\",\"trainNumber\":\"XYZ789\",\"travelDate\":\"2013-05-06 11:18:45\",\"travelTime\":\"30\"}");
                        Response stepResponse1 = req.when().post("/api/v1/adminorderservice/adminorder")
                               .then().log().ifValidationFails()
                               .statusCode(200)
                               .extract().response();
