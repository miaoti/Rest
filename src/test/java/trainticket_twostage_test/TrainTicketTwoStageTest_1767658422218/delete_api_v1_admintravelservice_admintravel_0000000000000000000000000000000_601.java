...
public class delete_api_v1_admintravelservice_admintravel_0000000000000000000000000000000_601 {
    ...
    public void test_negative_DELETE_601_48() throws Exception {
        ...
        Allure.label("subSuite", "test_negative_DELETE_601_48");
                                    ...
                                    if (dataValue instanceof org.json.JSONObject) {
                                        ...
                                        if (dataObj.optBoolean("injected", false)) {
                                            ...
                                            if (!detectedFaultName.isEmpty()) {
                                                ...
                                                System.out.println("🔍 FAULT DETECTED (in failed test): " + detectedFaultName + " in test: test_negative_DELETE_601_48");
                                            }
                                        }
                                    }
                                }
