...
public class delete_api_v1_admintravelservice_admintravel_trip_321654_601 {
    ...
    public void test_DELETE_601_59() throws Exception {
        ...
        Allure.label("subSuite", "test_DELETE_601_59");
    ...
    public void test_DELETE_601_76() throws Exception {
        ...
        Allure.label("parentSuite", "ts-admin-travel-service");
        Allure.label("suite", "DELETE /api/v1/admintravelservice/admintravel/{tripId}");
        Allure.label("subSuite", "test_DELETE_601_76");
                                    ...
                                    if (dataValue instanceof org.json.JSONObject) {
                                        ...
                                        if (dataObj.optBoolean("injected", false)) {
                                            ...
                                            if (!detectedFaultName.isEmpty()) {
                                                ...
                                                System.out.println("🔍 FAULT DETECTED (in failed test): " + detectedFaultName + " in test: test_DELETE_601_76");
                                            }
                                        }
                                    }
                                }
