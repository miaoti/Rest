            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        String requestBody1 = "{\"distanceList\":\"350\",\"distances\":\"[\\\"10\\\", \\\"50\\\", \\\"100\\\", \\\"250\\\", \\\"500\\\"]\",\"endStation\":\"zhenjiang\",\"id\":\"3f78a\",\"loginId\":\"a1b2c3d4-e5f6-7890-1234-567890abcdef\",\"startStation\":\"wuxi\",\"stationList\":\"Grand Central Terminal\",\"stations\":\"Shanghai,suzhou,taiyuan\"}";
            ...
            Allure.step("Step 2: ts-station-service POST /api/v1/stationservice/stations/idlist (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "[\"dongguan\", \"changsha\"]";
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"350\",\"endStation\":\"zhenjiang\",\"id\":\"3f78a\",\"startStation\":\"wuxi\",\"stationList\":\"Grand Central Terminal\"}";
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"350\",\"distances\":\"[\\\"10\\\", \\\"50\\\", \\\"100\\\", \\\"250\\\", \\\"500\\\"]\",\"endStation\":\"jiaxingnan\",\"id\":\"9a2b3c4d-5678-e1fa-9b8c-d7e5f4a3b2c1\",\"loginId\":\"98765432-bcdef-4321-abcd-ef0123456789\",\"startStation\":\"wuxi\",\"stationList\":\"chongqing\",\"stations\":\"suzhou\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-station-service POST /api/v1/stationservice/stations/idlist (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "[\"haidian\", \"guangzhou\"]";
                        req = req.body(requestBody2);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"350\",\"endStation\":\"jiaxingnan\",\"id\":\"9a2b3c4d-5678-e1fa-9b8c-d7e5f4a3b2c1\",\"startStation\":\"wuxi\",\"stationList\":\"chongqing\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"350\",\"distances\":\"[\\\"10\\\", \\\"50\\\", \\\"100\\\", \\\"250\\\", \\\"500\\\"]\",\"endStation\":\"xuzhou\",\"id\":\"f1a2b3c4-5678-e1fa-9b8c-d7e5f4a3b2c1\",\"loginId\":\"4d2a46c7-71cb-4cf1-b5bb-b68406d9da6f\",\"startStation\":\"wuxi\",\"stationList\":\"shanghai,suzhou,taiyuan\",\"stations\":\"[\\\"Grand Central Terminal\\\", \\\"Union Station - Denver\\\", \\\"King Street Station - Newcastle\\\", \\\"Victoria Station - London\\\", \\\"Penn Station - New York\\\"]\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-station-service POST /api/v1/stationservice/stations/idlist (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "[\"[\\\"Grand Central Terminal\\\", \\\"O'Hare International Airport\\\", \\\"Hartsfield-Jackson Atlanta International Airport\\\", \\\"Denver International Airport\\\", \\\"LaGuardia Airport\\\"]\", \"qingdao\", \"xiamen\"]";
                        req = req.body(requestBody2);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"350\",\"endStation\":\"xuzhou\",\"id\":\"f1a2b3c4-5678-e1fa-9b8c-d7e5f4a3b2c1\",\"startStation\":\"wuxi\",\"stationList\":\"shanghai,suzhou,taiyuan\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"350\",\"distances\":\"[\\\"10\\\", \\\"50\\\", \\\"100\\\", \\\"250\\\", \\\"500\\\"]\",\"endStation\":\"wuxi,shijiazhuang\",\"id\":\"123\",\"loginId\":\"1a2b3c4d-5678-9012-345\",\"startStation\":\"wuxi\",\"stationList\":\"suzhou\",\"stations\":\"[\\\"Grand Central Terminal\\\", \\\"Union Station - Denver\\\", \\\"King Street Station - Newcastle\\\", \\\"Victoria Station - London\\\", \\\"Penn Station - New York\\\"]\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-station-service POST /api/v1/stationservice/stations/idlist (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "[\"wuxi,shijiazhuang\", \"nanjing\", \"zhengzhou\"]";
                        req = req.body(requestBody2);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"350\",\"endStation\":\"wuxi,shijiazhuang\",\"id\":\"123\",\"startStation\":\"wuxi\",\"stationList\":\"suzhou\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"350\",\"distances\":\"[\\\"10\\\", \\\"50\\\", \\\"100\\\", \\\"250\\\", \\\"500\\\"]\",\"endStation\":\"dallas\",\"id\":\"1c2d3e4f-5678-e1fa-9b8c-d7e5f4a3b2c1\",\"loginId\":\"f8a9b0c1-2345-6789-0123-456789abcdef\",\"startStation\":\"wuxi\",\"stationList\":\"shanghai\",\"stations\":\"shanghai\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-station-service POST /api/v1/stationservice/stations/idlist (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "[\"wuhan\", \"dongguan\", \"changsha\"]";
                        req = req.body(requestBody2);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"350\",\"endStation\":\"dallas\",\"id\":\"1c2d3e4f-5678-e1fa-9b8c-d7e5f4a3b2c1\",\"startStation\":\"wuxi\",\"stationList\":\"shanghai\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"350\",\"distances\":\"[\\\"10\\\", \\\"50\\\", \\\"100\\\", \\\"250\\\", \\\"500\\\"]\",\"endStation\":\"suzhou\",\"id\":\"e8b4d9a1-f3c2-4a7b-9d1e-c8f2a7b9d1e5\",\"loginId\":\"c7d8e9f0-1234-5678-9abc-def012345678\",\"startStation\":\"wuxi\",\"stationList\":\"taiyuan\",\"stations\":\"taiyuan\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-station-service POST /api/v1/stationservice/stations/idlist (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "[\"haidian\", \"guangzhou\", \"qingdao\", \"xiamen\"]";
                        req = req.body(requestBody2);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"350\",\"endStation\":\"suzhou\",\"id\":\"e8b4d9a1-f3c2-4a7b-9d1e-c8f2a7b9d1e5\",\"startStation\":\"wuxi\",\"stationList\":\"taiyuan\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"10\",\"distances\":\"[\\\"10\\\", \\\"50\\\", \\\"100\\\", \\\"250\\\", \\\"500\\\"]\",\"endStation\":\"waco\",\"id\":\"06f71780-c647-465c-969f-cf8c019bc45f\",\"loginId\":\"a1b2c3d4-e5f6-7890-1234-567890abcdef\",\"startStation\":\"wuxi\",\"stationList\":\"nanjing\",\"stations\":\"nanjing\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-station-service POST /api/v1/stationservice/stations/idlist (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "[\"wuxi,shijiazhuang\", \"nanjing\", \"zhengzhou\", \"wuhan\"]";
                        req = req.body(requestBody2);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"10\",\"endStation\":\"waco\",\"id\":\"06f71780-c647-465c-969f-cf8c019bc45f\",\"startStation\":\"wuxi\",\"stationList\":\"nanjing\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"350\",\"distances\":\"[\\\"10\\\", \\\"50\\\", \\\"100\\\", \\\"250\\\", \\\"500\\\"]\",\"endStation\":\"shijiazhuang\",\"id\":\"bdbacf78-877f-4d8c-ace5-399f12897a57\",\"loginId\":\"98765432-bcdef-4321-abcd-ef0123456789\",\"startStation\":\"Grand Central Terminal\",\"stationList\":\"zibo\",\"stations\":\"zhejiang\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-station-service POST /api/v1/stationservice/stations/idlist (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "[\"[\\\"Grand Central Terminal\\\", \\\"O'Hare International Airport\\\", \\\"Hartsfield-Jackson Atlanta International Airport\\\", \\\"Denver International Airport\\\", \\\"LaGuardia Airport\\\"]\", \"dongguan\", \"changsha\"]";
                        req = req.body(requestBody2);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"350\",\"endStation\":\"shijiazhuang\",\"id\":\"bdbacf78-877f-4d8c-ace5-399f12897a57\",\"startStation\":\"Grand Central Terminal\",\"stationList\":\"zibo\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"350\",\"distances\":\"[\\\"10\\\", \\\"50\\\", \\\"100\\\", \\\"250\\\", \\\"500\\\"]\",\"endStation\":\"austin\",\"id\":\"123\",\"loginId\":\"4d2a46c7-71cb-4cf1-b5bb-b68406d9da6f\",\"startStation\":\"wuxi\",\"stationList\":\"Grand Central Terminal\",\"stations\":\"hangzhou\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"350\",\"endStation\":\"austin\",\"id\":\"123\",\"startStation\":\"wuxi\",\"stationList\":\"Grand Central Terminal\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"350\",\"distances\":\"[\\\"10\\\", \\\"50\\\", \\\"100\\\", \\\"250\\\", \\\"500\\\"]\",\"endStation\":\"wuxi\",\"id\":\"3f78a\",\"loginId\":\"1a2b3c4d-5678-9012-345\",\"startStation\":\"wuxi\",\"stationList\":\"guangzhou\",\"stations\":\"wuxi\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-station-service POST /api/v1/stationservice/stations/idlist (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "[\"wuxi,shijiazhuang\", \"nanjing\", \"zhengzhou\", \"[\\\"Grand Central Terminal\\\", \\\"O'Hare International Airport\\\", \\\"Hartsfield-Jackson Atlanta International Airport\\\", \\\"Denver International Airport\\\", \\\"LaGuardia Airport\\\"]\"]";
                        req = req.body(requestBody2);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"350\",\"endStation\":\"wuxi\",\"id\":\"3f78a\",\"startStation\":\"wuxi\",\"stationList\":\"guangzhou\"}";
                        req = req.body(requestBody3);
