package trainticket_twostage_test.TrainTicketTwoStageTest_1754447499300;
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        String requestBody1 = "{\"accountId\":\"4d2a46c7-71cb-4cf1-b5bb-b68406d9da6f\",\"boughtDate\":\"2013-05-04 09:00:00\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"2135488099312X\",\"contactsName\":\"trainticket_notify@163.com\",\"differenceMoney\":\"100.0\",\"documentType\":\"1\",\"from\":\"shanghai\",\"id\":\"9a2b3c4d-5678-e1fa-9b8c-d7e5f4a3b2c1\",\"price\":\"8.0\",\"seatClass\":\"1\",\"seatNumber\":\"1A\",\"status\":\"1\",\"to\":\"PDX\",\"trainNumber\":\"12345\",\"travelDate\":\"2024-03-10\",\"travelTime\":\"30\"}";
            ...
            Allure.step("Step 2: ts-order-other-service POST /api/v1/orderOtherService/orderOther/admin (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "{\"accountId\":\"4d2a46c7-71cb-4cf1-b5bb-b68406d9da6f\",\"boughtDate\":\"2013-05-04 09:00:00\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"2135488099312X\",\"contactsName\":\"trainticket_notify@163.com\",\"documentType\":\"1\",\"from\":\"shanghai\",\"id\":\"9a2b3c4d-5678-e1fa-9b8c-d7e5f4a3b2c1\",\"price\":\"8.0\",\"seatClass\":\"1\",\"seatNumber\":\"1A\",\"status\":\"1\",\"to\":\"PDX\",\"trainNumber\":\"12345\",\"travelDate\":\"2024-03-10\",\"travelTime\":\"30\"}";
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"1234567890\",\"boughtDate\":\"2013-05-04 12:00:00\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"888888888888MN\",\"contactsName\":\"fdse_microservice\",\"differenceMoney\":\"10000.0\",\"documentType\":\"1\",\"from\":\"suzhou\",\"id\":\"f1a2b3c4-5678-e1fa-9b8c-d7e5f4a3b2c1\",\"price\":\"2.0\",\"seatClass\":\"1\",\"seatNumber\":\"1A\",\"status\":\"10\",\"to\":\"beijing\",\"trainNumber\":\"12345\",\"travelDate\":\"2024-03-10\",\"travelTime\":\"30\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-order-other-service POST /api/v1/orderOtherService/orderOther/admin (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "{\"accountId\":\"1234567890\",\"boughtDate\":\"2013-05-04 12:00:00\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"888888888888MN\",\"contactsName\":\"fdse_microservice\",\"documentType\":\"1\",\"from\":\"suzhou\",\"id\":\"f1a2b3c4-5678-e1fa-9b8c-d7e5f4a3b2c1\",\"price\":\"2.0\",\"seatClass\":\"1\",\"seatNumber\":\"1A\",\"status\":\"10\",\"to\":\"beijing\",\"trainNumber\":\"12345\",\"travelDate\":\"2024-03-10\",\"travelTime\":\"30\"}";
                        req = req.body(requestBody2);
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"xyz123abc-def456ghi-7890-jklm-\",\"boughtDate\":\"2013-05-04 15:51:52\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"777777777777OP\",\"contactsName\":\"account_manager_johnson\",\"differenceMoney\":\"5000.0\",\"documentType\":\"1\",\"from\":\"2013-05-04 12:00:00\",\"id\":\"1c2d3e4f-5678-e1fa-9b8c-d7e5f4a3b2c1\",\"price\":\"19.99\",\"seatClass\":\"1\",\"seatNumber\":\"1A\",\"status\":\"1235\",\"to\":\"ORD\",\"trainNumber\":\"12345\",\"travelDate\":\"2024-03-10\",\"travelTime\":\"30\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-order-other-service POST /api/v1/orderOtherService/orderOther/admin (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "{\"accountId\":\"xyz123abc-def456ghi-7890-jklm-\",\"boughtDate\":\"2013-05-04 15:51:52\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"777777777777OP\",\"contactsName\":\"account_manager_johnson\",\"documentType\":\"1\",\"from\":\"2013-05-04 12:00:00\",\"id\":\"1c2d3e4f-5678-e1fa-9b8c-d7e5f4a3b2c1\",\"price\":\"19.99\",\"seatClass\":\"1\",\"seatNumber\":\"1A\",\"status\":\"1235\",\"to\":\"ORD\",\"trainNumber\":\"12345\",\"travelDate\":\"2024-03-10\",\"travelTime\":\"30\"}";
                        req = req.body(requestBody2);
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"fedcba98-7654-3210-abcdef-01234567890\",\"boughtDate\":\"2023-10-26\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"666666666666QR\",\"contactsName\":\"sales_department\",\"differenceMoney\":\"250.0\",\"documentType\":\"1\",\"from\":\"2013-05-04 15:51:52\",\"id\":\"e8b4d9a1-f3c2-4a7b-9d1e-c8f2a7b9d1e5\",\"price\":\"4.0\",\"seatClass\":\"1\",\"seatNumber\":\"1A\",\"status\":\"1234\",\"to\":\"LAX\",\"trainNumber\":\"12345\",\"travelDate\":\"2024-03-10\",\"travelTime\":\"30\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-order-other-service POST /api/v1/orderOtherService/orderOther/admin (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "{\"accountId\":\"fedcba98-7654-3210-abcdef-01234567890\",\"boughtDate\":\"2023-10-26\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"666666666666QR\",\"contactsName\":\"sales_department\",\"documentType\":\"1\",\"from\":\"2013-05-04 15:51:52\",\"id\":\"e8b4d9a1-f3c2-4a7b-9d1e-c8f2a7b9d1e5\",\"price\":\"4.0\",\"seatClass\":\"1\",\"seatNumber\":\"1A\",\"status\":\"1234\",\"to\":\"LAX\",\"trainNumber\":\"12345\",\"travelDate\":\"2024-03-10\",\"travelTime\":\"30\"}";
                        req = req.body(requestBody2);
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"1a2b3c4d-5678-9012-3456-78901234567\",\"boughtDate\":\"2013-05-03 20:00:00\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"555555555555ST\",\"contactsName\":\"customer_service_desk\",\"differenceMoney\":\"120.0\",\"documentType\":\"1\",\"from\":\"2013-05-04 09:00:00\",\"id\":\"06f71780-c647-465c-969f-cf8c019bc45f\",\"price\":\"3. 20.0\",\"seatClass\":\"1\",\"seatNumber\":\"1A\",\"status\":\"56789\",\"to\":\"MIA\",\"trainNumber\":\"12345\",\"travelDate\":\"2024-03-10\",\"travelTime\":\"30\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-order-other-service POST /api/v1/orderOtherService/orderOther/admin (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "{\"accountId\":\"1a2b3c4d-5678-9012-3456-78901234567\",\"boughtDate\":\"2013-05-03 20:00:00\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"555555555555ST\",\"contactsName\":\"customer_service_desk\",\"documentType\":\"1\",\"from\":\"2013-05-04 09:00:00\",\"id\":\"06f71780-c647-465c-969f-cf8c019bc45f\",\"price\":\"3. 20.0\",\"seatClass\":\"1\",\"seatNumber\":\"1A\",\"status\":\"56789\",\"to\":\"MIA\",\"trainNumber\":\"12345\",\"travelDate\":\"2024-03-10\",\"travelTime\":\"30\"}";
                        req = req.body(requestBody2);
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"a1b2c3d4-e5f6-7890-1234-567890abcdef\",\"boughtDate\":\"2013-05-05 14:58:33\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"678901234567GH\",\"contactsName\":\"technical_support_team\",\"differenceMoney\":\"7500.5\",\"documentType\":\"1\",\"from\":\"taiyuan\",\"id\":\"bdbacf78-877f-4d8c-ace5-399f12897a57\",\"price\":\"4. 24.0\",\"seatClass\":\"1\",\"seatNumber\":\"1A\",\"status\":\"9876\",\"to\":\"DFW\",\"trainNumber\":\"12345\",\"travelDate\":\"2024-03-10\",\"travelTime\":\"30\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-order-other-service POST /api/v1/orderOtherService/orderOther/admin (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "{\"accountId\":\"a1b2c3d4-e5f6-7890-1234-567890abcdef\",\"boughtDate\":\"2013-05-05 14:58:33\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"678901234567GH\",\"contactsName\":\"technical_support_team\",\"documentType\":\"1\",\"from\":\"taiyuan\",\"id\":\"bdbacf78-877f-4d8c-ace5-399f12897a57\",\"price\":\"4. 24.0\",\"seatClass\":\"1\",\"seatNumber\":\"1A\",\"status\":\"9876\",\"to\":\"DFW\",\"trainNumber\":\"12345\",\"travelDate\":\"2024-03-10\",\"travelTime\":\"30\"}";
                        req = req.body(requestBody2);
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"98765432-bcdef-4321-abcd-ef0123456789\",\"boughtDate\":\"2013-05-04 07:22:11\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"123456789012IJ\",\"contactsName\":\"support_team\",\"differenceMoney\":\"10.50\",\"documentType\":\"1\",\"from\":\"2013-05-04 11:15:00\",\"id\":\"3f78a\",\"price\":\"7. 100.0\",\"seatClass\":\"1\",\"seatNumber\":\"1A\",\"status\":\"10\",\"to\":\"ATL\",\"trainNumber\":\"12345\",\"travelDate\":\"2024-03-10\",\"travelTime\":\"30\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-order-other-service POST /api/v1/orderOtherService/orderOther/admin (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "{\"accountId\":\"98765432-bcdef-4321-abcd-ef0123456789\",\"boughtDate\":\"2013-05-04 07:22:11\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"123456789012IJ\",\"contactsName\":\"support_team\",\"documentType\":\"1\",\"from\":\"2013-05-04 11:15:00\",\"id\":\"3f78a\",\"price\":\"7. 100.0\",\"seatClass\":\"1\",\"seatNumber\":\"1A\",\"status\":\"10\",\"to\":\"ATL\",\"trainNumber\":\"12345\",\"travelDate\":\"2024-03-10\",\"travelTime\":\"30\"}";
                        req = req.body(requestBody2);
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"4d2a46c7-71cb-4cf1-b5bb-b68406d9da6f\",\"boughtDate\":\"2013-05-04 11:45:00\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"382719546015AB\",\"contactsName\":\"marketing_lead\",\"differenceMoney\":\"3000.75\",\"documentType\":\"1\",\"from\":\"2013-05-05 08:30:00\",\"id\":\"9a2b3c4d-5678-e1fa-9b8c-d7e5f4a3b2c1\",\"price\":\"2. 16.0\",\"seatClass\":\"1\",\"seatNumber\":\"1A\",\"status\":\"2345\",\"to\":\"BCN\",\"trainNumber\":\"12345\",\"travelDate\":\"2024-03-15\",\"travelTime\":\"30\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-order-other-service POST /api/v1/orderOtherService/orderOther/admin (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "{\"accountId\":\"4d2a46c7-71cb-4cf1-b5bb-b68406d9da6f\",\"boughtDate\":\"2013-05-04 11:45:00\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"382719546015AB\",\"contactsName\":\"marketing_lead\",\"documentType\":\"1\",\"from\":\"2013-05-05 08:30:00\",\"id\":\"9a2b3c4d-5678-e1fa-9b8c-d7e5f4a3b2c1\",\"price\":\"2. 16.0\",\"seatClass\":\"1\",\"seatNumber\":\"1A\",\"status\":\"2345\",\"to\":\"BCN\",\"trainNumber\":\"12345\",\"travelDate\":\"2024-03-15\",\"travelTime\":\"30\"}";
                        req = req.body(requestBody2);
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"xyz123abc-def456ghi-7890-jklm-\",\"boughtDate\":\"2013-05-04 18:30:00\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"918273649203EF\",\"contactsName\":\"billing_inquiries@company.net\",\"differenceMoney\":\"10.50\",\"documentType\":\"1\",\"from\":\"guangzhou\",\"id\":\"f1a2b3c4-5678-e1fa-9b8c-d7e5f4a3b2c1\",\"price\":\"5. 32.0\",\"seatClass\":\"1\",\"seatNumber\":\"1A\",\"status\":\"1024\",\"to\":\"SFO\",\"trainNumber\":\"12345\",\"travelDate\":\"2024-03-10\",\"travelTime\":\"30\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-order-other-service POST /api/v1/orderOtherService/orderOther/admin (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "{\"accountId\":\"xyz123abc-def456ghi-7890-jklm-\",\"boughtDate\":\"2013-05-04 18:30:00\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"918273649203EF\",\"contactsName\":\"billing_inquiries@company.net\",\"documentType\":\"1\",\"from\":\"guangzhou\",\"id\":\"f1a2b3c4-5678-e1fa-9b8c-d7e5f4a3b2c1\",\"price\":\"5. 32.0\",\"seatClass\":\"1\",\"seatNumber\":\"1A\",\"status\":\"1024\",\"to\":\"SFO\",\"trainNumber\":\"12345\",\"travelDate\":\"2024-03-10\",\"travelTime\":\"30\"}";
                        req = req.body(requestBody2);
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"fedcba98-7654-3210-abcdef-01234567890\",\"boughtDate\":\"2013-05-05 02:15:47\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"445566778899JK\",\"contactsName\":\"trainticket_notify@163.com\",\"differenceMoney\":\"100.0\",\"documentType\":\"1\",\"from\":\"beijing\",\"id\":\"1c2d3e4f-5678-e1fa-9b8c-d7e5f4a3b2c1\",\"price\":\"1. 10.0\",\"seatClass\":\"1\",\"seatNumber\":\"1A\",\"status\":\"1122\",\"to\":\"JFK\",\"trainNumber\":\"12345\",\"travelDate\":\"2024-03-10\",\"travelTime\":\"30\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-order-other-service POST /api/v1/orderOtherService/orderOther/admin (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "{\"accountId\":\"fedcba98-7654-3210-abcdef-01234567890\",\"boughtDate\":\"2013-05-05 02:15:47\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"445566778899JK\",\"contactsName\":\"trainticket_notify@163.com\",\"documentType\":\"1\",\"from\":\"beijing\",\"id\":\"1c2d3e4f-5678-e1fa-9b8c-d7e5f4a3b2c1\",\"price\":\"1. 10.0\",\"seatClass\":\"1\",\"seatNumber\":\"1A\",\"status\":\"1122\",\"to\":\"JFK\",\"trainNumber\":\"12345\",\"travelDate\":\"2024-03-10\",\"travelTime\":\"30\"}";
                        req = req.body(requestBody2);
