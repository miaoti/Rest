            ...
            Allure.step("Step 1: ts-admin-basic-info-service POST /api/v1/adminbasicservice/adminbasic/prices (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        String requestBody1 = "{\"basicPriceRate\":\"0.38\",\"firstClassPriceRate\":\"15.99\",\"id\":\"0b23bd3e-876a-4af3-b920-c50a90c90b04\",\"routeId\":\"Route1\",\"trainType\":\"Commuter\"}";
            ...
            Allure.step("Step 2: ts-price-service POST /api/v1/priceservice/prices (expect 201)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "{\"basicPriceRate\":\"0.38\",\"firstClassPriceRate\":\"15.99\",\"id\":\"0b23bd3e-876a-4af3-b920-c50a90c90b04\",\"routeId\":\"Route1\",\"trainType\":\"Commuter\"}";
            ...
            Allure.step("Step 1: ts-admin-basic-info-service POST /api/v1/adminbasicservice/adminbasic/prices (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"basicPriceRate\":\"0.38\",\"firstClassPriceRate\":\"100.0\",\"id\":\"0b23bd3e-876a-4af3-b920-c50a90c90b04\",\"routeId\":\"Route1\",\"trainType\":\"Commuter\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-price-service POST /api/v1/priceservice/prices (expect 201)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "{\"basicPriceRate\":\"0.38\",\"firstClassPriceRate\":\"100.0\",\"id\":\"0b23bd3e-876a-4af3-b920-c50a90c90b04\",\"routeId\":\"Route1\",\"trainType\":\"Commuter\"}";
                        req = req.body(requestBody2);
            ...
            Allure.step("Step 1: ts-admin-basic-info-service POST /api/v1/adminbasicservice/adminbasic/prices (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"basicPriceRate\":\"0.38\",\"firstClassPriceRate\":\"100.0\",\"id\":\"0b23bd3e-876a-4af3-b920-c50a90c90b04\",\"routeId\":\"92708982-77af-4318-be25-57ccb0ff69ad\",\"trainType\":\"Commuter\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-price-service POST /api/v1/priceservice/prices (expect 201)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "{\"basicPriceRate\":\"0.38\",\"firstClassPriceRate\":\"100.0\",\"id\":\"0b23bd3e-876a-4af3-b920-c50a90c90b04\",\"routeId\":\"92708982-77af-4318-be25-57ccb0ff69ad\",\"trainType\":\"Commuter\"}";
                        req = req.body(requestBody2);
            ...
            Allure.step("Step 1: ts-admin-basic-info-service POST /api/v1/adminbasicservice/adminbasic/prices (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"basicPriceRate\":\"0.38\",\"firstClassPriceRate\":\"100.0\",\"id\":\"0b23bd3e-876a-4af3-b920-c50a90c90b04\",\"routeId\":\"nanjing\",\"trainType\":\"Commuter\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-price-service POST /api/v1/priceservice/prices (expect 201)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "{\"basicPriceRate\":\"0.38\",\"firstClassPriceRate\":\"100.0\",\"id\":\"0b23bd3e-876a-4af3-b920-c50a90c90b04\",\"routeId\":\"nanjing\",\"trainType\":\"Commuter\"}";
                        req = req.body(requestBody2);
            ...
            Allure.step("Step 1: ts-admin-basic-info-service POST /api/v1/adminbasicservice/adminbasic/prices (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"basicPriceRate\":\"0.38\",\"firstClassPriceRate\":\"100.0\",\"id\":\"0b23bd3e-876a-4af3-b920-c50a90c90b04\",\"routeId\":\"67aba9ad-f550-46b3-ac36-2de602f63bdf\",\"trainType\":\"Commuter\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-price-service POST /api/v1/priceservice/prices (expect 201)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "{\"basicPriceRate\":\"0.38\",\"firstClassPriceRate\":\"100.0\",\"id\":\"0b23bd3e-876a-4af3-b920-c50a90c90b04\",\"routeId\":\"67aba9ad-f550-46b3-ac36-2de602f63bdf\",\"trainType\":\"Commuter\"}";
                        req = req.body(requestBody2);
            ...
            Allure.step("Step 1: ts-admin-basic-info-service POST /api/v1/adminbasicservice/adminbasic/prices (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"basicPriceRate\":\"0.38\",\"firstClassPriceRate\":\"100.0\",\"id\":\"0b23bd3e-876a-4af3-b920-c50a90c90b04\",\"routeId\":\"suzhou\",\"trainType\":\"Commuter\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-price-service POST /api/v1/priceservice/prices (expect 201)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "{\"basicPriceRate\":\"0.38\",\"firstClassPriceRate\":\"100.0\",\"id\":\"0b23bd3e-876a-4af3-b920-c50a90c90b04\",\"routeId\":\"suzhou\",\"trainType\":\"Commuter\"}";
                        req = req.body(requestBody2);
            ...
            Allure.step("Step 1: ts-admin-basic-info-service POST /api/v1/adminbasicservice/adminbasic/prices (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"basicPriceRate\":\"0.38\",\"firstClassPriceRate\":\"15.99\",\"id\":\"0b23bd3e-876a-4af3-b920-c50a90c90b04\",\"routeId\":\"1dd34abf-d6a7-4769-95cd-b206384e5fb0\",\"trainType\":\"Commuter\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-price-service POST /api/v1/priceservice/prices (expect 201)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "{\"basicPriceRate\":\"0.38\",\"firstClassPriceRate\":\"15.99\",\"id\":\"0b23bd3e-876a-4af3-b920-c50a90c90b04\",\"routeId\":\"1dd34abf-d6a7-4769-95cd-b206384e5fb0\",\"trainType\":\"Commuter\"}";
                        req = req.body(requestBody2);
            ...
            Allure.step("Step 1: ts-admin-basic-info-service POST /api/v1/adminbasicservice/adminbasic/prices (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"basicPriceRate\":\"0.38\",\"firstClassPriceRate\":\"100.0\",\"id\":\"0b23bd3e-876a-4af3-b920-c50a90c90b04\",\"routeId\":\"shanghai\",\"trainType\":\"Commuter\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-price-service POST /api/v1/priceservice/prices (expect 201)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "{\"basicPriceRate\":\"0.38\",\"firstClassPriceRate\":\"100.0\",\"id\":\"0b23bd3e-876a-4af3-b920-c50a90c90b04\",\"routeId\":\"shanghai\",\"trainType\":\"Commuter\"}";
                        req = req.body(requestBody2);
            ...
            Allure.step("Step 1: ts-admin-basic-info-service POST /api/v1/adminbasicservice/adminbasic/prices (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"basicPriceRate\":\"0.38\",\"firstClassPriceRate\":\"100.0\",\"id\":\"12345\",\"routeId\":\"29915a35-fed9-43b8-b95b-bacd3b59c61f\",\"trainType\":\"Commuter\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-price-service POST /api/v1/priceservice/prices (expect 201)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "{\"basicPriceRate\":\"0.38\",\"firstClassPriceRate\":\"100.0\",\"id\":\"12345\",\"routeId\":\"29915a35-fed9-43b8-b95b-bacd3b59c61f\",\"trainType\":\"Commuter\"}";
                        req = req.body(requestBody2);
            ...
            Allure.step("Step 1: ts-admin-basic-info-service POST /api/v1/adminbasicservice/adminbasic/prices (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"basicPriceRate\":\"0.38\",\"firstClassPriceRate\":\"100.0\",\"id\":\"0b23bd3e-876a-4af3-b920-c50a90c90b04\",\"routeId\":\"aefcef3f-3f42-46e8-afd7-6cb2a928bd3d\",\"trainType\":\"Commuter\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-price-service POST /api/v1/priceservice/prices (expect 201)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "{\"basicPriceRate\":\"0.38\",\"firstClassPriceRate\":\"100.0\",\"id\":\"0b23bd3e-876a-4af3-b920-c50a90c90b04\",\"routeId\":\"aefcef3f-3f42-46e8-afd7-6cb2a928bd3d\",\"trainType\":\"Commuter\"}";
                        req = req.body(requestBody2);
