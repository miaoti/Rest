            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        String requestBody1 = "{\"distanceList\":\"350\",\"distances\":\"[\\\"10\\\", \\\"50\\\", \\\"100\\\", \\\"250\\\", \\\"500\\\"]\",\"endStation\":\"jiaxingnan\",\"id\":\"123\",\"loginId\":\"fedcba09-8765-4321-0fed-cba\",\"startStation\":\"wuxi\",\"stationList\":\"shanghai,suzhou,taiyuan\",\"stations\":\"[\\\"guangzhou\\\"]\"}";
            ...
            Allure.step("Step 2: ts-station-service POST /api/v1/stationservice/stations/idlist (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "[\"[\\\"haikou\\\"]\", \"[\\\"zhengzhou\\\"]\", \"[\\\"wenzhou\\\"]\"]";
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"350\",\"endStation\":\"jiaxingnan\",\"id\":\"123\",\"startStation\":\"wuxi\",\"stationList\":\"shanghai,suzhou,taiyuan\"}";
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"350\",\"distances\":\"[\\\"10\\\", \\\"50\\\", \\\"100\\\", \\\"250\\\", \\\"500\\\"]\",\"endStation\":\"xuzhou\",\"id\":\"bdbacf78-877f-4d8c-ace5-399f12897a57\",\"loginId\":\"a9b3c8e1-f2d9-4a7b-8c3d-e1f2a3b4c5d6\",\"startStation\":\"wuxi\",\"stationList\":\"suzhou\",\"stations\":\"[\\\"changzhou\\\"]\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-station-service POST /api/v1/stationservice/stations/idlist (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "[\"[\\\"changsha\\\"]\", \"[\\\"guangzhou\\\"]\"]";
                        req = req.body(requestBody2);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"350\",\"endStation\":\"xuzhou\",\"id\":\"bdbacf78-877f-4d8c-ace5-399f12897a57\",\"startStation\":\"wuxi\",\"stationList\":\"suzhou\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"350\",\"distances\":\"[\\\"10\\\", \\\"50\\\", \\\"100\\\", \\\"250\\\", \\\"500\\\"]\",\"endStation\":\"wuxi,shijiazhuang\",\"id\":\"98765432-10fe-4567-89ab-cdef01234567\",\"loginId\":\"34567890-abcdef-1234-5678-90abcdef1234\",\"startStation\":\"wuxi\",\"stationList\":\"shanghai\",\"stations\":\"[\\\"suzhou\\\", \\\"shanghai\\\"]\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-station-service POST /api/v1/stationservice/stations/idlist (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "[\"[\\\"dalian\\\"]\", \"[\\\"qingdao\\\"]\", \"[\\\"xiamen\\\"]\"]";
                        req = req.body(requestBody2);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"350\",\"endStation\":\"wuxi,shijiazhuang\",\"id\":\"98765432-10fe-4567-89ab-cdef01234567\",\"startStation\":\"wuxi\",\"stationList\":\"shanghai\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"10\",\"distances\":\"[\\\"10\\\", \\\"50\\\", \\\"100\\\", \\\"250\\\", \\\"500\\\"]\",\"endStation\":\"dallas\",\"id\":\"a1b2c3d4-5678-90ef-1234-567890abcdef1\",\"loginId\":\"c1d2e3f4-5678-9abc-def0-123456789012\",\"startStation\":\"wuxi\",\"stationList\":\"taiyuan\",\"stations\":\"[\\\"suzhou\\\"]\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-station-service POST /api/v1/stationservice/stations/idlist (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "[\"[\\\"wuxi\\\", \\\"shijiazhuang\\\"]\", \"[\\\"nanjing\\\"]\", \"[\\\"Grand Central Terminal\\\", \\\"O'Hare International Airport\\\", \\\"Hartsfield-Jackson Atlanta International Airport\\\", \\\"Denver International Airport\\\", \\\"LaGuardia Airport\\\"]\", \"[\\\"haikou\\\"]\"]";
                        req = req.body(requestBody2);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"10\",\"endStation\":\"dallas\",\"id\":\"a1b2c3d4-5678-90ef-1234-567890abcdef1\",\"startStation\":\"wuxi\",\"stationList\":\"taiyuan\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"350\",\"distances\":\"[\\\"10\\\", \\\"50\\\", \\\"100\\\", \\\"250\\\", \\\"500\\\"]\",\"endStation\":\"suzhou\",\"id\":\"3c4d5e6f-7890-1234-\",\"loginId\":\"4d2a46c7-71cb-4cf1-b5bb-b68406d9da6f\",\"startStation\":\"Grand Central Terminal\",\"stationList\":\"nanjing\",\"stations\":\"[\\\"shanghai\\\"]\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-station-service POST /api/v1/stationservice/stations/idlist (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "[\"[\\\"zhengzhou\\\"]\", \"[\\\"wenzhou\\\"]\", \"[\\\"changsha\\\"]\", \"[\\\"guangzhou\\\"]\"]";
                        req = req.body(requestBody2);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"350\",\"endStation\":\"suzhou\",\"id\":\"3c4d5e6f-7890-1234-\",\"startStation\":\"Grand Central Terminal\",\"stationList\":\"nanjing\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"350\",\"distances\":\"[\\\"10\\\", \\\"50\\\", \\\"100\\\", \\\"250\\\", \\\"500\\\"]\",\"endStation\":\"Grand Central Terminal\",\"id\":\"f1a2b3c4-5678-90ab-cdef-123456789012\",\"loginId\":\"7890abcdef-1234-5678-9abc-def012345678\",\"startStation\":\"wuxi\",\"stationList\":\"zhejiang\",\"stations\":\"[\\\"taiyuan\\\"]\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"350\",\"endStation\":\"Grand Central Terminal\",\"id\":\"f1a2b3c4-5678-90ab-cdef-123456789012\",\"startStation\":\"wuxi\",\"stationList\":\"zhejiang\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"350\",\"distances\":\"[\\\"10\\\", \\\"50\\\", \\\"100\\\", \\\"250\\\", \\\"500\\\"]\",\"endStation\":\"waco\",\"id\":\"e8a9b2c3-d456-7890-1234-567890abcdef\",\"loginId\":\"fedcba09-8765-4321-0fed-cba\",\"startStation\":\"wuxi\",\"stationList\":\"wuhan\",\"stations\":\"[\\\"nanjing\\\"]\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-station-service POST /api/v1/stationservice/stations/idlist (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "[\"[\\\"dalian\\\"]\", \"[\\\"qingdao\\\"]\", \"[\\\"Grand Central Terminal\\\", \\\"O'Hare International Airport\\\", \\\"Hartsfield-Jackson Atlanta International Airport\\\", \\\"Denver International Airport\\\", \\\"LaGuardia Airport\\\"]\"]";
                        req = req.body(requestBody2);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"350\",\"endStation\":\"waco\",\"id\":\"e8a9b2c3-d456-7890-1234-567890abcdef\",\"startStation\":\"wuxi\",\"stationList\":\"wuhan\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"350\",\"distances\":\"[\\\"10\\\", \\\"50\\\", \\\"100\\\", \\\"250\\\", \\\"500\\\"]\",\"endStation\":\"shijiazhuang\",\"id\":\"06f71780-c647-465c-969f-cf8c019bc45f\",\"loginId\":\"a9b3c8e1-f2d9-4a7b-8c3d-e1f2a3b4c5d6\",\"startStation\":\"wuxi\",\"stationList\":\"changsha\",\"stations\":\"[\\\"zhejiang\\\"]\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"350\",\"endStation\":\"shijiazhuang\",\"id\":\"06f71780-c647-465c-969f-cf8c019bc45f\",\"startStation\":\"wuxi\",\"stationList\":\"changsha\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"350\",\"distances\":\"[\\\"10\\\", \\\"50\\\", \\\"100\\\", \\\"250\\\", \\\"500\\\"]\",\"endStation\":\"austin\",\"id\":\"bdbacf78-877f-4d8c-ace5-399f12897a57\",\"loginId\":\"34567890-abcdef-1234-5678-90abcdef1234\",\"startStation\":\"wuxi\",\"stationList\":\"guangzhou\",\"stations\":\"[\\\"hangzhou\\\"]\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-station-service POST /api/v1/stationservice/stations/idlist (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "[\"[\\\"Grand Central Terminal\\\", \\\"O'Hare International Airport\\\", \\\"Hartsfield-Jackson Atlanta International Airport\\\", \\\"Denver International Airport\\\", \\\"LaGuardia Airport\\\"]\", \"[\\\"nanjing\\\"]\", \"[\\\"haikou\\\"]\", \"[\\\"zhengzhou\\\"]\"]";
                        req = req.body(requestBody2);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"350\",\"endStation\":\"austin\",\"id\":\"bdbacf78-877f-4d8c-ace5-399f12897a57\",\"startStation\":\"wuxi\",\"stationList\":\"guangzhou\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"350\",\"distances\":\"[\\\"10\\\", \\\"50\\\", \\\"100\\\", \\\"250\\\", \\\"500\\\"]\",\"endStation\":\"wuxi\",\"id\":\"98765432-10fe-4567-89ab-cdef01234567\",\"loginId\":\"c1d2e3f4-5678-9abc-def0-123456789012\",\"startStation\":\"wuxi\",\"stationList\":\"shanghai,suzhou,taiyuan\",\"stations\":\"[\\\"guangzhou\\\"]\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-station-service POST /api/v1/stationservice/stations/idlist (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "[\"[\\\"wenzhou\\\"]\", \"[\\\"changsha\\\"]\"]";
                        req = req.body(requestBody2);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"350\",\"endStation\":\"wuxi\",\"id\":\"98765432-10fe-4567-89ab-cdef01234567\",\"startStation\":\"wuxi\",\"stationList\":\"shanghai,suzhou,taiyuan\"}";
                        req = req.body(requestBody3);
