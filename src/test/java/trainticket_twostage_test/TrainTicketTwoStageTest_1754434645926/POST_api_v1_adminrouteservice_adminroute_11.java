            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        String requestBody1 = "{\"distanceList\":\"[\\\"125.7\\\"]\",\"distances\":\"[12.5, 78.2, 34.1, 99.7, 5.3]\",\"endStation\":\"nanning\",\"id\":\"12345\",\"loginId\":\"4d2a46c7-71cb-4cf1-b5bb-b68406d9da6f\",\"startStation\":\"hangzhou\",\"stationList\":\"[\\\"Travel Planning Platform\\\"]\",\"stations\":\"[\\\"xiamen\\\"]\"}";
            ...
            Allure.step("Step 2: ts-station-service POST /api/v1/stationservice/stations/idlist (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "[\"[\\\"xian\\\"]\", \"[\\\"tianjin\\\"]\", \"[\\\"guangzhou\\\"]\"]";
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"[\\\"125.7\\\"]\",\"endStation\":\"nanning\",\"id\":\"12345\",\"startStation\":\"hangzhou\",\"stationList\":\"[\\\"Travel Planning Platform\\\"]\"}";
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"[\\\"125.7\\\"]\",\"distances\":\"[12.5, 78.2, 34.1, 99.7, 5.3]\",\"endStation\":\"shenzhen\",\"id\":\"database records\",\"loginId\":\"user123\",\"startStation\":\"shanghai\",\"stationList\":\"Grand Central Terminal\",\"stations\":\"[\\\"shanghai\\\", \\\"nanjing\\\", \\\"shijiazhuang\\\", \\\"taiyuan\\\"]\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-station-service POST /api/v1/stationservice/stations/idlist (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "[\"[\\\"beijing\\\"]\", \"[\\\"chongqing\\\"]\", \"[\\\"shanghai\\\", \\\"suzhou\\\", \\\"taiyuan\\\"]\"]";
                        req = req.body(requestBody2);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"[\\\"125.7\\\"]\",\"endStation\":\"shenzhen\",\"id\":\"database records\",\"startStation\":\"shanghai\",\"stationList\":\"Grand Central Terminal\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"[\\\"125.7\\\"]\",\"distances\":\"[12.5, 78.2, 34.1, 99.7, 5.3]\",\"endStation\":\"chongqing\",\"id\":\"06f71780-c647-465c-969f-cf8c019bc45f\",\"loginId\":\"c7d8e9f0-1a2b-3c4d-5e\",\"startStation\":\"shanghaihongqiao\",\"stationList\":\"[\\\"Journey Planner API\\\"]\",\"stations\":\"[\\\"nanjing\\\"]\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-station-service POST /api/v1/stationservice/stations/idlist (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "[\"[\\\"suzhou\\\"]\", \"[\\\"shanghai\\\"]\"]";
                        req = req.body(requestBody2);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"[\\\"125.7\\\"]\",\"endStation\":\"chongqing\",\"id\":\"06f71780-c647-465c-969f-cf8c019bc45f\",\"startStation\":\"shanghaihongqiao\",\"stationList\":\"[\\\"Journey Planner API\\\"]\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"[\\\"125.7\\\"]\",\"distances\":\"10\",\"endStation\":\"Grand Central Terminal\",\"id\":\"b2d5f8a9\",\"loginId\":\"the generated values will also be UUIDs.\",\"startStation\":\"Grand Central Terminal\",\"stationList\":\"[\\\"RoutePlan Service\\\"]\",\"stations\":\"[\\\"shijiazhuang\\\"]\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-station-service POST /api/v1/stationservice/stations/idlist (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "[\"[\\\"taiyuan\\\"]\", \"[\\\"wuhan\\\"]\", \"[\\\"xian\\\"]\", \"[\\\"tianjin\\\"]\"]";
                        req = req.body(requestBody2);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"[\\\"125.7\\\"]\",\"endStation\":\"Grand Central Terminal\",\"id\":\"b2d5f8a9\",\"startStation\":\"Grand Central Terminal\",\"stationList\":\"[\\\"RoutePlan Service\\\"]\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"[\\\"125.7\\\"]\",\"distances\":\"[12.5, 78.2, 34.1, 99.7, 5.3]\",\"endStation\":\"taiyuan\",\"id\":\"transactions).\",\"loginId\":\"4d2a46c7-71cb-4cf1-b5bb-b68406d9da6f\",\"startStation\":\"jinan\",\"stationList\":\"[\\\"Transit Routing System\\\"]\",\"stations\":\"[\\\"shanghai\\\"]\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-station-service POST /api/v1/stationservice/stations/idlist (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "[\"Grand Central Terminal\", \"[\\\"guangzhou\\\"]\", \"[\\\"beijing\\\"]\", \"[\\\"chongqing\\\"]\"]";
                        req = req.body(requestBody2);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"[\\\"125.7\\\"]\",\"endStation\":\"taiyuan\",\"id\":\"transactions).\",\"startStation\":\"jinan\",\"stationList\":\"[\\\"Transit Routing System\\\"]\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"[\\\"125.7\\\"]\",\"distances\":\"[12.5, 78.2, 34.1, 99.7, 5.3]\",\"endStation\":\"zhengzhou\",\"id\":\"objects\",\"loginId\":\"user123\",\"startStation\":\"taiyuan\",\"stationList\":\"[\\\"Public Transport Navigator\\\"]\",\"stations\":\"Grand Central Terminal\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-station-service POST /api/v1/stationservice/stations/idlist (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "[\"[\\\"shanghai\\\", \\\"suzhou\\\", \\\"taiyuan\\\"]\", \"[\\\"suzhou\\\"]\", \"[\\\"shanghai\\\"]\", \"[\\\"taiyuan\\\"]\"]";
                        req = req.body(requestBody2);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"[\\\"125.7\\\"]\",\"endStation\":\"zhengzhou\",\"id\":\"objects\",\"startStation\":\"taiyuan\",\"stationList\":\"[\\\"Public Transport Navigator\\\"]\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"[\\\"125.7\\\"]\",\"distances\":\"[12.5, 78.2, 34.1, 99.7, 5.3]\",\"endStation\":\"wuhan\",\"id\":\"database records\",\"loginId\":\"c7d8e9f0-1a2b-3c4d-5e\",\"startStation\":\"xuzhou\",\"stationList\":\"Grand Central Terminal\",\"stations\":\"[\\\"jinan\\\"]\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-station-service POST /api/v1/stationservice/stations/idlist (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "[\"[\\\"wuhan\\\"]\", \"[\\\"xian\\\"]\", \"[\\\"tianjin\\\"]\", \"[\\\"guangzhou\\\"]\"]";
                        req = req.body(requestBody2);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"[\\\"125.7\\\"]\",\"endStation\":\"wuhan\",\"id\":\"database records\",\"startStation\":\"xuzhou\",\"stationList\":\"Grand Central Terminal\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"[\\\"125.7\\\"]\",\"distances\":\"10\",\"endStation\":\"changsha\",\"id\":\"06f71780-c647-465c-969f-cf8c019bc45f\",\"loginId\":\"the generated values will also be UUIDs.\",\"startStation\":\"wuxi\",\"stationList\":\"[\\\"Mobility Solutions API\\\"]\",\"stations\":\"[\\\"beijing\\\"]\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-station-service POST /api/v1/stationservice/stations/idlist (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "[\"[\\\"beijing\\\"]\", \"[\\\"chongqing\\\"]\", \"[\\\"shanghai\\\", \\\"suzhou\\\", \\\"taiyuan\\\"]\", \"[\\\"suzhou\\\"]\"]";
                        req = req.body(requestBody2);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"[\\\"125.7\\\"]\",\"endStation\":\"changsha\",\"id\":\"06f71780-c647-465c-969f-cf8c019bc45f\",\"startStation\":\"wuxi\",\"stationList\":\"[\\\"Mobility Solutions API\\\"]\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"[\\\"125.7\\\"]\",\"distances\":\"[12.5, 78.2, 34.1, 99.7, 5.3]\",\"endStation\":\"xi'an\",\"id\":\"b2d5f8a9\",\"loginId\":\"4d2a46c7-71cb-4cf1-b5bb-b68406d9da6f\",\"startStation\":\"Grand Central Terminal\",\"stationList\":\"[\\\"Navigation Hub\\\"]\",\"stations\":\"Grand Central Terminal\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-station-service POST /api/v1/stationservice/stations/idlist (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "[\"Grand Central Terminal\", \"[\\\"shanghai\\\"]\"]";
                        req = req.body(requestBody2);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"[\\\"125.7\\\"]\",\"endStation\":\"xi'an\",\"id\":\"b2d5f8a9\",\"startStation\":\"Grand Central Terminal\",\"stationList\":\"[\\\"Navigation Hub\\\"]\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"[\\\"125.7\\\"]\",\"distances\":\"[12.5, 78.2, 34.1, 99.7, 5.3]\",\"endStation\":\"dalian\",\"id\":\"12345\",\"loginId\":\"c7d8e9f0-1a2b-3c4d-5e\",\"startStation\":\"nanjing\",\"stationList\":\"[\\\"Route Optimization Engine\\\"]\",\"stations\":\"[\\\"taiyuan\\\"]\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"[\\\"125.7\\\"]\",\"endStation\":\"dalian\",\"id\":\"12345\",\"startStation\":\"nanjing\",\"stationList\":\"[\\\"Route Optimization Engine\\\"]\"}";
                        req = req.body(requestBody3);
