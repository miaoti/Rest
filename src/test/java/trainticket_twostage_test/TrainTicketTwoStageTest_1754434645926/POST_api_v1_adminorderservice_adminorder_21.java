            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        String requestBody1 = "{\"accountId\":\"4d2a46c7-71cb-4cf1-b5bb-b68406d9da6f\",\"boughtDate\":\"2025-04-30 09:14:53\",\"coachNumber\":\"5\",\"contactsDocumentNumber\":\"DocumentNumber_One\",\"contactsName\":\"fdse_microservice\",\"differenceMoney\":\"12.75\",\"documentType\":\"1\",\"from\":\"shanghai\",\"id\":\"transactions).\",\"price\":\"10000.0\",\"seatClass\":\"1\",\"seatNumber\":\"1A\",\"status\":\"[\\\"0\\\"]\",\"to\":\"beijing\",\"trainNumber\":\"K102\",\"travelDate\":\"2024-03-10\",\"travelTime\":\"6:00\"}";
            ...
            Allure.step("Step 2: ts-order-other-service POST /api/v1/orderOtherService/orderOther/admin (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "{\"accountId\":\"4d2a46c7-71cb-4cf1-b5bb-b68406d9da6f\",\"boughtDate\":\"2025-04-30 09:14:53\",\"coachNumber\":\"5\",\"contactsDocumentNumber\":\"DocumentNumber_One\",\"contactsName\":\"fdse_microservice\",\"documentType\":\"1\",\"from\":\"shanghai\",\"id\":\"transactions).\",\"price\":\"10000.0\",\"seatClass\":\"1\",\"seatNumber\":\"1A\",\"status\":\"[\\\"0\\\"]\",\"to\":\"beijing\",\"trainNumber\":\"K102\",\"travelDate\":\"2024-03-10\",\"travelTime\":\"6:00\"}";
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"12345\",\"boughtDate\":\"2025-05-19 12:51:00\",\"coachNumber\":\"11\",\"contactsDocumentNumber\":\"DocumentNumber_Six\",\"contactsName\":\"John Smith\",\"differenceMoney\":\"12.75\",\"documentType\":\"2\",\"from\":\"suzhou\",\"id\":\"12345\",\"price\":\"13100.99\",\"seatClass\":\"1\",\"seatNumber\":\"FirstClass-30\",\"status\":\"[\\\"1\\\"]\",\"to\":\"Beijing\",\"trainNumber\":\"K102\",\"travelDate\":\"2024-03-10\",\"travelTime\":\"2013-05-04 17:51:52\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-order-other-service POST /api/v1/orderOtherService/orderOther/admin (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "{\"accountId\":\"12345\",\"boughtDate\":\"2025-05-19 12:51:00\",\"coachNumber\":\"11\",\"contactsDocumentNumber\":\"DocumentNumber_Six\",\"contactsName\":\"John Smith\",\"documentType\":\"2\",\"from\":\"suzhou\",\"id\":\"12345\",\"price\":\"13100.99\",\"seatClass\":\"1\",\"seatNumber\":\"FirstClass-30\",\"status\":\"[\\\"1\\\"]\",\"to\":\"Beijing\",\"trainNumber\":\"K102\",\"travelDate\":\"2024-03-10\",\"travelTime\":\"2013-05-04 17:51:52\"}";
                        req = req.body(requestBody2);
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"567890ab-cd12-34ef-5678-9\",\"boughtDate\":\"2025-07-10 21:03:59\",\"coachNumber\":\"12\",\"contactsDocumentNumber\":\"DocumentNumber_Two\",\"contactsName\":\"reporting_engine\",\"differenceMoney\":\"12.75\",\"documentType\":\"3\",\"from\":\"taiyuan\",\"id\":\"objects\",\"price\":\"12.99\",\"seatClass\":\"[\\\"1\\\"]\",\"seatNumber\":\"BusinessClass-8A\",\"status\":\"[\\\"2\\\"]\",\"to\":\"Shanghai\",\"trainNumber\":\"12345\",\"travelDate\":\"2024-03-10\",\"travelTime\":\"2013-05-04 15:51:52\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-order-other-service POST /api/v1/orderOtherService/orderOther/admin (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "{\"accountId\":\"567890ab-cd12-34ef-5678-9\",\"boughtDate\":\"2025-07-10 21:03:59\",\"coachNumber\":\"12\",\"contactsDocumentNumber\":\"DocumentNumber_Two\",\"contactsName\":\"reporting_engine\",\"documentType\":\"3\",\"from\":\"taiyuan\",\"id\":\"objects\",\"price\":\"12.99\",\"seatClass\":\"[\\\"1\\\"]\",\"seatNumber\":\"BusinessClass-8A\",\"status\":\"[\\\"2\\\"]\",\"to\":\"Shanghai\",\"trainNumber\":\"12345\",\"travelDate\":\"2024-03-10\",\"travelTime\":\"2013-05-04 15:51:52\"}";
                        req = req.body(requestBody2);
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"4d2a46c7-71cb-4cf1-b5bb-b68406d9da6f\",\"boughtDate\":\"2025-12-17\",\"coachNumber\":\"13\",\"contactsDocumentNumber\":\"DocumentNumber_Four\",\"contactsName\":\"auth_service\",\"differenceMoney\":\"12.75\",\"documentType\":\"4\",\"from\":\"2024-01-01\",\"id\":\"database records\",\"price\":\"11200.75\",\"seatClass\":\"[\\\"1\\\"]\",\"seatNumber\":\"FirstClass-21\",\"status\":\"[\\\"3\\\"]\",\"to\":\"Nanjing\",\"trainNumber\":\"K102\",\"travelDate\":\"2024-03-10\",\"travelTime\":\"2013-05-04 11:31:52\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-order-other-service POST /api/v1/orderOtherService/orderOther/admin (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "{\"accountId\":\"4d2a46c7-71cb-4cf1-b5bb-b68406d9da6f\",\"boughtDate\":\"2025-12-17\",\"coachNumber\":\"13\",\"contactsDocumentNumber\":\"DocumentNumber_Four\",\"contactsName\":\"auth_service\",\"documentType\":\"4\",\"from\":\"2024-01-01\",\"id\":\"database records\",\"price\":\"11200.75\",\"seatClass\":\"[\\\"1\\\"]\",\"seatNumber\":\"FirstClass-21\",\"status\":\"[\\\"3\\\"]\",\"to\":\"Nanjing\",\"trainNumber\":\"K102\",\"travelDate\":\"2024-03-10\",\"travelTime\":\"2013-05-04 11:31:52\"}";
                        req = req.body(requestBody2);
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"567890ab-cd12-34ef-5678-9\",\"boughtDate\":\"2025-06-02 07:45:22\",\"coachNumber\":\"14\",\"contactsDocumentNumber\":\"DocNum_Two\",\"contactsName\":\"payment_gateway\",\"differenceMoney\":\"12.75\",\"documentType\":\"5\",\"from\":\"zhengzhou\",\"id\":\"06f71780-c647-465c-969f-cf8c019bc45f\",\"price\":\"7999.00\",\"seatClass\":\"[\\\"1\\\"]\",\"seatNumber\":\"Economy-112B\",\"status\":\"0\",\"to\":\"Chengdu\",\"trainNumber\":\"12345\",\"travelDate\":\"2024-03-15\",\"travelTime\":\"2013-05-04 09:51:52\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-order-other-service POST /api/v1/orderOtherService/orderOther/admin (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "{\"accountId\":\"567890ab-cd12-34ef-5678-9\",\"boughtDate\":\"2025-06-02 07:45:22\",\"coachNumber\":\"14\",\"contactsDocumentNumber\":\"DocNum_Two\",\"contactsName\":\"payment_gateway\",\"documentType\":\"5\",\"from\":\"zhengzhou\",\"id\":\"06f71780-c647-465c-969f-cf8c019bc45f\",\"price\":\"7999.00\",\"seatClass\":\"[\\\"1\\\"]\",\"seatNumber\":\"Economy-112B\",\"status\":\"0\",\"to\":\"Chengdu\",\"trainNumber\":\"12345\",\"travelDate\":\"2024-03-15\",\"travelTime\":\"2013-05-04 09:51:52\"}";
                        req = req.body(requestBody2);
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"4d2a46c7-71cb-4cf1-b5bb-b68406d9da6f\",\"boughtDate\":\"2025-08-28 14:17:33\",\"coachNumber\":\"6\",\"contactsDocumentNumber\":\"DocumentNumber_Three\",\"contactsName\":\"data_ingestion\",\"differenceMoney\":\"12.75\",\"documentType\":\"6\",\"from\":\"wuhan\",\"id\":\"b2d5f8a9\",\"price\":\"9200.00\",\"seatClass\":\"[\\\"1\\\"]\",\"seatNumber\":\"EconomyPlus-22B\",\"status\":\"[\\\"4\\\"]\",\"to\":\"Wuhan\",\"trainNumber\":\"K102\",\"travelDate\":\"2024-03-10\",\"travelTime\":\"2013-05-04 22:45:12\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-order-other-service POST /api/v1/orderOtherService/orderOther/admin (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "{\"accountId\":\"4d2a46c7-71cb-4cf1-b5bb-b68406d9da6f\",\"boughtDate\":\"2025-08-28 14:17:33\",\"coachNumber\":\"6\",\"contactsDocumentNumber\":\"DocumentNumber_Three\",\"contactsName\":\"data_ingestion\",\"documentType\":\"6\",\"from\":\"wuhan\",\"id\":\"b2d5f8a9\",\"price\":\"9200.00\",\"seatClass\":\"[\\\"1\\\"]\",\"seatNumber\":\"EconomyPlus-22B\",\"status\":\"[\\\"4\\\"]\",\"to\":\"Wuhan\",\"trainNumber\":\"K102\",\"travelDate\":\"2024-03-10\",\"travelTime\":\"2013-05-04 22:45:12\"}";
                        req = req.body(requestBody2);
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"567890ab-cd12-34ef-5678-9\",\"boughtDate\":\"2025-09-05 02:56:47\",\"coachNumber\":\"7\",\"contactsDocumentNumber\":\"DocNum_Three\",\"contactsName\":\"analytics_pipeline\",\"differenceMoney\":\"12.75\",\"documentType\":\"7\",\"from\":\"hangzhou\",\"id\":\"transactions).\",\"price\":\"12500.00\",\"seatClass\":\"1\",\"seatNumber\":\"Economy-45C\",\"status\":\"[\\\"5\\\"]\",\"to\":\"Chongqing\",\"trainNumber\":\"K102\",\"travelDate\":\"2024-03-10\",\"travelTime\":\"2013-05-05 14:31:02\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-order-other-service POST /api/v1/orderOtherService/orderOther/admin (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "{\"accountId\":\"567890ab-cd12-34ef-5678-9\",\"boughtDate\":\"2025-09-05 02:56:47\",\"coachNumber\":\"7\",\"contactsDocumentNumber\":\"DocNum_Three\",\"contactsName\":\"analytics_pipeline\",\"documentType\":\"7\",\"from\":\"hangzhou\",\"id\":\"transactions).\",\"price\":\"12500.00\",\"seatClass\":\"1\",\"seatNumber\":\"Economy-45C\",\"status\":\"[\\\"5\\\"]\",\"to\":\"Chongqing\",\"trainNumber\":\"K102\",\"travelDate\":\"2024-03-10\",\"travelTime\":\"2013-05-05 14:31:02\"}";
                        req = req.body(requestBody2);
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"4d2a46c7-71cb-4cf1-b5bb-b68406d9da6f\",\"boughtDate\":\"2025-10-22 19:39:16\",\"coachNumber\":\"8\",\"contactsDocumentNumber\":\"DocumentNumber_Five\",\"contactsName\":\"security_module\",\"differenceMoney\":\"12.75\",\"documentType\":\"8\",\"from\":\"dalian\",\"id\":\"objects\",\"price\":\"10500.00\",\"seatClass\":\"[\\\"1\\\"]\",\"seatNumber\":\"1A\",\"status\":\"0\",\"to\":\"2024-01-26\",\"trainNumber\":\"12345\",\"travelDate\":\"2024-03-10\",\"travelTime\":\"2013-05-05 08:12:12\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-order-other-service POST /api/v1/orderOtherService/orderOther/admin (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "{\"accountId\":\"4d2a46c7-71cb-4cf1-b5bb-b68406d9da6f\",\"boughtDate\":\"2025-10-22 19:39:16\",\"coachNumber\":\"8\",\"contactsDocumentNumber\":\"DocumentNumber_Five\",\"contactsName\":\"security_module\",\"documentType\":\"8\",\"from\":\"dalian\",\"id\":\"objects\",\"price\":\"10500.00\",\"seatClass\":\"[\\\"1\\\"]\",\"seatNumber\":\"1A\",\"status\":\"0\",\"to\":\"2024-01-26\",\"trainNumber\":\"12345\",\"travelDate\":\"2024-03-10\",\"travelTime\":\"2013-05-05 08:12:12\"}";
                        req = req.body(requestBody2);
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"567890ab-cd12-34ef-5678-9\",\"boughtDate\":\"2025-03-15 16:28:11\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"DocNum_One\",\"contactsName\":\"inventory_manager\",\"differenceMoney\":\"12.75\",\"documentType\":\"9\",\"from\":\"kunming\",\"id\":\"database records\",\"price\":\"9876.50\",\"seatClass\":\"[\\\"1\\\"]\",\"seatNumber\":\"BusinessClass-12A\",\"status\":\"[\\\"6\\\"]\",\"to\":\"Guangzhou\",\"trainNumber\":\"12345\",\"travelDate\":\"2024-03-10\",\"travelTime\":\"2013-05-04 13:21:32\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-order-other-service POST /api/v1/orderOtherService/orderOther/admin (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "{\"accountId\":\"567890ab-cd12-34ef-5678-9\",\"boughtDate\":\"2025-03-15 16:28:11\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"DocNum_One\",\"contactsName\":\"inventory_manager\",\"documentType\":\"9\",\"from\":\"kunming\",\"id\":\"database records\",\"price\":\"9876.50\",\"seatClass\":\"[\\\"1\\\"]\",\"seatNumber\":\"BusinessClass-12A\",\"status\":\"[\\\"6\\\"]\",\"to\":\"Guangzhou\",\"trainNumber\":\"12345\",\"travelDate\":\"2024-03-10\",\"travelTime\":\"2013-05-04 13:21:32\"}";
                        req = req.body(requestBody2);
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"12345\",\"boughtDate\":\"2025-11-08 05:01:29\",\"coachNumber\":\"9\",\"contactsDocumentNumber\":\"Document_Number_One\",\"contactsName\":\"user_profile_api\",\"differenceMoney\":\"12.75\",\"documentType\":\"10\",\"from\":\"xiamen\",\"id\":\"06f71780-c647-465c-969f-cf8c019bc45f\",\"price\":\"8750.20\",\"seatClass\":\"[\\\"1\\\"]\",\"seatNumber\":\"FirstClass-05\",\"status\":\"[\\\"7\\\"]\",\"to\":\"Hangzhou\",\"trainNumber\":\"K102\",\"travelDate\":\"2024-03-10\",\"travelTime\":\"7:15\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-order-other-service POST /api/v1/orderOtherService/orderOther/admin (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "{\"accountId\":\"12345\",\"boughtDate\":\"2025-11-08 05:01:29\",\"coachNumber\":\"9\",\"contactsDocumentNumber\":\"Document_Number_One\",\"contactsName\":\"user_profile_api\",\"documentType\":\"10\",\"from\":\"xiamen\",\"id\":\"06f71780-c647-465c-969f-cf8c019bc45f\",\"price\":\"8750.20\",\"seatClass\":\"[\\\"1\\\"]\",\"seatNumber\":\"FirstClass-05\",\"status\":\"[\\\"7\\\"]\",\"to\":\"Hangzhou\",\"trainNumber\":\"K102\",\"travelDate\":\"2024-03-10\",\"travelTime\":\"7:15\"}";
                        req = req.body(requestBody2);
