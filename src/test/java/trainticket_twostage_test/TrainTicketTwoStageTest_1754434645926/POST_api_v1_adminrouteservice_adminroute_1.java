            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        String requestBody1 = "{\"distanceList\":\"125.7\",\"distances\":\"[12.5, 78.2, 34.1, 99.7, 5.3]\",\"endStation\":\"Grand Central Terminal\",\"id\":\"06f71780-c647-465c-969f-cf8c019bc45f\",\"loginId\":\"4d2a46c7-71cb-4cf1-b5bb-b68406d9da6f\",\"startStation\":\"wuxi\",\"stationList\":\"[\\\"RoutePlan Service\\\"]\",\"stations\":\"[\\\"shanghai\\\", \\\"nanjing\\\", \\\"shijiazhuang\\\", \\\"taiyuan\\\"]\"}";
            ...
            Allure.step("Step 2: ts-station-service POST /api/v1/stationservice/stations/idlist (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "[\"[\\\"shanghai\\\", \\\"suzhou\\\", \\\"taiyuan\\\"]\", \"[\\\"suzhou\\\"]\"]";
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"125.7\",\"endStation\":\"Grand Central Terminal\",\"id\":\"06f71780-c647-465c-969f-cf8c019bc45f\",\"startStation\":\"wuxi\",\"stationList\":\"[\\\"RoutePlan Service\\\"]\"}";
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"[\\\"125.7\\\"]\",\"distances\":\"[12.5, 78.2, 34.1, 99.7, 5.3]\",\"endStation\":\"taiyuan\",\"id\":\"b2d5f8a9\",\"loginId\":\"c7d8e9f0-1a2b-3c4d-5e\",\"startStation\":\"nanjing\",\"stationList\":\"[\\\"Transit Routing System\\\"]\",\"stations\":\"[\\\"nanjing\\\"]\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-station-service POST /api/v1/stationservice/stations/idlist (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "[\"[\\\"shanghai\\\"]\", \"[\\\"taiyuan\\\"]\", \"[\\\"wuhan\\\"]\"]";
                        req = req.body(requestBody2);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"[\\\"125.7\\\"]\",\"endStation\":\"taiyuan\",\"id\":\"b2d5f8a9\",\"startStation\":\"nanjing\",\"stationList\":\"[\\\"Transit Routing System\\\"]\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"[\\\"125.7\\\"]\",\"distances\":\"[12.5, 78.2, 34.1, 99.7, 5.3]\",\"endStation\":\"zhengzhou\",\"id\":\"transactions).\",\"loginId\":\"the generated values will also be UUIDs.\",\"startStation\":\"dallas\",\"stationList\":\"Grand Central Terminal\",\"stations\":\"[\\\"shijiazhuang\\\"]\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"[\\\"125.7\\\"]\",\"endStation\":\"zhengzhou\",\"id\":\"transactions).\",\"startStation\":\"dallas\",\"stationList\":\"Grand Central Terminal\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"[\\\"125.7\\\"]\",\"distances\":\"[12.5, 78.2, 34.1, 99.7, 5.3]\",\"endStation\":\"wuhan\",\"id\":\"12345\",\"loginId\":\"4d2a46c7-71cb-4cf1-b5bb-b68406d9da6f\",\"startStation\":\"waco\",\"stationList\":\"Grand Central Terminal\",\"stations\":\"[\\\"shanghai\\\"]\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"[\\\"125.7\\\"]\",\"endStation\":\"wuhan\",\"id\":\"12345\",\"startStation\":\"waco\",\"stationList\":\"Grand Central Terminal\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"[\\\"125.7\\\"]\",\"distances\":\"[12.5, 78.2, 34.1, 99.7, 5.3]\",\"endStation\":\"Grand Central Terminal\",\"id\":\"objects\",\"loginId\":\"c7d8e9f0-1a2b-3c4d-5e\",\"startStation\":\"shijiazhuang\",\"stationList\":\"[\\\"Public Transport Navigator\\\"]\",\"stations\":\"[\\\"jinan\\\"]\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-station-service POST /api/v1/stationservice/stations/idlist (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "[\"[\\\"suzhou\\\"]\", \"[\\\"shanghai\\\"]\", \"[\\\"taiyuan\\\"]\"]";
                        req = req.body(requestBody2);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"[\\\"125.7\\\"]\",\"endStation\":\"Grand Central Terminal\",\"id\":\"objects\",\"startStation\":\"shijiazhuang\",\"stationList\":\"[\\\"Public Transport Navigator\\\"]\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"[\\\"125.7\\\"]\",\"distances\":\"[12.5, 78.2, 34.1, 99.7, 5.3]\",\"endStation\":\"changsha\",\"id\":\"database records\",\"loginId\":\"the generated values will also be UUIDs.\",\"startStation\":\"beijing\",\"stationList\":\"[\\\"Mobility Solutions API\\\"]\",\"stations\":\"Grand Central Terminal\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-station-service POST /api/v1/stationservice/stations/idlist (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "[\"[\\\"wuhan\\\"]\", \"Grand Central Terminal\"]";
                        req = req.body(requestBody2);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"[\\\"125.7\\\"]\",\"endStation\":\"changsha\",\"id\":\"database records\",\"startStation\":\"beijing\",\"stationList\":\"[\\\"Mobility Solutions API\\\"]\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"[\\\"125.7\\\"]\",\"distances\":\"[12.5, 78.2, 34.1, 99.7, 5.3]\",\"endStation\":\"Grand Central Terminal\",\"id\":\"06f71780-c647-465c-969f-cf8c019bc45f\",\"loginId\":\"user123\",\"startStation\":\"zhenjiang\",\"stationList\":\"[\\\"Navigation Hub\\\"]\",\"stations\":\"[\\\"beijing\\\"]\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"[\\\"125.7\\\"]\",\"endStation\":\"Grand Central Terminal\",\"id\":\"06f71780-c647-465c-969f-cf8c019bc45f\",\"startStation\":\"zhenjiang\",\"stationList\":\"[\\\"Navigation Hub\\\"]\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"[\\\"125.7\\\"]\",\"distances\":\"[12.5, 78.2, 34.1, 99.7, 5.3]\",\"endStation\":\"xi'an\",\"id\":\"b2d5f8a9\",\"loginId\":\"4d2a46c7-71cb-4cf1-b5bb-b68406d9da6f\",\"startStation\":\"jiaxingnan\",\"stationList\":\"[\\\"Route Optimization Engine\\\"]\",\"stations\":\"[\\\"taiyuan\\\"]\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"[\\\"125.7\\\"]\",\"endStation\":\"xi'an\",\"id\":\"b2d5f8a9\",\"startStation\":\"jiaxingnan\",\"stationList\":\"[\\\"Route Optimization Engine\\\"]\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"[\\\"125.7\\\"]\",\"distances\":\"[12.5, 78.2, 34.1, 99.7, 5.3]\",\"endStation\":\"dalian\",\"id\":\"transactions).\",\"loginId\":\"c7d8e9f0-1a2b-3c4d-5e\",\"startStation\":\"suzhou\",\"stationList\":\"[\\\"Commute Assistance Service\\\"]\",\"stations\":\"[\\\"xuzhou\\\"]\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"[\\\"125.7\\\"]\",\"endStation\":\"dalian\",\"id\":\"transactions).\",\"startStation\":\"suzhou\",\"stationList\":\"[\\\"Commute Assistance Service\\\"]\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"[\\\"125.7\\\"]\",\"distances\":\"[12.5, 78.2, 34.1, 99.7, 5.3]\",\"endStation\":\"kunming\",\"id\":\"objects\",\"loginId\":\"the generated values will also be UUIDs.\",\"startStation\":\"austin\",\"stationList\":\"[\\\"Trip Design Tool\\\"]\",\"stations\":\"[\\\"wuhan\\\"]\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-station-service POST /api/v1/stationservice/stations/idlist (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "[\"Grand Central Terminal\", \"[\\\"taiyuan\\\"]\", \"[\\\"wuhan\\\"]\"]";
                        req = req.body(requestBody2);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"[\\\"125.7\\\"]\",\"endStation\":\"kunming\",\"id\":\"objects\",\"startStation\":\"austin\",\"stationList\":\"[\\\"Trip Design Tool\\\"]\"}";
                        req = req.body(requestBody3);
