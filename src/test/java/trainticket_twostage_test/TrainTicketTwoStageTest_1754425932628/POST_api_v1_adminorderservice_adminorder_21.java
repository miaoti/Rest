package trainticket_twostage_test.TrainTicketTwoStageTest_1754425932628;
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        String requestBody1 = "{\"accountId\":\"test881\",\"boughtDate\":\"test912\",\"coachNumber\":\"test972\",\"contactsDocumentNumber\":\"test26\",\"contactsName\":\"test79\",\"differenceMoney\":\"test132\",\"documentType\":\"test172\",\"from\":\"test200\",\"id\":\"user123\",\"price\":\"test291\",\"seatClass\":\"test338\",\"seatNumber\":\"test399\",\"status\":\"test442\",\"to\":\"test505\",\"trainNumber\":\"test536\",\"travelDate\":\"test576\",\"travelTime\":\"test618\"}";
            ...
            Allure.step("Step 2: ts-order-other-service POST /api/v1/orderOtherService/orderOther/admin (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "{\"accountId\":\"test881\",\"boughtDate\":\"test912\",\"coachNumber\":\"test972\",\"contactsDocumentNumber\":\"test26\",\"contactsName\":\"test79\",\"documentType\":\"test172\",\"from\":\"test200\",\"id\":\"user123\",\"price\":\"test291\",\"seatClass\":\"test338\",\"seatNumber\":\"test399\",\"status\":\"test442\",\"to\":\"test505\",\"trainNumber\":\"test536\",\"travelDate\":\"test576\",\"travelTime\":\"test618\"}";
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"test881\",\"boughtDate\":\"test912\",\"coachNumber\":\"test972\",\"contactsDocumentNumber\":\"test26\",\"contactsName\":\"test79\",\"differenceMoney\":\"test132\",\"documentType\":\"test172\",\"from\":\"test200\",\"id\":\"user123\",\"price\":\"test291\",\"seatClass\":\"test338\",\"seatNumber\":\"test399\",\"status\":\"test442\",\"to\":\"test505\",\"trainNumber\":\"$.data[*].name\",\"travelDate\":\"0b23bd3e-876a-4af3-b920-c50a90c90b04\",\"travelTime\":\"$.data[0].endTime\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-order-other-service POST /api/v1/orderOtherService/orderOther/admin (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "{\"accountId\":\"test881\",\"boughtDate\":\"test912\",\"coachNumber\":\"test972\",\"contactsDocumentNumber\":\"test26\",\"contactsName\":\"test79\",\"documentType\":\"test172\",\"from\":\"test200\",\"id\":\"user123\",\"price\":\"test291\",\"seatClass\":\"test338\",\"seatNumber\":\"test399\",\"status\":\"test442\",\"to\":\"test505\",\"trainNumber\":\"$.data[*].name\",\"travelDate\":\"0b23bd3e-876a-4af3-b920-c50a90c90b04\",\"travelTime\":\"$.data[0].endTime\"}";
                        req = req.body(requestBody2);
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"06f71780-c647-465c-969f-cf8c019bc45f\",\"boughtDate\":\"test912\",\"coachNumber\":\"test972\",\"contactsDocumentNumber\":\"test26\",\"contactsName\":\"test79\",\"differenceMoney\":\"test132\",\"documentType\":\"test172\",\"from\":\"test200\",\"id\":\"user123\",\"price\":\"test291\",\"seatClass\":\"test338\",\"seatNumber\":\"test399\",\"status\":\"test442\",\"to\":\"test505\",\"trainNumber\":\"$.data[*].name\",\"travelDate\":\"0b23bd3e-876a-4af3-b920-c50a90c90b04\",\"travelTime\":\"$.data[0].endTime\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-order-other-service POST /api/v1/orderOtherService/orderOther/admin (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "{\"accountId\":\"06f71780-c647-465c-969f-cf8c019bc45f\",\"boughtDate\":\"test912\",\"coachNumber\":\"test972\",\"contactsDocumentNumber\":\"test26\",\"contactsName\":\"test79\",\"documentType\":\"test172\",\"from\":\"test200\",\"id\":\"user123\",\"price\":\"test291\",\"seatClass\":\"test338\",\"seatNumber\":\"test399\",\"status\":\"test442\",\"to\":\"test505\",\"trainNumber\":\"$.data[*].name\",\"travelDate\":\"0b23bd3e-876a-4af3-b920-c50a90c90b04\",\"travelTime\":\"$.data[0].endTime\"}";
                        req = req.body(requestBody2);
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"06f71780-c647-465c-969f-cf8c019bc45f\",\"boughtDate\":\"test912\",\"coachNumber\":\"test972\",\"contactsDocumentNumber\":\"test26\",\"contactsName\":\"test79\",\"differenceMoney\":\"test132\",\"documentType\":\"test172\",\"from\":\"test200\",\"id\":\"user123\",\"price\":\"test291\",\"seatClass\":\"test338\",\"seatNumber\":\"test399\",\"status\":\"test442\",\"to\":\"test505\",\"trainNumber\":\"$.data[*].name\",\"travelDate\":\"test576\",\"travelTime\":\"$.data[0].endTime\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-order-other-service POST /api/v1/orderOtherService/orderOther/admin (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "{\"accountId\":\"06f71780-c647-465c-969f-cf8c019bc45f\",\"boughtDate\":\"test912\",\"coachNumber\":\"test972\",\"contactsDocumentNumber\":\"test26\",\"contactsName\":\"test79\",\"documentType\":\"test172\",\"from\":\"test200\",\"id\":\"user123\",\"price\":\"test291\",\"seatClass\":\"test338\",\"seatNumber\":\"test399\",\"status\":\"test442\",\"to\":\"test505\",\"trainNumber\":\"$.data[*].name\",\"travelDate\":\"test576\",\"travelTime\":\"$.data[0].endTime\"}";
                        req = req.body(requestBody2);
