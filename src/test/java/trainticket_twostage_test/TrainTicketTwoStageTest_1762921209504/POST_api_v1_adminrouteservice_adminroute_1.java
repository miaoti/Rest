            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        String requestBody1 = "{\"distanceList\":\"12.5\",\"distances\":\"INVALID_VALUE_MISSING_distances\",\"endStation\":\"New York Penn Station\",\"id\":\"RT-7890\",\"loginId\":\"service_login_456\",\"startStation\":\"Boston South Station\",\"stationList\":\"Central Station\",\"stations\":[\"Grand Central Terminal\",\"Times Square Station\",\"Brooklyn Bridge Station\",\"Union Square Station\",\"Chelsea Station\"]}";
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"12.5\",\"distances\":\"INVALID_VALUE_MISSING_distances\",\"endStation\":\"New York Penn Station\",\"id\":\"RT-7890\",\"loginId\":\"service_login_456\",\"startStation\":\"Boston South Station\",\"stationList\":\"Central Station\",\"stations\":[\"Grand Central Terminal\",\"Times Square Station\",\"Brooklyn Bridge Station\",\"Union Square Station\",\"Chelsea Station\"]}");
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"12.5\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":\"New York Penn Station\",\"id\":\"RT-7890\",\"loginId\":\"operator007\",\"startStation\":\"New York Penn Station\",\"stationList\":\"Central Station\",\"stations\":[\"Grand Central Terminal\",\"Times Square Station\",\"Brooklyn Bridge Station\",\"Union Square Station\",\"Chelsea Station\"]}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"12.5\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":\"New York Penn Station\",\"id\":\"RT-7890\",\"loginId\":\"operator007\",\"startStation\":\"New York Penn Station\",\"stationList\":\"Central Station\",\"stations\":[\"Grand Central Terminal\",\"Times Square Station\",\"Brooklyn Bridge Station\",\"Union Square Station\",\"Chelsea Station\"]}");
                        Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               .statusCode(200)
                               .extract().response();
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"3.1\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":\"New York Penn Station\",\"id\":\"RT-7890\",\"loginId\":\"admin_user_123\",\"startStation\":\"New York Penn Station\",\"stationList\":\"Central Station\",\"stations\":[\"Grand Central Terminal\",\"Times Square Station\",\"Brooklyn Bridge Station\",\"Union Square Station\",\"Chelsea Station\"]}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"3.1\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":\"New York Penn Station\",\"id\":\"RT-7890\",\"loginId\":\"admin_user_123\",\"startStation\":\"New York Penn Station\",\"stationList\":\"Central Station\",\"stations\":[\"Grand Central Terminal\",\"Times Square Station\",\"Brooklyn Bridge Station\",\"Union Square Station\",\"Chelsea Station\"]}");
                        Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               .statusCode(200)
                               .extract().response();
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"12.5\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":\"New York Penn Station\",\"id\":\"ROUTE-456\",\"loginId\":\"admin_user_123\",\"startStation\":\"New York Penn Station\",\"stationList\":\"Central Station\",\"stations\":[\"hangzhou\"]}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"12.5\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":\"New York Penn Station\",\"id\":\"ROUTE-456\",\"loginId\":\"admin_user_123\",\"startStation\":\"New York Penn Station\",\"stationList\":\"Central Station\",\"stations\":[\"hangzhou\"]}");
                        Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               .statusCode(200)
                               .extract().response();
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"12.5\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":\"New York Penn Station\",\"id\":\"SYSTEM-789\",\"loginId\":\"admin_user_123\",\"startStation\":\"New York Penn Station\",\"stationList\":\"Central Station\",\"stations\":[\"wuxi\"]}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"12.5\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":\"New York Penn Station\",\"id\":\"SYSTEM-789\",\"loginId\":\"admin_user_123\",\"startStation\":\"New York Penn Station\",\"stationList\":\"Central Station\",\"stations\":[\"wuxi\"]}");
                        Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               .statusCode(200)
                               .extract().response();
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"12.5\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":\"New York Penn Station\",\"id\":\"nanjing\",\"loginId\":\"admin_user_123\",\"startStation\":\"New York Penn Station\",\"stationList\":\"Central Station\",\"stations\":[\"Grand Central Terminal\",\"Times Square Station\",\"Brooklyn Bridge Station\",\"Union Square Station\",\"Chelsea Station\"]}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"12.5\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":\"New York Penn Station\",\"id\":\"nanjing\",\"loginId\":\"admin_user_123\",\"startStation\":\"New York Penn Station\",\"stationList\":\"Central Station\",\"stations\":[\"Grand Central Terminal\",\"Times Square Station\",\"Brooklyn Bridge Station\",\"Union Square Station\",\"Chelsea Station\"]}");
                        Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               .statusCode(200)
                               .extract().response();
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"12.5\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":\"San Francisco Station\",\"id\":\"RT-7890\",\"loginId\":\"admin_user_123\",\"startStation\":\"New York Penn Station\",\"stationList\":\"wuxi\",\"stations\":[\"shanghai\"]}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"12.5\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":\"San Francisco Station\",\"id\":\"RT-7890\",\"loginId\":\"admin_user_123\",\"startStation\":\"New York Penn Station\",\"stationList\":\"wuxi\",\"stations\":[\"shanghai\"]}");
                        Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               .statusCode(200)
                               .extract().response();
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"12.5\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":\"New York Penn Station\",\"id\":\"shijiazhuang\",\"loginId\":\"admin_user_123\",\"startStation\":\"New York Penn Station\",\"stationList\":\"Central Station\",\"stations\":[\"Grand Central Terminal\",\"Times Square Station\",\"Brooklyn Bridge Station\",\"Union Square Station\",\"Chelsea Station\"]}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"12.5\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":\"New York Penn Station\",\"id\":\"shijiazhuang\",\"loginId\":\"admin_user_123\",\"startStation\":\"New York Penn Station\",\"stationList\":\"Central Station\",\"stations\":[\"Grand Central Terminal\",\"Times Square Station\",\"Brooklyn Bridge Station\",\"Union Square Station\",\"Chelsea Station\"]}");
                        Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               .statusCode(200)
                               .extract().response();
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"12.5\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":\"INVALID_VALUE_MISSING_endStation\",\"id\":\"9fc9c261-3263-4bfa-82f8-bb44e06b2f52\",\"loginId\":\"sysadmin999\",\"startStation\":\"Los Angeles Union Station\",\"stationList\":\"Central Station\",\"stations\":[\"Grand Central Terminal\",\"Times Square Station\",\"Brooklyn Bridge Station\",\"Union Square Station\",\"Chelsea Station\"]}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"12.5\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":\"INVALID_VALUE_MISSING_endStation\",\"id\":\"9fc9c261-3263-4bfa-82f8-bb44e06b2f52\",\"loginId\":\"sysadmin999\",\"startStation\":\"Los Angeles Union Station\",\"stationList\":\"Central Station\",\"stations\":[\"Grand Central Terminal\",\"Times Square Station\",\"Brooklyn Bridge Station\",\"Union Square Station\",\"Chelsea Station\"]}");
                        Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               // Negative test: expect error code (4XX or 5XX), not success code
                               .statusCode(org.hamcrest.Matchers.greaterThanOrEqualTo(400))
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"12.5\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":\"Boston South Station\",\"id\":\"shanghai\",\"loginId\":\"INVALID_VALUE_MISSING_loginId\",\"startStation\":\"New York Penn Station\",\"stationList\":\"Central Station\",\"stations\":[\"shanghaihongqiao\"]}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"12.5\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":\"Boston South Station\",\"id\":\"shanghai\",\"loginId\":\"INVALID_VALUE_MISSING_loginId\",\"startStation\":\"New York Penn Station\",\"stationList\":\"Central Station\",\"stations\":[\"shanghaihongqiao\"]}");
                        Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               // Negative test: expect error code (4XX or 5XX), not success code
                               .statusCode(org.hamcrest.Matchers.greaterThanOrEqualTo(400))
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"12.5\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":\"New York Penn Station\",\"id\":\"RT-7890\",\"loginId\":\"admin_user_123\",\"startStation\":\"New York Penn Station\",\"stationList\":\"INVALID_VALUE_MISSING_stationList\",\"stations\":[\"Grand Central Terminal\",\"Times Square Station\",\"Brooklyn Bridge Station\",\"Union Square Station\",\"Chelsea Station\"]}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"12.5\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":\"New York Penn Station\",\"id\":\"RT-7890\",\"loginId\":\"admin_user_123\",\"startStation\":\"New York Penn Station\",\"stationList\":\"INVALID_VALUE_MISSING_stationList\",\"stations\":[\"Grand Central Terminal\",\"Times Square Station\",\"Brooklyn Bridge Station\",\"Union Square Station\",\"Chelsea Station\"]}");
                        Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               // Negative test: expect error code (4XX or 5XX), not success code
                               .statusCode(org.hamcrest.Matchers.greaterThanOrEqualTo(400))
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"12.5\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":\"New York Penn Station\",\"id\":\"jinan\",\"loginId\":\"admin_user_123\",\"startStation\":\"Chicago Union Station\",\"stationList\":\"Central Station\",\"stations\":[\"jinan\"]}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"12.5\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":\"New York Penn Station\",\"id\":\"jinan\",\"loginId\":\"admin_user_123\",\"startStation\":\"Chicago Union Station\",\"stationList\":\"Central Station\",\"stations\":[\"jinan\"]}");
                        Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               .statusCode(200)
                               .extract().response();
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"12.5\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":\"New York Penn Station\",\"id\":\"RT-7890\",\"loginId\":\"admin_user_123\",\"startStation\":\"New York Penn Station\",\"stationList\":\"Central Station\",\"stations\":[\"Grand Central Terminal\",\"Times Square Station\",\"Brooklyn Bridge Station\",\"Union Square Station\",\"Chelsea Station\"]}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"12.5\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":\"New York Penn Station\",\"id\":\"RT-7890\",\"loginId\":\"admin_user_123\",\"startStation\":\"New York Penn Station\",\"stationList\":\"Central Station\",\"stations\":[\"Grand Central Terminal\",\"Times Square Station\",\"Brooklyn Bridge Station\",\"Union Square Station\",\"Chelsea Station\"]}");
                        Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               .statusCode(200)
                               .extract().response();
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"INVALID_VALUE_MISSING_distanceList\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":\"New York Penn Station\",\"id\":\"RT-7890\",\"loginId\":\"admin_user_123\",\"startStation\":\"New York Penn Station\",\"stationList\":\"Central Station\",\"stations\":[\"Grand Central Terminal\",\"Times Square Station\",\"Brooklyn Bridge Station\",\"Union Square Station\",\"Chelsea Station\"]}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"INVALID_VALUE_MISSING_distanceList\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":\"New York Penn Station\",\"id\":\"RT-7890\",\"loginId\":\"admin_user_123\",\"startStation\":\"New York Penn Station\",\"stationList\":\"Central Station\",\"stations\":[\"Grand Central Terminal\",\"Times Square Station\",\"Brooklyn Bridge Station\",\"Union Square Station\",\"Chelsea Station\"]}");
                        Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               // Negative test: expect error code (4XX or 5XX), not success code
                               .statusCode(org.hamcrest.Matchers.greaterThanOrEqualTo(400))
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"12.5\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":\"New York Penn Station\",\"id\":\"RT-7890\",\"loginId\":\"admin_user_123\",\"startStation\":\"INVALID_VALUE_MISSING_startStation\",\"stationList\":\"Central Station\",\"stations\":[\"taiyuan\"]}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"12.5\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":\"New York Penn Station\",\"id\":\"RT-7890\",\"loginId\":\"admin_user_123\",\"startStation\":\"INVALID_VALUE_MISSING_startStation\",\"stationList\":\"Central Station\",\"stations\":[\"taiyuan\"]}");
                        Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               // Negative test: expect error code (4XX or 5XX), not success code
                               .statusCode(org.hamcrest.Matchers.greaterThanOrEqualTo(400))
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"12.5\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":\"Los Angeles Union Station\",\"id\":\"123\",\"loginId\":\"admin_user_123\",\"startStation\":\"New York Penn Station\",\"stationList\":\"Central Station\",\"stations\":[\"Grand Central Terminal\",\"Times Square Station\",\"Brooklyn Bridge Station\",\"Union Square Station\",\"Chelsea Station\"]}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"12.5\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":\"Los Angeles Union Station\",\"id\":\"123\",\"loginId\":\"admin_user_123\",\"startStation\":\"New York Penn Station\",\"stationList\":\"Central Station\",\"stations\":[\"Grand Central Terminal\",\"Times Square Station\",\"Brooklyn Bridge Station\",\"Union Square Station\",\"Chelsea Station\"]}");
                        Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               // Negative test: expect error code (4XX or 5XX), not success code
                               .statusCode(org.hamcrest.Matchers.greaterThanOrEqualTo(400))
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"12.5\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":\"New York Penn Station\",\"id\":\"RT-7890\",\"loginId\":\"admin_user_123\",\"startStation\":\"New York Penn Station\",\"stationList\":\"Central Station\",\"stations\":\"INVALID_VALUE_MISSING_stations\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"12.5\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":\"New York Penn Station\",\"id\":\"RT-7890\",\"loginId\":\"admin_user_123\",\"startStation\":\"New York Penn Station\",\"stationList\":\"Central Station\",\"stations\":\"INVALID_VALUE_MISSING_stations\"}");
                        Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               // Negative test: expect error code (4XX or 5XX), not success code
                               .statusCode(org.hamcrest.Matchers.greaterThanOrEqualTo(400))
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"22.9\",\"distances\":\"INVALID_VALUE_MISSING_distances\",\"endStation\":\"Chicago Union Station\",\"id\":\"beijing\",\"loginId\":\"admin_user_123\",\"startStation\":\"New York Penn Station\",\"stationList\":\"Central Station\",\"stations\":[\"Grand Central Terminal\",\"Times Square Station\",\"Brooklyn Bridge Station\",\"Union Square Station\",\"Chelsea Station\"]}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"22.9\",\"distances\":\"INVALID_VALUE_MISSING_distances\",\"endStation\":\"Chicago Union Station\",\"id\":\"beijing\",\"loginId\":\"admin_user_123\",\"startStation\":\"New York Penn Station\",\"stationList\":\"Central Station\",\"stations\":[\"Grand Central Terminal\",\"Times Square Station\",\"Brooklyn Bridge Station\",\"Union Square Station\",\"Chelsea Station\"]}");
                        Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               // Negative test: expect error code (4XX or 5XX), not success code
                               .statusCode(org.hamcrest.Matchers.greaterThanOrEqualTo(400))
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"12.5\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":\"New York Penn Station\",\"id\":\"RT-7890\",\"loginId\":\"testuser12345\",\"startStation\":\"New York Penn Station\",\"stationList\":\"Central Station\",\"stations\":[\"Grand Central Terminal\",\"Times Square Station\",\"Brooklyn Bridge Station\",\"Union Square Station\",\"Chelsea Station\"]}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"12.5\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":\"New York Penn Station\",\"id\":\"RT-7890\",\"loginId\":\"testuser12345\",\"startStation\":\"New York Penn Station\",\"stationList\":\"Central Station\",\"stations\":[\"Grand Central Terminal\",\"Times Square Station\",\"Brooklyn Bridge Station\",\"Union Square Station\",\"Chelsea Station\"]}");
                        Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               .statusCode(200)
                               .extract().response();
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"12.5\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":\"INVALID_VALUE_MISSING_endStation\",\"id\":\"RT-7890\",\"loginId\":\"admin_user_123\",\"startStation\":\"New York Penn Station\",\"stationList\":\"shanghai\",\"stations\":[\"Grand Central Terminal\",\"Times Square Station\",\"Brooklyn Bridge Station\",\"Union Square Station\",\"Chelsea Station\"]}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"12.5\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":\"New York Penn Station\",\"id\":\"RT-7890\",\"loginId\":\"INVALID_VALUE_MISSING_loginId\",\"startStation\":\"New York Penn Station\",\"stationList\":\"Central Station\",\"stations\":[\"xuzhou\"]}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"12.5\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":\"New York Penn Station\",\"id\":\"RT-7890\",\"loginId\":\"INVALID_VALUE_MISSING_loginId\",\"startStation\":\"New York Penn Station\",\"stationList\":\"Central Station\",\"stations\":[\"xuzhou\"]}");
                        Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               // Negative test: expect error code (4XX or 5XX), not success code
                               .statusCode(org.hamcrest.Matchers.greaterThanOrEqualTo(400))
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"12.5\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":\"New York Penn Station\",\"id\":\"RT-7890\",\"loginId\":\"admin_user_123\",\"startStation\":\"San Francisco Station\",\"stationList\":\"Central Station\",\"stations\":[\"Grand Central Terminal\",\"Times Square Station\",\"Brooklyn Bridge Station\",\"Union Square Station\",\"Chelsea Station\"]}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"12.5\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":\"New York Penn Station\",\"id\":\"RT-7890\",\"loginId\":\"admin_user_123\",\"startStation\":\"San Francisco Station\",\"stationList\":\"Central Station\",\"stations\":[\"Grand Central Terminal\",\"Times Square Station\",\"Brooklyn Bridge Station\",\"Union Square Station\",\"Chelsea Station\"]}");
                        Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               .statusCode(200)
                               .extract().response();
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"12.5\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":\"San Francisco Station\",\"id\":\"RT-7890\",\"loginId\":\"admin_user_123\",\"startStation\":\"New York Penn Station\",\"stationList\":\"shanghaihongqiao\",\"stations\":[\"Grand Central Terminal\",\"Times Square Station\",\"Brooklyn Bridge Station\",\"Union Square Station\",\"Chelsea Station\"]}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"12.5\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":\"San Francisco Station\",\"id\":\"RT-7890\",\"loginId\":\"admin_user_123\",\"startStation\":\"New York Penn Station\",\"stationList\":\"shanghaihongqiao\",\"stations\":[\"Grand Central Terminal\",\"Times Square Station\",\"Brooklyn Bridge Station\",\"Union Square Station\",\"Chelsea Station\"]}");
                        Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               .statusCode(200)
                               .extract().response();
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"12.5\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":\"New York Penn Station\",\"id\":\"RT-7890\",\"loginId\":\"admin_user_123\",\"startStation\":\"New York Penn Station\",\"stationList\":\"jinan\",\"stations\":[\"Grand Central Terminal\",\"Times Square Station\",\"Brooklyn Bridge Station\",\"Union Square Station\",\"Chelsea Station\"]}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"12.5\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":\"New York Penn Station\",\"id\":\"RT-7890\",\"loginId\":\"admin_user_123\",\"startStation\":\"New York Penn Station\",\"stationList\":\"jinan\",\"stations\":[\"Grand Central Terminal\",\"Times Square Station\",\"Brooklyn Bridge Station\",\"Union Square Station\",\"Chelsea Station\"]}");
                        Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               .statusCode(200)
                               .extract().response();
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"8.2\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":\"New York Penn Station\",\"id\":\"RT-7890\",\"loginId\":\"service_login_456\",\"startStation\":\"New York Penn Station\",\"stationList\":\"Central Station\",\"stations\":[\"suzhou\",\"wuxi\"]}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"8.2\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":\"New York Penn Station\",\"id\":\"RT-7890\",\"loginId\":\"service_login_456\",\"startStation\":\"New York Penn Station\",\"stationList\":\"Central Station\",\"stations\":[\"suzhou\",\"wuxi\"]}");
                        Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               .statusCode(200)
                               .extract().response();
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"12.5\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":\"Boston South Station\",\"id\":\"RT-7890\",\"loginId\":\"admin_user_123\",\"startStation\":\"New York Penn Station\",\"stationList\":\"Central Station\",\"stations\":[\"Grand Central Terminal\",\"Times Square Station\",\"Brooklyn Bridge Station\",\"Union Square Station\",\"Chelsea Station\"]}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"12.5\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":\"Boston South Station\",\"id\":\"RT-7890\",\"loginId\":\"admin_user_123\",\"startStation\":\"New York Penn Station\",\"stationList\":\"Central Station\",\"stations\":[\"Grand Central Terminal\",\"Times Square Station\",\"Brooklyn Bridge Station\",\"Union Square Station\",\"Chelsea Station\"]}");
                        Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               .statusCode(200)
                               .extract().response();
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"12.5\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":\"New York Penn Station\",\"id\":\"taiyuan\",\"loginId\":\"admin_user_123\",\"startStation\":\"New York Penn Station\",\"stationList\":\"Central Station\",\"stations\":[\"Grand Central Terminal\",\"Times Square Station\",\"Brooklyn Bridge Station\",\"Union Square Station\",\"Chelsea Station\"]}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"12.5\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":\"New York Penn Station\",\"id\":\"taiyuan\",\"loginId\":\"admin_user_123\",\"startStation\":\"New York Penn Station\",\"stationList\":\"Central Station\",\"stations\":[\"Grand Central Terminal\",\"Times Square Station\",\"Brooklyn Bridge Station\",\"Union Square Station\",\"Chelsea Station\"]}");
                        Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               .statusCode(200)
                               .extract().response();
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"12.5\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":\"New York Penn Station\",\"id\":\"xuzhou\",\"loginId\":\"admin_user_123\",\"startStation\":\"New York Penn Station\",\"stationList\":\"taiyuan\",\"stations\":[\"Grand Central Terminal\",\"Times Square Station\",\"Brooklyn Bridge Station\",\"Union Square Station\",\"Chelsea Station\"]}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"12.5\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":\"New York Penn Station\",\"id\":\"xuzhou\",\"loginId\":\"admin_user_123\",\"startStation\":\"New York Penn Station\",\"stationList\":\"taiyuan\",\"stations\":[\"Grand Central Terminal\",\"Times Square Station\",\"Brooklyn Bridge Station\",\"Union Square Station\",\"Chelsea Station\"]}");
                        Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               .statusCode(200)
                               .extract().response();
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"12.5\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":\"New York Penn Station\",\"id\":\"RT-7890\",\"loginId\":\"operator007\",\"startStation\":\"Boston South Station\",\"stationList\":\"INVALID_VALUE_MISSING_stationList\",\"stations\":[\"Grand Central Terminal\",\"Times Square Station\",\"Brooklyn Bridge Station\",\"Union Square Station\",\"Chelsea Station\"]}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"12.5\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"3.1\",\"22.9\"],\"endStation\":\"New York Penn Station\",\"id\":\"RT-7890\",\"loginId\":\"operator007\",\"startStation\":\"Boston South Station\",\"stationList\":\"INVALID_VALUE_MISSING_stationList\",\"stations\":[\"Grand Central Terminal\",\"Times Square Station\",\"Brooklyn Bridge Station\",\"Union Square Station\",\"Chelsea Station\"]}");
                        Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               // Negative test: expect error code (4XX or 5XX), not success code
                               .statusCode(org.hamcrest.Matchers.greaterThanOrEqualTo(400))
