package trainticket_twostage_test.TrainTicketTwoStageTest_1763767920466;
        ...
        try {
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect != 200 (any error))", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    // LLM validation variables (declared early for scope access in SUCCESS reporting)
                    ...
                    try {
                        ...
                        String requestBody1 = "{\"distanceList\":\"35.0\",\"endStation\":123,\"id\":\"AR-12345\",\"loginId\":\"operator_789\",\"startStation\":\"Chicago Union Station\",\"stationList\":\"New York Penn Station,Grand Central Terminal,Times Square Station\"}";
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"35.0\",\"endStation\":123,\"id\":\"AR-12345\",\"loginId\":\"operator_789\",\"startStation\":\"Chicago Union Station\",\"stationList\":\"New York Penn Station,Grand Central Terminal,Times Square Station\"}");
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect != 200 (any error))", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"15.2\",\"endStation\":\"San Francisco Station\",\"id\":\"beijing\",\"loginId\":123,\"startStation\":\"Chicago Union Station\",\"stationList\":\"Boston South Station,Harvard Station,Cambridge Station\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"15.2\",\"endStation\":\"San Francisco Station\",\"id\":\"beijing\",\"loginId\":123,\"startStation\":\"Chicago Union Station\",\"stationList\":\"Boston South Station,Harvard Station,Cambridge Station\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               .extract().response();
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"5.4\",\"endStation\":\"Boston South Station\",\"id\":\"AR-12345\",\"loginId\":\"admin_user_001\",\"startStation\":\"suzhou\",\"stationList\":\"Seattle King Street Station,Space Needle Station,Pike Place Market Station\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"5.4\",\"endStation\":\"Boston South Station\",\"id\":\"AR-12345\",\"loginId\":\"admin_user_001\",\"startStation\":\"suzhou\",\"stationList\":\"Seattle King Street Station,Space Needle Station,Pike Place Market Station\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               .extract().response();
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect != 200 (any error))", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"15.2\",\"endStation\":\"Chicago Union Station\",\"id\":\"AR-12345\",\"loginId\":\"admin_user_001\",\"startStation\":\"hangzhou\",\"stationList\":123}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"15.2\",\"endStation\":\"Chicago Union Station\",\"id\":\"AR-12345\",\"loginId\":\"admin_user_001\",\"startStation\":\"hangzhou\",\"stationList\":123}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               .extract().response();
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"40.3\",\"endStation\":\"Chicago Union Station\",\"id\":\"AR-12345\",\"loginId\":\"admin_user_001\",\"startStation\":\"shanghai\",\"stationList\":\"New York Penn Station,Grand Central Terminal,Times Square Station\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"40.3\",\"endStation\":\"Chicago Union Station\",\"id\":\"AR-12345\",\"loginId\":\"admin_user_001\",\"startStation\":\"shanghai\",\"stationList\":\"New York Penn Station,Grand Central Terminal,Times Square Station\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               .extract().response();
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect != 200 (any error))", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":123,\"endStation\":\"Chicago Union Station\",\"id\":\"AR-12345\",\"loginId\":\"admin_user_001\",\"startStation\":\"Chicago Union Station\",\"stationList\":\"New York Penn Station,Grand Central Terminal,Times Square Station\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":123,\"endStation\":\"Chicago Union Station\",\"id\":\"AR-12345\",\"loginId\":\"admin_user_001\",\"startStation\":\"Chicago Union Station\",\"stationList\":\"New York Penn Station,Grand Central Terminal,Times Square Station\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               .extract().response();
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"15.2\",\"endStation\":\"Chicago Union Station\",\"id\":\"AR-12345\",\"loginId\":\"manager_login\",\"startStation\":\"Chicago Union Station\",\"stationList\":\"New York Penn Station,Grand Central Terminal,Times Square Station\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"15.2\",\"endStation\":\"Chicago Union Station\",\"id\":\"AR-12345\",\"loginId\":\"manager_login\",\"startStation\":\"Chicago Union Station\",\"stationList\":\"New York Penn Station,Grand Central Terminal,Times Square Station\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               .extract().response();
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect != 200 (any error))", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"15.2\",\"endStation\":\"Chicago Union Station\",\"id\":\"taiyuan\",\"loginId\":\"admin_user_001\",\"startStation\":123,\"stationList\":\"New York Penn Station,Grand Central Terminal,Times Square Station\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"15.2\",\"endStation\":\"Chicago Union Station\",\"id\":\"taiyuan\",\"loginId\":\"admin_user_001\",\"startStation\":123,\"stationList\":\"New York Penn Station,Grand Central Terminal,Times Square Station\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               .extract().response();
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"8.9\",\"endStation\":\"Chicago Union Station\",\"id\":\"AR-12345\",\"loginId\":\"admin_access_2025\",\"startStation\":\"Chicago Union Station\",\"stationList\":\"New York Penn Station,Grand Central Terminal,Times Square Station\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"8.9\",\"endStation\":\"Chicago Union Station\",\"id\":\"AR-12345\",\"loginId\":\"admin_access_2025\",\"startStation\":\"Chicago Union Station\",\"stationList\":\"New York Penn Station,Grand Central Terminal,Times Square Station\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               .extract().response();
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"15.2\",\"endStation\":\"Chicago Union Station\",\"id\":\"xuzhou\",\"loginId\":\"admin_user_001\",\"startStation\":\"wuxi\",\"stationList\":\"New York Penn Station,Grand Central Terminal,Times Square Station\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"15.2\",\"endStation\":\"Chicago Union Station\",\"id\":\"xuzhou\",\"loginId\":\"admin_user_001\",\"startStation\":\"wuxi\",\"stationList\":\"New York Penn Station,Grand Central Terminal,Times Square Station\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               .extract().response();
