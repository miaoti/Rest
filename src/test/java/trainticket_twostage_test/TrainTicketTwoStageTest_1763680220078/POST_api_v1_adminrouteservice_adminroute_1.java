package trainticket_twostage_test.TrainTicketTwoStageTest_1763680220078;
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        String requestBody1 = "{\"distanceList\":\"15.2\",\"endStation\":\"New York Penn Station\",\"id\":\"AR-12345\",\"loginId\":\"admin_panel_user\",\"startStation\":\"Chicago Union Station\",\"stationList\":\"New York Penn Station,Grand Central Terminal,Times Square Station\"}";
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"15.2\",\"endStation\":\"New York Penn Station\",\"id\":\"AR-12345\",\"loginId\":\"admin_panel_user\",\"startStation\":\"Chicago Union Station\",\"stationList\":\"New York Penn Station,Grand Central Terminal,Times Square Station\"}");
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect != 200 (any error))", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"15.2\",\"endStation\":123,\"id\":\"AR-12345\",\"loginId\":\"admin_user_001\",\"startStation\":\"Los Angeles Union Station\",\"stationList\":\"New York Penn Station,Grand Central Terminal,Times Square Station\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"15.2\",\"endStation\":123,\"id\":\"AR-12345\",\"loginId\":\"admin_user_001\",\"startStation\":\"Los Angeles Union Station\",\"stationList\":\"New York Penn Station,Grand Central Terminal,Times Square Station\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               .extract().response();
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect != 200 (any error))", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"15.2\",\"endStation\":\"New York Penn Station\",\"id\":\"AR-12345\",\"loginId\":123,\"startStation\":\"Boston South Station\",\"stationList\":\"New York Penn Station,Grand Central Terminal,Times Square Station\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"15.2\",\"endStation\":\"New York Penn Station\",\"id\":\"AR-12345\",\"loginId\":123,\"startStation\":\"Boston South Station\",\"stationList\":\"New York Penn Station,Grand Central Terminal,Times Square Station\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               .extract().response();
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect != 200 (any error))", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"15.2\",\"endStation\":\"Chicago O'Hare International Airport\",\"id\":\"AR-12345\",\"loginId\":\"admin_user_001\",\"startStation\":\"Chicago Union Station\",\"stationList\":123}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"15.2\",\"endStation\":\"Chicago O'Hare International Airport\",\"id\":\"AR-12345\",\"loginId\":\"admin_user_001\",\"startStation\":\"Chicago Union Station\",\"stationList\":123}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               .extract().response();
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"15.2\",\"endStation\":\"New York Penn Station\",\"id\":\"TS-67890\",\"loginId\":\"admin_user_001\",\"startStation\":\"Chicago Union Station\",\"stationList\":\"New York Penn Station,Grand Central Terminal,Times Square Station\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"15.2\",\"endStation\":\"New York Penn Station\",\"id\":\"TS-67890\",\"loginId\":\"admin_user_001\",\"startStation\":\"Chicago Union Station\",\"stationList\":\"New York Penn Station,Grand Central Terminal,Times Square Station\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               .extract().response();
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"8.9\",\"endStation\":\"New York Penn Station\",\"id\":\"AR-12345\",\"loginId\":\"admin_user_001\",\"startStation\":\"Chicago Union Station\",\"stationList\":\"New York Penn Station,Grand Central Terminal,Times Square Station\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"8.9\",\"endStation\":\"New York Penn Station\",\"id\":\"AR-12345\",\"loginId\":\"admin_user_001\",\"startStation\":\"Chicago Union Station\",\"stationList\":\"New York Penn Station,Grand Central Terminal,Times Square Station\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               .extract().response();
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect != 200 (any error))", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":123,\"endStation\":\"Miami International Airport\",\"id\":\"AR-12345\",\"loginId\":\"admin_user_001\",\"startStation\":\"Chicago Union Station\",\"stationList\":\"New York Penn Station,Grand Central Terminal,Times Square Station\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":123,\"endStation\":\"Miami International Airport\",\"id\":\"AR-12345\",\"loginId\":\"admin_user_001\",\"startStation\":\"Chicago Union Station\",\"stationList\":\"New York Penn Station,Grand Central Terminal,Times Square Station\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               .extract().response();
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect != 200 (any error))", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"35.4\",\"endStation\":\"New York Penn Station\",\"id\":\"ADMIN-11223\",\"loginId\":\"admin_user_001\",\"startStation\":123,\"stationList\":\"New York Penn Station,Grand Central Terminal,Times Square Station\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"35.4\",\"endStation\":\"New York Penn Station\",\"id\":\"ADMIN-11223\",\"loginId\":\"admin_user_001\",\"startStation\":123,\"stationList\":\"New York Penn Station,Grand Central Terminal,Times Square Station\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               .extract().response();
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"15.2\",\"endStation\":\"New York Penn Station\",\"id\":\"AR-12345\",\"loginId\":\"admin_user_001\",\"startStation\":\"Chicago Union Station\",\"stationList\":\"New York Penn Station,Grand Central Terminal,Times Square Station\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"15.2\",\"endStation\":\"New York Penn Station\",\"id\":\"AR-12345\",\"loginId\":\"admin_user_001\",\"startStation\":\"Chicago Union Station\",\"stationList\":\"New York Penn Station,Grand Central Terminal,Times Square Station\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               .extract().response();
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"5.7\",\"endStation\":\"New York Penn Station\",\"id\":\"AR-12345\",\"loginId\":\"admin_user_001\",\"startStation\":\"Chicago Union Station\",\"stationList\":\"New York Penn Station,Grand Central Terminal,Times Square Station\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"5.7\",\"endStation\":\"New York Penn Station\",\"id\":\"AR-12345\",\"loginId\":\"admin_user_001\",\"startStation\":\"Chicago Union Station\",\"stationList\":\"New York Penn Station,Grand Central Terminal,Times Square Station\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               .extract().response();
