package trainticket_twostage_test.TrainTicketTwoStageTest_1763766432241;
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect != 200 (any error))", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        String requestBody1 = "{\"distanceList\":\"15.2\",\"endStation\":123,\"id\":\"1234567890\",\"loginId\":\"admin_user_001\",\"startStation\":\"Chicago Union Station\",\"stationList\":\"Grand Central Terminal,Penn Station,Union Station,Times Square Station,Broadway Station\"}";
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"15.2\",\"endStation\":123,\"id\":\"1234567890\",\"loginId\":\"admin_user_001\",\"startStation\":\"Chicago Union Station\",\"stationList\":\"Grand Central Terminal,Penn Station,Union Station,Times Square Station,Broadway Station\"}");
                        ...
                        es.us.isa.restest.generators.ZeroShotLLMGenerator.ValidationResult validationResult = null;
                        ...
                        if (llmValidationEnabled && (!only2xx || (actualStatusCode1 >= 200 && actualStatusCode1 < 300))) {
                            try {
                                ...
                                // Store validation result for later attachment (after Response attachment)
                                // Apply validation logic based on test type
                                // Negative test logic:
                                // - If LLM says FAILED: PASS (we expected an error)
                                // - If LLM says SUCCESS: FAIL (we expected an error but got success)
                                if (!validationResult.isFailed()) {
                                    throw new AssertionError("Negative test failed: Expected error but LLM validated response as successful. RCA: " + validationResult.getRca());
                                }
                                System.out.println("✅ Negative test PASSED: LLM detected soft error as expected");
                        ...
                        try {
                            ...
                            // Add LLM validation result (if validation was performed) - AFTER Response
                            if (llmValidationEnabled && includeRca && (!only2xx || (actualStatus >= 200 && actualStatus < 300))) {
                                try {
                                ...
                                } catch (Exception llmAttachEx) {
                                    System.err.println("⚠️ Failed to attach LLM validation: " + llmAttachEx.getMessage());
                                }
                            }
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect != 200 (any error))", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"15.2\",\"endStation\":\"Chicago Union Station\",\"id\":\"1234567890\",\"loginId\":123,\"startStation\":\"Chicago Union Station\",\"stationList\":\"Grand Central Terminal,Penn Station,Union Station,Times Square Station,Broadway Station\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"15.2\",\"endStation\":\"Chicago Union Station\",\"id\":\"1234567890\",\"loginId\":123,\"startStation\":\"Chicago Union Station\",\"stationList\":\"Grand Central Terminal,Penn Station,Union Station,Times Square Station,Broadway Station\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               .extract().response();
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"15.2\",\"endStation\":\"Chicago Union Station\",\"id\":\"5556667770\",\"loginId\":\"admin_user_001\",\"startStation\":\"Chicago Union Station\",\"stationList\":\"Grand Central Terminal,Penn Station,Union Station,Times Square Station,Broadway Station\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"15.2\",\"endStation\":\"Chicago Union Station\",\"id\":\"5556667770\",\"loginId\":\"admin_user_001\",\"startStation\":\"Chicago Union Station\",\"stationList\":\"Grand Central Terminal,Penn Station,Union Station,Times Square Station,Broadway Station\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               .extract().response();
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"15.2\",\"endStation\":\"Los Angeles Union Station\",\"id\":\"1234567890\",\"loginId\":\"service_manager_123\",\"startStation\":\"Chicago Union Station\",\"stationList\":\"Grand Central Terminal,Penn Station,Union Station,Times Square Station,Broadway Station\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"15.2\",\"endStation\":\"Los Angeles Union Station\",\"id\":\"1234567890\",\"loginId\":\"service_manager_123\",\"startStation\":\"Chicago Union Station\",\"stationList\":\"Grand Central Terminal,Penn Station,Union Station,Times Square Station,Broadway Station\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               .extract().response();
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect != 200 (any error))", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"15.2\",\"endStation\":\"Chicago Union Station\",\"id\":\"1234567890\",\"loginId\":\"admin_user_001\",\"startStation\":\"Chicago Union Station\",\"stationList\":123}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"15.2\",\"endStation\":\"Chicago Union Station\",\"id\":\"1234567890\",\"loginId\":\"admin_user_001\",\"startStation\":\"Chicago Union Station\",\"stationList\":123}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               .extract().response();
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"15.2\",\"endStation\":\"New York Penn Station\",\"id\":\"1234567890\",\"loginId\":\"admin_user_001\",\"startStation\":\"Chicago Union Station\",\"stationList\":\"Grand Central Terminal,Penn Station,Union Station,Times Square Station,Broadway Station\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"15.2\",\"endStation\":\"New York Penn Station\",\"id\":\"1234567890\",\"loginId\":\"admin_user_001\",\"startStation\":\"Chicago Union Station\",\"stationList\":\"Grand Central Terminal,Penn Station,Union Station,Times Square Station,Broadway Station\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               .extract().response();
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"15.2\",\"endStation\":\"Chicago Union Station\",\"id\":\"1234567890\",\"loginId\":\"operator_login_456\",\"startStation\":\"Chicago Union Station\",\"stationList\":\"Grand Central Terminal,Penn Station,Union Station,Times Square Station,Broadway Station\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"15.2\",\"endStation\":\"Chicago Union Station\",\"id\":\"1234567890\",\"loginId\":\"operator_login_456\",\"startStation\":\"Chicago Union Station\",\"stationList\":\"Grand Central Terminal,Penn Station,Union Station,Times Square Station,Broadway Station\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               .extract().response();
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect != 200 (any error))", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":123,\"endStation\":\"Chicago Union Station\",\"id\":\"1234567890\",\"loginId\":\"admin_user_001\",\"startStation\":\"Chicago Union Station\",\"stationList\":\"jiaxingnan\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":123,\"endStation\":\"Chicago Union Station\",\"id\":\"1234567890\",\"loginId\":\"admin_user_001\",\"startStation\":\"Chicago Union Station\",\"stationList\":\"jiaxingnan\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               .extract().response();
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"12.8\",\"endStation\":\"Chicago Union Station\",\"id\":\"1234567890\",\"loginId\":\"admin_user_001\",\"startStation\":\"Chicago Union Station\",\"stationList\":\"Grand Central Terminal,Penn Station,Union Station,Times Square Station,Broadway Station\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"12.8\",\"endStation\":\"Chicago Union Station\",\"id\":\"1234567890\",\"loginId\":\"admin_user_001\",\"startStation\":\"Chicago Union Station\",\"stationList\":\"Grand Central Terminal,Penn Station,Union Station,Times Square Station,Broadway Station\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               .extract().response();
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect != 200 (any error))", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"15.2\",\"endStation\":\"Chicago Union Station\",\"id\":\"1234567890\",\"loginId\":\"supervisor_user\",\"startStation\":123,\"stationList\":\"Grand Central Terminal,Penn Station,Union Station,Times Square Station,Broadway Station\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"15.2\",\"endStation\":\"Chicago Union Station\",\"id\":\"1234567890\",\"loginId\":\"supervisor_user\",\"startStation\":123,\"stationList\":\"Grand Central Terminal,Penn Station,Union Station,Times Square Station,Broadway Station\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               .extract().response();
