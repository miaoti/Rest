            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"test447\",\"distances\":\"test510\",\"endStation\":\"04b0a8ff-4d70-40ca-9e55-98d2ca2cf325\",\"id\":\"test638\",\"loginId\":\"test665\",\"startStation\":\"04b0a8ff-4d70-40ca-9e55-98d2ca2cf325\",\"stationList\":\"test407\",\"stations\":\"04b0a8ff-4d70-40ca-9e55-98d2ca2cf325\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"test447\",\"endStation\":\"04b0a8ff-4d70-40ca-9e55-98d2ca2cf325\",\"id\":\"test638\",\"startStation\":\"04b0a8ff-4d70-40ca-9e55-98d2ca2cf325\",\"stationList\":\"test407\"}";
                        req = req.body(requestBody3);
