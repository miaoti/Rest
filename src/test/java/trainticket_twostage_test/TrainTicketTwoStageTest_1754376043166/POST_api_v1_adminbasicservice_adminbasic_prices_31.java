            ...
            Allure.step("Step 1: ts-admin-basic-info-service POST /api/v1/adminbasicservice/adminbasic/prices (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        String requestBody1 = "{\"basicPriceRate\":\"test468\",\"firstClassPriceRate\":\"test538\",\"id\":\"test638\",\"routeId\":\"test573\",\"trainType\":\"67aba9ad-f550-46b3-ac36-2de602f63bdf\"}";
            ...
            Allure.step("Step 2: ts-price-service POST /api/v1/priceservice/prices (expect 201)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "{\"basicPriceRate\":\"test468\",\"firstClassPriceRate\":\"test538\",\"id\":\"test638\",\"routeId\":\"test573\",\"trainType\":\"67aba9ad-f550-46b3-ac36-2de602f63bdf\"}";
            ...
            Allure.step("Step 1: ts-admin-basic-info-service POST /api/v1/adminbasicservice/adminbasic/prices (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"basicPriceRate\":\"test468\",\"firstClassPriceRate\":\"test538\",\"id\":\"test638\",\"routeId\":\"0b23bd3e-876a-4af3-b920-c50a90c90b04\",\"trainType\":\"67aba9ad-f550-46b3-ac36-2de602f63bdf\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-price-service POST /api/v1/priceservice/prices (expect 201)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "{\"basicPriceRate\":\"test468\",\"firstClassPriceRate\":\"test538\",\"id\":\"test638\",\"routeId\":\"0b23bd3e-876a-4af3-b920-c50a90c90b04\",\"trainType\":\"67aba9ad-f550-46b3-ac36-2de602f63bdf\"}";
                        req = req.body(requestBody2);
            ...
            Allure.step("Step 1: ts-admin-basic-info-service POST /api/v1/adminbasicservice/adminbasic/prices (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"basicPriceRate\":\"test468\",\"firstClassPriceRate\":\"test538\",\"id\":\"test638\",\"routeId\":\"0b23bd3e-876a-4af3-b920-c50a90c90b04\",\"trainType\":\"test209\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-price-service POST /api/v1/priceservice/prices (expect 201)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "{\"basicPriceRate\":\"test468\",\"firstClassPriceRate\":\"test538\",\"id\":\"test638\",\"routeId\":\"0b23bd3e-876a-4af3-b920-c50a90c90b04\",\"trainType\":\"test209\"}";
                        req = req.body(requestBody2);
            ...
            Allure.step("Step 1: ts-admin-basic-info-service POST /api/v1/adminbasicservice/adminbasic/prices (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"basicPriceRate\":\"test468\",\"firstClassPriceRate\":\"test538\",\"id\":\"test638\",\"routeId\":\"test573\",\"trainType\":\"test209\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-price-service POST /api/v1/priceservice/prices (expect 201)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "{\"basicPriceRate\":\"test468\",\"firstClassPriceRate\":\"test538\",\"id\":\"test638\",\"routeId\":\"test573\",\"trainType\":\"test209\"}";
                        req = req.body(requestBody2);
