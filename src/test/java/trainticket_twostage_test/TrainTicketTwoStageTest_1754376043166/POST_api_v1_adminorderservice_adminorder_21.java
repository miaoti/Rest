            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        String requestBody1 = "{\"accountId\":\"test672\",\"boughtDate\":\"test719\",\"coachNumber\":\"test770\",\"contactsDocumentNumber\":\"test831\",\"contactsName\":\"test846\",\"differenceMoney\":\"test892\",\"documentType\":\"test940\",\"from\":\"test989\",\"id\":\"test638\",\"price\":\"test34\",\"seatClass\":\"test39\",\"seatNumber\":\"test79\",\"status\":\"test151\",\"to\":\"test208\",\"trainNumber\":\"67aba9ad-f550-46b3-ac36-2de602f63bdf\",\"travelDate\":\"test409\",\"travelTime\":\"test439\"}";
            ...
            Allure.step("Step 2: ts-order-other-service POST /api/v1/orderOtherService/orderOther/admin (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "{\"accountId\":\"test672\",\"boughtDate\":\"test719\",\"coachNumber\":\"test770\",\"contactsDocumentNumber\":\"test831\",\"contactsName\":\"test846\",\"documentType\":\"test940\",\"from\":\"test989\",\"id\":\"test638\",\"price\":\"test34\",\"seatClass\":\"test39\",\"seatNumber\":\"test79\",\"status\":\"test151\",\"to\":\"test208\",\"trainNumber\":\"67aba9ad-f550-46b3-ac36-2de602f63bdf\",\"travelDate\":\"test409\",\"travelTime\":\"test439\"}";
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"test672\",\"boughtDate\":\"test719\",\"coachNumber\":\"test770\",\"contactsDocumentNumber\":\"test831\",\"contactsName\":\"test846\",\"differenceMoney\":\"test892\",\"documentType\":\"test940\",\"from\":\"test989\",\"id\":\"test638\",\"price\":\"test34\",\"seatClass\":\"test39\",\"seatNumber\":\"test79\",\"status\":\"test151\",\"to\":\"test208\",\"trainNumber\":\"test337\",\"travelDate\":\"test409\",\"travelTime\":\"test439\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-order-other-service POST /api/v1/orderOtherService/orderOther/admin (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "{\"accountId\":\"test672\",\"boughtDate\":\"test719\",\"coachNumber\":\"test770\",\"contactsDocumentNumber\":\"test831\",\"contactsName\":\"test846\",\"documentType\":\"test940\",\"from\":\"test989\",\"id\":\"test638\",\"price\":\"test34\",\"seatClass\":\"test39\",\"seatNumber\":\"test79\",\"status\":\"test151\",\"to\":\"test208\",\"trainNumber\":\"test337\",\"travelDate\":\"test409\",\"travelTime\":\"test439\"}";
                        req = req.body(requestBody2);
