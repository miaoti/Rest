package trainticket_twostage_test.TrainTicketTwoStageTest_1762918561956;
                        ...
                        if (json.has("data")) {
                            ...
                            if (data.length() > 0) {
                                ...
                                if (bestScore > 0) {
                                    ...
                                    // ALWAYS fetch COMPLETE trace with all spans for analysis
                                    if (bestTrace != null) {
                                        ...
                                        // If this is the current trace, stop searching
                                        if (isCurrentTrace) {
                                            return;
                                        }
                                        // Otherwise continue searching for a more recent trace
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        String requestBody1 = "{\"distanceList\":\"12.5\",\"distances\":\"123\",\"endStation\":\"New York Penn Station\",\"id\":\"AR-12345\",\"loginId\":\"admin_user_123\",\"startStation\":\"New York Penn Station\",\"stationList\":\"Central Station\",\"stations\":[\"Grand Central Terminal\",\"Penn Station\",\"Union Station\",\"Times Square Station\",\"Broadway Station\"]}";
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"12.5\",\"distances\":\"123\",\"endStation\":\"New York Penn Station\",\"id\":\"AR-12345\",\"loginId\":\"admin_user_123\",\"startStation\":\"New York Penn Station\",\"stationList\":\"Central Station\",\"stations\":[\"Grand Central Terminal\",\"Penn Station\",\"Union Station\",\"Times Square Station\",\"Broadway Station\"]}");
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"12.5\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"22.1\",\"5.9\"],\"endStation\":\"New York Penn Station\",\"id\":\"AR-12345\",\"loginId\":\"admin_user_123\",\"startStation\":\"New York Penn Station\",\"stationList\":\"Central Station\",\"stations\":[\"Grand Central Terminal\",\"Penn Station\",\"Union Station\",\"Times Square Station\",\"Broadway Station\"]}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"12.5\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"22.1\",\"5.9\"],\"endStation\":\"New York Penn Station\",\"id\":\"AR-12345\",\"loginId\":\"admin_user_123\",\"startStation\":\"New York Penn Station\",\"stationList\":\"Central Station\",\"stations\":[\"Grand Central Terminal\",\"Penn Station\",\"Union Station\",\"Times Square Station\",\"Broadway Station\"]}");
                        Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               .statusCode(200)
                               .extract().response();
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"12.5\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"22.1\",\"5.9\"],\"endStation\":\"123\",\"id\":\"AR-12345\",\"loginId\":\"admin_user_123\",\"startStation\":\"New York Penn Station\",\"stationList\":\"Central Station\",\"stations\":[\"Grand Central Terminal\",\"Penn Station\",\"Union Station\",\"Times Square Station\",\"Broadway Station\"]}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"12.5\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"22.1\",\"5.9\"],\"endStation\":\"123\",\"id\":\"AR-12345\",\"loginId\":\"admin_user_123\",\"startStation\":\"New York Penn Station\",\"stationList\":\"Central Station\",\"stations\":[\"Grand Central Terminal\",\"Penn Station\",\"Union Station\",\"Times Square Station\",\"Broadway Station\"]}");
                        Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               // Negative test: expect error code (4XX or 5XX), not success code
                               .statusCode(org.hamcrest.Matchers.greaterThanOrEqualTo(400))
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"12.5\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"22.1\",\"5.9\"],\"endStation\":\"New York Penn Station\",\"id\":\"AR-12345\",\"loginId\":\"123\",\"startStation\":\"New York Penn Station\",\"stationList\":\"Central Station\",\"stations\":[\"Grand Central Terminal\",\"Penn Station\",\"Union Station\",\"Times Square Station\",\"Broadway Station\"]}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"12.5\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"22.1\",\"5.9\"],\"endStation\":\"New York Penn Station\",\"id\":\"AR-12345\",\"loginId\":\"123\",\"startStation\":\"New York Penn Station\",\"stationList\":\"Central Station\",\"stations\":[\"Grand Central Terminal\",\"Penn Station\",\"Union Station\",\"Times Square Station\",\"Broadway Station\"]}");
                        Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               // Negative test: expect error code (4XX or 5XX), not success code
                               .statusCode(org.hamcrest.Matchers.greaterThanOrEqualTo(400))
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"12.5\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"22.1\",\"5.9\"],\"endStation\":\"New York Penn Station\",\"id\":\"AR-12345\",\"loginId\":\"admin_user_123\",\"startStation\":\"New York Penn Station\",\"stationList\":\"123\",\"stations\":[\"Grand Central Terminal\",\"Penn Station\",\"Union Station\",\"Times Square Station\",\"Broadway Station\"]}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"12.5\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"22.1\",\"5.9\"],\"endStation\":\"New York Penn Station\",\"id\":\"AR-12345\",\"loginId\":\"admin_user_123\",\"startStation\":\"New York Penn Station\",\"stationList\":\"123\",\"stations\":[\"Grand Central Terminal\",\"Penn Station\",\"Union Station\",\"Times Square Station\",\"Broadway Station\"]}");
                        Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               // Negative test: expect error code (4XX or 5XX), not success code
                               .statusCode(org.hamcrest.Matchers.greaterThanOrEqualTo(400))
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"123\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"22.1\",\"5.9\"],\"endStation\":\"New York Penn Station\",\"id\":\"AR-12345\",\"loginId\":\"admin_user_123\",\"startStation\":\"New York Penn Station\",\"stationList\":\"Central Station\",\"stations\":[\"Grand Central Terminal\",\"Penn Station\",\"Union Station\",\"Times Square Station\",\"Broadway Station\"]}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"123\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"22.1\",\"5.9\"],\"endStation\":\"New York Penn Station\",\"id\":\"AR-12345\",\"loginId\":\"admin_user_123\",\"startStation\":\"New York Penn Station\",\"stationList\":\"Central Station\",\"stations\":[\"Grand Central Terminal\",\"Penn Station\",\"Union Station\",\"Times Square Station\",\"Broadway Station\"]}");
                        Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               // Negative test: expect error code (4XX or 5XX), not success code
                               .statusCode(org.hamcrest.Matchers.greaterThanOrEqualTo(400))
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"12.5\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"22.1\",\"5.9\"],\"endStation\":\"New York Penn Station\",\"id\":\"AR-12345\",\"loginId\":\"admin_user_123\",\"startStation\":\"123\",\"stationList\":\"Central Station\",\"stations\":[\"Grand Central Terminal\",\"Penn Station\",\"Union Station\",\"Times Square Station\",\"Broadway Station\"]}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"12.5\",\"distances\":[\"12.5\",\"8.2\",\"15.7\",\"22.1\",\"5.9\"],\"endStation\":\"New York Penn Station\",\"id\":\"AR-12345\",\"loginId\":\"admin_user_123\",\"startStation\":\"123\",\"stationList\":\"Central Station\",\"stations\":[\"Grand Central Terminal\",\"Penn Station\",\"Union Station\",\"Times Square Station\",\"Broadway Station\"]}");
                        Response stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               // Negative test: expect error code (4XX or 5XX), not success code
                               .statusCode(org.hamcrest.Matchers.greaterThanOrEqualTo(400))
