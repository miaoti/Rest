            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        String requestBody1 = "{\"distanceList\":\"6789\",\"distances\":\"1000\",\"endStation\":\"Los angeles union station\",\"id\":\"Xyz789\",\"loginId\":\"john_doe\",\"startStation\":\"san francisco bay area rapid transit (bart) - powell street station\",\"stationList\":\"Houston Hobby Airport\",\"stations\":\"Paris gare de l'est\"}";
            ...
            Allure.step("Step 2: ts-station-service POST /api/v1/stationservice/stations/idlist (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "[\"```json\", \"{id=04b0a8ff-4d70-40ca-9e55-98d2ca2cf325, name=wuxi, stayTime=3}\"]";
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"6789\",\"endStation\":\"Los angeles union station\",\"id\":\"Xyz789\",\"startStation\":\"san francisco bay area rapid transit (bart) - powell street station\",\"stationList\":\"Houston Hobby Airport\"}";
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"300\",\"distances\":\"bd_div_story\",\"endStation\":\"Boston Logan International Terminal\",\"id\":\"nbc\",\"loginId\":\"Admins\",\"startStation\":\"Los angeles metro - lax terminal 4\",\"stationList\":\"Houston Hobby Airport\",\"stations\":\"times square\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-station-service POST /api/v1/stationservice/stations/idlist (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "[\"{id=04b0a8ff-4d70-40ca-9e55-98d2ca2cf325, name=wuxi, stayTime=3}\", \"{id=04b0a8ff-4d70-40ca-9e55-98d2ca2cf325, name=wuxi, stayTime=3}\", \"{id=04b0a8ff-4d70-40ca-9e55-98d2ca2cf325, name=wuxi, stayTime=3}\", \"{id=04b0a8ff-4d70-40ca-9e55-98d2ca2cf325, name=wuxi, stayTime=3}\"]";
                        req = req.body(requestBody2);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"300\",\"endStation\":\"Boston Logan International Terminal\",\"id\":\"nbc\",\"startStation\":\"Los angeles metro - lax terminal 4\",\"stationList\":\"Houston Hobby Airport\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"4,000\",\"distances\":\"var_bd_=_getElementsByClass\",\"endStation\":\"San Francisco International Airport\",\"id\":\"Xyz789\",\"loginId\":\"Admin456\",\"startStation\":\"Chicago transit authority - union station\",\"stationList\":\"Chicago Loop\",\"stations\":\"central london station\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-station-service POST /api/v1/stationservice/stations/idlist (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "[\"{id=04b0a8ff-4d70-40ca-9e55-98d2ca2cf325, name=wuxi, stayTime=3}\", \"```json\", \"{id=04b0a8ff-4d70-40ca-9e55-98d2ca2cf325, name=wuxi, stayTime=3}\"]";
                        req = req.body(requestBody2);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"4,000\",\"endStation\":\"San Francisco International Airport\",\"id\":\"Xyz789\",\"startStation\":\"Chicago transit authority - union station\",\"stationList\":\"Chicago Loop\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"300\",\"distances\":\"-3.5\",\"endStation\":\"Los Angeles Union Station\",\"id\":\"test_123\",\"loginId\":\"john_doe\",\"startStation\":\"New york city subway - times square\",\"stationList\":\"Chicago Loop\",\"stations\":\"Paris Gare de l'Est\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-station-service POST /api/v1/stationservice/stations/idlist (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "[\"{id=04b0a8ff-4d70-40ca-9e55-98d2ca2cf325, name=wuxi, stayTime=3}\", \"{id=04b0a8ff-4d70-40ca-9e55-98d2ca2cf325, name=wuxi, stayTime=3}\", \"{id=04b0a8ff-4d70-40ca-9e55-98d2ca2cf325, name=wuxi, stayTime=3}\"]";
                        req = req.body(requestBody2);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"300\",\"endStation\":\"Los Angeles Union Station\",\"id\":\"test_123\",\"startStation\":\"New york city subway - times square\",\"stationList\":\"Chicago Loop\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"6789\",\"distances\":\"bd_div_story\",\"endStation\":\"boston logan international terminal\",\"id\":\"admin001\",\"loginId\":\"User123\",\"startStation\":\"new york city subway - times square\",\"stationList\":\"New York Penn Station\",\"stations\":\"montreal vanier train terminal\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"6789\",\"endStation\":\"boston logan international terminal\",\"id\":\"admin001\",\"startStation\":\"new york city subway - times square\",\"stationList\":\"New York Penn Station\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"6789\",\"distances\":\"-3.5\",\"endStation\":\"Boston logan international terminal\",\"id\":\"abc123\",\"loginId\":\"jane12\",\"startStation\":\"San Francisco Bay Area Rapid Transit (BART) - Powell Street Station\",\"stationList\":\"houston hobby airport\",\"stations\":\"Central london station\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-station-service POST /api/v1/stationservice/stations/idlist (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "[\"{id=04b0a8ff-4d70-40ca-9e55-98d2ca2cf325, name=wuxi, stayTime=3}\", \"{id=04b0a8ff-4d70-40ca-9e55-98d2ca2cf325, name=wuxi, stayTime=3}\", \"```json\", \"```json\"]";
                        req = req.body(requestBody2);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"6789\",\"endStation\":\"Boston logan international terminal\",\"id\":\"abc123\",\"startStation\":\"San Francisco Bay Area Rapid Transit (BART) - Powell Street Station\",\"stationList\":\"houston hobby airport\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"25.5\",\"distances\":\"0\",\"endStation\":\"New York Penn Station\",\"id\":\"buf\",\"loginId\":\"perez_hilton\",\"startStation\":\"Chicago transit authority - union station\",\"stationList\":\"san francisco international airport\",\"stations\":\"Central London Station\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"25.5\",\"endStation\":\"New York Penn Station\",\"id\":\"buf\",\"startStation\":\"Chicago transit authority - union station\",\"stationList\":\"san francisco international airport\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"4,000\",\"distances\":\"-3.5\",\"endStation\":\"new york penn station\",\"id\":\"User456\",\"loginId\":\"Admin456\",\"startStation\":\"Boston's MBTA - South Station\",\"stationList\":\"Los Angeles Union Station\",\"stations\":\"Harajuku station\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"4,000\",\"endStation\":\"new york penn station\",\"id\":\"User456\",\"startStation\":\"Boston's MBTA - South Station\",\"stationList\":\"Los Angeles Union Station\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"4,000\",\"distances\":\"0\",\"endStation\":\"Chicago o'hare international airport\",\"id\":\"Abc123\",\"loginId\":\"guests\",\"startStation\":\"san francisco bay area rapid transit (bart) - powell street station\",\"stationList\":\"Chicago Loop\",\"stations\":\"Harajuku station\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-station-service POST /api/v1/stationservice/stations/idlist (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "[\"{id=04b0a8ff-4d70-40ca-9e55-98d2ca2cf325, name=wuxi, stayTime=3}\", \"{id=04b0a8ff-4d70-40ca-9e55-98d2ca2cf325, name=wuxi, stayTime=3}\"]";
                        req = req.body(requestBody2);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"4,000\",\"endStation\":\"Chicago o'hare international airport\",\"id\":\"Abc123\",\"startStation\":\"san francisco bay area rapid transit (bart) - powell street station\",\"stationList\":\"Chicago Loop\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"6789\",\"distances\":\"BORDER_=\",\"endStation\":\"San Francisco International Airport\",\"id\":\"printf\",\"loginId\":\"guests\",\"startStation\":\"chicago transit authority - union station\",\"stationList\":\"Houston hobby airport\",\"stations\":\"Montreal Vanier Train Terminal\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"6789\",\"endStation\":\"San Francisco International Airport\",\"id\":\"printf\",\"startStation\":\"chicago transit authority - union station\",\"stationList\":\"Houston hobby airport\"}";
                        req = req.body(requestBody3);
