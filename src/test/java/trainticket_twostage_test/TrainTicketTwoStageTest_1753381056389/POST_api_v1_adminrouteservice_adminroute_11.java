            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        String requestBody1 = "{\"distanceList\":\"300\",\"distances\":\"BORDER_=\",\"endStation\":\"New York Penn Station\",\"id\":\"buf\",\"loginId\":\"galljdaj\",\"startStation\":\"Los angeles metro - lax terminal 4\",\"stationList\":\"Houston hobby airport\",\"stations\":\"Montreal vanier train terminal\"}";
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"300\",\"endStation\":\"New York Penn Station\",\"id\":\"buf\",\"startStation\":\"Los angeles metro - lax terminal 4\",\"stationList\":\"Houston hobby airport\"}";
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"25.5\",\"distances\":\"var_bd_=_getElementsByClass\",\"endStation\":\"los angeles union station\",\"id\":\"brennan\",\"loginId\":\"galljdaj\",\"startStation\":\"New York City Subway - Times Square\",\"stationList\":\"new york penn station\",\"stations\":\"central london station\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-station-service POST /api/v1/stationservice/stations/idlist (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "[\"```json\", \"{id=04b0a8ff-4d70-40ca-9e55-98d2ca2cf325, name=wuxi, stayTime=3}\", \"{id=04b0a8ff-4d70-40ca-9e55-98d2ca2cf325, name=wuxi, stayTime=3}\", \"{id=04b0a8ff-4d70-40ca-9e55-98d2ca2cf325, name=wuxi, stayTime=3}\"]";
                        req = req.body(requestBody2);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"25.5\",\"endStation\":\"los angeles union station\",\"id\":\"brennan\",\"startStation\":\"New York City Subway - Times Square\",\"stationList\":\"new york penn station\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"10\",\"distances\":\"4567890\",\"endStation\":\"san francisco international airport\",\"id\":\"test_123\",\"loginId\":\"admins\",\"startStation\":\"Los angeles metro - lax terminal 4\",\"stationList\":\"los angeles union station\",\"stations\":\"Harajuku station\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"10\",\"endStation\":\"san francisco international airport\",\"id\":\"test_123\",\"startStation\":\"Los angeles metro - lax terminal 4\",\"stationList\":\"los angeles union station\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"25.5\",\"distances\":\"4567890\",\"endStation\":\"Los angeles union station\",\"id\":\"Sydney_measured_####kbps\",\"loginId\":\"John_doe\",\"startStation\":\"New York City Subway - Times Square\",\"stationList\":\"new york penn station\",\"stations\":\"Central london station\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"25.5\",\"endStation\":\"Los angeles union station\",\"id\":\"Sydney_measured_####kbps\",\"startStation\":\"New York City Subway - Times Square\",\"stationList\":\"new york penn station\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"10\",\"distances\":\"0\",\"endStation\":\"New york penn station\",\"id\":\"user456\",\"loginId\":\"admin456\",\"startStation\":\"boston's mbta - south station\",\"stationList\":\"New york penn station\",\"stations\":\"central london station\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-station-service POST /api/v1/stationservice/stations/idlist (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "[\"```json\", \"```json\", \"{id=04b0a8ff-4d70-40ca-9e55-98d2ca2cf325, name=wuxi, stayTime=3}\", \"{id=04b0a8ff-4d70-40ca-9e55-98d2ca2cf325, name=wuxi, stayTime=3}\"]";
                        req = req.body(requestBody2);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"10\",\"endStation\":\"New york penn station\",\"id\":\"user456\",\"startStation\":\"boston's mbta - south station\",\"stationList\":\"New york penn station\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"4,000\",\"distances\":\"0\",\"endStation\":\"boston logan international terminal\",\"id\":\"cbs\",\"loginId\":\"Admin456\",\"startStation\":\"Boston's mbta - south station\",\"stationList\":\"Chicago loop\",\"stations\":\"Montreal vanier train terminal\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"4,000\",\"endStation\":\"boston logan international terminal\",\"id\":\"cbs\",\"startStation\":\"Boston's mbta - south station\",\"stationList\":\"Chicago loop\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"300\",\"distances\":\"0\",\"endStation\":\"Los Angeles Union Station\",\"id\":\"brennan\",\"loginId\":\"John_doe\",\"startStation\":\"los angeles metro - lax terminal 4\",\"stationList\":\"Los angeles union station\",\"stations\":\"paris gare de l'est\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"300\",\"endStation\":\"Los Angeles Union Station\",\"id\":\"brennan\",\"startStation\":\"los angeles metro - lax terminal 4\",\"stationList\":\"Los angeles union station\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"4,000\",\"distances\":\"1000\",\"endStation\":\"Los angeles union station\",\"id\":\"admin001\",\"loginId\":\"users\",\"startStation\":\"Boston's MBTA - South Station\",\"stationList\":\"Los Angeles Union Station\",\"stations\":\"Harajuku Station\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"4,000\",\"endStation\":\"Los angeles union station\",\"id\":\"admin001\",\"startStation\":\"Boston's MBTA - South Station\",\"stationList\":\"Los Angeles Union Station\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"6789\",\"distances\":\"var_bd_=_getElementsByClass\",\"endStation\":\"chicago o'hare international airport\",\"id\":\"Xyz789\",\"loginId\":\"User123\",\"startStation\":\"san francisco bay area rapid transit (bart) - powell street station\",\"stationList\":\"los angeles union station\",\"stations\":\"times square\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 2: ts-station-service POST /api/v1/stationservice/stations/idlist (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody2 = "[\"{id=04b0a8ff-4d70-40ca-9e55-98d2ca2cf325, name=wuxi, stayTime=3}\", \"```json\"]";
                        req = req.body(requestBody2);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"6789\",\"endStation\":\"chicago o'hare international airport\",\"id\":\"Xyz789\",\"startStation\":\"san francisco bay area rapid transit (bart) - powell street station\",\"stationList\":\"los angeles union station\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"10\",\"distances\":\"4567890\",\"endStation\":\"Los angeles union station\",\"id\":\"Sydney_measured_####kbps\",\"loginId\":\"galljdaj\",\"startStation\":\"Chicago transit authority - union station\",\"stationList\":\"Houston Hobby Airport\",\"stations\":\"montreal vanier train terminal\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"10\",\"endStation\":\"Los angeles union station\",\"id\":\"Sydney_measured_####kbps\",\"startStation\":\"Chicago transit authority - union station\",\"stationList\":\"Houston Hobby Airport\"}";
                        req = req.body(requestBody3);
