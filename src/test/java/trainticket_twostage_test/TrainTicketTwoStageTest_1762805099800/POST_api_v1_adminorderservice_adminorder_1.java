package trainticket_twostage_test.TrainTicketTwoStageTest_1762805099800;
...
public class POST_api_v1_adminorderservice_adminorder_1 {
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        String requestBody1 = "{\"accountId\":\"1234567890\",\"boughtDate\":\"2023-12-15\",\"coachNumber\":\"12346\",\"contactsDocumentNumber\":\"ABC123456789\",\"contactsName\":\"Sarah Johnson\",\"differenceMoney\":\"100.50\",\"documentType\":\"1\",\"from\":\"user@example.com\",\"id\":\"user123\",\"price\":\"0.99\",\"seatClass\":\"5\",\"seatNumber\":\"C18\",\"status\":\"0\",\"to\":\"user@example.com\",\"trainNumber\":\"12345\",\"travelDate\":\"2013-05-08\",\"travelTime\":\"2023-12-15T09:30:00Z\"}";
                        ...
                        allStepParameters.put("body", "{\"accountId\":\"1234567890\",\"boughtDate\":\"2023-12-15\",\"coachNumber\":\"12346\",\"contactsDocumentNumber\":\"ABC123456789\",\"contactsName\":\"Sarah Johnson\",\"differenceMoney\":\"100.50\",\"documentType\":\"1\",\"from\":\"user@example.com\",\"id\":\"user123\",\"price\":\"0.99\",\"seatClass\":\"5\",\"seatNumber\":\"C18\",\"status\":\"0\",\"to\":\"user@example.com\",\"trainNumber\":\"12345\",\"travelDate\":\"2013-05-08\",\"travelTime\":\"2023-12-15T09:30:00Z\"}");
    ...
    public void test_negative_POST_1_2() throws Exception {
        ...
        Allure.parameter("🔴 Invalid Parameters", "travelTime=123abc");
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"1234567890\",\"boughtDate\":\"2023-12-15\",\"coachNumber\":\"12347\",\"contactsDocumentNumber\":\"ABC123456789\",\"contactsName\":\"John Smith\",\"differenceMoney\":\"100.50\",\"documentType\":\"2\",\"from\":\"user@example.com\",\"id\":\"f8a1b2c3-d4e5-4f6a-7b8c-9d0e1f2a3b4c\",\"price\":\"1000.00\",\"seatClass\":\"1\",\"seatNumber\":\"D23\",\"status\":\"1\",\"to\":\"test@qa.environment\",\"trainNumber\":\"12345\",\"travelDate\":\"2013-05-07\",\"travelTime\":\"123abc\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"accountId\":\"1234567890\",\"boughtDate\":\"2023-12-15\",\"coachNumber\":\"12347\",\"contactsDocumentNumber\":\"ABC123456789\",\"contactsName\":\"John Smith\",\"differenceMoney\":\"100.50\",\"documentType\":\"2\",\"from\":\"user@example.com\",\"id\":\"f8a1b2c3-d4e5-4f6a-7b8c-9d0e1f2a3b4c\",\"price\":\"1000.00\",\"seatClass\":\"1\",\"seatNumber\":\"D23\",\"status\":\"1\",\"to\":\"test@qa.environment\",\"trainNumber\":\"12345\",\"travelDate\":\"2013-05-07\",\"travelTime\":\"123abc\"}");
                        Response stepResponse1 = req.when().post("/api/v1/adminorderservice/adminorder")
                               .then().log().ifValidationFails()
    ...
    public void test_negative_POST_1_3() throws Exception {
        ...
        // 🚨 NEGATIVE TEST METADATA
        Allure.parameter("🚨 Test Type", "NEGATIVE (Invalid Input Testing)");
        Allure.parameter("🔴 Invalid Parameters", "documentType=\"hello\"");
        Allure.description("**⚠️ This is a NEGATIVE test case with intentionally invalid inputs.**\n\n" +
                         "The following parameters were intentionally set to invalid values:\n" +
                         "documentType=\"hello\"\n\n" +
                         "This test expects a 4XX or 5XX error response. If it returns 2XX, the test will FAIL.");
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"1234567890\",\"boughtDate\":\"2023-12-15\",\"coachNumber\":\"1234\",\"contactsDocumentNumber\":\"ABC123456789\",\"contactsName\":\"Michael Brown\",\"differenceMoney\":\"-25.00\",\"documentType\":\"\\\"hello\\\"\",\"from\":\"tianjin\",\"id\":\"0b23bd3e-876a-4af3-b920-c50a90c90b04\",\"price\":\"19.99\",\"seatClass\":\"1\",\"seatNumber\":\"A12\",\"status\":\"2\",\"to\":\"user@example.com\",\"trainNumber\":\"G5678\",\"travelDate\":\"2023-12-25\",\"travelTime\":\"2023-12-16T14:45:00Z\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"accountId\":\"1234567890\",\"boughtDate\":\"2023-12-15\",\"coachNumber\":\"1234\",\"contactsDocumentNumber\":\"ABC123456789\",\"contactsName\":\"Michael Brown\",\"differenceMoney\":\"-25.00\",\"documentType\":\"\\\"hello\\\"\",\"from\":\"tianjin\",\"id\":\"0b23bd3e-876a-4af3-b920-c50a90c90b04\",\"price\":\"19.99\",\"seatClass\":\"1\",\"seatNumber\":\"A12\",\"status\":\"2\",\"to\":\"user@example.com\",\"trainNumber\":\"G5678\",\"travelDate\":\"2023-12-25\",\"travelTime\":\"2023-12-16T14:45:00Z\"}");
                        Response stepResponse1 = req.when().post("/api/v1/adminorderservice/adminorder")
                               .then().log().ifValidationFails()
                               // Negative test: expect error code (4XX or 5XX), not success code
                               .statusCode(org.hamcrest.Matchers.greaterThanOrEqualTo(400))
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"1234567890\",\"boughtDate\":\"2023-12-15\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"DocumentNumber_Four\",\"contactsName\":\"John Smith\",\"differenceMoney\":\"100.50\",\"documentType\":\"3\",\"from\":\"guangzhou\",\"id\":\"user123\",\"price\":\"19.99\",\"seatClass\":\"2\",\"seatNumber\":\"E7\",\"status\":\"1\",\"to\":\"user@example.com\",\"trainNumber\":\"D1357\",\"travelDate\":\"2013-05-06\",\"travelTime\":\"2023-12-17T08:15:00Z\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"accountId\":\"1234567890\",\"boughtDate\":\"2023-12-15\",\"coachNumber\":\"12345\",\"contactsDocumentNumber\":\"DocumentNumber_Four\",\"contactsName\":\"John Smith\",\"differenceMoney\":\"100.50\",\"documentType\":\"3\",\"from\":\"guangzhou\",\"id\":\"user123\",\"price\":\"19.99\",\"seatClass\":\"2\",\"seatNumber\":\"E7\",\"status\":\"1\",\"to\":\"user@example.com\",\"trainNumber\":\"D1357\",\"travelDate\":\"2013-05-06\",\"travelTime\":\"2023-12-17T08:15:00Z\"}");
                        Response stepResponse1 = req.when().post("/api/v1/adminorderservice/adminorder")
                               .then().log().ifValidationFails()
                               .statusCode(200)
                               .extract().response();
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"1234567890\",\"boughtDate\":\"2023-12-15\",\"coachNumber\":\"1234\",\"contactsDocumentNumber\":\"DocumentNumber_Seven\",\"contactsName\":\"John Smith\",\"differenceMoney\":\"100.50\",\"documentType\":\"1\",\"from\":\"user@example.com\",\"id\":\"user123\",\"price\":\"19.99\",\"seatClass\":\"1\",\"seatNumber\":\"A12\",\"status\":\"1\",\"to\":\"user@example.com\",\"trainNumber\":\"G1237\",\"travelDate\":\"2023-12-25\",\"travelTime\":\"2023-12-18T17:20:00Z\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"accountId\":\"1234567890\",\"boughtDate\":\"2023-12-15\",\"coachNumber\":\"1234\",\"contactsDocumentNumber\":\"DocumentNumber_Seven\",\"contactsName\":\"John Smith\",\"differenceMoney\":\"100.50\",\"documentType\":\"1\",\"from\":\"user@example.com\",\"id\":\"user123\",\"price\":\"19.99\",\"seatClass\":\"1\",\"seatNumber\":\"A12\",\"status\":\"1\",\"to\":\"user@example.com\",\"trainNumber\":\"G1237\",\"travelDate\":\"2023-12-25\",\"travelTime\":\"2023-12-18T17:20:00Z\"}");
                        Response stepResponse1 = req.when().post("/api/v1/adminorderservice/adminorder")
                               .then().log().ifValidationFails()
                               .statusCode(200)
                               .extract().response();
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"1234567890\",\"boughtDate\":\"2023-12-15\",\"coachNumber\":\"1234\",\"contactsDocumentNumber\":\"DocumentNumber_Three\",\"contactsName\":\"John Smith\",\"differenceMoney\":\"0.00\",\"documentType\":\"4\",\"from\":\"user@example.com\",\"id\":\"admin-456\",\"price\":\"19.99\",\"seatClass\":\"1\",\"seatNumber\":\"A12\",\"status\":\"-1\",\"to\":\"backup@archive.systems\",\"trainNumber\":\"12345\",\"travelDate\":\"2013-05-05\",\"travelTime\":\"2023-12-15T09:30:00Z\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"accountId\":\"1234567890\",\"boughtDate\":\"2023-12-15\",\"coachNumber\":\"1234\",\"contactsDocumentNumber\":\"DocumentNumber_Three\",\"contactsName\":\"John Smith\",\"differenceMoney\":\"0.00\",\"documentType\":\"4\",\"from\":\"user@example.com\",\"id\":\"admin-456\",\"price\":\"19.99\",\"seatClass\":\"1\",\"seatNumber\":\"A12\",\"status\":\"-1\",\"to\":\"backup@archive.systems\",\"trainNumber\":\"12345\",\"travelDate\":\"2013-05-05\",\"travelTime\":\"2023-12-15T09:30:00Z\"}");
                        Response stepResponse1 = req.when().post("/api/v1/adminorderservice/adminorder")
                               .then().log().ifValidationFails()
                               .statusCode(200)
                               .extract().response();
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"1234567890\",\"boughtDate\":\"2024-01-30\",\"coachNumber\":\"1234\",\"contactsDocumentNumber\":\"ABC123456789\",\"contactsName\":\"Emily Davis\",\"differenceMoney\":\"100.50\",\"documentType\":\"1\",\"from\":\"user@example.com\",\"id\":\"test_id_789\",\"price\":\"19.99\",\"seatClass\":\"3\",\"seatNumber\":\"A12\",\"status\":\"1\",\"to\":\"user@example.com\",\"trainNumber\":\"12345\",\"travelDate\":\"2013-05-09\",\"travelTime\":\"2023-12-19T11:05:00Z\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"accountId\":\"1234567890\",\"boughtDate\":\"2024-01-30\",\"coachNumber\":\"1234\",\"contactsDocumentNumber\":\"ABC123456789\",\"contactsName\":\"Emily Davis\",\"differenceMoney\":\"100.50\",\"documentType\":\"1\",\"from\":\"user@example.com\",\"id\":\"test_id_789\",\"price\":\"19.99\",\"seatClass\":\"3\",\"seatNumber\":\"A12\",\"status\":\"1\",\"to\":\"user@example.com\",\"trainNumber\":\"12345\",\"travelDate\":\"2013-05-09\",\"travelTime\":\"2023-12-19T11:05:00Z\"}");
                        Response stepResponse1 = req.when().post("/api/v1/adminorderservice/adminorder")
                               .then().log().ifValidationFails()
                               .statusCode(200)
                               .extract().response();
    ...
    public void test_negative_POST_1_8() throws Exception {
        ...
        // 🚨 NEGATIVE TEST METADATA
        Allure.parameter("🚨 Test Type", "NEGATIVE (Invalid Input Testing)");
        Allure.parameter("🔴 Invalid Parameters", "contactsDocumentNumber=1234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789");
        Allure.description("**⚠️ This is a NEGATIVE test case with intentionally invalid inputs.**\n\n" +
                         "The following parameters were intentionally set to invalid values:\n" +
                         "contactsDocumentNumber=1234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789\n\n" +
                         "This test expects a 4XX or 5XX error response. If it returns 2XX, the test will FAIL.");
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"1234567890\",\"boughtDate\":\"2023-12-15\",\"coachNumber\":\"5678\",\"contactsDocumentNumber\":\"1234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789\",\"contactsName\":\"John Smith\",\"differenceMoney\":\"100.50\",\"documentType\":\"1\",\"from\":\"user@example.com\",\"id\":\"user123\",\"price\":\"25.50\",\"seatClass\":\"1\",\"seatNumber\":\"A12\",\"status\":\"1\",\"to\":\"user@example.com\",\"trainNumber\":\"12345\",\"travelDate\":\"2013-05-04\",\"travelTime\":\"2023-12-15T09:30:00Z\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"accountId\":\"1234567890\",\"boughtDate\":\"2023-12-15\",\"coachNumber\":\"5678\",\"contactsDocumentNumber\":\"1234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789012345678901234567890123456789\",\"contactsName\":\"John Smith\",\"differenceMoney\":\"100.50\",\"documentType\":\"1\",\"from\":\"user@example.com\",\"id\":\"user123\",\"price\":\"25.50\",\"seatClass\":\"1\",\"seatNumber\":\"A12\",\"status\":\"1\",\"to\":\"user@example.com\",\"trainNumber\":\"12345\",\"travelDate\":\"2013-05-04\",\"travelTime\":\"2023-12-15T09:30:00Z\"}");
                        Response stepResponse1 = req.when().post("/api/v1/adminorderservice/adminorder")
                               .then().log().ifValidationFails()
                               // Negative test: expect error code (4XX or 5XX), not success code
                               .statusCode(org.hamcrest.Matchers.greaterThanOrEqualTo(400))
    ...
    public void test_negative_POST_1_9() throws Exception {
        ...
        // 🚨 NEGATIVE TEST METADATA
        Allure.parameter("🚨 Test Type", "NEGATIVE (Invalid Input Testing)");
        Allure.parameter("🔴 Invalid Parameters", "contactsName=\"\ud83d\ude00\ud83d\ude03\ud83d\ude04\ud83d\ude01\"");
        Allure.description("**⚠️ This is a NEGATIVE test case with intentionally invalid inputs.**\n\n" +
                         "The following parameters were intentionally set to invalid values:\n" +
                         "contactsName=\"\ud83d\ude00\ud83d\ude03\ud83d\ude04\ud83d\ude01\"\n\n" +
                         "This test expects a 4XX or 5XX error response. If it returns 2XX, the test will FAIL.");
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"4d2a46c7-71cb-4cf1-b5bb-b68406d9da6f\",\"boughtDate\":\"2023-12-15\",\"coachNumber\":\"9012\",\"contactsDocumentNumber\":\"ABC123456789\",\"contactsName\":\"\\\"😀😃😄😁\\\"\",\"differenceMoney\":\"999.99\",\"documentType\":\"1\",\"from\":\"user@example.com\",\"id\":\"user123\",\"price\":\"599.99\",\"seatClass\":\"4\",\"seatNumber\":\"A12\",\"status\":\"1\",\"to\":\"admin@company.org\",\"trainNumber\":\"ICE123\",\"travelDate\":\"2023-12-25\",\"travelTime\":\"2023-12-15T09:30:00Z\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"accountId\":\"4d2a46c7-71cb-4cf1-b5bb-b68406d9da6f\",\"boughtDate\":\"2023-12-15\",\"coachNumber\":\"9012\",\"contactsDocumentNumber\":\"ABC123456789\",\"contactsName\":\"\\\"😀😃😄😁\\\"\",\"differenceMoney\":\"999.99\",\"documentType\":\"1\",\"from\":\"user@example.com\",\"id\":\"user123\",\"price\":\"599.99\",\"seatClass\":\"4\",\"seatNumber\":\"A12\",\"status\":\"1\",\"to\":\"admin@company.org\",\"trainNumber\":\"ICE123\",\"travelDate\":\"2023-12-25\",\"travelTime\":\"2023-12-15T09:30:00Z\"}");
                        Response stepResponse1 = req.when().post("/api/v1/adminorderservice/adminorder")
                               .then().log().ifValidationFails()
                               // Negative test: expect error code (4XX or 5XX), not success code
                               .statusCode(org.hamcrest.Matchers.greaterThanOrEqualTo(400))
    ...
    public void test_negative_POST_1_10() throws Exception {
        ...
        // 🚨 NEGATIVE TEST METADATA
        Allure.parameter("🚨 Test Type", "NEGATIVE (Invalid Input Testing)");
        Allure.parameter("🔴 Invalid Parameters", "differenceMoney=null");
        Allure.description("**⚠️ This is a NEGATIVE test case with intentionally invalid inputs.**\n\n" +
                         "The following parameters were intentionally set to invalid values:\n" +
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"1234567890\",\"boughtDate\":\"2024-03-10\",\"coachNumber\":\"3456\",\"contactsDocumentNumber\":\"DocumentNumber_Five\",\"contactsName\":\"David Wilson\",\"differenceMoney\":\"null\",\"documentType\":\"1\",\"from\":\"chengdu\",\"id\":\"support-001\",\"price\":\"19.99\",\"seatClass\":\"1\",\"seatNumber\":\"A12\",\"status\":\"5\",\"to\":\"support@helpdesk.net\",\"trainNumber\":\"12345\",\"travelDate\":\"2023-12-25\",\"travelTime\":\"2023-12-16T14:45:00Z\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"acc-987654321\",\"boughtDate\":\"2023-12-15\",\"coachNumber\":\"1234\",\"contactsDocumentNumber\":\"ABC123456789\",\"contactsName\":\"John Smith\",\"differenceMoney\":\"100.50\",\"documentType\":\"1\",\"from\":\"user@example.com\",\"id\":\"guest-999\",\"price\":\"19.99\",\"seatClass\":\"5\",\"seatNumber\":\"B5\",\"status\":\"1\",\"to\":\"user@example.com\",\"trainNumber\":\"REGIO2023\",\"travelDate\":\"2024-01-15\",\"travelTime\":\"2023-12-15T09:30:00Z\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"accountId\":\"acc-987654321\",\"boughtDate\":\"2023-12-15\",\"coachNumber\":\"1234\",\"contactsDocumentNumber\":\"ABC123456789\",\"contactsName\":\"John Smith\",\"differenceMoney\":\"100.50\",\"documentType\":\"1\",\"from\":\"user@example.com\",\"id\":\"guest-999\",\"price\":\"19.99\",\"seatClass\":\"5\",\"seatNumber\":\"B5\",\"status\":\"1\",\"to\":\"user@example.com\",\"trainNumber\":\"REGIO2023\",\"travelDate\":\"2024-01-15\",\"travelTime\":\"2023-12-15T09:30:00Z\"}");
                        Response stepResponse1 = req.when().post("/api/v1/adminorderservice/adminorder")
                               .then().log().ifValidationFails()
                               .statusCode(200)
                               .extract().response();
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"account_12345\",\"boughtDate\":\"2023-12-15\",\"coachNumber\":\"1234\",\"contactsDocumentNumber\":\"DocumentNumber_One\",\"contactsName\":\"John Smith\",\"differenceMoney\":\"100.50\",\"documentType\":\"1\",\"from\":\"user@example.com\",\"id\":\"user123\",\"price\":\"19.99\",\"seatClass\":\"1\",\"seatNumber\":\"A12\",\"status\":\"1\",\"to\":\"user@example.com\",\"trainNumber\":\"12345\",\"travelDate\":\"2023-12-25\",\"travelTime\":\"2023-12-15T09:30:00Z\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"accountId\":\"account_12345\",\"boughtDate\":\"2023-12-15\",\"coachNumber\":\"1234\",\"contactsDocumentNumber\":\"DocumentNumber_One\",\"contactsName\":\"John Smith\",\"differenceMoney\":\"100.50\",\"documentType\":\"1\",\"from\":\"user@example.com\",\"id\":\"user123\",\"price\":\"19.99\",\"seatClass\":\"1\",\"seatNumber\":\"A12\",\"status\":\"1\",\"to\":\"user@example.com\",\"trainNumber\":\"12345\",\"travelDate\":\"2023-12-25\",\"travelTime\":\"2023-12-15T09:30:00Z\"}");
                        Response stepResponse1 = req.when().post("/api/v1/adminorderservice/adminorder")
                               .then().log().ifValidationFails()
                               .statusCode(200)
                               .extract().response();
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"1234567890\",\"boughtDate\":\"2023-12-15\",\"coachNumber\":\"1234\",\"contactsDocumentNumber\":\"ABC123456789\",\"contactsName\":\"John Smith\",\"differenceMoney\":\"100.50\",\"documentType\":\"1\",\"from\":\"nanjing\",\"id\":\"user123\",\"price\":\"19.99\",\"seatClass\":\"1\",\"seatNumber\":\"A12\",\"status\":\"1\",\"to\":\"user@example.com\",\"trainNumber\":\"S12345\",\"travelDate\":\"2023-11-30\",\"travelTime\":\"2023-12-17T08:15:00Z\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"accountId\":\"1234567890\",\"boughtDate\":\"2023-12-15\",\"coachNumber\":\"1234\",\"contactsDocumentNumber\":\"ABC123456789\",\"contactsName\":\"John Smith\",\"differenceMoney\":\"100.50\",\"documentType\":\"1\",\"from\":\"nanjing\",\"id\":\"user123\",\"price\":\"19.99\",\"seatClass\":\"1\",\"seatNumber\":\"A12\",\"status\":\"1\",\"to\":\"user@example.com\",\"trainNumber\":\"S12345\",\"travelDate\":\"2023-11-30\",\"travelTime\":\"2023-12-17T08:15:00Z\"}");
                        Response stepResponse1 = req.when().post("/api/v1/adminorderservice/adminorder")
                               .then().log().ifValidationFails()
                               .statusCode(200)
                               .extract().response();
    ...
    public void test_negative_POST_1_14() throws Exception {
        ...
        // 🚨 NEGATIVE TEST METADATA
        Allure.parameter("🚨 Test Type", "NEGATIVE (Invalid Input Testing)");
        Allure.parameter("🔴 Invalid Parameters", "seatNumber=seat$123");
        Allure.description("**⚠️ This is a NEGATIVE test case with intentionally invalid inputs.**\n\n" +
                         "The following parameters were intentionally set to invalid values:\n" +
                         "seatNumber=seat$123\n\n" +
                         "This test expects a 4XX or 5XX error response. If it returns 2XX, the test will FAIL.");
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"1234567890\",\"boughtDate\":\"2023-12-15\",\"coachNumber\":\"1234\",\"contactsDocumentNumber\":\"XYZ987654321\",\"contactsName\":\"Sarah Johnson\",\"differenceMoney\":\"100.50\",\"documentType\":\"1\",\"from\":\"user@example.com\",\"id\":\"nanjing\",\"price\":\"19.99\",\"seatClass\":\"1\",\"seatNumber\":\"seat$123\",\"status\":\"0\",\"to\":\"user@example.com\",\"trainNumber\":\"12345\",\"travelDate\":\"2023-12-25\",\"travelTime\":\"2023-12-15T09:30:00Z\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"accountId\":\"1234567890\",\"boughtDate\":\"2023-12-15\",\"coachNumber\":\"1234\",\"contactsDocumentNumber\":\"XYZ987654321\",\"contactsName\":\"Sarah Johnson\",\"differenceMoney\":\"100.50\",\"documentType\":\"1\",\"from\":\"user@example.com\",\"id\":\"nanjing\",\"price\":\"19.99\",\"seatClass\":\"1\",\"seatNumber\":\"seat$123\",\"status\":\"0\",\"to\":\"user@example.com\",\"trainNumber\":\"12345\",\"travelDate\":\"2023-12-25\",\"travelTime\":\"2023-12-15T09:30:00Z\"}");
                        Response stepResponse1 = req.when().post("/api/v1/adminorderservice/adminorder")
                               .then().log().ifValidationFails()
                               // Negative test: expect error code (4XX or 5XX), not success code
                               .statusCode(org.hamcrest.Matchers.greaterThanOrEqualTo(400))
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"1234567890\",\"boughtDate\":\"2024-01-15\",\"coachNumber\":\"1234\",\"contactsDocumentNumber\":\"ABC123456789\",\"contactsName\":\"John Smith\",\"differenceMoney\":\"-0.25\",\"documentType\":\"5\",\"from\":\"user@example.com\",\"id\":\"shijiazhuang\",\"price\":\"0.99\",\"seatClass\":\"1\",\"seatNumber\":\"A12\",\"status\":\"1\",\"to\":\"test@qa.environment\",\"trainNumber\":\"12345\",\"travelDate\":\"2024-02-29\",\"travelTime\":\"2023-12-15T09:30:00Z\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"accountId\":\"1234567890\",\"boughtDate\":\"2024-01-15\",\"coachNumber\":\"1234\",\"contactsDocumentNumber\":\"ABC123456789\",\"contactsName\":\"John Smith\",\"differenceMoney\":\"-0.25\",\"documentType\":\"5\",\"from\":\"user@example.com\",\"id\":\"shijiazhuang\",\"price\":\"0.99\",\"seatClass\":\"1\",\"seatNumber\":\"A12\",\"status\":\"1\",\"to\":\"test@qa.environment\",\"trainNumber\":\"12345\",\"travelDate\":\"2024-02-29\",\"travelTime\":\"2023-12-15T09:30:00Z\"}");
                        Response stepResponse1 = req.when().post("/api/v1/adminorderservice/adminorder")
                               .then().log().ifValidationFails()
                               .statusCode(200)
                               .extract().response();
    ...
    public void test_negative_POST_1_16() throws Exception {
        ...
        // 🚨 NEGATIVE TEST METADATA
        Allure.parameter("🚨 Test Type", "NEGATIVE (Invalid Input Testing)");
        Allure.parameter("🔴 Invalid Parameters", "accountId=null");
        Allure.description("**⚠️ This is a NEGATIVE test case with intentionally invalid inputs.**\n\n" +
                         "The following parameters were intentionally set to invalid values:\n" +
                         "accountId=null\n\n" +
                         "This test expects a 4XX or 5XX error response. If it returns 2XX, the test will FAIL.");
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":null,\"boughtDate\":\"2023-12-15\",\"coachNumber\":\"1234\",\"contactsDocumentNumber\":\"ABC123456789\",\"contactsName\":\"John Smith\",\"differenceMoney\":\"100.50\",\"documentType\":\"1\",\"from\":\"support@company.org\",\"id\":\"user123\",\"price\":\"1000.00\",\"seatClass\":\"1\",\"seatNumber\":\"A12\",\"status\":\"1\",\"to\":\"user@example.com\",\"trainNumber\":\"12345\",\"travelDate\":\"2023-12-25\",\"travelTime\":\"2023-12-15T09:30:00Z\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"accountId\":null,\"boughtDate\":\"2023-12-15\",\"coachNumber\":\"1234\",\"contactsDocumentNumber\":\"ABC123456789\",\"contactsName\":\"John Smith\",\"differenceMoney\":\"100.50\",\"documentType\":\"1\",\"from\":\"support@company.org\",\"id\":\"user123\",\"price\":\"1000.00\",\"seatClass\":\"1\",\"seatNumber\":\"A12\",\"status\":\"1\",\"to\":\"user@example.com\",\"trainNumber\":\"12345\",\"travelDate\":\"2023-12-25\",\"travelTime\":\"2023-12-15T09:30:00Z\"}");
                        Response stepResponse1 = req.when().post("/api/v1/adminorderservice/adminorder")
                               .then().log().ifValidationFails()
                               // Negative test: expect error code (4XX or 5XX), not success code
                               .statusCode(org.hamcrest.Matchers.greaterThanOrEqualTo(400))
    ...
    public void test_negative_POST_1_17() throws Exception {
        ...
        // 🚨 NEGATIVE TEST METADATA
        Allure.parameter("🚨 Test Type", "NEGATIVE (Invalid Input Testing)");
        Allure.parameter("🔴 Invalid Parameters", "coachNumber=12.789");
        Allure.description("**⚠️ This is a NEGATIVE test case with intentionally invalid inputs.**\n\n" +
                         "The following parameters were intentionally set to invalid values:\n" +
                         "coachNumber=12.789\n\n" +
                         "This test expects a 4XX or 5XX error response. If it returns 2XX, the test will FAIL.");
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"1234567890\",\"boughtDate\":\"2023-12-15\",\"coachNumber\":\"12.789\",\"contactsDocumentNumber\":\"ABC123456789\",\"contactsName\":\"John Smith\",\"differenceMoney\":\"100.50\",\"documentType\":\"1\",\"from\":\"user@example.com\",\"id\":\"9fc9c261-3263-4bfa-82f8-bb44e06b2f52\",\"price\":\"25.50\",\"seatClass\":\"2\",\"seatNumber\":\"A12\",\"status\":\"1\",\"to\":\"user@example.com\",\"trainNumber\":\"12345\",\"travelDate\":\"2023-10-10\",\"travelTime\":\"2023-12-18T17:20:00Z\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"accountId\":\"1234567890\",\"boughtDate\":\"2023-12-15\",\"coachNumber\":\"12.789\",\"contactsDocumentNumber\":\"ABC123456789\",\"contactsName\":\"John Smith\",\"differenceMoney\":\"100.50\",\"documentType\":\"1\",\"from\":\"user@example.com\",\"id\":\"9fc9c261-3263-4bfa-82f8-bb44e06b2f52\",\"price\":\"25.50\",\"seatClass\":\"2\",\"seatNumber\":\"A12\",\"status\":\"1\",\"to\":\"user@example.com\",\"trainNumber\":\"12345\",\"travelDate\":\"2023-10-10\",\"travelTime\":\"2023-12-18T17:20:00Z\"}");
                        Response stepResponse1 = req.when().post("/api/v1/adminorderservice/adminorder")
                               .then().log().ifValidationFails()
                               // Negative test: expect error code (4XX or 5XX), not success code
                               .statusCode(org.hamcrest.Matchers.greaterThanOrEqualTo(400))
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"1234567890\",\"boughtDate\":\"2023-12-15\",\"coachNumber\":\"1234\",\"contactsDocumentNumber\":\"ABC123456789\",\"contactsName\":\"Michael Brown\",\"differenceMoney\":\"-25.00\",\"documentType\":\"1\",\"from\":\"user@example.com\",\"id\":\"user123\",\"price\":\"19.99\",\"seatClass\":\"1\",\"seatNumber\":\"A12\",\"status\":\"2\",\"to\":\"user@example.com\",\"trainNumber\":\"THAL1234\",\"travelDate\":\"2023-12-25\",\"travelTime\":\"2023-12-15T09:30:00Z\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"accountId\":\"1234567890\",\"boughtDate\":\"2023-12-15\",\"coachNumber\":\"1234\",\"contactsDocumentNumber\":\"ABC123456789\",\"contactsName\":\"Michael Brown\",\"differenceMoney\":\"-25.00\",\"documentType\":\"1\",\"from\":\"user@example.com\",\"id\":\"user123\",\"price\":\"19.99\",\"seatClass\":\"1\",\"seatNumber\":\"A12\",\"status\":\"2\",\"to\":\"user@example.com\",\"trainNumber\":\"THAL1234\",\"travelDate\":\"2023-12-25\",\"travelTime\":\"2023-12-15T09:30:00Z\"}");
                        Response stepResponse1 = req.when().post("/api/v1/adminorderservice/adminorder")
                               .then().log().ifValidationFails()
                               .statusCode(200)
                               .extract().response();
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"1234567890\",\"boughtDate\":\"2023-12-15\",\"coachNumber\":\"7890\",\"contactsDocumentNumber\":\"ABC123456789\",\"contactsName\":\"John Smith\",\"differenceMoney\":\"100.50\",\"documentType\":\"2\",\"from\":\"user@example.com\",\"id\":\"shanghai\",\"price\":\"19.99\",\"seatClass\":\"1\",\"seatNumber\":\"A12\",\"status\":\"1\",\"to\":\"backup@archive.systems\",\"trainNumber\":\"12345\",\"travelDate\":\"2013-05-11\",\"travelTime\":\"2023-12-15T09:30:00Z\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"accountId\":\"1234567890\",\"boughtDate\":\"2023-12-15\",\"coachNumber\":\"7890\",\"contactsDocumentNumber\":\"ABC123456789\",\"contactsName\":\"John Smith\",\"differenceMoney\":\"100.50\",\"documentType\":\"2\",\"from\":\"user@example.com\",\"id\":\"shanghai\",\"price\":\"19.99\",\"seatClass\":\"1\",\"seatNumber\":\"A12\",\"status\":\"1\",\"to\":\"backup@archive.systems\",\"trainNumber\":\"12345\",\"travelDate\":\"2013-05-11\",\"travelTime\":\"2023-12-15T09:30:00Z\"}");
                        Response stepResponse1 = req.when().post("/api/v1/adminorderservice/adminorder")
                               .then().log().ifValidationFails()
                               .statusCode(200)
                               .extract().response();
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"1234567890\",\"boughtDate\":\"2023-12-15\",\"coachNumber\":\"1234\",\"contactsDocumentNumber\":\"ABC123456789\",\"contactsName\":\"John Smith\",\"differenceMoney\":\"0.00\",\"documentType\":\"1\",\"from\":\"admin@domain.net\",\"id\":\"user123\",\"price\":\"599.99\",\"seatClass\":\"1\",\"seatNumber\":\"C18\",\"status\":\"1\",\"to\":\"user@example.com\",\"trainNumber\":\"12345\",\"travelDate\":\"2013-05-10\",\"travelTime\":\"2023-12-19T11:05:00Z\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"accountId\":\"1234567890\",\"boughtDate\":\"2023-12-15\",\"coachNumber\":\"1234\",\"contactsDocumentNumber\":\"ABC123456789\",\"contactsName\":\"John Smith\",\"differenceMoney\":\"0.00\",\"documentType\":\"1\",\"from\":\"admin@domain.net\",\"id\":\"user123\",\"price\":\"599.99\",\"seatClass\":\"1\",\"seatNumber\":\"C18\",\"status\":\"1\",\"to\":\"user@example.com\",\"trainNumber\":\"12345\",\"travelDate\":\"2013-05-10\",\"travelTime\":\"2023-12-19T11:05:00Z\"}");
                        Response stepResponse1 = req.when().post("/api/v1/adminorderservice/adminorder")
                               .then().log().ifValidationFails()
                               .statusCode(200)
                               .extract().response();
