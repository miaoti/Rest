package trainticket_twostage_test.TrainTicketTwoStageTest_1752567687680;
...
public class GET_api_v1_adminorderservice_adminorder_1 {
    ...
    public void test_GET_1_1() throws Exception {
        ...
        if (decision1.shouldExecute) {
            System.out.println("✅ EXECUTING: Step 1: ts-admin-order-service GET /api/v1/adminorderservice/adminorder (expect 200) (dependency analysis passed)");
            ...
            stepResults.put(1, false);
            System.out.println("⏭️ SKIPPING: Step 1: ts-admin-order-service GET /api/v1/adminorderservice/adminorder (expect 200) - " + decision1.skipReason.description + " (" + decision1.skipMessage + ")");
        ...
        if (decision2.shouldExecute) {
            System.out.println("✅ EXECUTING: Step 2: ts-order-service GET /api/v1/orderservice/order (expect 200) (dependency analysis passed)");
            // Use Allure.step() for proper step hierarchy and visualization
            ...
            stepResults.put(2, false);
            System.out.println("⏭️ SKIPPING: Step 2: ts-order-service GET /api/v1/orderservice/order (expect 200) - " + decision2.skipReason.description + " (" + decision2.skipMessage + ")");
            // Create detailed skip step with comprehensive reasoning
            Allure.step("⏭️ Step 2: ts-order-service GET /api/v1/orderservice/order (expect 200) (SKIPPED)", () -> {
                ...
                Allure.description("⏭️ **Step Skipped**: ts-order-service\n" +
                                 "📡 **Method**: GET\n" +
                                 "🔗 **Path**: /api/v1/orderservice/order\n" +
                                 "🔗 **Dependency Type**: INDEPENDENT (can execute regardless of other step results)\n" +
                ...
                StringBuilder depAnalysis = new StringBuilder();
                depAnalysis.append("📋 DEPENDENCY ANALYSIS REPORT\n\n");
                depAnalysis.append("🔍 Step: " + 2 + " - ts-order-service\n");
                depAnalysis.append("📡 Method: get\n");
                depAnalysis.append("🔗 Path: /api/v1/orderservice/order\n\n");
                depAnalysis.append("📊 EXECUTION DECISION LOGIC:\n");
        ...
        if (decision3.shouldExecute) {
            System.out.println("✅ EXECUTING: Step 3: ts-order-other-service GET /api/v1/orderOtherService/orderOther (expect 200) (dependency analysis passed)");
            // Use Allure.step() for proper step hierarchy and visualization
            ...
            stepResults.put(3, false);
            System.out.println("⏭️ SKIPPING: Step 3: ts-order-other-service GET /api/v1/orderOtherService/orderOther (expect 200) - " + decision3.skipReason.description + " (" + decision3.skipMessage + ")");
            // Create detailed skip step with comprehensive reasoning
            Allure.step("⏭️ Step 3: ts-order-other-service GET /api/v1/orderOtherService/orderOther (expect 200) (SKIPPED)", () -> {
                ...
                StringBuilder depAnalysis = new StringBuilder();
                depAnalysis.append("📋 DEPENDENCY ANALYSIS REPORT\n\n");
                depAnalysis.append("🔍 Step: " + 3 + " - ts-order-other-service\n");
                depAnalysis.append("📡 Method: get\n");
                depAnalysis.append("🔗 Path: /api/v1/orderOtherService/orderOther\n\n");
                depAnalysis.append("📊 EXECUTION DECISION LOGIC:\n");
