            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        String requestBody1 = "{\"distanceList\":\"999\",\"distances\":\"25.3\",\"endStation\":\"Central park\",\"id\":\"testing\",\"loginId\":\"admins\",\"startStation\":\"new york city station\",\"stationList\":\"new york central station\",\"stations\":\"Los Angeles Union Station\"}";
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"999\",\"endStation\":\"Central park\",\"id\":\"testing\",\"startStation\":\"new york city station\",\"stationList\":\"new york central station\"}";
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"BORDER_=\",\"distances\":\"150\",\"endStation\":\"Central Park\",\"id\":\"users\",\"loginId\":\"User123\",\"startStation\":\"San Francisco Pier\",\"stationList\":\"houston\",\"stations\":\"Chicago union terminal\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"BORDER_=\",\"endStation\":\"Central Park\",\"id\":\"users\",\"startStation\":\"San Francisco Pier\",\"stationList\":\"houston\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"var_bd_=_getElementsByClass\",\"distances\":\"150\",\"endStation\":\"Union Square\",\"id\":\"tested\",\"loginId\":\"Admins\",\"startStation\":\"Chicago railway center\",\"stationList\":\"Boston logan international airport\",\"stations\":\"New york penn station\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"var_bd_=_getElementsByClass\",\"endStation\":\"Union Square\",\"id\":\"tested\",\"startStation\":\"Chicago railway center\",\"stationList\":\"Boston logan international airport\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"999\",\"distances\":\"150\",\"endStation\":\"Times Square Station\",\"id\":\"tested\",\"loginId\":\"User123\",\"startStation\":\"los angeles terminal\",\"stationList\":\"Boston Logan International Airport\",\"stations\":\"Chicago Union Terminal\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"999\",\"endStation\":\"Times Square Station\",\"id\":\"tested\",\"startStation\":\"los angeles terminal\",\"stationList\":\"Boston Logan International Airport\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"75\",\"distances\":\"75\",\"endStation\":\"Grand Central Terminal\",\"id\":\"users\",\"loginId\":\"User123\",\"startStation\":\"chicago railway center\",\"stationList\":\"denver\",\"stations\":\"Los Angeles Union Station\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"75\",\"endStation\":\"Grand Central Terminal\",\"id\":\"users\",\"startStation\":\"chicago railway center\",\"stationList\":\"denver\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"BORDER_=\",\"distances\":\"25.3\",\"endStation\":\"Pennsylvania station\",\"id\":\"testing\",\"loginId\":\"admin456\",\"startStation\":\"san francisco pier\",\"stationList\":\"Seattle-tacoma international airport\",\"stations\":\"los angeles union station\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"BORDER_=\",\"endStation\":\"Pennsylvania station\",\"id\":\"testing\",\"startStation\":\"san francisco pier\",\"stationList\":\"Seattle-tacoma international airport\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"10\",\"distances\":\"150\",\"endStation\":\"grand central terminal\",\"id\":\"Admin_456\",\"loginId\":\"Testuser001\",\"startStation\":\"Los Angeles Terminal\",\"stationList\":\"Seattle-Tacoma International Airport\",\"stations\":\"San Francisco Oakland International Airport\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"10\",\"endStation\":\"grand central terminal\",\"id\":\"Admin_456\",\"startStation\":\"Los Angeles Terminal\",\"stationList\":\"Seattle-Tacoma International Airport\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"75\",\"distances\":\"150\",\"endStation\":\"Grand Central Terminal\",\"id\":\"test789\",\"loginId\":\"admins\",\"startStation\":\"Houston bus depot\",\"stationList\":\"new york central station\",\"stations\":\"san francisco oakland international airport\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"75\",\"endStation\":\"Grand Central Terminal\",\"id\":\"test789\",\"startStation\":\"Houston bus depot\",\"stationList\":\"new york central station\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"bd_div_story\",\"distances\":\"150\",\"endStation\":\"Times square station\",\"id\":\"Test789\",\"loginId\":\"Admins\",\"startStation\":\"Houston Bus Depot\",\"stationList\":\"Chicago union passenger terminal\",\"stations\":\"Chicago union terminal\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"bd_div_story\",\"endStation\":\"Times square station\",\"id\":\"Test789\",\"startStation\":\"Houston Bus Depot\",\"stationList\":\"Chicago union passenger terminal\"}";
                        req = req.body(requestBody3);
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"bd_div_story\",\"distances\":\"400\",\"endStation\":\"Grand central terminal\",\"id\":\"Admin_456\",\"loginId\":\"guestaccount\",\"startStation\":\"Los angeles terminal\",\"stationList\":\"Boston logan international airport\",\"stations\":\"boston logan international airport\"}";
                        req = req.body(requestBody1);
            ...
            Allure.step("Step 3: ts-route-service POST /api/v1/routeservice/routes (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody3 = "{\"distanceList\":\"bd_div_story\",\"endStation\":\"Grand central terminal\",\"id\":\"Admin_456\",\"startStation\":\"Los angeles terminal\",\"stationList\":\"Boston logan international airport\"}";
                        req = req.body(requestBody3);
