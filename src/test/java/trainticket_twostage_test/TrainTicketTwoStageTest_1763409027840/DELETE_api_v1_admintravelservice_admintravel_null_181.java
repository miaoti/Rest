...
public class DELETE_api_v1_admintravelservice_admintravel_null_181 {
    ...
    @Test
    public void test_negative_DELETE_181_28() throws Exception {
        // Record test execution for fault detection tracking
        es.us.isa.restest.analysis.FaultDetectionTracker.getInstance()
            .recordTestCase(this.getClass().getName(), "test_negative_DELETE_181_28");
            ...
            Allure.step("Step 1: ts-admin-travel-service DELETE /api/v1/admintravelservice/admintravel/null (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        Response stepResponse1 = req.when().delete("/api/v1/admintravelservice/admintravel/null")
                               .then().log().ifValidationFails()
                                ...
                                if (dataObj.optBoolean("injected", false)) {
                                    ...
                                    if (!detectedFaultName.isEmpty()) {
                                        es.us.isa.restest.analysis.FaultDetectionTracker.getInstance().recordDetectedFault(
                                            ...
                                            "test_negative_DELETE_181_28",
                                            System.currentTimeMillis(),
                                            faultCheckBody
                                        );
                                        System.out.println("🔍 FAULT DETECTED: " + detectedFaultName + " in test: test_negative_DELETE_181_28");
                                    }
                                }
                            }
                        ...
                        try {
                            ...
                            attachJaegerTrace("ts-admin-travel-service", "DELETE", "/api/v1/admintravelservice/admintravel/null", requestStartMicros, allStepParameters);
                        } catch (Exception e) {
        ...
        Allure.label("story", "test_negative_DELETE_181_28");
        Allure.description("Microservice test scenario with " + totalSteps + " steps.");
        
        System.out.println("=== SCENARIO RESULT ===");
        System.out.println("Scenario: test_negative_DELETE_181_28");
