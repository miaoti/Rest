...
public class DELETE_api_v1_admintravelservice_admintravel_tripId_1234567890_1234567890_1234567890_123456_CCFE89B2_181 {
    ...
    @Test
    public void test_negative_DELETE_181_3() throws Exception {
        // Record test execution for fault detection tracking
        es.us.isa.restest.analysis.FaultDetectionTracker.getInstance()
            .recordTestCase(this.getClass().getName(), "test_negative_DELETE_181_3");
        ...
        // Step 1: ts-admin-travel-service DELETE /api/v1/admintravelservice/admintravel/tripId_1234567890_1234567890_1234567890_1234567890_1234567890_1234567890_1234567890_1234567890_1234567890_1234567890_1234567890_1234567890_1234567890_1234567890_1234567890_1234567890_1234567890_123456789 (expect 4XX/5XX error)
            ...
            Allure.step("Step 1: ts-admin-travel-service DELETE /api/v1/admintravelservice/admintravel/tripId_1234567890_1234567890_1234567890_1234567890_1234567890_1234567890_1234567890_1234567890_1234567890_1234567890_1234567890_1234567890_1234567890_1234567890_1234567890_1234567890_1234567890_123456789 (expect 4XX/5XX error)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        Response stepResponse1 = req.when().delete("/api/v1/admintravelservice/admintravel/tripId_1234567890_1234567890_1234567890_1234567890_1234567890_1234567890_1234567890_1234567890_1234567890_1234567890_1234567890_1234567890_1234567890_1234567890_1234567890_1234567890_1234567890_123456789")
                               .then().log().ifValidationFails()
                                ...
                                if (dataObj.optBoolean("injected", false)) {
                                    ...
                                    if (!detectedFaultName.isEmpty()) {
                                        es.us.isa.restest.analysis.FaultDetectionTracker.getInstance().recordDetectedFault(
                                            ...
                                            "test_negative_DELETE_181_3",
                                            System.currentTimeMillis(),
                                            faultCheckBody
                                        );
                                        System.out.println("🔍 FAULT DETECTED: " + detectedFaultName + " in test: test_negative_DELETE_181_3");
                                    }
                                }
                            }
        ...
        Allure.label("story", "test_negative_DELETE_181_3");
        Allure.description("Microservice test scenario with " + totalSteps + " steps.");
        
        System.out.println("=== SCENARIO RESULT ===");
        System.out.println("Scenario: test_negative_DELETE_181_3");
