package trainticket_twostage_test.TrainTicketTwoStageTest_1763769612771;
...
public class POST_api_v1_adminorderservice_adminorder_11 {
    ...
    @Test
    public void test_negative_POST_11_1() throws Exception {
        // Record test execution for fault detection tracking
        es.us.isa.restest.analysis.FaultDetectionTracker.getInstance()
            .recordTestCase(this.getClass().getName(), "test_negative_POST_11_1");
        ...
        // Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect != 200 (any error))
        ...
        try {
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect != 200 (any error))", () -> {
                ...
                if (!shouldSkip) {
                    System.out.println("▶️ EXECUTING: Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect != 200 (any error)) (dependency analysis passed)");
                    ...
                    try {
                        ...
                        String requestBody1 = "{\"accountId\":\"1234567890\",\"boughtDate\":\"2025-11-25\",\"coachNumber\":16,\"contactsDocumentNumber\":\"123456789012345678\",\"contactsName\":\"John Smith\",\"differenceMoney\":\"-25.50\",\"documentType\":2,\"from\":\"Beijing\",\"id\":\"ROUTE-55667\",\"price\":\"299.99\",\"seatClass\":1,\"seatNumber\":\"12A\",\"status\":1,\"to\":\"Beijing\",\"trainNumber\":\"G1234\",\"travelDate\":\"2013-05-07\",\"travelTime\":123}";
                        ...
                        allStepParameters.put("body", "{\"accountId\":\"1234567890\",\"boughtDate\":\"2025-11-25\",\"coachNumber\":16,\"contactsDocumentNumber\":\"123456789012345678\",\"contactsName\":\"John Smith\",\"differenceMoney\":\"-25.50\",\"documentType\":2,\"from\":\"Beijing\",\"id\":\"ROUTE-55667\",\"price\":\"299.99\",\"seatClass\":1,\"seatNumber\":\"12A\",\"status\":1,\"to\":\"Beijing\",\"trainNumber\":\"G1234\",\"travelDate\":\"2013-05-07\",\"travelTime\":123}");
                                ...
                                if (dataObj.optBoolean("injected", false)) {
                                    ...
                                    if (!detectedFaultName.isEmpty()) {
                                        es.us.isa.restest.analysis.FaultDetectionTracker.getInstance().recordDetectedFault(
                                            ...
                                            "test_negative_POST_11_1",
                                            System.currentTimeMillis(),
                                            faultCheckBody
                                        );
                                        System.out.println("🔍 FAULT DETECTED: " + detectedFaultName + " in test: test_negative_POST_11_1");
                                    }
                                }
                            }
                        ...
                        System.out.println("✅ Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect != 200 (any error)) - SUCCESS");
                        ...
                        System.out.println("❌ Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect != 200 (any error)) - FAILED: " + t.getMessage());
                        ...
                        errorDetails.append("=====================================\n\n");
                        errorDetails.append("📋 Step: Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect != 200 (any error))\n");
                        ...
                        throw new RuntimeException("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect != 200 (any error)) failed: " + failureReason + " (" + errorType + ")", t);
                    }
                } else {
                    // ⏭️ SKIP: Clean skip reporting with proper Allure status
                    System.out.println("⏭️ SKIPPING: Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect != 200 (any error)) - " + skipReason);
                    stepResults.put(1, false);
            ...
            if (stepException instanceof RuntimeException && stepException.getMessage().startsWith("Step failed:")) {
                ...
                System.out.println("⚠️ Step wrapper failed for Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect != 200 (any error)): " + stepException.getMessage());
                stepResults.put(1, false);
            }
        }
        ...
        Allure.label("story", "test_negative_POST_11_1");
        Allure.description("Microservice test scenario with " + totalSteps + " steps.");
        
        System.out.println("=== SCENARIO RESULT ===");
        System.out.println("Scenario: test_negative_POST_11_1");
    ...
    @Test
    public void test_negative_POST_11_2() throws Exception {
        // Record test execution for fault detection tracking
        es.us.isa.restest.analysis.FaultDetectionTracker.getInstance()
            .recordTestCase(this.getClass().getName(), "test_negative_POST_11_2");
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect != 200 (any error))", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"1234567890\",\"boughtDate\":\"2025-12-05\",\"coachNumber\":12,\"contactsDocumentNumber\":\"123456789012345678\",\"contactsName\":\"Michael Wilson\",\"differenceMoney\":\"150.00\",\"documentType\":\"abc\",\"from\":\"Shanghai\",\"id\":\"STATION-99001\",\"price\":\"128.50\",\"seatClass\":1,\"seatNumber\":\"12A\",\"status\":3,\"to\":\"Beijing\",\"trainNumber\":\"G1234\",\"travelDate\":\"2025-11-25\",\"travelTime\":\"08:30:00\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"accountId\":\"1234567890\",\"boughtDate\":\"2025-12-05\",\"coachNumber\":12,\"contactsDocumentNumber\":\"123456789012345678\",\"contactsName\":\"Michael Wilson\",\"differenceMoney\":\"150.00\",\"documentType\":\"abc\",\"from\":\"Shanghai\",\"id\":\"STATION-99001\",\"price\":\"128.50\",\"seatClass\":1,\"seatNumber\":\"12A\",\"status\":3,\"to\":\"Beijing\",\"trainNumber\":\"G1234\",\"travelDate\":\"2025-11-25\",\"travelTime\":\"08:30:00\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/adminorderservice/adminorder")
                               .then().log().ifValidationFails()
                               .extract().response();
                                ...
                                if (dataObj.optBoolean("injected", false)) {
                                    ...
                                    if (!detectedFaultName.isEmpty()) {
                                        es.us.isa.restest.analysis.FaultDetectionTracker.getInstance().recordDetectedFault(
                                            detectedFaultName,
                                            this.getClass().getName(),
                                            "test_negative_POST_11_2",
                                            System.currentTimeMillis(),
                                            faultCheckBody
                                        );
                                        System.out.println("🔍 FAULT DETECTED: " + detectedFaultName + " in test: test_negative_POST_11_2");
                                    }
                                }
                            }
                        } catch (Exception faultEx) {
        ...
        Allure.label("severity", severity);
        Allure.label("feature", "Microservice Workflow");
        Allure.label("story", "test_negative_POST_11_2");
        Allure.description("Microservice test scenario with " + totalSteps + " steps.");
        
        System.out.println("=== SCENARIO RESULT ===");
        System.out.println("Scenario: test_negative_POST_11_2");
        System.out.println("Total Steps: " + totalSteps);
        System.out.println("Successful: " + successfulSteps);
        System.out.println("Failed: " + failedSteps);
        System.out.println("Login Status: " + (loginSucceeded.get() ? "SUCCESS" : "FAILED"));
    ...
    @Test
    public void test_negative_POST_11_3() throws Exception {
        // Record test execution for fault detection tracking
        es.us.isa.restest.analysis.FaultDetectionTracker.getInstance()
            .recordTestCase(this.getClass().getName(), "test_negative_POST_11_3");
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect != 200 (any error))", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"e5f6a7b8-c9d0-\",\"boughtDate\":\"2025-11-25\",\"coachNumber\":12,\"contactsDocumentNumber\":123,\"contactsName\":\"John Smith\",\"differenceMoney\":\"0.00\",\"documentType\":3,\"from\":\"Beijing\",\"id\":\"AR-12345\",\"price\":\"128.50\",\"seatClass\":1,\"seatNumber\":\"12A\",\"status\":1,\"to\":\"Beijing\",\"trainNumber\":\"G1234\",\"travelDate\":\"2025-11-25\",\"travelTime\":\"18:20:00\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"accountId\":\"e5f6a7b8-c9d0-\",\"boughtDate\":\"2025-11-25\",\"coachNumber\":12,\"contactsDocumentNumber\":123,\"contactsName\":\"John Smith\",\"differenceMoney\":\"0.00\",\"documentType\":3,\"from\":\"Beijing\",\"id\":\"AR-12345\",\"price\":\"128.50\",\"seatClass\":1,\"seatNumber\":\"12A\",\"status\":1,\"to\":\"Beijing\",\"trainNumber\":\"G1234\",\"travelDate\":\"2025-11-25\",\"travelTime\":\"18:20:00\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/adminorderservice/adminorder")
                               .then().log().ifValidationFails()
                               .extract().response();
                                ...
                                if (dataObj.optBoolean("injected", false)) {
                                    ...
                                    if (!detectedFaultName.isEmpty()) {
                                        es.us.isa.restest.analysis.FaultDetectionTracker.getInstance().recordDetectedFault(
                                            detectedFaultName,
                                            this.getClass().getName(),
                                            "test_negative_POST_11_3",
                                            System.currentTimeMillis(),
                                            faultCheckBody
                                        );
                                        System.out.println("🔍 FAULT DETECTED: " + detectedFaultName + " in test: test_negative_POST_11_3");
                                    }
                                }
                            }
                        } catch (Exception faultEx) {
        ...
        Allure.label("severity", severity);
        Allure.label("feature", "Microservice Workflow");
        Allure.label("story", "test_negative_POST_11_3");
        Allure.description("Microservice test scenario with " + totalSteps + " steps.");
        
        System.out.println("=== SCENARIO RESULT ===");
        System.out.println("Scenario: test_negative_POST_11_3");
        System.out.println("Total Steps: " + totalSteps);
        System.out.println("Successful: " + successfulSteps);
        System.out.println("Failed: " + failedSteps);
        System.out.println("Login Status: " + (loginSucceeded.get() ? "SUCCESS" : "FAILED"));
    ...
    @Test
    public void test_negative_POST_11_4() throws Exception {
        // Record test execution for fault detection tracking
        es.us.isa.restest.analysis.FaultDetectionTracker.getInstance()
            .recordTestCase(this.getClass().getName(), "test_negative_POST_11_4");
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect != 200 (any error))", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"1234567890\",\"boughtDate\":\"2025-11-28\",\"coachNumber\":12,\"contactsDocumentNumber\":\"DocumentNumber_Ten\",\"contactsName\":123,\"differenceMoney\":\"150.00\",\"documentType\":1,\"from\":\"Beijing\",\"id\":\"TS-67890\",\"price\":\"85.00\",\"seatClass\":1,\"seatNumber\":\"12A\",\"status\":1,\"to\":\"Beijing\",\"trainNumber\":\"G1234\",\"travelDate\":\"2013-05-06\",\"travelTime\":\"08:30:00\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"accountId\":\"1234567890\",\"boughtDate\":\"2025-11-28\",\"coachNumber\":12,\"contactsDocumentNumber\":\"DocumentNumber_Ten\",\"contactsName\":123,\"differenceMoney\":\"150.00\",\"documentType\":1,\"from\":\"Beijing\",\"id\":\"TS-67890\",\"price\":\"85.00\",\"seatClass\":1,\"seatNumber\":\"12A\",\"status\":1,\"to\":\"Beijing\",\"trainNumber\":\"G1234\",\"travelDate\":\"2013-05-06\",\"travelTime\":\"08:30:00\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/adminorderservice/adminorder")
                               .then().log().ifValidationFails()
                               .extract().response();
                                ...
                                if (dataObj.optBoolean("injected", false)) {
                                    ...
                                    if (!detectedFaultName.isEmpty()) {
                                        es.us.isa.restest.analysis.FaultDetectionTracker.getInstance().recordDetectedFault(
                                            detectedFaultName,
                                            this.getClass().getName(),
                                            "test_negative_POST_11_4",
                                            System.currentTimeMillis(),
                                            faultCheckBody
                                        );
                                        System.out.println("🔍 FAULT DETECTED: " + detectedFaultName + " in test: test_negative_POST_11_4");
                                    }
                                }
                            }
                        } catch (Exception faultEx) {
        ...
        Allure.label("severity", severity);
        Allure.label("feature", "Microservice Workflow");
        Allure.label("story", "test_negative_POST_11_4");
        Allure.description("Microservice test scenario with " + totalSteps + " steps.");
        
        System.out.println("=== SCENARIO RESULT ===");
        System.out.println("Scenario: test_negative_POST_11_4");
        System.out.println("Total Steps: " + totalSteps);
        System.out.println("Successful: " + successfulSteps);
        System.out.println("Failed: " + failedSteps);
        System.out.println("Login Status: " + (loginSucceeded.get() ? "SUCCESS" : "FAILED"));
    ...
    public void test_POST_11_5() throws Exception {
        // Record test execution for fault detection tracking
        es.us.isa.restest.analysis.FaultDetectionTracker.getInstance()
            .recordTestCase(this.getClass().getName(), "test_POST_11_5");
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"4d2a46c7-71cb-4cf1-b5bb-b68406d9da6f\",\"boughtDate\":\"2025-11-25\",\"coachNumber\":3,\"contactsDocumentNumber\":\"123456789012345678\",\"contactsName\":\"John Smith\",\"differenceMoney\":\"75.25\",\"documentType\":1,\"from\":\"Beijing\",\"id\":\"AR-12345\",\"price\":\"128.50\",\"seatClass\":1,\"seatNumber\":\"12A\",\"status\":1,\"to\":\"elizabethwhite_customer@business.com\",\"trainNumber\":\"G1234\",\"travelDate\":\"2025-11-25\",\"travelTime\":\"14:15:00\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"accountId\":\"4d2a46c7-71cb-4cf1-b5bb-b68406d9da6f\",\"boughtDate\":\"2025-11-25\",\"coachNumber\":3,\"contactsDocumentNumber\":\"123456789012345678\",\"contactsName\":\"John Smith\",\"differenceMoney\":\"75.25\",\"documentType\":1,\"from\":\"Beijing\",\"id\":\"AR-12345\",\"price\":\"128.50\",\"seatClass\":1,\"seatNumber\":\"12A\",\"status\":1,\"to\":\"elizabethwhite_customer@business.com\",\"trainNumber\":\"G1234\",\"travelDate\":\"2025-11-25\",\"travelTime\":\"14:15:00\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/adminorderservice/adminorder")
                               .then().log().ifValidationFails()
                               .extract().response();
                            ...
                            if (faultJson.has("data")) {
                                ...
                                if (dataObj.optBoolean("injected", false)) {
                                    ...
                                    if (!detectedFaultName.isEmpty()) {
                                        ...
                                        System.out.println("🔍 FAULT DETECTED: " + detectedFaultName + " in test: test_POST_11_5");
                                    }
                                }
                            }
                        } catch (Exception faultEx) {
    ...
    public void test_POST_11_6() throws Exception {
        // Record test execution for fault detection tracking
        es.us.isa.restest.analysis.FaultDetectionTracker.getInstance()
            .recordTestCase(this.getClass().getName(), "test_POST_11_6");
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"1234567890\",\"boughtDate\":\"2025-11-25\",\"coachNumber\":12,\"contactsDocumentNumber\":\"123456789012345678\",\"contactsName\":\"John Smith\",\"differenceMoney\":\"150.00\",\"documentType\":1,\"from\":\"Beijing\",\"id\":\"AR-12345\",\"price\":\"420.75\",\"seatClass\":2,\"seatNumber\":\"12A\",\"status\":1,\"to\":\"Beijing\",\"trainNumber\":\"G1234\",\"travelDate\":\"2025-11-25\",\"travelTime\":\"08:30:00\"}";
                        req = req.body(requestBody1);
                            ...
                            if (faultJson.has("data")) {
                                ...
                                if (dataObj.optBoolean("injected", false)) {
                                    ...
                                    if (!detectedFaultName.isEmpty()) {
                                        ...
                                        System.out.println("🔍 FAULT DETECTED: " + detectedFaultName + " in test: test_POST_11_6");
                                    }
                                }
                            }
                        } catch (Exception faultEx) {
    ...
    public void test_POST_11_7() throws Exception {
        // Record test execution for fault detection tracking
        es.us.isa.restest.analysis.FaultDetectionTracker.getInstance()
            .recordTestCase(this.getClass().getName(), "test_POST_11_7");
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"1234567890\",\"boughtDate\":\"2025-11-25\",\"coachNumber\":12,\"contactsDocumentNumber\":\"123456789012345678\",\"contactsName\":\"John Smith\",\"differenceMoney\":\"300.00\",\"documentType\":4,\"from\":\"Beijing\",\"id\":\"AR-12345\",\"price\":\"67.25\",\"seatClass\":1,\"seatNumber\":\"12A\",\"status\":1,\"to\":\"Beijing\",\"trainNumber\":\"G1234\",\"travelDate\":\"2025-11-25\",\"travelTime\":\"08:30:00\"}";
                        req = req.body(requestBody1);
                            ...
                            if (faultJson.has("data")) {
                                ...
                                if (dataObj.optBoolean("injected", false)) {
                                    ...
                                    if (!detectedFaultName.isEmpty()) {
                                        ...
                                        System.out.println("🔍 FAULT DETECTED: " + detectedFaultName + " in test: test_POST_11_7");
                                    }
                                }
                            }
                        } catch (Exception faultEx) {
    ...
    @Test
    public void test_negative_POST_11_8() throws Exception {
        // Record test execution for fault detection tracking
        es.us.isa.restest.analysis.FaultDetectionTracker.getInstance()
            .recordTestCase(this.getClass().getName(), "test_negative_POST_11_8");
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect != 200 (any error))", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"1234567890\",\"boughtDate\":\"2025-12-10\",\"coachNumber\":12,\"contactsDocumentNumber\":\"123456789012345678\",\"contactsName\":\"John Smith\",\"differenceMoney\":123,\"documentType\":5,\"from\":\"Beijing\",\"id\":\"AR-12345\",\"price\":\"128.50\",\"seatClass\":1,\"seatNumber\":\"17D\",\"status\":1,\"to\":\"Beijing\",\"trainNumber\":\"G1234\",\"travelDate\":\"2025-11-25\",\"travelTime\":\"08:30:00\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"accountId\":\"1234567890\",\"boughtDate\":\"2025-12-10\",\"coachNumber\":12,\"contactsDocumentNumber\":\"123456789012345678\",\"contactsName\":\"John Smith\",\"differenceMoney\":123,\"documentType\":5,\"from\":\"Beijing\",\"id\":\"AR-12345\",\"price\":\"128.50\",\"seatClass\":1,\"seatNumber\":\"17D\",\"status\":1,\"to\":\"Beijing\",\"trainNumber\":\"G1234\",\"travelDate\":\"2025-11-25\",\"travelTime\":\"08:30:00\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/adminorderservice/adminorder")
                               .then().log().ifValidationFails()
                               .extract().response();
                                ...
                                if (dataObj.optBoolean("injected", false)) {
                                    ...
                                    if (!detectedFaultName.isEmpty()) {
                                        es.us.isa.restest.analysis.FaultDetectionTracker.getInstance().recordDetectedFault(
                                            detectedFaultName,
                                            this.getClass().getName(),
                                            "test_negative_POST_11_8",
                                            System.currentTimeMillis(),
                                            faultCheckBody
                                        );
                                        System.out.println("🔍 FAULT DETECTED: " + detectedFaultName + " in test: test_negative_POST_11_8");
                                    }
                                }
                            }
                        } catch (Exception faultEx) {
        ...
        Allure.label("severity", severity);
        Allure.label("feature", "Microservice Workflow");
        Allure.label("story", "test_negative_POST_11_8");
        Allure.description("Microservice test scenario with " + totalSteps + " steps.");
        
        System.out.println("=== SCENARIO RESULT ===");
        System.out.println("Scenario: test_negative_POST_11_8");
        System.out.println("Total Steps: " + totalSteps);
        System.out.println("Successful: " + successfulSteps);
        System.out.println("Failed: " + failedSteps);
        System.out.println("Login Status: " + (loginSucceeded.get() ? "SUCCESS" : "FAILED"));
    ...
    public void test_POST_11_9() throws Exception {
        // Record test execution for fault detection tracking
        es.us.isa.restest.analysis.FaultDetectionTracker.getInstance()
            .recordTestCase(this.getClass().getName(), "test_POST_11_9");
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"1234567890\",\"boughtDate\":\"2025-11-25\",\"coachNumber\":12,\"contactsDocumentNumber\":\"DocumentNumber_Four\",\"contactsName\":\"John Smith\",\"differenceMoney\":\"150.00\",\"documentType\":1,\"from\":\"Guangzhou\",\"id\":\"AR-12345\",\"price\":\"128.50\",\"seatClass\":1,\"seatNumber\":\"3F\",\"status\":1,\"to\":\"Beijing\",\"trainNumber\":\"TeKuai\",\"travelDate\":\"2013-05-05\",\"travelTime\":\"22:45:00\"}";
                        req = req.body(requestBody1);
                            ...
                            if (faultJson.has("data")) {
                                ...
                                if (dataObj.optBoolean("injected", false)) {
                                    ...
                                    if (!detectedFaultName.isEmpty()) {
                                        ...
                                        System.out.println("🔍 FAULT DETECTED: " + detectedFaultName + " in test: test_POST_11_9");
                                    }
                                }
                            }
                        } catch (Exception faultEx) {
    ...
    public void test_POST_11_10() throws Exception {
        // Record test execution for fault detection tracking
        es.us.isa.restest.analysis.FaultDetectionTracker.getInstance()
            .recordTestCase(this.getClass().getName(), "test_POST_11_10");
            ...
            Allure.step("Step 1: ts-admin-order-service POST /api/v1/adminorderservice/adminorder (expect 200)", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"accountId\":\"1234567890\",\"boughtDate\":\"2025-11-25\",\"coachNumber\":25,\"contactsDocumentNumber\":\"123456789012345678\",\"contactsName\":\"Maria Garcia\",\"differenceMoney\":\"150.00\",\"documentType\":1,\"from\":\"Shenzhen\",\"id\":\"AR-12345\",\"price\":\"299.99\",\"seatClass\":1,\"seatNumber\":\"12A\",\"status\":4,\"to\":\"Beijing\",\"trainNumber\":\"ZhiDa\",\"travelDate\":\"2025-11-25\",\"travelTime\":\"06:00:00\"}";
                        req = req.body(requestBody1);
                            ...
                            if (faultJson.has("data")) {
                                ...
                                if (dataObj.optBoolean("injected", false)) {
                                    ...
                                    if (!detectedFaultName.isEmpty()) {
                                        ...
                                        System.out.println("🔍 FAULT DETECTED: " + detectedFaultName + " in test: test_POST_11_10");
                                    }
                                }
                            }
                        } catch (Exception faultEx) {
