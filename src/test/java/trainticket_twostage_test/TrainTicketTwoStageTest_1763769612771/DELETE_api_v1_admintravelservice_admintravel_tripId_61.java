...
public class DELETE_api_v1_admintravelservice_admintravel_tripId_61 {
    ...
    public void test_DELETE_61_6() throws Exception {
                            ...
                            if (faultJson.has("data")) {
                                ...
                                if (dataObj.optBoolean("injected", false)) {
                                    ...
                                    if (!detectedFaultName.isEmpty()) {
                                        ...
                                        System.out.println("🔍 FAULT DETECTED: " + detectedFaultName + " in test: test_DELETE_61_6");
                                    }
                                }
                            }
        ...
        Allure.label("story", "test_DELETE_61_6");
        Allure.description("Microservice test scenario with " + totalSteps + " steps.");
        
        System.out.println("=== SCENARIO RESULT ===");
        System.out.println("Scenario: test_DELETE_61_6");
