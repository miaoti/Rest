...
public class TrainTicketTest_1750978780408 {
    ...
    public void testScenario1() throws Exception {
        ...
        if (!scenarioFailed.get()) {
            ...
            try {
                ...
                req = req.body("{\"basicPriceRate\":\"test211\",\"firstClassPriceRate\":\"test215\",\"id\":\"test217\",\"routeId\":\"test220\",\"trainType\":\"test222\"}");
