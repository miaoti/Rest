...
public class Flow_Scenario_10414 {
    ...
    @Test
    public void test_positive_flow_S10414_v1() throws Exception {
        // Record test execution for fault detection tracking
        io.mist.core.analysis.FaultDetectionTracker.getInstance()
            .recordTestCase(this.getClass().getName(), "test_positive_flow_S10414_v1");
        ...
        if (decision1.shouldExecute && loginSucceeded.get()) {
            System.out.println("✅ EXECUTING: Root 1: ts-admin-basic-info-service GET /api/v1/adminbasicservice/adminbasic/stations [expect 200]");
            // Execute step logic here (simplified version)
            stepResults.put(1, true);
        } else {
            System.out.println("⏭️ SKIPPING: Root 1: ts-admin-basic-info-service GET /api/v1/adminbasicservice/adminbasic/stations [expect 200]");
        ...
        System.out.println("Scenario: test_positive_flow_S10414_v1");
