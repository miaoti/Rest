...
@io.qameta.allure.junit4.DisplayName("Flow_Scenario_513 | GET /api/v1/adminbasicservice/adminbasic/stations")
public class Flow_Scenario_513 {
    ...
    public void test_positive_flow_S513_v1() throws Exception {
        ...
        Allure.label("suite", "GET /api/v1/adminbasicservice/adminbasic/stations");
