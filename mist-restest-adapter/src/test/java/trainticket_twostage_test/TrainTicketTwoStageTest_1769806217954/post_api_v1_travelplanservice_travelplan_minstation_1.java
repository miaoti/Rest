package trainticket_twostage_test.TrainTicketTwoStageTest_1769806217954;
            ...
            Allure.step("Step 1: ts-travel-plan-service POST /api/v1/travelplanservice/travelPlan/minStation [expect not 200]", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        String requestBody1 = "{\"departureTime\":12345,\"endPlace\":\"test249\",\"startPlace\":\"test886\"}";
                        ...
                        allStepParameters.put("body", "{\"departureTime\":12345,\"endPlace\":\"test249\",\"startPlace\":\"test886\"}");
            ...
            Allure.step("Step 1: ts-travel-plan-service POST /api/v1/travelplanservice/travelPlan/minStation [expect 200]", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"departureTime\":\"test69\",\"endPlace\":\"test249\",\"startPlace\":\"test886\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"departureTime\":\"test69\",\"endPlace\":\"test249\",\"startPlace\":\"test886\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/travelplanservice/travelPlan/minStation")
                               .then().log().ifValidationFails()
                               .extract().response();
            ...
            Allure.step("Step 1: ts-travel-plan-service POST /api/v1/travelplanservice/travelPlan/minStation [expect not 200]", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"departureTime\":\"test69\",\"endPlace\":\"test249\",\"startPlace\":12345}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"departureTime\":\"test69\",\"endPlace\":\"test249\",\"startPlace\":12345}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/travelplanservice/travelPlan/minStation")
                               .then().log().ifValidationFails()
                               .extract().response();
            ...
            Allure.step("Step 1: ts-travel-plan-service POST /api/v1/travelplanservice/travelPlan/minStation [expect not 200]", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"departureTime\":\"test69\",\"endPlace\":12345,\"startPlace\":\"test886\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"departureTime\":\"test69\",\"endPlace\":12345,\"startPlace\":\"test886\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/travelplanservice/travelPlan/minStation")
                               .then().log().ifValidationFails()
                               .extract().response();
