package trainticket_twostage_test.TrainTicketTwoStageTest_1769807061095;
...
public class post_api_v1_travelplanservice_travelplan_minstation_1 {
    ...
    public void test_negative_POST_1_1() throws Exception {
        ...
        Allure.label("subSuite", "test_negative_POST_1_1");
            ...
            Allure.step("Step 1: ts-travel-plan-service POST /api/v1/travelplanservice/travelPlan/minStation [expect not 200]", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        String requestBody1 = "{\"departureTime\":123456,\"endPlace\":\"Beijing\",\"startPlace\":\"Shanghai\"}";
                        ...
                        allStepParameters.put("body", "{\"departureTime\":123456,\"endPlace\":\"Beijing\",\"startPlace\":\"Shanghai\"}");
            ...
            Allure.step("Step 1: ts-travel-plan-service POST /api/v1/travelplanservice/travelPlan/minStation [expect 200]", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"departureTime\":\"2024-02-20\",\"endPlace\":\"Beijing\",\"startPlace\":\"Shanghai\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"departureTime\":\"2024-02-20\",\"endPlace\":\"Beijing\",\"startPlace\":\"Shanghai\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/travelplanservice/travelPlan/minStation")
                               .then().log().ifValidationFails()
                               .extract().response();
    ...
    public void test_POST_1_3() throws Exception {
        ...
        Allure.label("parentSuite", "ts-travel-plan-service");
        Allure.label("suite", "POST /api/v1/travelplanservice/travelPlan/minStation");
        Allure.label("subSuite", "test_POST_1_3");
            ...
            Allure.step("Step 1: ts-travel-plan-service POST /api/v1/travelplanservice/travelPlan/minStation [expect 200]", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"departureTime\":\"2026-02-15\",\"endPlace\":\"guangzhou\",\"startPlace\":\"Hangzhou\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"departureTime\":\"2026-02-15\",\"endPlace\":\"guangzhou\",\"startPlace\":\"Hangzhou\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/travelplanservice/travelPlan/minStation")
                               .then().log().ifValidationFails()
                               .extract().response();
            ...
            Allure.step("Step 1: ts-travel-plan-service POST /api/v1/travelplanservice/travelPlan/minStation [expect not 200]", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"departureTime\":\"2024-04-25\",\"endPlace\":123,\"startPlace\":\"Shanghai\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"departureTime\":\"2024-04-25\",\"endPlace\":123,\"startPlace\":\"Shanghai\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/travelplanservice/travelPlan/minStation")
                               .then().log().ifValidationFails()
                               .extract().response();
