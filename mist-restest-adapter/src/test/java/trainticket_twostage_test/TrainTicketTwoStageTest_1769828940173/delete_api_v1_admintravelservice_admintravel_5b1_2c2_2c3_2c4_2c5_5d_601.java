...
public class delete_api_v1_admintravelservice_admintravel_5b1_2c2_2c3_2c4_2c5_5d_601 {
                                    ...
                                    if (dataValue instanceof org.json.JSONObject) {
                                        ...
                                        if (dataObj.optBoolean("injected", false)) {
                                            ...
                                            if (!detectedFaultName.isEmpty()) {
                                                ...
                                                System.out.println("🔍 FAULT DETECTED (in failed test): " + detectedFaultName + " in test: test_negative_DELETE_601_17");
                                            }
                                        }
                                    }
                                }
