package trainticket_twostage_test.TrainTicketTwoStageTest_1778001841606;
...
@Epic("Baseline Tests")
@Feature("ts-admin-basic-info-service")
@io.qameta.allure.junit4.DisplayName("Flow_Scenario_2096 | PUT /api/v1/adminbasicservice/adminbasic/trains")
public class Flow_Scenario_2096 {
    ...
    @Test
    public void test_positive_flow_S2096_v1() throws Exception {
        // Record test execution for fault detection tracking
        es.us.isa.restest.analysis.FaultDetectionTracker.getInstance()
            .recordTestCase(this.getClass().getName(), "test_positive_flow_S2096_v1");
        ...
        Allure.label("parentSuite", "ts-admin-basic-info-service");
        ...
        try {
            Allure.step("Root 1: ts-admin-basic-info-service PUT /api/v1/adminbasicservice/adminbasic/trains [expect 200]", () -> {
                Allure.parameter("🏢 Service", "ts-admin-basic-info-service");
                Allure.parameter("📡 HTTP Method", "PUT");
                Allure.parameter("🔗 Endpoint", "/api/v1/adminbasicservice/adminbasic/trains");
                Allure.parameter("🎯 Expected Status", 200);
                ...
                Allure.description("🎯 **Testing**: ts-admin-basic-info-service\n" +
                                 "📡 **Method**: PUT\n" +
                                 "🔗 **Path**: /api/v1/adminbasicservice/adminbasic/trains\n" +
                                 "🎯 **Expected**: 200\n" +
                ...
                if (!shouldSkip) {
                    System.out.println("▶️ EXECUTING: Root 1: ts-admin-basic-info-service PUT /api/v1/adminbasicservice/adminbasic/trains [expect 200] (dependency analysis passed)");
                    ...
                    try {
                        ...
                        String requestBody1 = "{\"averageSpeed\":859,\"confortClass\":366,\"economyClass\":775,\"id\":\"test576\",\"name\":\"test985\"}";
                        ...
                        allStepParameters.put("body", "{\"averageSpeed\":859,\"confortClass\":366,\"economyClass\":775,\"id\":\"test576\",\"name\":\"test985\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().put("/api/v1/adminbasicservice/adminbasic/trains")
                               .then().log().ifValidationFails()
                               .extract().response();
                                    ...
                                    if (dataObj.optBoolean("injected", false)) {
                                        ...
                                        if (!detectedFaultName.isEmpty()) {
                                            es.us.isa.restest.analysis.FaultDetectionTracker.getInstance().recordDetectedFault(
                                                ...
                                                "test_positive_flow_S2096_v1",
                                                System.currentTimeMillis(),
                                                faultCheckBody
                                            );
                                            System.out.println("🔍 FAULT DETECTED: " + detectedFaultName + " in test: test_positive_flow_S2096_v1");
                                        }
                                    }
                                }
                            }
                        ...
                        System.out.println("✅ Root 1: ts-admin-basic-info-service PUT /api/v1/adminbasicservice/adminbasic/trains [expect 200] - SUCCESS");
                        try {
                        ...
                        try {
                            ...
                            attachJaegerTrace("ts-admin-basic-info-service", "PUT", "/api/v1/adminbasicservice/adminbasic/trains", requestStartMicros, allStepParameters, false);
                        } catch (Exception e) {
                            Allure.parameter("🎯 Result", "✅ SUCCESS (response capture failed)");
                        }
                    } catch (Throwable t) {
                        stepResults.put(1, false);
                        System.out.println("❌ Root 1: ts-admin-basic-info-service PUT /api/v1/adminbasicservice/adminbasic/trains [expect 200] - FAILED: " + t.getMessage());
                                    ...
                                    if (dataValue instanceof org.json.JSONObject) {
                                        ...
                                        if (dataObj.optBoolean("injected", false)) {
                                            ...
                                            if (!detectedFaultName.isEmpty()) {
                                                ...
                                                System.out.println("🔍 FAULT DETECTED (in failed test): " + detectedFaultName + " in test: test_positive_flow_S2096_v1");
                                            }
                                        }
                                    }
                                }
                        ...
                        Allure.parameter("📡 Failed Method", "PUT");
                        Allure.parameter("🔗 Failed Endpoint", "/api/v1/adminbasicservice/adminbasic/trains");
                        ...
                        errorDetails.append("=====================================\n\n");
                        errorDetails.append("📋 Step: Root 1: ts-admin-basic-info-service PUT /api/v1/adminbasicservice/adminbasic/trains [expect 200]\n");
                        errorDetails.append("🏢 Service: ts-admin-basic-info-service\n");
                        errorDetails.append("📡 Method: PUT\n");
                        errorDetails.append("🔗 Endpoint: /api/v1/adminbasicservice/adminbasic/trains\n");
                        ...
                        // ⏱️ Wait longer for trace propagation to Jaeger (increased delay)
                        try { Thread.sleep(3000); } catch (InterruptedException ie) { Thread.currentThread().interrupt(); }
                        attachJaegerTrace("ts-admin-basic-info-service", "PUT", "/api/v1/adminbasicservice/adminbasic/trains", requestStartMicros, allStepParameters, true);
                        
                        // 🔥 CRITICAL: Throw exception to mark step as FAILED (red arrow) in Allure
                        throw new RuntimeException("Root 1: ts-admin-basic-info-service PUT /api/v1/adminbasicservice/adminbasic/trains [expect 200] failed: " + failureReason + " (" + errorType + ")", t);
                    }
                } else {
                    // ⏭️ SKIP: Clean skip reporting with proper Allure status
                    System.out.println("⏭️ SKIPPING: Root 1: ts-admin-basic-info-service PUT /api/v1/adminbasicservice/adminbasic/trains [expect 200] - " + skipReason);
                    stepResults.put(1, false);
            ...
            if (stepException instanceof RuntimeException && stepException.getMessage().startsWith("Step failed:")) {
                ...
                System.out.println("⚠️ Step wrapper failed for Root 1: ts-admin-basic-info-service PUT /api/v1/adminbasicservice/adminbasic/trains [expect 200]: " + stepException.getMessage());
                stepResults.put(1, false);
            }
        }
        ...
        System.out.println("Scenario: test_positive_flow_S2096_v1");
    ...
    @Test
    public void test_positive_flow_S2096_v2() throws Exception {
        // Record test execution for fault detection tracking
        es.us.isa.restest.analysis.FaultDetectionTracker.getInstance()
            .recordTestCase(this.getClass().getName(), "test_positive_flow_S2096_v2");
            ...
            Allure.step("Root 1: ts-admin-basic-info-service PUT /api/v1/adminbasicservice/adminbasic/trains [expect 200]", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"averageSpeed\":250,\"confortClass\":366,\"economyClass\":775,\"id\":\"test576\",\"name\":\"test985\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"averageSpeed\":250,\"confortClass\":366,\"economyClass\":775,\"id\":\"test576\",\"name\":\"test985\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().put("/api/v1/adminbasicservice/adminbasic/trains")
                               .then().log().ifValidationFails()
                               .extract().response();
                                    ...
                                    if (dataObj.optBoolean("injected", false)) {
                                        ...
                                        if (!detectedFaultName.isEmpty()) {
                                            es.us.isa.restest.analysis.FaultDetectionTracker.getInstance().recordDetectedFault(
                                                detectedFaultName,
                                                this.getClass().getName(),
                                                "test_positive_flow_S2096_v2",
                                                System.currentTimeMillis(),
                                                faultCheckBody
                                            );
                                            System.out.println("🔍 FAULT DETECTED: " + detectedFaultName + " in test: test_positive_flow_S2096_v2");
                                        }
                                    }
                                }
                            }
                                    ...
                                    if (dataValue instanceof org.json.JSONObject) {
                                        ...
                                        if (dataObj.optBoolean("injected", false)) {
                                            ...
                                            if (!detectedFaultName.isEmpty()) {
                                                ...
                                                System.out.println("🔍 FAULT DETECTED (in failed test): " + detectedFaultName + " in test: test_positive_flow_S2096_v2");
                                            }
                                        }
                                    }
                                }
        ...
        System.out.println("=== SCENARIO RESULT ===");
        System.out.println("Scenario: test_positive_flow_S2096_v2");
        System.out.println("Total Steps: " + totalSteps);
        System.out.println("Successful: " + successfulSteps);
        System.out.println("Failed: " + failedSteps);
        System.out.println("Login Status: " + (loginSucceeded.get() ? "SUCCESS" : "FAILED"));
    ...
    @Test
    public void test_positive_flow_S2096_v3() throws Exception {
        // Record test execution for fault detection tracking
        es.us.isa.restest.analysis.FaultDetectionTracker.getInstance()
            .recordTestCase(this.getClass().getName(), "test_positive_flow_S2096_v3");
            ...
            Allure.step("Root 1: ts-admin-basic-info-service PUT /api/v1/adminbasicservice/adminbasic/trains [expect 200]", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"averageSpeed\":859,\"confortClass\":366,\"economyClass\":775,\"id\":\"0b23bd3e-876a-4af3-b920-c50a90c90b04\",\"name\":\"test985\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"averageSpeed\":859,\"confortClass\":366,\"economyClass\":775,\"id\":\"0b23bd3e-876a-4af3-b920-c50a90c90b04\",\"name\":\"test985\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().put("/api/v1/adminbasicservice/adminbasic/trains")
                               .then().log().ifValidationFails()
                               .extract().response();
                                    ...
                                    if (dataObj.optBoolean("injected", false)) {
                                        ...
                                        if (!detectedFaultName.isEmpty()) {
                                            es.us.isa.restest.analysis.FaultDetectionTracker.getInstance().recordDetectedFault(
                                                detectedFaultName,
                                                this.getClass().getName(),
                                                "test_positive_flow_S2096_v3",
                                                System.currentTimeMillis(),
                                                faultCheckBody
                                            );
                                            System.out.println("🔍 FAULT DETECTED: " + detectedFaultName + " in test: test_positive_flow_S2096_v3");
                                        }
                                    }
                                }
                            }
                                    ...
                                    if (dataValue instanceof org.json.JSONObject) {
                                        ...
                                        if (dataObj.optBoolean("injected", false)) {
                                            ...
                                            if (!detectedFaultName.isEmpty()) {
                                                ...
                                                System.out.println("🔍 FAULT DETECTED (in failed test): " + detectedFaultName + " in test: test_positive_flow_S2096_v3");
                                            }
                                        }
                                    }
                                }
        ...
        System.out.println("=== SCENARIO RESULT ===");
        System.out.println("Scenario: test_positive_flow_S2096_v3");
        System.out.println("Total Steps: " + totalSteps);
        System.out.println("Successful: " + successfulSteps);
        System.out.println("Failed: " + failedSteps);
        System.out.println("Login Status: " + (loginSucceeded.get() ? "SUCCESS" : "FAILED"));
    ...
    @Test
    public void test_positive_flow_S2096_v5() throws Exception {
        // Record test execution for fault detection tracking
        es.us.isa.restest.analysis.FaultDetectionTracker.getInstance()
            .recordTestCase(this.getClass().getName(), "test_positive_flow_S2096_v5");
            ...
            Allure.step("Root 1: ts-admin-basic-info-service PUT /api/v1/adminbasicservice/adminbasic/trains [expect 200]", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"averageSpeed\":250,\"confortClass\":366,\"economyClass\":775,\"id\":\"0b23bd3e-876a-4af3-b920-c50a90c90b04\",\"name\":\"test985\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"averageSpeed\":250,\"confortClass\":366,\"economyClass\":775,\"id\":\"0b23bd3e-876a-4af3-b920-c50a90c90b04\",\"name\":\"test985\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().put("/api/v1/adminbasicservice/adminbasic/trains")
                               .then().log().ifValidationFails()
                               .extract().response();
                                    ...
                                    if (dataObj.optBoolean("injected", false)) {
                                        ...
                                        if (!detectedFaultName.isEmpty()) {
                                            es.us.isa.restest.analysis.FaultDetectionTracker.getInstance().recordDetectedFault(
                                                detectedFaultName,
                                                this.getClass().getName(),
                                                "test_positive_flow_S2096_v5",
                                                System.currentTimeMillis(),
                                                faultCheckBody
                                            );
                                            System.out.println("🔍 FAULT DETECTED: " + detectedFaultName + " in test: test_positive_flow_S2096_v5");
                                        }
                                    }
                                }
                            }
                                    ...
                                    if (dataValue instanceof org.json.JSONObject) {
                                        ...
                                        if (dataObj.optBoolean("injected", false)) {
                                            ...
                                            if (!detectedFaultName.isEmpty()) {
                                                ...
                                                System.out.println("🔍 FAULT DETECTED (in failed test): " + detectedFaultName + " in test: test_positive_flow_S2096_v5");
                                            }
                                        }
                                    }
                                }
        ...
        System.out.println("=== SCENARIO RESULT ===");
        System.out.println("Scenario: test_positive_flow_S2096_v5");
        System.out.println("Total Steps: " + totalSteps);
        System.out.println("Successful: " + successfulSteps);
        System.out.println("Failed: " + failedSteps);
        System.out.println("Login Status: " + (loginSucceeded.get() ? "SUCCESS" : "FAILED"));
