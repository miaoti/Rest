...
public class delete_api_v1_admintravelservice_admintravel_abc123_601 {
    ...
    public void test_negative_DELETE_601_30() throws Exception {
        ...
        Allure.label("subSuite", "test_negative_DELETE_601_30");
                                    ...
                                    if (dataValue instanceof org.json.JSONObject) {
                                        ...
                                        if (dataObj.optBoolean("injected", false)) {
                                            ...
                                            if (!detectedFaultName.isEmpty()) {
                                                ...
                                                System.out.println("🔍 FAULT DETECTED (in failed test): " + detectedFaultName + " in test: test_negative_DELETE_601_30");
                                            }
                                        }
                                    }
                                }
    ...
    public void test_negative_DELETE_601_51() throws Exception {
        ...
        Allure.label("parentSuite", "ts-admin-travel-service");
        Allure.label("suite", "DELETE /api/v1/admintravelservice/admintravel/{tripId}");
        Allure.label("subSuite", "test_negative_DELETE_601_51");
