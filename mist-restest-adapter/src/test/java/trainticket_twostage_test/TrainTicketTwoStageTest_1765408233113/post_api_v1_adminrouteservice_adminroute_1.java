package trainticket_twostage_test.TrainTicketTwoStageTest_1765408233113;
...
public class post_api_v1_adminrouteservice_adminroute_1 {
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute [expect not 200]", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        String requestBody1 = "{\"distanceList\":\"8.9\",\"endStation\":123,\"id\":\"jinan\",\"loginId\":\"admin_user_001\",\"startStation\":\"wuxi\",\"stationList\":\"Grand Central Terminal,Penn Station,Union Station,Times Square Station,Broadway Station\"}";
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"8.9\",\"endStation\":123,\"id\":\"jinan\",\"loginId\":\"admin_user_001\",\"startStation\":\"wuxi\",\"stationList\":\"Grand Central Terminal,Penn Station,Union Station,Times Square Station,Broadway Station\"}");
                        ...
                        invalidParams.put("endStation", "123");
    ...
    public void test_negative_POST_1_2() throws Exception {
        ...
        es.us.isa.restest.enhancer.TestResultCapture.addParameter(
            ...
            "12.5,8.2,15.7,22.1,5.9", false);
        es.us.isa.restest.enhancer.TestResultCapture.addParameter(
            "endStation", "New York Penn Station", 
            "string", "formData", 
            null, 
            null, false);
        es.us.isa.restest.enhancer.TestResultCapture.addParameter(
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute [expect not 200]", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"35.2\",\"endStation\":\"Union Station\",\"id\":\"AR-2025-001\",\"loginId\":123,\"startStation\":\"Grand Central Terminal\",\"stationList\":\"Grand Central Terminal,Penn Station,Union Station,Times Square Station,Broadway Station\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"35.2\",\"endStation\":\"Union Station\",\"id\":\"AR-2025-001\",\"loginId\":123,\"startStation\":\"Grand Central Terminal\",\"stationList\":\"Grand Central Terminal,Penn Station,Union Station,Times Square Station,Broadway Station\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               .extract().response();
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute [expect not 200]", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"10.5\",\"endStation\":\"New York Penn Station\",\"id\":\"AR-2025-001\",\"loginId\":\"admin_user_001\",\"startStation\":\"New York Penn Station\",\"stationList\":123}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"10.5\",\"endStation\":\"New York Penn Station\",\"id\":\"AR-2025-001\",\"loginId\":\"admin_user_001\",\"startStation\":\"New York Penn Station\",\"stationList\":123}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               .extract().response();
                        ...
                        // Build map of designed invalid parameters for this negative test
                        java.util.Map<String, String> invalidParams = new java.util.HashMap<>();
                        invalidParams.put("stationList", "123");
    ...
    public void test_negative_POST_1_4() throws Exception {
        ...
        // ═══════════════════════════════════════════════════════════════════════
        Allure.label("enhancement", "ENHANCED");
        Allure.addAttachment("📝 Original Failure", "text/plain", "Original Status: 200\nOriginal Response: {\"status\":0,\"msg\":\"start or end station not include in stationList.\",\"data\":null}\nEnhanced Parameters: {endStation=Times Square Station, startStation=Grand Central Terminal}");
        ...
        es.us.isa.restest.enhancer.TestResultCapture.addParameter(
            ...
            "12.5,8.2,15.7,22.1,5.9", false);
        es.us.isa.restest.enhancer.TestResultCapture.addParameter(
            "endStation", "Los Angeles Union Station", 
            "string", "formData", 
            null, 
            null, false);
        es.us.isa.restest.enhancer.TestResultCapture.addParameter(
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute [expect not 200]", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":123,\"endStation\":\"Times Square Station\",\"id\":\"beijing\",\"loginId\":\"admin_user_001\",\"startStation\":\"Grand Central Terminal\",\"stationList\":\"Grand Central Terminal,Penn Station,Union Station,Times Square Station,Broadway Station\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":123,\"endStation\":\"Times Square Station\",\"id\":\"beijing\",\"loginId\":\"admin_user_001\",\"startStation\":\"Grand Central Terminal\",\"stationList\":\"Grand Central Terminal,Penn Station,Union Station,Times Square Station,Broadway Station\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               .extract().response();
                        ...
                        // Build map of designed invalid parameters for this negative test
                        java.util.Map<String, String> invalidParams = new java.util.HashMap<>();
                        invalidParams.put("distanceList", "123");
            ...
            Allure.step("Step 1: ts-admin-route-service POST /api/v1/adminrouteservice/adminroute [expect 200]", () -> {
                ...
                if (!shouldSkip) {
                    ...
                    try {
                        ...
                        // 🔥 FIX: Set Content-Type to application/json for requests with bodies
                        req = req.contentType("application/json");
                        String requestBody1 = "{\"distanceList\":\"20.3\",\"endStation\":\"Union Station\",\"id\":\"AR-2025-001\",\"loginId\":\"admin_user_001\",\"startStation\":\"Grand Central Terminal\",\"stationList\":\"Grand Central Terminal,Penn Station,Union Station,Times Square Station,Broadway Station\"}";
                        req = req.body(requestBody1);
                        ...
                        allStepParameters.put("body", "{\"distanceList\":\"20.3\",\"endStation\":\"Union Station\",\"id\":\"AR-2025-001\",\"loginId\":\"admin_user_001\",\"startStation\":\"Grand Central Terminal\",\"stationList\":\"Grand Central Terminal,Penn Station,Union Station,Times Square Station,Broadway Station\"}");
                        // 🔥 FIX: Extract response FIRST (before status code assertion) to capture response body in all cases
                        stepResponse1 = req.when().post("/api/v1/adminrouteservice/adminroute")
                               .then().log().ifValidationFails()
                               .extract().response();
                                    ...
                                    if (dataValue instanceof org.json.JSONObject) {
                                        ...
                                        if (dataObj.optBoolean("injected", false)) {
                                            ...
                                            if (!detectedFaultName.isEmpty()) {
                                                ...
                                                System.out.println("🔍 FAULT DETECTED (in failed test): " + detectedFaultName + " in test: test_POST_1_5");
                                            }
                                        }
                                    }
                                }
