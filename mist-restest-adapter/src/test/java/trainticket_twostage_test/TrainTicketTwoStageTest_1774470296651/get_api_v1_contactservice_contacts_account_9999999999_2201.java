...
public class get_api_v1_contactservice_contacts_account_9999999999_2201 {
    ...
    public void test_negative_GET_2201_53() throws Exception {
        ...
        Allure.parameter("🔴 Invalid Parameters", "accountId=9999999999");
        ...
        es.us.isa.restest.enhancer.TestResultCapture.addInvalidParameter("accountId=9999999999");
        ...
        // Step 1: ts-contacts-service GET /api/v1/contactservice/contacts/account/9999999999 [expect not 200]
        ...
        try {
            Allure.step("Step 1: ts-contacts-service GET /api/v1/contactservice/contacts/account/9999999999 [expect not 200]", () -> {
                ...
                if (!shouldSkip) {
                    System.out.println("▶️ EXECUTING: Step 1: ts-contacts-service GET /api/v1/contactservice/contacts/account/9999999999 [expect not 200] (dependency analysis passed)");
                    ...
                    try {
                        ...
                        invalidParams.put("accountId", "9999999999");
                        ...
                        System.out.println("✅ Step 1: ts-contacts-service GET /api/v1/contactservice/contacts/account/9999999999 [expect not 200] - SUCCESS");
                        ...
                        System.out.println("❌ Step 1: ts-contacts-service GET /api/v1/contactservice/contacts/account/9999999999 [expect not 200] - FAILED: " + t.getMessage());
                        ...
                        errorDetails.append("=====================================\n\n");
                        errorDetails.append("📋 Step: Step 1: ts-contacts-service GET /api/v1/contactservice/contacts/account/9999999999 [expect not 200]\n");
                        ...
                        throw new RuntimeException("Step 1: ts-contacts-service GET /api/v1/contactservice/contacts/account/9999999999 [expect not 200] failed: " + failureReason + " (" + errorType + ")", t);
                    }
                } else {
                    // ⏭️ SKIP: Clean skip reporting with proper Allure status
                    System.out.println("⏭️ SKIPPING: Step 1: ts-contacts-service GET /api/v1/contactservice/contacts/account/9999999999 [expect not 200] - " + skipReason);
                    stepResults.put(1, false);
            ...
            if (stepException instanceof RuntimeException && stepException.getMessage().startsWith("Step failed:")) {
                ...
                System.out.println("⚠️ Step wrapper failed for Step 1: ts-contacts-service GET /api/v1/contactservice/contacts/account/9999999999 [expect not 200]: " + stepException.getMessage());
                stepResults.put(1, false);
            }
        }
