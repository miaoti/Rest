...
public final class SutHealthCheck {
    ...
    /**
     * Default HTTP-based probe. Sends the requested verb at the URL with a
     * 0-byte body, follows no redirects, treats anything &lt; 500 as
     * reachable. {@code timeoutMs} bounds both connect and read.
     *
