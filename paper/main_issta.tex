...
MIST is open-source and available at \url{https://github.com/miaoti/Rest/}, with documentation covering installation, configuration, and a TrainTicket walkthrough. A screencast demonstrating MIST on the TrainTicket benchmark is at \url{https://TODO-screencast.example.invalid}. The archived snapshot used in this paper is available at \url{https://TODO-zenodo-doi.example.invalid}.
