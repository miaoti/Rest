...
\node[durlbl]  at (16.95, -1.55) {0.2\,ms};
...
% =============================================================
\node[vbox, anchor=north west] (vrd) at (-0.05, -1.95) {%
\textbf{Trace Shape Oracle verdict.}\\[2pt]
\begin{tabular}{@{}l@{\hspace{0.7em}}p{6.4cm}@{}}
\textbf{Response-level} & \emph{passes / misses}: entry is \texttt{HTTP 200}; a status-, schema-, or body-only oracle records the run as success. \\
\textbf{StatusPropagation} & passes (no learned per-API baseline for this SUT). \\
...
% =============================================================
\node[bodybox, anchor=north east] (body) at (16.95, -1.95) {%
\textnormal{\footnotesize\textbf{Client response}} (HTTP 200):\\[2pt]
reviews rendered \emph{without} ratings\\
