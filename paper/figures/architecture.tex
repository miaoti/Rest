...
\node[stage] (mut)      at (9.8, -0.65) {\textbf{(iv) Sniper Strategy}\\one fault per variant};
\node[stage] (oracle)   at (6.6, -0.65) {\textbf{(v) Trace Shape Oracle}\\4 learned + 2 structural};
